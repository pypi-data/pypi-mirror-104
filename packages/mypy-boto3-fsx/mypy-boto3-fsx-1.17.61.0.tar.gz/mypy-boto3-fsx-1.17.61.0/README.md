...
[boto3.FSx 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/fsx.html#FSx) service
compatible with
...
def check_value(value: AliasLifecycle) -> bool:
    ...
```
