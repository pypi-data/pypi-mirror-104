...
from cowin_api.api.appointment_availability_ap_is_api import (
    AsyncAppointmentAvailabilityAPIsApi,
    SyncAppointmentAvailabilityAPIsApi,
)
from cowin_api.api.authentication_ap_is_api import AsyncAuthenticationAPIsApi, SyncAuthenticationAPIsApi
from cowin_api.api.beneficiary_registration_ap_is_api import (
    AsyncBeneficiaryRegistrationAPIsApi,
    SyncBeneficiaryRegistrationAPIsApi,
)
from cowin_api.api.certificate_ap_is_api import AsyncCertificateAPIsApi, SyncCertificateAPIsApi
from cowin_api.api.metadata_ap_is_api import AsyncMetadataAPIsApi, SyncMetadataAPIsApi
from cowin_api.api.user_authentication_ap_is_api import AsyncUserAuthenticationAPIsApi, SyncUserAuthenticationAPIsApi
from cowin_api.api.vaccination_appointment_ap_is_api import (
    AsyncVaccinationAppointmentAPIsApi,
    SyncVaccinationAppointmentAPIsApi,
)
from cowin_api.exceptions import ResponseHandlingException, UnexpectedResponse
