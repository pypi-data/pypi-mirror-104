...
- buttons (list; default [    "screenshot",    "expand",    "download",    "guided_tour",    "contact_person",]):
    Array of strings, representing which buttons to render. Full set
    is ['download', 'contact_person', 'guided_tour', 'screenshot',
    'expand'].

- contact_person (dict; default undefined):
...
- download (dict; default undefined):
...
- tour_steps (list; optional):
    ...
    and 'content')."""
    @_explicitize_args
    def __init__(self, children=None, id=Component.UNDEFINED, buttons=Component.UNDEFINED, contact_person=Component.UNDEFINED, download=Component.UNDEFINED, screenshot_filename=Component.UNDEFINED, tour_steps=Component.UNDEFINED, data_requested=Component.UNDEFINED, deprecation_warnings=Component.UNDEFINED, **kwargs):
        self._prop_names = ['children', 'id', 'buttons', 'contact_person', 'data_requested', 'deprecation_warnings', 'download', 'screenshot_filename', 'tour_steps']
        self._type = 'WebvizPluginPlaceholder'
        self._namespace = 'webviz_core_components'
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'buttons', 'contact_person', 'data_requested', 'deprecation_warnings', 'download', 'screenshot_filename', 'tour_steps']
