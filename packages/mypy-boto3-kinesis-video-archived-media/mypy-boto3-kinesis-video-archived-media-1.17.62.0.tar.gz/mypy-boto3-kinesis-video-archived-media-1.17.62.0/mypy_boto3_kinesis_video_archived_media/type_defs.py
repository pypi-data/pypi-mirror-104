...
FragmentSelectorTypeDef = TypedDict(
    "FragmentSelectorTypeDef",
    {"FragmentSelectorType": FragmentSelectorType, "TimestampRange": "TimestampRangeTypeDef"},
)
...
HLSFragmentSelectorTypeDef = TypedDict(
    "HLSFragmentSelectorTypeDef",
    {"FragmentSelectorType": HLSFragmentSelectorType, "TimestampRange": "HLSTimestampRangeTypeDef"},
    total=False,
)
