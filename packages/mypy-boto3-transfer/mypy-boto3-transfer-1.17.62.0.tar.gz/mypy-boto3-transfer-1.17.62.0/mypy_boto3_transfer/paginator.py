...
class ListServersPaginator(Boto3Paginator):
    """
    [Paginator.ListServers documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/transfer.html#Transfer.Paginator.ListServers)
    """
    ...
    def paginate(
        ...
        """
        [ListServers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/transfer.html#Transfer.Paginator.ListServers.paginate)
        """
