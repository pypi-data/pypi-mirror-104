...
[boto3.Transfer 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/transfer.html#Transfer) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_transfer/README.md)
...
def check_value(value: Domain) -> bool:
    ...
```
...
def get_structure() -> CreateServerResponseTypeDef:
    return {
      ...
    }
```
