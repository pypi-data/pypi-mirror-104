...
if __name__ == '__main__':
    ...
    try:
        ...
        manager.ads_client.add_tag({"name":"GIO.xbControlPower"})
        manager.ads_client.add_tag({"name":"GNV.fTouchLoadSetPounds"})
        manager.ads_client.add_tag({"name":"GNV.fFinalLoadSetPounds"})
