...
[boto3.CodeGuruReviewer 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/codeguru-reviewer.html#CodeGuruReviewer)
...
[mypy-boto3-codeguru-reviewer docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_codeguru_reviewer/README.md)
...
def get_structure() -> AssociateRepositoryResponseTypeDef:
    return {
      ...
    }
```
