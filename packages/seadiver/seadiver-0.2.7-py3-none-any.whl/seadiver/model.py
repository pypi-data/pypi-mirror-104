...
class ANN():
    ...
    def export(self, directory=r".", file_name= "model_" + str(time.localtime().tm_year) + "-" + str(time.localtime().tm_mon) + "-" + str(time.localtime().tm_mday) + "-" + str(time.localtime().tm_hour) + ":" + str(time.localtime().tm_min) + ".json", include = "all"):
        ...
        if include not in compat_include_params:
            ...
            if type(inlclude) == list or type(inlclude) == tuple or type(inlclude) == set:
        ...
        #optional export
        if include == "all" or "error_log" in include:
        ...
        if include == "all" or "gradients" in include:
        ...
        if include == "all" or "fan_io" in include:
