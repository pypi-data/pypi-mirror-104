...
QueryErrorTypeDef = TypedDict(
    "QueryErrorTypeDef", {"ErrorCode": QueryErrorCode, "Message": str}, total=False
)
...
ResourceStatusTypeDef = TypedDict(
    "ResourceStatusTypeDef", {"Name": ResourceStatusValue}, total=False
)
...
GroupFilterTypeDef = TypedDict("GroupFilterTypeDef", {"Name": GroupFilterName, "Values": List[str]})
...
ResourceFilterTypeDef = TypedDict(
    "ResourceFilterTypeDef", {"Name": ResourceFilterName, "Values": List[str]}
)
