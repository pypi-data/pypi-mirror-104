...
@click.option("--max_depth", default=30000, help="Maximum read depth for calculation")
def calculate_noise(ref_fasta, bam_file, bed_file, sample_id, threshold, truncate, min_mapq, min_basq, max_depth):
    """
