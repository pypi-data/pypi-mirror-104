...
def removeDuplicateEntries(filepath, questionType):
...
#open csv file
def putInCsv(Topic_Number,Number_Of_Iterations,Main_Function,Filename,Remove_Duplicates=True,Create_Textfile=False):
    ...
    if(Remove_Duplicates == True):
        removeDuplicateEntries(csv_filename, questionType)
