...
class DescribeBucketsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeBuckets.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.DescribeBuckets.paginate)
        """
...
class GetUsageStatisticsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetUsageStatistics.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.GetUsageStatistics.paginate)
        """
...
class ListClassificationJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListClassificationJobs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListClassificationJobs.paginate)
        """
...
class ListCustomDataIdentifiersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListCustomDataIdentifiers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListCustomDataIdentifiers.paginate)
        """
...
class ListFindingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFindings.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListFindings.paginate)
        """
...
class ListFindingsFiltersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListFindingsFilters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListFindingsFilters.paginate)
        """
...
class ListInvitationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInvitations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListInvitations.paginate)
        """
...
class ListMembersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListMembers.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListMembers.paginate)
        """
...
class ListOrganizationAdminAccountsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListOrganizationAdminAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/macie2.html#Macie2.Paginator.ListOrganizationAdminAccounts.paginate)
        """
