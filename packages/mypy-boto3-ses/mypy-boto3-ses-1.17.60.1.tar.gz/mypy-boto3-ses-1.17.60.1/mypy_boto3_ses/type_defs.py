...
DeliveryOptionsTypeDef = TypedDict("DeliveryOptionsTypeDef", {"TlsPolicy": TlsPolicy}, total=False)
...
_RequiredIdentityDkimAttributesTypeDef = TypedDict(
    ...
    {"DkimEnabled": bool, "DkimVerificationStatus": VerificationStatus},
)
...
_RequiredIdentityVerificationAttributesTypeDef = TypedDict(
    "_RequiredIdentityVerificationAttributesTypeDef", {"VerificationStatus": VerificationStatus}
)
...
_OptionalLambdaActionTypeDef = TypedDict(
    "_OptionalLambdaActionTypeDef", {"TopicArn": str, "InvocationType": InvocationType}, total=False
)
...
ReceiptIpFilterTypeDef = TypedDict(
    "ReceiptIpFilterTypeDef", {"Policy": ReceiptFilterPolicy, "Cidr": str}
)
...
_RequiredRecipientDsnFieldsTypeDef = TypedDict(
    "_RequiredRecipientDsnFieldsTypeDef", {"Action": DsnAction, "Status": str}
)
...
_OptionalSNSActionTypeDef = TypedDict(
    "_OptionalSNSActionTypeDef", {"Encoding": SNSActionEncoding}, total=False
)
...
_RequiredStopActionTypeDef = TypedDict("_RequiredStopActionTypeDef", {"Scope": StopScope})
