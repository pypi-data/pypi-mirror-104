...
[boto3.SES 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/ses.html#SES) service
compatible with
...
`mypy_boto3_ses.literals` module contains literals extracted from shapes
