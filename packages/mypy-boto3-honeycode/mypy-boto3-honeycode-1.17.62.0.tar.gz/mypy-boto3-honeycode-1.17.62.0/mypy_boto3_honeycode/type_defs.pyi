...
DataItemTypeDef = TypedDict(
    "DataItemTypeDef",
    {"overrideFormat": Format, "rawValue": str, "formattedValue": str},
    total=False,
)
...
UpsertRowsResultTypeDef = TypedDict(
    "UpsertRowsResultTypeDef", {"rowIds": List[str], "upsertAction": UpsertAction}
)
...
StartTableDataImportJobResultTypeDef = TypedDict(
    "StartTableDataImportJobResultTypeDef", {"jobId": str, "jobStatus": TableDataImportJobStatus}
)
