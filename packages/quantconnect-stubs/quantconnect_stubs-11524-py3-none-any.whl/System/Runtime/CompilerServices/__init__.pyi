...
System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T = typing.TypeVar("System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T")
...
class InterpolatedStringBuilder:
    """Provides a builder used by the language compiler to process interpolated strings into string instances."""

    @typing.overload
    def AppendFormatted(self, value: System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T) -> None:
        ...

    @typing.overload
    def AppendFormatted(self, value: System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T, format: str) -> None:
        """
    ...
    @typing.overload
    def AppendFormatted(self, value: System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T, alignment: int) -> None:
        """
        Writes the specified value to the builder.
    ...
    @typing.overload
    def AppendFormatted(self, value: System_Runtime_CompilerServices_InterpolatedStringBuilder_AppendFormatted_T, alignment: int, format: str) -> None:
        """
        Writes the specified value to the builder.
    ...
    @staticmethod
    @typing.overload
    def Create(literalLength: int, formattedCount: int) -> System.Runtime.CompilerServices.InterpolatedStringBuilder:
        """
        Creates a builder used to translate an interpolated string into a string.
        
        :param literalLength: The number of constant characters outside of holes in the interpolated string.
        :param formattedCount: The number of holes in the interpolated string.
        """
        ...

    @staticmethod
    @typing.overload
    def Create(literalLength: int, formattedCount: int, provider: System.IFormatProvider) -> System.Runtime.CompilerServices.InterpolatedStringBuilder:
        """
        Creates a builder used to translate an interpolated string into a string.
    ...
    @staticmethod
    @typing.overload
    def Create(literalLength: int, formattedCount: int, scratchBuffer: System.Span[str]) -> System.Runtime.CompilerServices.InterpolatedStringBuilder:
        """
        Creates a builder used to translate an interpolated string into a string.
        
        :param literalLength: The number of constant characters outside of holes in the interpolated string.
        :param formattedCount: The number of holes in the interpolated string.
        :param scratchBuffer: A buffer temporarily transferred to the builder for use as part of its formatting.  Contents may be overwritten.
        """
        ...

    @staticmethod
    @typing.overload
    def Create(literalLength: int, formattedCount: int, provider: System.IFormatProvider, scratchBuffer: System.Span[str]) -> System.Runtime.CompilerServices.InterpolatedStringBuilder:
        """
        Creates a builder used to translate an interpolated string into a string.
    ...
    def ToStringAndClear(self) -> str:
        """
        Gets the built string and clears the builder.
