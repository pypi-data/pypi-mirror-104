...
class Api(System.Object, QuantConnect.Interfaces.IApi, QuantConnect.Interfaces.IDownloadProvider):
    ...
    def DownloadData(self, symbol: typing.Union[QuantConnect.Symbol, str], resolution: QuantConnect.Resolution, date: typing.Union[datetime.datetime, datetime.date]) -> bool:
        """
    ...
    def ReadDataLink(self, symbol: typing.Union[QuantConnect.Symbol, str], resolution: QuantConnect.Resolution, date: typing.Union[datetime.datetime, datetime.date]) -> QuantConnect.Api.Link:
        """
