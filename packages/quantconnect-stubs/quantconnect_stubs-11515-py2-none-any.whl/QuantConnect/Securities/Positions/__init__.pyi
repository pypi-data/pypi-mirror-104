...
class GetMaximumLotsForTargetBuyingPowerParameters(System.Object):
    ...
    def __init__(self, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroup: QuantConnect.Securities.Positions.IPositionGroup, targetBuyingPower: float, silenceNonErrorReasons: bool = False) -> None:
        """
...
class GetMaximumLotsForDeltaBuyingPowerParameters(System.Object):
    ...
    def __init__(self, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroup: QuantConnect.Securities.Positions.IPositionGroup, deltaBuyingPower: float, silenceNonErrorReasons: bool = False) -> None:
        """
...
class PositionExtensions(System.Object):
    ...
    @staticmethod
    def GetNumberOfLots(position: QuantConnect.Securities.Positions.IPosition) -> float:
        """Gets the number of lots contained within the specified"""
        ...
...
class PositionGroupBuyingPowerModelExtensions(System.Object):
    ...
    @staticmethod
    def GetChangeInReservedBuyingPower(model: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroup: QuantConnect.Securities.Positions.IPositionGroup, order: QuantConnect.Orders.Order) -> float:
        """
    ...
    @staticmethod
    def GetMaximumLotsForDeltaBuyingPower(model: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroup: QuantConnect.Securities.Positions.IPositionGroup, deltaBuyingPower: float) -> QuantConnect.Securities.Positions.GetMaximumLotsResult:
        """
        Get the maximum market position group order quantity to obtain a delta in the buying power used by a position group.
        The deltas sign defines the position side to apply it to, positive long, negative short.
        """
    ...
    @staticmethod
    def GetMaximumLotsForTargetBuyingPower(model: QuantConnect.Securities.Positions.IPositionGroupBuyingPowerModel, portfolio: QuantConnect.Securities.SecurityPortfolioManager, positionGroup: QuantConnect.Securities.Positions.IPositionGroup, targetBuyingPower: float) -> QuantConnect.Securities.Positions.GetMaximumLotsResult:
        """
        Get the maximum position group order quantity to obtain a position with a given buying power
        percentage. Will not take into account free buying power.
        """
