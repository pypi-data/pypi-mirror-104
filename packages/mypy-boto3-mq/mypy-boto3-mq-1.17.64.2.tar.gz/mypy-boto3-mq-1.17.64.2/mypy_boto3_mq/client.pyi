...
class MQClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.can_paginate)
    ...
    def create_broker(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.create_broker)
    ...
    def create_configuration(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.create_configuration)
    ...
    def create_tags(self, ResourceArn: str, Tags: Dict[str, str] = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.create_tags)
    ...
    def create_user(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.create_user)
    ...
    def delete_broker(self, BrokerId: str) -> DeleteBrokerResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.delete_broker)
    ...
    def delete_tags(self, ResourceArn: str, TagKeys: List[str]) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.delete_tags)
    ...
    def delete_user(self, BrokerId: str, Username: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.delete_user)
    ...
    def describe_broker(self, BrokerId: str) -> DescribeBrokerResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_broker)
    ...
    def describe_broker_engine_types(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_broker_engine_types)
    ...
    def describe_broker_instance_options(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_broker_instance_options)
    ...
    def describe_configuration(self, ConfigurationId: str) -> DescribeConfigurationResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_configuration)
    ...
    def describe_configuration_revision(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_configuration_revision)
    ...
    def describe_user(self, BrokerId: str, Username: str) -> DescribeUserResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.describe_user)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.generate_presigned_url)
    ...
    def list_brokers(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.list_brokers)
    ...
    def list_configuration_revisions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.list_configuration_revisions)
    ...
    def list_configurations(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.list_configurations)
    ...
    def list_tags(self, ResourceArn: str) -> ListTagsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.list_tags)
    ...
    def list_users(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.list_users)
    ...
    def reboot_broker(self, BrokerId: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.reboot_broker)
    ...
    def update_broker(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.update_broker)
    ...
    def update_configuration(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.update_configuration)
    ...
    def update_user(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Client.update_user)
    ...
    def get_paginator(self, operation_name: Literal["list_brokers"]) -> ListBrokersPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/mq.html#MQ.Paginator.ListBrokers)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_mq/paginators.html#listbrokerspaginator)
        """
