...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', '4.1.0-alpha.1619780403+c916b3cb'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault 4.1.0-alpha.1619780403+c916b3cb`
                """)
            else:
                raise
