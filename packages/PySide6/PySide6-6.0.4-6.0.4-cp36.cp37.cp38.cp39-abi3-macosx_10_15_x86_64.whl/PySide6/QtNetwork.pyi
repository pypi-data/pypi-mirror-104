...
class QHostInfo(Shiboken.Object):
    ...
    def setAddresses(self, addresses: typing.Sequence[PySide6.QtNetwork.QHostAddress]) -> None: ...
...
class QNetworkAccessManager(PySide6.QtCore.QObject):
    ...
    def addStrictTransportSecurityHosts(self, knownHosts: typing.Sequence[PySide6.QtNetwork.QHstsPolicy]) -> None: ...
...
class QNetworkCacheMetaData(Shiboken.Object):
    ...
    def setRawHeaders(self, headers: typing.Sequence[typing.Tuple[PySide6.QtCore.QByteArray, PySide6.QtCore.QByteArray]]) -> None: ...
...
class QNetworkCookie(Shiboken.Object):
    ...
    @staticmethod
    def parseCookies(cookieString: PySide6.QtCore.QByteArray) -> typing.List[PySide6.QtNetwork.QNetworkCookie]: ...
    def path(self) -> str: ...
...
class QNetworkCookieJar(PySide6.QtCore.QObject):
    ...
    def cookiesForUrl(self, url: PySide6.QtCore.QUrl) -> typing.List[PySide6.QtNetwork.QNetworkCookie]: ...
    ...
    def setAllCookies(self, cookieList: typing.Sequence[PySide6.QtNetwork.QNetworkCookie]) -> None: ...
    def setCookiesFromUrl(self, cookieList: typing.Sequence[PySide6.QtNetwork.QNetworkCookie], url: PySide6.QtCore.QUrl) -> bool: ...
...
class QNetworkProxyFactory(Shiboken.Object):
    ...
    @staticmethod
    def proxyForQuery(query: PySide6.QtNetwork.QNetworkProxyQuery) -> typing.List[PySide6.QtNetwork.QNetworkProxy]: ...
    def queryProxy(self, query: PySide6.QtNetwork.QNetworkProxyQuery = ...) -> typing.List[PySide6.QtNetwork.QNetworkProxy]: ...
    @staticmethod
    ...
    @staticmethod
    def systemProxyForQuery(query: PySide6.QtNetwork.QNetworkProxyQuery = ...) -> typing.List[PySide6.QtNetwork.QNetworkProxy]: ...
    @staticmethod
...
class QNetworkReply(PySide6.QtCore.QIODevice):
    ...
    @typing.overload
    def ignoreSslErrors(self, errors: typing.Sequence[PySide6.QtNetwork.QSslError]) -> None: ...
    def ignoreSslErrorsImplementation(self, arg__1: typing.Sequence[PySide6.QtNetwork.QSslError]) -> None: ...
    def isFinished(self) -> bool: ...
...
class QSslCertificate(Shiboken.Object):
    ...
    @staticmethod
    def fromData(data: PySide6.QtCore.QByteArray, format: PySide6.QtNetwork.QSsl.EncodingFormat = ...) -> typing.List[PySide6.QtNetwork.QSslCertificate]: ...
    @staticmethod
    ...
    @typing.overload
    def issuerInfo(self, attribute: PySide6.QtCore.QByteArray) -> typing.List[str]: ...
    @typing.overload
    ...
    @typing.overload
    def subjectInfo(self, attribute: PySide6.QtCore.QByteArray) -> typing.List[str]: ...
    @typing.overload
    ...
    def toText(self) -> str: ...
    @staticmethod
    def verify(certificateChain: typing.Sequence[PySide6.QtNetwork.QSslCertificate], hostName: str = ...) -> typing.List[PySide6.QtNetwork.QSslError]: ...
...
class QSslConfiguration(Shiboken.Object):
    ...
    @typing.overload
    def addCaCertificates(self, certificates: typing.Sequence[PySide6.QtNetwork.QSslCertificate]) -> None: ...
    @typing.overload
    ...
    def setAllowedNextProtocols(self, protocols: typing.Sequence[PySide6.QtCore.QByteArray]) -> None: ...
    ...
    def setCaCertificates(self, certificates: typing.Sequence[PySide6.QtNetwork.QSslCertificate]) -> None: ...
    @typing.overload
    def setCiphers(self, ciphers: typing.Sequence[PySide6.QtNetwork.QSslCipher]) -> None: ...
    @typing.overload
    ...
    def setLocalCertificateChain(self, localChain: typing.Sequence[PySide6.QtNetwork.QSslCertificate]) -> None: ...
...
class QUdpSocket(PySide6.QtNetwork.QAbstractSocket):
    ...
    def readDatagram(self, data: bytes, maxlen: int, host: PySide6.QtNetwork.QHostAddress) -> typing.Tuple[int, int]: ...
