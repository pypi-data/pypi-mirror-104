...
enum : int {
    ...
    SBK_QFUTUREINTERFACEBASE_STATE_IDX                       = 140,
    SBK_QFUTUREINTERFACEBASE_IDX                             = 139,
    SBK_QGENERICARGUMENT_IDX                                 = 141,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 142,
    SBK_QIODEVICE_IDX                                        = 143,
    SBK_QIODEVICEBASE_OPENMODEFLAG_IDX                       = 145,
    SBK_QFLAGS_QIODEVICEBASE_OPENMODEFLAG_IDX                = 102,
    SBK_QIODEVICEBASE_IDX                                    = 144,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 146,
    SBK_QITEMSELECTION_IDX                                   = 147,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 147,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 149,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 103,
    SBK_QITEMSELECTIONMODEL_IDX                              = 148,
    SBK_QITEMSELECTIONRANGE_IDX                              = 150,
    SBK_QJSONARRAY_IDX                                       = 151,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 153,
    SBK_QJSONDOCUMENT_IDX                                    = 152,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 155,
    SBK_QJSONPARSEERROR_IDX                                  = 154,
    SBK_QJSONVALUE_TYPE_IDX                                  = 157,
    SBK_QJSONVALUE_IDX                                       = 156,
    SBK_QKEYCOMBINATION_IDX                                  = 158,
    SBK_QLIBRARYINFO_LIBRARYPATH_IDX                         = 160,
    SBK_QLIBRARYINFO_IDX                                     = 159,
    SBK_QLINE_IDX                                            = 161,
    SBK_QLINEF_INTERSECTIONTYPE_IDX                          = 163,
    SBK_QLINEF_IDX                                           = 162,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 169,
    SBK_QLOCALE_SCRIPT_IDX                                   = 404,
    SBK_QLOCALE_COUNTRY_IDX                                  = 165,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 170,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 168,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 171,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 105,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 167,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 402,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 166,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 104,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 403,
    SBK_QLOCALE_IDX                                          = 164,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 173,
    SBK_QLOCKFILE_IDX                                        = 172,
    SBK_QMARGINS_IDX                                         = 174,
    SBK_QMARGINSF_IDX                                        = 175,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 176,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 177,
    SBK_QMETACLASSINFO_IDX                                   = 178,
    SBK_QMETAENUM_IDX                                        = 179,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 181,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 182,
    SBK_QMETAMETHOD_IDX                                      = 180,
    SBK_QMETAOBJECT_CALL_IDX                                 = 184,
    SBK_QMETAOBJECT_IDX                                      = 183,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 185,
    SBK_QMETAPROPERTY_IDX                                    = 186,
    SBK_QMETATYPE_TYPE_IDX                                   = 188,
    SBK_QMETATYPE_TYPEFLAG_IDX                               = 189,
    SBK_QFLAGS_QMETATYPE_TYPEFLAG_IDX                        = 106,
    SBK_QMETATYPE_IDX                                        = 187,
    SBK_QMIMEDATA_IDX                                        = 190,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 192,
    SBK_QMIMEDATABASE_IDX                                    = 191,
    SBK_QMIMETYPE_IDX                                        = 193,
    SBK_QMODELINDEX_IDX                                      = 194,
    SBK_QMUTEX_IDX                                           = 195,
    SBK_QOBJECT_IDX                                          = 196,
    ...
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 225,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 108,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 224,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 223,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 107,
    SBK_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX      = 226,
    SBK_QFLAGS_QREGULAREXPRESSION_WILDCARDCONVERSIONOPTION_IDX = 109,
    SBK_QREGULAREXPRESSION_IDX                               = 222,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 227,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 228,
    SBK_QRESOURCE_COMPRESSION_IDX                            = 230,
    SBK_QRESOURCE_IDX                                        = 229,
    SBK_QRUNNABLE_IDX                                        = 231,
    SBK_QSAVEFILE_IDX                                        = 232,
    SBK_QSEMAPHORE_IDX                                       = 233,
    SBK_QSEMAPHORERELEASER_IDX                               = 234,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 235,
    SBK_QSETTINGS_STATUS_IDX                                 = 239,
    SBK_QSETTINGS_FORMAT_IDX                                 = 237,
    SBK_QSETTINGS_SCOPE_IDX                                  = 238,
    SBK_QSETTINGS_IDX                                        = 236,
    SBK_QSIGNALBLOCKER_IDX                                   = 240,
    SBK_QSIGNALMAPPER_IDX                                    = 241,
    SBK_QSIZE_IDX                                            = 242,
    SBK_QSIZEF_IDX                                           = 243,
    SBK_QSOCKETDESCRIPTOR_IDX                                = 244,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 246,
    SBK_QSOCKETNOTIFIER_IDX                                  = 245,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 247,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 250,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 249,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 110,
    SBK_QSTANDARDPATHS_IDX                                   = 248,
    ...
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 111,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 261,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 267,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 265,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 268,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 266,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 112,
    SBK_QTEXTSTREAM_IDX                                      = 264,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 269,
    SBK_QTHREAD_PRIORITY_IDX                                 = 271,
    SBK_QTHREAD_IDX                                          = 270,
    SBK_QTHREADPOOL_IDX                                      = 272,
    SBK_QTIME_IDX                                            = 273,
    SBK_QTIMELINE_STATE_IDX                                  = 276,
    SBK_QTIMELINE_DIRECTION_IDX                              = 275,
    SBK_QTIMELINE_IDX                                        = 274,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 280,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 278,
    SBK_QTIMEZONE_IDX                                        = 277,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 279,
    SBK_QTIMER_IDX                                           = 281,
    SBK_QTIMEREVENT_IDX                                      = 282,
    SBK_QTRANSLATOR_IDX                                      = 283,
    SBK_QTRANSPOSEPROXYMODEL_IDX                             = 284,
    SBK_QURL_PARSINGMODE_IDX                                 = 287,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 288,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 286,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 113,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 289,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 115,
    SBK_QURL_IDX                                             = 285,
    SBK_QURLQUERY_IDX                                        = 290,
    SBK_QUUID_VARIANT_IDX                                    = 293,
    SBK_QUUID_VERSION_IDX                                    = 294,
    SBK_QUUID_STRINGFORMAT_IDX                               = 292,
    SBK_QUUID_IDX                                            = 291,
    SBK_QVARIANTANIMATION_IDX                                = 295,
    SBK_QVERSIONNUMBER_IDX                                   = 296,
    SBK_QWAITCONDITION_IDX                                   = 297,
    SBK_QWRITELOCKER_IDX                                     = 298,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 299,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 300,
    SBK_QLIST_QXMLSTREAMATTRIBUTE_IDX                        = 300,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 301,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 302,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 303,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 304,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 308,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 307,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 306,
    SBK_QXMLSTREAMREADER_IDX                                 = 305,
    SBK_QXMLSTREAMWRITER_IDX                                 = 309,
    SBK_QT_GLOBALCOLOR_IDX                                   = 344,
    SBK_QT_MOUSEBUTTON_IDX                                   = 360,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 129,
    SBK_QT_ORIENTATION_IDX                                   = 365,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 131,
    SBK_QT_FOCUSPOLICY_IDX                                   = 339,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 378,
    SBK_QT_SORTORDER_IDX                                     = 376,
    SBK_QT_SPLITBEHAVIORFLAGS_IDX                            = 377,
    SBK_QFLAGS_QT_SPLITBEHAVIORFLAGS_IDX                     = 133,
    SBK_QT_TILERULE_IDX                                      = 383,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 311,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 116,
    SBK_QT_TEXTFLAG_IDX                                      = 380,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 379,
    SBK_QT_WHITESPACEMODE_IDX                                = 392,
    SBK_QT_HITTESTACCURACY_IDX                               = 346,
    SBK_QT_WINDOWTYPE_IDX                                    = 397,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 138,
    SBK_QT_WINDOWSTATE_IDX                                   = 396,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 137,
    SBK_QT_APPLICATIONSTATE_IDX                              = 314,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 117,
    SBK_QT_SCREENORIENTATION_IDX                             = 370,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 132,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 393,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 313,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 347,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 123,
    SBK_QT_BGMODE_IDX                                        = 318,
    SBK_QT_KEY_IDX                                           = 354,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 355,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 127,
    SBK_QT_MODIFIER_IDX                                      = 359,
    SBK_QT_ARROWTYPE_IDX                                     = 315,
    SBK_QT_PENSTYLE_IDX                                      = 368,
    SBK_QT_PENCAPSTYLE_IDX                                   = 366,
    SBK_QT_PENJOINSTYLE_IDX                                  = 367,
    SBK_QT_BRUSHSTYLE_IDX                                    = 319,
    SBK_QT_SIZEMODE_IDX                                      = 375,
    SBK_QT_UIEFFECT_IDX                                      = 391,
    SBK_QT_CURSORSHAPE_IDX                                   = 328,
    SBK_QT_TEXTFORMAT_IDX                                    = 381,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 316,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 331,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 118,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 332,
    SBK_QT_TOOLBARAREA_IDX                                   = 386,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 135,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 387,
    SBK_QT_DATEFORMAT_IDX                                    = 329,
    SBK_QT_TIMESPEC_IDX                                      = 384,
    SBK_QT_DAYOFWEEK_IDX                                     = 330,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 371,
    SBK_QT_CASESENSITIVITY_IDX                               = 320,
    SBK_QT_CORNER_IDX                                        = 327,
    SBK_QT_EDGE_IDX                                          = 334,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 120,
    SBK_QT_CONNECTIONTYPE_IDX                                = 324,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 373,
    SBK_QT_FILLRULE_IDX                                      = 337,
    SBK_QT_MASKMODE_IDX                                      = 357,
    SBK_QT_CLIPOPERATION_IDX                                 = 323,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 352,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 353,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 390,
    SBK_QT_AXIS_IDX                                          = 317,
    SBK_QT_FOCUSREASON_IDX                                   = 340,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 325,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 349,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 125,
    SBK_QT_INPUTMETHODHINT_IDX                               = 348,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 124,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 335,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 388,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 356,
    SBK_QT_ANCHORPOINT_IDX                                   = 312,
    SBK_QT_FINDCHILDOPTION_IDX                               = 338,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 121,
    SBK_QT_DROPACTION_IDX                                    = 333,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 119,
    SBK_QT_CHECKSTATE_IDX                                    = 321,
    SBK_QT_ITEMDATAROLE_IDX                                  = 350,
    SBK_QT_ITEMFLAG_IDX                                      = 351,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 126,
    SBK_QT_MATCHFLAG_IDX                                     = 358,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 128,
    SBK_QT_WINDOWMODALITY_IDX                                = 395,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 382,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 134,
    SBK_QT_EVENTPRIORITY_IDX                                 = 336,
    SBK_QT_SIZEHINT_IDX                                      = 374,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 394,
    SBK_QT_COORDINATESYSTEM_IDX                              = 326,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 389,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 136,
    SBK_QT_GESTURESTATE_IDX                                  = 342,
    SBK_QT_GESTURETYPE_IDX                                   = 343,
    SBK_QT_GESTUREFLAG_IDX                                   = 341,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 122,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 363,
    SBK_QT_NAVIGATIONMODE_IDX                                = 364,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 405,
    SBK_QT_TIMERTYPE_IDX                                     = 385,
    SBK_QT_SCROLLPHASE_IDX                                   = 372,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 362,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 361,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 130,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 322,
    SBK_QT_HIGHDPISCALEFACTORROUNDINGPOLICY_IDX              = 345,
    SBK_QT_RETURNBYVALUECONSTANT_IDX                         = 369,
    SBK_QtCoreQT_IDX                                         = 310,
    SBK_QTCOREHELPER_QMUTEXLOCKER_IDX                        = 399,
...
// Converter indices
enum : int {
    SBK_QBYTEARRAYVIEW_IDX                                   = 0,
    SBK_QCHAR_IDX                                            = 1,
    SBK_QJSONOBJECT_IDX                                      = 2,
    SBK_QMODELINDEXLIST_IDX                                  = 3,
    SBK_QSTRING_IDX                                          = 4,
    SBK_QSTRINGLIST_IDX                                      = 5,
    SBK_QSTRINGVIEW_IDX                                      = 6,
    SBK_QVARIANT_IDX                                         = 7,
    SBK_BOOL_IDX                                             = 8,
    SBK_QINTPTR_IDX                                          = 9,
    SBK_QPTRDIFF_IDX                                         = 10,
    SBK_QUINTPTR_IDX                                         = 11,
    SBK_QTCORE_QLIST_QXMLSTREAMNAMESPACEDECLARATION_IDX      = 12, // const QList<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QLIST_QXMLSTREAMENTITYDECLARATION_IDX         = 13, // QList<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMNOTATIONDECLARATION_IDX       = 14, // QList<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 15, // QList<QXmlStreamAttribute >
    SBK_QTCORE_QLIST_INT_IDX                                 = 16, // QList<int > &&
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 17, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 18, // QList<QPair< QString,QString > >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 19, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 20, // QList<QMimeType >
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 21, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 22, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 23, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QBYTEARRAY_IDX                          = 24, // QList<QByteArray >
    SBK_QTCORE_QLIST_QTIMEZONE_OFFSETDATA_IDX                = 25, // QList<QTimeZone::OffsetData >
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 26, // const QList<QVariant > &
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 27, // QList<QItemSelectionRange > &&
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 28, // const QList<QObject* > &
    SBK_QTCORE_QLIST_QURL_IDX                                = 29, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QPOINTF_IDX                             = 30, // QList<QPointF >
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 31, // QList<QFileInfo >
    SBK_QTCORE_QPAIR_QINT64_UNSIGNEDINT_IDX                  = 32, // QPair<qint64,unsigned int >
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 33, // const QList<QCommandLineOption > &
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 34, // const QHash<QString,QVariant > &
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 35, // const QMap<QString,QVariant > &
    SBK_QTCORE_QLIST_QCBORVALUE_IDX                          = 36, // QList<QCborValue >
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 37, // QMap<int,QVariant >
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 38, // const QList<QPersistentModelIndex > &
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 39, // QHash<int,QByteArray >
    SBK_QTCORE_QLIST_QABSTRACTITEMMODELPTR_IDX               = 40, // QList<QAbstractItemModel* >
    SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX  = 41, // QList<QAbstractEventDispatcher::TimerInfo >
    SBK_QTCORE_STD_PAIR_QREAL_QVARIANT_IDX                   = 42, // std::pair<qreal,QVariant >
    SBK_QTCORE_QLIST_STD_PAIR_QREAL_QVARIANT_IDX             = 43, // QList<std::pair< qreal,QVariant > >
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 44, // QList<QString >
    SBK_QtCore_CONVERTERS_IDX_COUNT                          = 45
};
