...
class Tagger:
    ...
    """
    def __init__(self, name, eta_data, dec_data, B_ID, calibrationMode, tau_ps=None, tauerr_ps=None, weight=None, selection=None, resolution_model=None, analytic_gradient=False, DM=None, DG=None):
        # Consistency checks
