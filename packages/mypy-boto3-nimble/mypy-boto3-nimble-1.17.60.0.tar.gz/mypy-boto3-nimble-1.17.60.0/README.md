...
[boto3.NimbleStudio 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/nimble.html#NimbleStudio) service
compatible with
...
def get_structure() -> ActiveDirectoryComputerAttributeTypeDef:
    return {
      ...
    }
```
