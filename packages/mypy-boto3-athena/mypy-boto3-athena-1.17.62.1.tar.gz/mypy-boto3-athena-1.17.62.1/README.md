...
[boto3.Athena 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/athena.html#Athena) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_athena/README.md)
...
def check_value(value: ColumnNullable) -> bool:
    ...
```
...
def get_structure() -> BatchGetNamedQueryOutputTypeDef:
    return {
      ...
    }
```
