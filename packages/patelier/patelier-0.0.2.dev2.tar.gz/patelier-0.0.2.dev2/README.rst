...
* **pip** (Installed with Python) (Tested with Ver. 21.1)
...
* **natsort** (Tested with Ver. 7.1.1)
* **pyperclip** (Tested with Ver. 1.8.2)
* **python-docx** (Tested with Ver. 0.8.10)
* **pywin32** (win32com) (Tested with Ver. 300)
* **regex** (Tested with Ver. 2020.12.9)
...
command::
    ...
    (for upgrade)
    py -3.7 -m pip install -U patelier
