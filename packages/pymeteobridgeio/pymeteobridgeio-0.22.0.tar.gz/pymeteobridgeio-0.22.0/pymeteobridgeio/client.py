        ...
        for values in rows:
            ...
            sensor_item = {
                ...
                "trend_temperature": {
                    ...
                    "device_class": DEVICE_CLASS_NONE,
                    "icon": "trending-up",
                    "unit": await cnv.trend_text(values[42],self._language),
                    },
                "trend_pressure": {
                    "value": values[43],
                    "name": "Pressure Trend",
                    ...
                    "device_class": DEVICE_CLASS_NONE,
                    "icon": "trending-down",
                    "unit": await cnv.trend_text(values[43],self._language),
                    },
                "absolute_pressure": {
                    "value": await cnv.pressure(float(values[44]), self._unit_pressure),
