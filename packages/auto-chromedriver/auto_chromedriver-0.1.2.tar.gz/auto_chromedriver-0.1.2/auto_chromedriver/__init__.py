...
class auto_chromedriver_installer:
	def __init__(self):
		...
		if platform == "linux" or platform == "linux2":
			...
			self.system="MacOS"
			self.file_name = 'chromedriver_mac64.zip'
			self.version_chromium="This Feature Is Not Supperted In MacOS Devices"
		elif platform == "win32":
			self.system="Windows"
			self.file_name = 'chromedriver_win32.zip'
			self.version_chromium="This Feature Is Not Supperted In Windows Devices"
