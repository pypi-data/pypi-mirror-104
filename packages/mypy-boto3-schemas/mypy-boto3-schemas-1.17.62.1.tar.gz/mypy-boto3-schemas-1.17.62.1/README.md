...
[boto3.Schemas 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/schemas.html#Schemas) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_schemas/README.md)
...
def get_structure() -> CreateDiscovererResponseTypeDef:
    return {
      ...
    }
```
