"""
Main interface for schemas service literal definitions.
...
CodeGenerationStatus = Literal["CREATE_COMPLETE", "CREATE_FAILED", "CREATE_IN_PROGRESS"]
DiscovererState = Literal["STARTED", "STOPPED"]
