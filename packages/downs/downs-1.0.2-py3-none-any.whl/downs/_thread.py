...
class nThread:
	...
	def __repr__(self):
		return '<class nThread with '+str(self.__n)+' threads and '+str(self.__waits)+' seconds wait time>'

	def __str__(self):
		return '<class nThread with '+str(self.__n)+' threads and '+str(self.__waits)+' seconds wait time>'

	def __del__(self):
		print('del this nThread, but '+str(self.__n)+'(or less) threads are running...')
