"""
Author: ifm CSR
This script provides logging features for logging data to file
...
class ImageLogger:
        ...
        try:
            for key in list(dictToSave.keys()):
                if 'distance' in key.lower():
                    ...
                    raise NameError('The data field of the supplied key can not be written to a png file currently.') from error
        except OSError as e:
    ...
    def __write_h5(self, data, name, filename=None):
        ...
        try:
            ...
            print('Data can not be written to file')
            print(e)
            pass
