...
from ml_investment.pipelines import BasePipeline, MergePipeline, \
...
if __name__ == '__main__':
    ...
    pipeline = MergePipeline(
        pipeline_list=[
            BasePipeline.load('{}/fair_marketcap_sf1.pickle'.format(
                                                    config['models_path'])),
            BasePipeline.load('{}/fair_marketcap_diff_sf1.pickle'.format(
                                                    config['models_path'])),
            BasePipeline.load('{}/marketcap_down_std_sf1.pickle'.format(
                                                    config['models_path'])),
