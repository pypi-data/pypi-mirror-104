...
class Customer(BaseNModel, DictModel, FullTextSearchable):
    ...
    tier_membership             = ndb.StringProperty(required=False)
    ...
    dict_properties     = ['name', 'mobile_phone', 'email', 'gender', 'birth_date', 'reference_code', 'merchant_reference_code',  
                           'tags_list', 'memberships_list', 'tier_membership',
    ...
    @staticmethod    
    def update_KPI(customer_acct, tags_list=None, memberships_list=None, tier_membership=None):
    ...
    @classmethod
    def create(cls, merchant_acct=None, outlet=None, name=None, email=None, mobile_phone=None, merchant_reference_code=None,
               password=None):
