...
class GoogleBigQuery:
    ...
    def __init__(
        ...
        if key is not None:
            ...
            self.credentials = google.oauth2.service_account.Credentials.from_service_account_info(self.key_info)
            self.gbq = bigquery.Client.from_service_account_json(self.key)
    ...
    def upload_table(
        ...
        print("[upload_and_replace_table] Project '{}': Uploading {:,} rows to BQ: {}...".format(self.project, len(df), dataset_table))
