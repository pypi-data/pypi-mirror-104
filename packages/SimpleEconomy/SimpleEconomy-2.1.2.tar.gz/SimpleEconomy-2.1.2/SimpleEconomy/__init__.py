...
class SimplePost(commands.Cog):
    ...
    async def on_command(self,ctx):
        try:
            r = await requests.post(f"https://simpleco.xyz/commands", headers={"Auth": Api},json={"project":Project,"command_name":str(ctx.command),"guilds":len(Client.guilds)})
