...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'spotinst', '3.2.0-alpha.1619737760+91b2df0f'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource spotinst 3.2.0-alpha.1619737760+91b2df0f`
                """)
            else:
                raise
