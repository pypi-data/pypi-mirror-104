...
ImageStateTypeDef = TypedDict(
    "ImageStateTypeDef", {"status": ImageStatus, "reason": str}, total=False
)
...
InstanceConfigurationTypeDef = TypedDict(
    "InstanceConfigurationTypeDef",
    {"image": str, "blockDeviceMappings": List["InstanceBlockDeviceMappingTypeDef"]},
    total=False,
)
...
_RequiredLaunchTemplateConfigurationTypeDef = TypedDict(
    "_RequiredLaunchTemplateConfigurationTypeDef", {"launchTemplateId": str}
)
_OptionalLaunchTemplateConfigurationTypeDef = TypedDict(
    "_OptionalLaunchTemplateConfigurationTypeDef",
    {"accountId": str, "setDefaultVersion": bool},
    total=False,
)
...
TargetContainerRepositoryTypeDef = TypedDict(
    "TargetContainerRepositoryTypeDef",
    {"service": ContainerRepositoryService, "repositoryName": str},
)
