...
class TopdeskConnector:
	...
	def operational_activity_add_action(self, activity_id: str, text: str, flag: bool):
		"""
		...
		return self.make_request('post', f'operationalActivities/{activity_id}/actions', params=params)
