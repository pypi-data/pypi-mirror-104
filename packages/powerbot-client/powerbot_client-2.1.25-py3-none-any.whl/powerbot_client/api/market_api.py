...
class MarketApi(object):
    ...
    def change_exchange_password(self, credentials, **kwargs):  # noqa: E501
        ...
        :param ChangedCredentials credentials: (required)
        :return: None
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.change_exchange_password_with_http_info(credentials, **kwargs)  # noqa: E501
            return data
    ...
    def change_exchange_password_with_http_info(self, credentials, **kwargs):  # noqa: E501
        ...
        if ('credentials' not in params or
            ...
            raise ValueError("Missing the required parameter `credentials` when calling `change_exchange_password`")  # noqa: E501
