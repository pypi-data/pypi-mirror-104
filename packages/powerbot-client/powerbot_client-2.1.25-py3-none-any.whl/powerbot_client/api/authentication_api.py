...
class AuthenticationApi(object):
    ...
    def add_api_key(self, value, **kwargs):  # noqa: E501
        ...
        :param NewApiKey value: (required)
    ...
    def add_api_key_with_http_info(self, value, **kwargs):  # noqa: E501
        ...
        all_params = ['value', 'x_exchange_password']  # noqa: E501
    ...
    def update_api_key(self, name, value, **kwargs):  # noqa: E501
        ...
        :param UpdatedApiKey value: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.update_api_key_with_http_info(name, value, **kwargs)  # noqa: E501
            return data
    ...
    def update_api_key_with_http_info(self, name, value, **kwargs):  # noqa: E501
        ...
        if ('value' not in params or
                params['value'] is None):
            raise ValueError("Missing the required parameter `value` when calling `update_api_key`")  # noqa: E501
    ...
    def update_api_key_portfolios(self, name, portfolio_ids, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_api_key_portfolios(name, portfolio_ids, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str name: Name of API key (required)
        :param list[str] portfolio_ids: (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.update_api_key_portfolios_with_http_info(name, portfolio_ids, **kwargs)  # noqa: E501
        else:
            (data) = self.update_api_key_portfolios_with_http_info(name, portfolio_ids, **kwargs)  # noqa: E501
            return data

    def update_api_key_portfolios_with_http_info(self, name, portfolio_ids, **kwargs):  # noqa: E501
        """Update the API key's portfolios  # noqa: E501

        Allows you to change the portfolios to which the API key has access to (you need to use the master-API-key or tenant-master-API-key to call this method).  **Heads up** - If the list of portfolios is empty, the API key has access to all portfolios to which the tenant has access to (portfolios are inherited).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.update_api_key_portfolios_with_http_info(name, portfolio_ids, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['name', 'portfolio_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'portfolio_ids' is set
        if ('portfolio_ids' not in params or
                params['portfolio_ids'] is None):
            raise ValueError("Missing the required parameter `portfolio_ids` when calling `update_api_key_portfolios`")  # noqa: E501
        ...
        body_params = None
        if 'portfolio_ids' in params:
            body_params = params['portfolio_ids']
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
