...
class AlgoDetails(object):
    ...
    def __init__(self, algo_id=None, algo_name=None, algo_description=None, require_heartbeat_every_seconds=None, on_missing_heartbeat=None, image=None, instances=None):  # noqa: E501
        """AlgoDetails - a model defined in Swagger"""  # noqa: E501
    ...
    def on_missing_heartbeat(self):
        ...
        Information on how the algorithm will handle orders if a heartbeat is missed  # noqa: E501
    ...
    def on_missing_heartbeat(self, on_missing_heartbeat):
        ...
        :type: str
        """
        allowed_values = ["DO_NOTHING", "DELETE_ORDERS"]  # noqa: E501
        if on_missing_heartbeat not in allowed_values:
            raise ValueError(
                "Invalid value for `on_missing_heartbeat` ({0}), must be one of {1}"  # noqa: E501
                .format(on_missing_heartbeat, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AlgoDetails, dict):
