...
class TradesApi(object):
    ...
    def add_internal_trade(self, new_internal_trade, **kwargs):  # noqa: E501
        ...
        :param NewInternalTrade new_internal_trade: (required)
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.add_internal_trade_with_http_info(new_internal_trade, **kwargs)  # noqa: E501
            return data
    ...
    def add_internal_trade_with_http_info(self, new_internal_trade, **kwargs):  # noqa: E501
        ...
        all_params = ['new_internal_trade']  # noqa: E501
        ...
        if ('new_internal_trade' not in params or
                params['new_internal_trade'] is None):
            raise ValueError("Missing the required parameter `new_internal_trade` when calling `add_internal_trade`")  # noqa: E501
        ...
        body_params = None
        if 'new_internal_trade' in params:
            body_params = params['new_internal_trade']
        # HTTP header `Accept`
