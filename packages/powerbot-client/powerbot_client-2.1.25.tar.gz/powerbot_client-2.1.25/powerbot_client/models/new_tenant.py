...
class NewTenant(object):
    ...
    def __init__(self, id=None, name=None, risk_management=None):  # noqa: E501
        """NewTenant - a model defined in Swagger"""  # noqa: E501
    ...
    def id(self, id):
        ...
        if id is not None and not re.search(r'[a-zA-Z0-9._-]{1,5}', id):  # noqa: E501
