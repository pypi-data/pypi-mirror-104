...
class OrderBookEntry(object):
    ...
    def __init__(self, order_id=None, delivery_area=None, contract_id=None, order_entry_time=None, price=None, quantity=None, exe_restriction=None, type=None):  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderBookEntry, dict):
