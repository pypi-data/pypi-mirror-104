...
class PublicTrade(object):
    ...
    def __init__(self, trade_id=None, buy_delivery_area=None, sell_delivery_area=None, api_timestamp=None, exec_time=None, contract_id=None, price=None, quantity=None, self_trade=None, active=None, state=None):  # noqa: E501
