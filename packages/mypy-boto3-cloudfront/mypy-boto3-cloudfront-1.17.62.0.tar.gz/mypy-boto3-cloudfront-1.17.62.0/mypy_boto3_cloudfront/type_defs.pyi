...
FunctionAssociationTypeDef = TypedDict(
    "FunctionAssociationTypeDef", {"FunctionARN": str, "EventType": EventType}
)

_RequiredFunctionAssociationsTypeDef = TypedDict(
    "_RequiredFunctionAssociationsTypeDef", {"Quantity": int}
)
...
FunctionConfigTypeDef = TypedDict(
    "FunctionConfigTypeDef", {"Comment": str, "Runtime": FunctionRuntime}
)

_RequiredFunctionListTypeDef = TypedDict(
    "_RequiredFunctionListTypeDef", {"MaxItems": int, "Quantity": int}
)
_OptionalFunctionListTypeDef = TypedDict(
    "_OptionalFunctionListTypeDef",
    {"NextMarker": str, "Items": List["FunctionSummaryTypeDef"]},
    total=False,
)
...
_RequiredFunctionMetadataTypeDef = TypedDict(
    "_RequiredFunctionMetadataTypeDef", {"FunctionARN": str, "LastModifiedTime": datetime}
)
_OptionalFunctionMetadataTypeDef = TypedDict(
    "_OptionalFunctionMetadataTypeDef",
    {"Stage": FunctionStage, "CreatedTime": datetime},
    total=False,
)
...
_OptionalFunctionSummaryTypeDef = TypedDict(
    "_OptionalFunctionSummaryTypeDef", {"Status": str}, total=False
)
...
CreateFunctionResultTypeDef = TypedDict(
    "CreateFunctionResultTypeDef",
    {"FunctionSummary": "FunctionSummaryTypeDef", "Location": str, "ETag": str},
    total=False,
)
...
DescribeFunctionResultTypeDef = TypedDict(
    "DescribeFunctionResultTypeDef",
    {"FunctionSummary": "FunctionSummaryTypeDef", "ETag": str},
    total=False,
)
...
GetFunctionResultTypeDef = TypedDict(
    "GetFunctionResultTypeDef",
    {"FunctionCode": Union[bytes, IO[bytes]], "ETag": str, "ContentType": str},
    total=False,
)
...
ListFunctionsResultTypeDef = TypedDict(
    "ListFunctionsResultTypeDef", {"FunctionList": "FunctionListTypeDef"}, total=False
)
...
PublishFunctionResultTypeDef = TypedDict(
    "PublishFunctionResultTypeDef", {"FunctionSummary": "FunctionSummaryTypeDef"}, total=False
)
...
TestFunctionResultTypeDef = TypedDict(
    "TestFunctionResultTypeDef", {"TestResult": "TestResultTypeDef"}, total=False
)
