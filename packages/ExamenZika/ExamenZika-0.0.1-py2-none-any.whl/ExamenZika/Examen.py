...
class Examen:
    ...
    def reiniciarTest(self):
        self.puntos=0
        print("Los puntos del test se han reiniciado")
    def realizarTest(self):
        self.siguientePregunta()


    # Esta funcion utiliza la variable "string" para enseñar por pantalla la pantalla el string que haya puesto para el input,
    ...
    # Esta funcion valida si el valor entrado es un int, si es un string envia el error de vuelta
    ...
    def guardar_resultado(self):
        ...
        resultado=("Nombre alumno: "+ str(nombre_alumno)+ "\n"
        "Puntos: "+str(self.puntos))
        pickle.dump( resultado, open( str(nombre_alumno), "wb" ))
...
class Pregunta:
    ...
    def comprobarRespuesta(self, respuestaUsuario):
        ...
        if respuestaUsuario == self.respuesta:
