...
BuiltinIntentMetadataTypeDef = TypedDict(
    "BuiltinIntentMetadataTypeDef",
    {"signature": str, "supportedLocales": List[Locale]},
    total=False,
)
...
_RequiredLogSettingsRequestTypeDef = TypedDict(
    ...
    {"logType": LogType, "destination": Destination, "resourceArn": str},
)
...
_RequiredMessageTypeDef = TypedDict(
    "_RequiredMessageTypeDef", {"contentType": ContentType, "content": str}
)
...
_RequiredSlotTypeDef = TypedDict(
    "_RequiredSlotTypeDef", {"name": str, "slotConstraint": SlotConstraint}
)
...
GetBuiltinIntentResponseTypeDef = TypedDict(
    "GetBuiltinIntentResponseTypeDef",
    {"signature": str, "supportedLocales": List[Locale], "slots": List["BuiltinIntentSlotTypeDef"]},
    total=False,
)
