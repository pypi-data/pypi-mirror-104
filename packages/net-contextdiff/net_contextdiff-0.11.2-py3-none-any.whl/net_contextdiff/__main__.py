...
def diffconfig(diff, devicename, from_filename, to_filename, output_filename,
               no_output, debug_rules, debug_parser, debug_convert):
    ...
    debug_rules, debug_parser, debug_convert -- the equivalent
...
parser.add_argument(
    ...
    action="count",
    default=0,
    help="enable debugging of contextual parsing (multiple levels "
         "increase verbosity up to a maxmimum of 2)")
...
if debug_rules >= 1:
    print(">> rule tree:")
    print(yaml.dump(diff.get_rules_tree(), default_flow_style=False))
    print(">> rule specs:")
...
if devicenames:
    for devicename in devicenames:
        ...
        complete_success = diffconfig(
                               ...
                               no_output, debug_rules, debug_parser,
                               debug_convert)
    ...
    complete_success = diffconfig(
        ...
        debug_rules, debug_parser, debug_convert)
