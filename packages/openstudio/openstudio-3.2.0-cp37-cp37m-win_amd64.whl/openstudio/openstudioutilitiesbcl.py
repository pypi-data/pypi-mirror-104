...
class OptionalMeasureType(object):
    ...
    def __ref__(self) -> "openstudio::MeasureType":
    ...
    def get(self) -> "openstudio::MeasureType":
        return _openstudioutilitiesbcl.OptionalMeasureType_get(self)

    def set(self, t: "MeasureType") -> "void":
...
class RemoteBCL(BCL):
    ...
    @staticmethod
    def remoteProductionUrl() -> "std::string":
        return _openstudioutilitiesbcl.RemoteBCL_remoteProductionUrl()

    @staticmethod
    def remoteDevelopmentUrl() -> "std::string":
...
def RemoteBCL_isOnline() -> "bool":
    return _openstudioutilitiesbcl.RemoteBCL_isOnline()

def RemoteBCL_remoteProductionUrl() -> "std::string":
    return _openstudioutilitiesbcl.RemoteBCL_remoteProductionUrl()

def RemoteBCL_remoteDevelopmentUrl() -> "std::string":
    return _openstudioutilitiesbcl.RemoteBCL_remoteDevelopmentUrl()
...
class LocalBCL(BCL):
    ...
    def dbPath(self) -> "openstudio::path":
