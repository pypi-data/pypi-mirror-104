...
_OptionalAggregatedValueTypeDef = TypedDict(
    "_OptionalAggregatedValueTypeDef", {"quality": Quality}, total=False
)
...
AssetErrorDetailsTypeDef = TypedDict(
    "AssetErrorDetailsTypeDef", {"assetId": str, "code": AssetErrorCode, "message": str}
)
...
_RequiredAssetModelStatusTypeDef = TypedDict(
    "_RequiredAssetModelStatusTypeDef", {"state": AssetModelState}
)
...
_OptionalAssetPropertyValueTypeDef = TypedDict(
    "_OptionalAssetPropertyValueTypeDef", {"quality": Quality}, total=False
)
...
_RequiredAssetRelationshipSummaryTypeDef = TypedDict(
    "_RequiredAssetRelationshipSummaryTypeDef", {"relationshipType": AssetRelationshipType}
)
...
_RequiredAssetStatusTypeDef = TypedDict("_RequiredAssetStatusTypeDef", {"state": AssetState})
...
ConfigurationErrorDetailsTypeDef = TypedDict(
    "ConfigurationErrorDetailsTypeDef", {"code": ErrorCode, "message": str}
)

_RequiredConfigurationStatusTypeDef = TypedDict(
    "_RequiredConfigurationStatusTypeDef", {"state": ConfigurationState}
)
...
ErrorDetailsTypeDef = TypedDict("ErrorDetailsTypeDef", {"code": ErrorCode, "message": str})
...
GatewayCapabilitySummaryTypeDef = TypedDict(
    "GatewayCapabilitySummaryTypeDef",
    {"capabilityNamespace": str, "capabilitySyncStatus": CapabilitySyncStatus},
)
...
ImageFileTypeDef = TypedDict(
    "ImageFileTypeDef", {"data": Union[bytes, IO[bytes]], "type": ImageFileType}
)
...
InterpolatedAssetPropertyValueTypeDef = TypedDict(
    "InterpolatedAssetPropertyValueTypeDef",
    {"timestamp": "TimeInNanosTypeDef", "value": "VariantTypeDef"},
)

LoggingOptionsTypeDef = TypedDict("LoggingOptionsTypeDef", {"level": LoggingLevel})
...
MonitorErrorDetailsTypeDef = TypedDict(
    "MonitorErrorDetailsTypeDef", {"code": MonitorErrorCode, "message": str}, total=False
)

PortalResourceTypeDef = TypedDict("PortalResourceTypeDef", {"id": str})

_RequiredPortalStatusTypeDef = TypedDict("_RequiredPortalStatusTypeDef", {"state": PortalState})
...
PropertyNotificationTypeDef = TypedDict(
    "PropertyNotificationTypeDef", {"topic": str, "state": PropertyNotificationState}
)
...
_RequiredDescribeDefaultEncryptionConfigurationResponseTypeDef = TypedDict(
    ...
    {"encryptionType": EncryptionType, "configurationStatus": "ConfigurationStatusTypeDef"},
)
...
_OptionalGetInterpolatedAssetPropertyValuesResponseTypeDef = TypedDict(
    "_OptionalGetInterpolatedAssetPropertyValuesResponseTypeDef", {"nextToken": str}, total=False
)
