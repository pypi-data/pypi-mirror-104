...
"""Setup script for the OQS-PycURL module distribution."""
long_description_content_type="text/markdown"
PACKAGE = "pycurl-oqs"
PY_PACKAGE = "pycurl-oqs"
VERSION = "1.0.0"
...
setup_args = dict(
    name=PACKAGE,
    version=VERSION,
    description='OQS-PycURL',
    long_description="",
    author="Anshul Bhardwaj",
    author_email="anshulbhardwaj798@gmail.com",
    maintainer="Anshul Bhardwaj",
    url="https://github.com/anshul798/pycurl.git",
    license="LGPL/MIT",
    keywords=['oqs-curl','curl','oqs-libcurl', 'libcurl', 'urllib', 'wget', 'download', 'file transfer',
        'http', 'www'],
    classifiers=[
