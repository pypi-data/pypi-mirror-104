...
DateRangeTypeDef = TypedDict("DateRangeTypeDef", {"Value": int, "Unit": DateRangeUnit}, total=False)
...
FindingProviderSeverityTypeDef = TypedDict(
    "FindingProviderSeverityTypeDef", {"Label": SeverityLabel, "Original": str}, total=False
)
...
MapFilterTypeDef = TypedDict(
    "MapFilterTypeDef", {"Key": str, "Value": str, "Comparison": MapFilterComparison}, total=False
)
...
SeverityTypeDef = TypedDict(
    "SeverityTypeDef",
    {"Product": float, "Label": SeverityLabel, "Normalized": int, "Original": str},
    total=False,
)
...
StringFilterTypeDef = TypedDict(
    "StringFilterTypeDef", {"Value": str, "Comparison": StringFilterComparison}, total=False
)
...
WorkflowTypeDef = TypedDict("WorkflowTypeDef", {"Status": WorkflowStatus}, total=False)
...
SeverityUpdateTypeDef = TypedDict(
    "SeverityUpdateTypeDef",
    {"Normalized": int, "Product": float, "Label": SeverityLabel},
    total=False,
)

SortCriterionTypeDef = TypedDict(
    "SortCriterionTypeDef", {"Field": str, "SortOrder": SortOrder}, total=False
)
...
WorkflowUpdateTypeDef = TypedDict("WorkflowUpdateTypeDef", {"Status": WorkflowStatus}, total=False)
