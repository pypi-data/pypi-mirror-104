...
class itkAnnulusOperatorD4(itk.itkNeighborhoodOperatorPython.itkNeighborhoodOperatorD4):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    CreateOperator = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_CreateOperator)
    SetInnerRadius = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetInnerRadius)
    GetInnerRadius = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetInnerRadius)
    SetThickness = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetThickness)
    GetThickness = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetThickness)
    SetSpacing = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetSpacing)
    GetSpacing = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetSpacing)
    SetNormalize = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetNormalize)
    GetNormalize = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetNormalize)
    NormalizeOn = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_NormalizeOn)
    NormalizeOff = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_NormalizeOff)
    SetBrightCenter = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetBrightCenter)
    GetBrightCenter = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetBrightCenter)
    BrightCenterOn = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_BrightCenterOn)
    BrightCenterOff = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_BrightCenterOff)
    SetInteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetInteriorValue)
    GetInteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetInteriorValue)
    SetAnnulusValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetAnnulusValue)
    GetAnnulusValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetAnnulusValue)
    SetExteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_SetExteriorValue)
    GetExteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorD4_GetExteriorValue)
...
class itkAnnulusOperatorF4(itk.itkNeighborhoodOperatorPython.itkNeighborhoodOperatorF4):
    ...
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    CreateOperator = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_CreateOperator)
    SetInnerRadius = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetInnerRadius)
    GetInnerRadius = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetInnerRadius)
    SetThickness = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetThickness)
    GetThickness = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetThickness)
    SetSpacing = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetSpacing)
    GetSpacing = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetSpacing)
    SetNormalize = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetNormalize)
    GetNormalize = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetNormalize)
    NormalizeOn = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_NormalizeOn)
    NormalizeOff = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_NormalizeOff)
    SetBrightCenter = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetBrightCenter)
    GetBrightCenter = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetBrightCenter)
    BrightCenterOn = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_BrightCenterOn)
    BrightCenterOff = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_BrightCenterOff)
    SetInteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetInteriorValue)
    GetInteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetInteriorValue)
    SetAnnulusValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetAnnulusValue)
    GetAnnulusValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetAnnulusValue)
    SetExteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_SetExteriorValue)
    GetExteriorValue = _swig_new_instance_method(_itkAnnulusOperatorPython.itkAnnulusOperatorF4_GetExteriorValue)
