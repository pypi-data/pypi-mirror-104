...
class itkImageFileReaderICD2(itk.itkImageSourcePython.itkImageSourceICD2):
    ...
    file type and the external expected type. The ConvertPixelTraits
    template parameter is used to do the conversion.
...
def image_file_reader(*args,  file_name_input=..., file_name=..., image_io=..., use_streaming: bool=...,**kwargs)-> itkt.ImageSourceReturn:
