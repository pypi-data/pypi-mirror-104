...
def image_series_writer(*args,  image_io=..., start_index: int=..., increment_index: int=..., series_format=..., file_names=..., file_name=..., meta_data_dictionary_array=..., use_compression: bool=...,**kwargs):
