...
class itkImageToHistogramFilterICD2(itk.itkImageSinkPython.itkImageSinkICD2):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICD2
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_cast)
...
itkImageToHistogramFilterICD2___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2___New_orig__
itkImageToHistogramFilterICD2_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD2_cast
...
class itkImageToHistogramFilterICD3(itk.itkImageSinkPython.itkImageSinkICD3):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICD3
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_cast)
...
itkImageToHistogramFilterICD3___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3___New_orig__
itkImageToHistogramFilterICD3_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD3_cast
...
class itkImageToHistogramFilterICD4(itk.itkImageSinkPython.itkImageSinkICD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICD4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_cast)
...
itkImageToHistogramFilterICD4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4___New_orig__
itkImageToHistogramFilterICD4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICD4_cast
...
class itkImageToHistogramFilterICF4(itk.itkImageSinkPython.itkImageSinkICF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICF4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_cast)
...
itkImageToHistogramFilterICF4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4___New_orig__
itkImageToHistogramFilterICF4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICF4_cast
...
class itkImageToHistogramFilterICVF24(itk.itkImageSinkPython.itkImageSinkICVF24):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICVF24
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_cast)
...
itkImageToHistogramFilterICVF24___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24___New_orig__
itkImageToHistogramFilterICVF24_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF24_cast
...
class itkImageToHistogramFilterICVF34(itk.itkImageSinkPython.itkImageSinkICVF34):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICVF34
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_cast)
...
itkImageToHistogramFilterICVF34___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34___New_orig__
itkImageToHistogramFilterICVF34_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF34_cast
...
class itkImageToHistogramFilterICVF44(itk.itkImageSinkPython.itkImageSinkICVF44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterICVF44
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_cast)
...
itkImageToHistogramFilterICVF44___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44___New_orig__
itkImageToHistogramFilterICVF44_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterICVF44_cast
...
class itkImageToHistogramFilterID4(itk.itkImageSinkPython.itkImageSinkID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterID4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_cast)
...
itkImageToHistogramFilterID4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterID4___New_orig__
itkImageToHistogramFilterID4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterID4_cast
...
class itkImageToHistogramFilterIF4(itk.itkImageSinkPython.itkImageSinkIF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIF4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_cast)
...
itkImageToHistogramFilterIF4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4___New_orig__
itkImageToHistogramFilterIF4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIF4_cast
...
class itkImageToHistogramFilterIRGBAUC4(itk.itkImageSinkPython.itkImageSinkIRGBAUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIRGBAUC4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_cast)
...
itkImageToHistogramFilterIRGBAUC4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4___New_orig__
itkImageToHistogramFilterIRGBAUC4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBAUC4_cast
...
class itkImageToHistogramFilterIRGBUC4(itk.itkImageSinkPython.itkImageSinkIRGBUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIRGBUC4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_cast)
...
itkImageToHistogramFilterIRGBUC4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4___New_orig__
itkImageToHistogramFilterIRGBUC4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIRGBUC4_cast
...
class itkImageToHistogramFilterISS4(itk.itkImageSinkPython.itkImageSinkISS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterISS4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_cast)
...
itkImageToHistogramFilterISS4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4___New_orig__
itkImageToHistogramFilterISS4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterISS4_cast
...
class itkImageToHistogramFilterIUC4(itk.itkImageSinkPython.itkImageSinkIUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIUC4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_cast)
...
itkImageToHistogramFilterIUC4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4___New_orig__
itkImageToHistogramFilterIUC4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIUC4_cast
...
class itkImageToHistogramFilterIUS4(itk.itkImageSinkPython.itkImageSinkIUS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIUS4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_cast)
...
itkImageToHistogramFilterIUS4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4___New_orig__
itkImageToHistogramFilterIUS4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIUS4_cast
...
class itkImageToHistogramFilterIVF24(itk.itkImageSinkPython.itkImageSinkIVF24):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIVF24
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_cast)
...
itkImageToHistogramFilterIVF24___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24___New_orig__
itkImageToHistogramFilterIVF24_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF24_cast
...
class itkImageToHistogramFilterIVF34(itk.itkImageSinkPython.itkImageSinkIVF34):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIVF34
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_cast)
...
itkImageToHistogramFilterIVF34___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34___New_orig__
itkImageToHistogramFilterIVF34_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF34_cast
...
class itkImageToHistogramFilterIVF44(itk.itkImageSinkPython.itkImageSinkIVF44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterIVF44
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_cast)
...
itkImageToHistogramFilterIVF44___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44___New_orig__
itkImageToHistogramFilterIVF44_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterIVF44_cast
...
class itkImageToHistogramFilterVID4(itk.itkImageSinkPython.itkImageSinkVID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterVID4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_cast)
...
itkImageToHistogramFilterVID4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4___New_orig__
itkImageToHistogramFilterVID4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVID4_cast
...
class itkImageToHistogramFilterVIF4(itk.itkImageSinkPython.itkImageSinkVIF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterVIF4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_cast)
...
itkImageToHistogramFilterVIF4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4___New_orig__
itkImageToHistogramFilterVIF4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIF4_cast
...
class itkImageToHistogramFilterVISS4(itk.itkImageSinkPython.itkImageSinkVISS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterVISS4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_cast)
...
itkImageToHistogramFilterVISS4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4___New_orig__
itkImageToHistogramFilterVISS4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVISS4_cast
...
class itkImageToHistogramFilterVIUC4(itk.itkImageSinkPython.itkImageSinkVIUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterVIUC4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_cast)
...
itkImageToHistogramFilterVIUC4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4___New_orig__
itkImageToHistogramFilterVIUC4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUC4_cast
...
class itkImageToHistogramFilterVIUS4(itk.itkImageSinkPython.itkImageSinkVIUS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_Clone)
    GetOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetOutput)
    SetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramSizeInput)
    SetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramSize)
    GetHistogramSizeInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramSizeInput)
    GetHistogramSize = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramSize)
    SetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetMarginalScaleInput)
    SetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetMarginalScale)
    GetMarginalScaleInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetMarginalScaleInput)
    GetMarginalScale = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetMarginalScale)
    SetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramBinMinimumInput)
    SetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramBinMinimum)
    GetHistogramBinMinimumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramBinMinimumInput)
    GetHistogramBinMinimum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramBinMinimum)
    SetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramBinMaximumInput)
    SetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetHistogramBinMaximum)
    GetHistogramBinMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramBinMaximumInput)
    GetHistogramBinMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetHistogramBinMaximum)
    SetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetAutoMinimumMaximumInput)
    SetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetAutoMinimumMaximum)
    GetAutoMinimumMaximumInput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetAutoMinimumMaximumInput)
    GetAutoMinimumMaximum = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetAutoMinimumMaximum)
    AutoMinimumMaximumOn = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_AutoMinimumMaximumOn)
    AutoMinimumMaximumOff = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_AutoMinimumMaximumOff)
    GraftOutput = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GraftOutput)
    SetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_SetNumberOfStreamDivisions)
    GetNumberOfStreamDivisions = _swig_new_instance_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_GetNumberOfStreamDivisions)
    __swig_destroy__ = _itkImageToHistogramFilterPython.delete_itkImageToHistogramFilterVIUS4
    cast = _swig_new_static_method(_itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_cast)
...
itkImageToHistogramFilterVIUS4___New_orig__ = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4___New_orig__
itkImageToHistogramFilterVIUS4_cast = _itkImageToHistogramFilterPython.itkImageToHistogramFilterVIUS4_cast
