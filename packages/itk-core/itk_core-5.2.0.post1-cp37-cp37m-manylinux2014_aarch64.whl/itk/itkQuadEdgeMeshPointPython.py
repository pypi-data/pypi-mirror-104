...
class itkQuadEdgeMeshPointF4GQEULULBBT(itk.itkPointPython.itkPointF4):
    ...
    SetEdge = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULULBBT_SetEdge)
    SetPoint = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULULBBT_SetPoint)
    GetEdge = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULULBBT_GetEdge)
    IsInternal = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULULBBT_IsInternal)
    GetValence = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULULBBT_GetValence)
