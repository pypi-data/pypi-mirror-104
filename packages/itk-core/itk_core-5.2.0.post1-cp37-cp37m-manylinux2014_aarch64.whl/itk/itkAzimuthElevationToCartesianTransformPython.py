...
class itkAzimuthElevationToCartesianTransformD4(itk.itkAffineTransformPython.itkAffineTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_Clone)
    SetAzimuthElevationToCartesianParameters = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetAzimuthElevationToCartesianParameters)
    BackTransform = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_BackTransform)
    BackTransformPoint = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_BackTransformPoint)
    SetForwardAzimuthElevationToCartesian = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetForwardAzimuthElevationToCartesian)
    SetForwardCartesianToAzimuthElevation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetForwardCartesianToAzimuthElevation)
    TransformAzElToCartesian = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_TransformAzElToCartesian)
    TransformCartesianToAzEl = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_TransformCartesianToAzEl)
    SetMaxAzimuth = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetMaxAzimuth)
    GetMaxAzimuth = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetMaxAzimuth)
    SetMaxElevation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetMaxElevation)
    GetMaxElevation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetMaxElevation)
    SetRadiusSampleSize = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetRadiusSampleSize)
    GetRadiusSampleSize = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetRadiusSampleSize)
    SetAzimuthAngularSeparation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetAzimuthAngularSeparation)
    GetAzimuthAngularSeparation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetAzimuthAngularSeparation)
    SetElevationAngularSeparation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetElevationAngularSeparation)
    GetElevationAngularSeparation = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetElevationAngularSeparation)
    SetFirstSampleDistance = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_SetFirstSampleDistance)
    GetFirstSampleDistance = _swig_new_instance_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_GetFirstSampleDistance)
    __swig_destroy__ = _itkAzimuthElevationToCartesianTransformPython.delete_itkAzimuthElevationToCartesianTransformD4
    cast = _swig_new_static_method(_itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_cast)
...
itkAzimuthElevationToCartesianTransformD4___New_orig__ = _itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4___New_orig__
itkAzimuthElevationToCartesianTransformD4_cast = _itkAzimuthElevationToCartesianTransformPython.itkAzimuthElevationToCartesianTransformD4_cast
