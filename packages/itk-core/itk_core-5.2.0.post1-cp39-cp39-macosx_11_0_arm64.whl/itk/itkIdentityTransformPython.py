...
class itkIdentityTransformD4(itk.itkTransformBasePython.itkTransformD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkIdentityTransformPython.itkIdentityTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkIdentityTransformPython.itkIdentityTransformD4_Clone)
    TransformVector = _swig_new_instance_method(_itkIdentityTransformPython.itkIdentityTransformD4_TransformVector)
    SetIdentity = _swig_new_instance_method(_itkIdentityTransformPython.itkIdentityTransformD4_SetIdentity)
    GetInverse = _swig_new_instance_method(_itkIdentityTransformPython.itkIdentityTransformD4_GetInverse)
    __swig_destroy__ = _itkIdentityTransformPython.delete_itkIdentityTransformD4
    cast = _swig_new_static_method(_itkIdentityTransformPython.itkIdentityTransformD4_cast)
...
itkIdentityTransformD4___New_orig__ = _itkIdentityTransformPython.itkIdentityTransformD4___New_orig__
itkIdentityTransformD4_cast = _itkIdentityTransformPython.itkIdentityTransformD4_cast
