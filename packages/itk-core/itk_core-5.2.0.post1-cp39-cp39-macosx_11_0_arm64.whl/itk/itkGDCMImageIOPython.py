...
class itkGDCMImageIO(itk.ITKIOImageBaseBasePython.itkImageIOBase):
    ...
    example{IO/GDCM/ResampleDICOMSeries,Resample DICOM Series}
...
def gdcm_series_file_names(*args,  input_directory=..., directory=..., output_directory=..., recursive: bool=..., use_series_details: bool=..., load_sequences: bool=..., load_private_tags: bool=...,**kwargs):
