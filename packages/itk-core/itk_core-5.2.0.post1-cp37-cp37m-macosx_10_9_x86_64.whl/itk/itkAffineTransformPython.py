...
class itkAffineTransformD4(itk.itkMatrixOffsetTransformBasePython.itkMatrixOffsetTransformBaseD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkAffineTransformPython.itkAffineTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Clone)
    Translate = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Translate)
    Scale = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Scale)
    Rotate = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Rotate)
    Rotate2D = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Rotate2D)
    Rotate3D = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Rotate3D)
    Shear = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Shear)
    GetInverse = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_GetInverse)
    Metric = _swig_new_instance_method(_itkAffineTransformPython.itkAffineTransformD4_Metric)
    __swig_destroy__ = _itkAffineTransformPython.delete_itkAffineTransformD4
    cast = _swig_new_static_method(_itkAffineTransformPython.itkAffineTransformD4_cast)
...
itkAffineTransformD4___New_orig__ = _itkAffineTransformPython.itkAffineTransformD4___New_orig__
itkAffineTransformD4_cast = _itkAffineTransformPython.itkAffineTransformD4_cast
