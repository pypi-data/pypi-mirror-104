...
class itkConnectedRegionsMeshFilterMD4MD4(itk.itkMeshToMeshFilterPython.itkMeshToMeshFilterMD4MD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4___New_orig__)
    Clone = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_Clone)
    ...
    SetExtractionMode = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionMode)
    GetExtractionMode = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_GetExtractionMode)
    SetExtractionModeToPointSeededRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToPointSeededRegions)
    SetExtractionModeToCellSeededRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToCellSeededRegions)
    SetExtractionModeToSpecifiedRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToSpecifiedRegions)
    SetExtractionModeToLargestRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToLargestRegion)
    SetExtractionModeToAllRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToAllRegions)
    SetExtractionModeToClosestPointRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetExtractionModeToClosestPointRegion)
    InitializeSeedList = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_InitializeSeedList)
    AddSeed = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_AddSeed)
    DeleteSeed = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_DeleteSeed)
    InitializeSpecifiedRegionList = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_InitializeSpecifiedRegionList)
    AddSpecifiedRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_AddSpecifiedRegion)
    DeleteSpecifiedRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_DeleteSpecifiedRegion)
    SetClosestPoint = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_SetClosestPoint)
    GetClosestPoint = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_GetClosestPoint)
    GetNumberOfExtractedRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_GetNumberOfExtractedRegions)
    __swig_destroy__ = _itkConnectedRegionsMeshFilterPython.delete_itkConnectedRegionsMeshFilterMD4MD4
    cast = _swig_new_static_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_cast)
...
itkConnectedRegionsMeshFilterMD4MD4___New_orig__ = _itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4___New_orig__
itkConnectedRegionsMeshFilterMD4MD4_cast = _itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMD4MD4_cast
...
class itkConnectedRegionsMeshFilterMF4MF4(itk.itkMeshToMeshFilterPython.itkMeshToMeshFilterMF4MF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4___New_orig__)
    Clone = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_Clone)
    ...
    SetExtractionMode = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionMode)
    GetExtractionMode = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_GetExtractionMode)
    SetExtractionModeToPointSeededRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToPointSeededRegions)
    SetExtractionModeToCellSeededRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToCellSeededRegions)
    SetExtractionModeToSpecifiedRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToSpecifiedRegions)
    SetExtractionModeToLargestRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToLargestRegion)
    SetExtractionModeToAllRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToAllRegions)
    SetExtractionModeToClosestPointRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetExtractionModeToClosestPointRegion)
    InitializeSeedList = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_InitializeSeedList)
    AddSeed = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_AddSeed)
    DeleteSeed = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_DeleteSeed)
    InitializeSpecifiedRegionList = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_InitializeSpecifiedRegionList)
    AddSpecifiedRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_AddSpecifiedRegion)
    DeleteSpecifiedRegion = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_DeleteSpecifiedRegion)
    SetClosestPoint = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_SetClosestPoint)
    GetClosestPoint = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_GetClosestPoint)
    GetNumberOfExtractedRegions = _swig_new_instance_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_GetNumberOfExtractedRegions)
    __swig_destroy__ = _itkConnectedRegionsMeshFilterPython.delete_itkConnectedRegionsMeshFilterMF4MF4
    cast = _swig_new_static_method(_itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_cast)
...
itkConnectedRegionsMeshFilterMF4MF4___New_orig__ = _itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4___New_orig__
itkConnectedRegionsMeshFilterMF4MF4_cast = _itkConnectedRegionsMeshFilterPython.itkConnectedRegionsMeshFilterMF4MF4_cast
