...
class itkMapContainerULLQEMPF4GQEULLULLBBT(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT___New_orig__)
    Clone = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_GetElement)
    SetElement = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_SetElement)
    InsertElement = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_InsertElement)
    IndexExists = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_DeleteIndex)
    Size = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_Size)
    Reserve = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_Reserve)
    Squeeze = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_Squeeze)
    Initialize = _swig_new_instance_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_Initialize)
    __swig_destroy__ = _itkQuadEdgeCellTraitsInfoPython.delete_itkMapContainerULLQEMPF4GQEULLULLBBT
    cast = _swig_new_static_method(_itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_cast)
...
itkMapContainerULLQEMPF4GQEULLULLBBT___New_orig__ = _itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT___New_orig__
itkMapContainerULLQEMPF4GQEULLULLBBT_cast = _itkQuadEdgeCellTraitsInfoPython.itkMapContainerULLQEMPF4GQEULLULLBBT_cast
