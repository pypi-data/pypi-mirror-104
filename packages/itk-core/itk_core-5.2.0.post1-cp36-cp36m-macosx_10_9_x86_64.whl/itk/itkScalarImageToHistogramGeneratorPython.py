...
class itkScalarImageToHistogramGeneratorID4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_Clone)
    Compute = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_Compute)
    SetInput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetInput)
    GetOutput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_GetOutput)
    SetNumberOfBins = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetNumberOfBins)
    SetMarginalScale = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetMarginalScale)
    SetHistogramMin = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetHistogramMin)
    SetHistogramMax = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetHistogramMax)
    SetAutoHistogramMinimumMaximum = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_SetAutoHistogramMinimumMaximum)
    __swig_destroy__ = _itkScalarImageToHistogramGeneratorPython.delete_itkScalarImageToHistogramGeneratorID4
    cast = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_cast)
...
itkScalarImageToHistogramGeneratorID4___New_orig__ = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4___New_orig__
itkScalarImageToHistogramGeneratorID4_cast = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorID4_cast
...
class itkScalarImageToHistogramGeneratorIF4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_Clone)
    Compute = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_Compute)
    SetInput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetInput)
    GetOutput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_GetOutput)
    SetNumberOfBins = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetNumberOfBins)
    SetMarginalScale = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetMarginalScale)
    SetHistogramMin = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetHistogramMin)
    SetHistogramMax = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetHistogramMax)
    SetAutoHistogramMinimumMaximum = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_SetAutoHistogramMinimumMaximum)
    __swig_destroy__ = _itkScalarImageToHistogramGeneratorPython.delete_itkScalarImageToHistogramGeneratorIF4
    cast = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_cast)
...
itkScalarImageToHistogramGeneratorIF4___New_orig__ = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4___New_orig__
itkScalarImageToHistogramGeneratorIF4_cast = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIF4_cast
...
class itkScalarImageToHistogramGeneratorISS4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_Clone)
    Compute = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_Compute)
    SetInput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetInput)
    GetOutput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_GetOutput)
    SetNumberOfBins = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetNumberOfBins)
    SetMarginalScale = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetMarginalScale)
    SetHistogramMin = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetHistogramMin)
    SetHistogramMax = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetHistogramMax)
    SetAutoHistogramMinimumMaximum = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_SetAutoHistogramMinimumMaximum)
    __swig_destroy__ = _itkScalarImageToHistogramGeneratorPython.delete_itkScalarImageToHistogramGeneratorISS4
    cast = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_cast)
...
itkScalarImageToHistogramGeneratorISS4___New_orig__ = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4___New_orig__
itkScalarImageToHistogramGeneratorISS4_cast = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorISS4_cast
...
class itkScalarImageToHistogramGeneratorIUC4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_Clone)
    Compute = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_Compute)
    SetInput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetInput)
    GetOutput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_GetOutput)
    SetNumberOfBins = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetNumberOfBins)
    SetMarginalScale = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetMarginalScale)
    SetHistogramMin = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetHistogramMin)
    SetHistogramMax = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetHistogramMax)
    SetAutoHistogramMinimumMaximum = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_SetAutoHistogramMinimumMaximum)
    __swig_destroy__ = _itkScalarImageToHistogramGeneratorPython.delete_itkScalarImageToHistogramGeneratorIUC4
    cast = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_cast)
...
itkScalarImageToHistogramGeneratorIUC4___New_orig__ = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4___New_orig__
itkScalarImageToHistogramGeneratorIUC4_cast = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUC4_cast
...
class itkScalarImageToHistogramGeneratorIUS4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_Clone)
    Compute = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_Compute)
    SetInput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetInput)
    GetOutput = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_GetOutput)
    SetNumberOfBins = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetNumberOfBins)
    SetMarginalScale = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetMarginalScale)
    SetHistogramMin = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetHistogramMin)
    SetHistogramMax = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetHistogramMax)
    SetAutoHistogramMinimumMaximum = _swig_new_instance_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_SetAutoHistogramMinimumMaximum)
    __swig_destroy__ = _itkScalarImageToHistogramGeneratorPython.delete_itkScalarImageToHistogramGeneratorIUS4
    cast = _swig_new_static_method(_itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_cast)
...
itkScalarImageToHistogramGeneratorIUS4___New_orig__ = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4___New_orig__
itkScalarImageToHistogramGeneratorIUS4_cast = _itkScalarImageToHistogramGeneratorPython.itkScalarImageToHistogramGeneratorIUS4_cast
