...
class itkBoundingBoxULL4DMCULLPD4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4___New_orig__)
    Clone = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_Clone)
    SetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_SetPoints)
    GetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetPoints)
    ComputeCorners = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_ComputeCorners)
    ComputeBoundingBox = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_ComputeBoundingBox)
    GetBounds = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetBounds)
    GetCenter = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetCenter)
    GetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_SetMaximum)
    ConsiderPoint = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_ConsiderPoint)
    GetDiagonalLength2 = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_GetDiagonalLength2)
    IsInside = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_IsInside)
    DeepCopy = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_DeepCopy)
    __swig_destroy__ = _itkBoundingBoxPython.delete_itkBoundingBoxULL4DMCULLPD4
    cast = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_cast)
...
itkBoundingBoxULL4DMCULLPD4___New_orig__ = _itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4___New_orig__
itkBoundingBoxULL4DMCULLPD4_cast = _itkBoundingBoxPython.itkBoundingBoxULL4DMCULLPD4_cast
...
class itkBoundingBoxULL4DVCULLPD4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4___New_orig__)
    Clone = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_Clone)
    SetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_SetPoints)
    GetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetPoints)
    ComputeCorners = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_ComputeCorners)
    ComputeBoundingBox = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_ComputeBoundingBox)
    GetBounds = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetBounds)
    GetCenter = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetCenter)
    GetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_SetMaximum)
    ConsiderPoint = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_ConsiderPoint)
    GetDiagonalLength2 = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_GetDiagonalLength2)
    IsInside = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_IsInside)
    DeepCopy = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_DeepCopy)
    __swig_destroy__ = _itkBoundingBoxPython.delete_itkBoundingBoxULL4DVCULLPD4
    cast = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_cast)
...
itkBoundingBoxULL4DVCULLPD4___New_orig__ = _itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4___New_orig__
itkBoundingBoxULL4DVCULLPD4_cast = _itkBoundingBoxPython.itkBoundingBoxULL4DVCULLPD4_cast
...
class itkBoundingBoxULL4FMCULLPF4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4___New_orig__)
    Clone = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_Clone)
    SetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_SetPoints)
    GetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetPoints)
    ComputeCorners = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_ComputeCorners)
    ComputeBoundingBox = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_ComputeBoundingBox)
    GetBounds = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetBounds)
    GetCenter = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetCenter)
    GetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_SetMaximum)
    ConsiderPoint = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_ConsiderPoint)
    GetDiagonalLength2 = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_GetDiagonalLength2)
    IsInside = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_IsInside)
    DeepCopy = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_DeepCopy)
    __swig_destroy__ = _itkBoundingBoxPython.delete_itkBoundingBoxULL4FMCULLPF4
    cast = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_cast)
...
itkBoundingBoxULL4FMCULLPF4___New_orig__ = _itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4___New_orig__
itkBoundingBoxULL4FMCULLPF4_cast = _itkBoundingBoxPython.itkBoundingBoxULL4FMCULLPF4_cast
...
class itkBoundingBoxULL4FVCULLPF4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4___New_orig__)
    Clone = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_Clone)
    SetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_SetPoints)
    GetPoints = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetPoints)
    ComputeCorners = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_ComputeCorners)
    ComputeBoundingBox = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_ComputeBoundingBox)
    GetBounds = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetBounds)
    GetCenter = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetCenter)
    GetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_SetMaximum)
    ConsiderPoint = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_ConsiderPoint)
    GetDiagonalLength2 = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_GetDiagonalLength2)
    IsInside = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_IsInside)
    DeepCopy = _swig_new_instance_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_DeepCopy)
    __swig_destroy__ = _itkBoundingBoxPython.delete_itkBoundingBoxULL4FVCULLPF4
    cast = _swig_new_static_method(_itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_cast)
...
itkBoundingBoxULL4FVCULLPF4___New_orig__ = _itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4___New_orig__
itkBoundingBoxULL4FVCULLPF4_cast = _itkBoundingBoxPython.itkBoundingBoxULL4FVCULLPF4_cast
