...
class itkBSplineInterpolateImageFunctionID4DD(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionID4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_Clone)
    Evaluate = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_Evaluate)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_EvaluateAtContinuousIndex)
    EvaluateDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_EvaluateDerivative)
    EvaluateDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_EvaluateDerivativeAtContinuousIndex)
    EvaluateValueAndDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_EvaluateValueAndDerivative)
    EvaluateValueAndDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_EvaluateValueAndDerivativeAtContinuousIndex)
    SetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_SetSplineOrder)
    GetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_GetSplineOrder)
    SetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_SetNumberOfWorkUnits)
    GetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_GetNumberOfWorkUnits)
    SetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_SetUseImageDirection)
    GetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_GetUseImageDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_UseImageDirectionOff)
    __swig_destroy__ = _itkBSplineInterpolateImageFunctionPython.delete_itkBSplineInterpolateImageFunctionID4DD
    cast = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_cast)
...
itkBSplineInterpolateImageFunctionID4DD___New_orig__ = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD___New_orig__
itkBSplineInterpolateImageFunctionID4DD_cast = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionID4DD_cast
...
class itkBSplineInterpolateImageFunctionIF4DF(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIF4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_Clone)
    Evaluate = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_Evaluate)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_EvaluateAtContinuousIndex)
    EvaluateDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_EvaluateDerivative)
    EvaluateDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_EvaluateDerivativeAtContinuousIndex)
    EvaluateValueAndDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_EvaluateValueAndDerivative)
    EvaluateValueAndDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_EvaluateValueAndDerivativeAtContinuousIndex)
    SetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_SetSplineOrder)
    GetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_GetSplineOrder)
    SetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_SetNumberOfWorkUnits)
    GetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_GetNumberOfWorkUnits)
    SetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_SetUseImageDirection)
    GetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_GetUseImageDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_UseImageDirectionOff)
    __swig_destroy__ = _itkBSplineInterpolateImageFunctionPython.delete_itkBSplineInterpolateImageFunctionIF4DF
    cast = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_cast)
...
itkBSplineInterpolateImageFunctionIF4DF___New_orig__ = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF___New_orig__
itkBSplineInterpolateImageFunctionIF4DF_cast = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIF4DF_cast
...
class itkBSplineInterpolateImageFunctionISS4DSS(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionISS4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_Clone)
    Evaluate = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_Evaluate)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_EvaluateAtContinuousIndex)
    EvaluateDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_EvaluateDerivative)
    EvaluateDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_EvaluateDerivativeAtContinuousIndex)
    EvaluateValueAndDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_EvaluateValueAndDerivative)
    EvaluateValueAndDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_EvaluateValueAndDerivativeAtContinuousIndex)
    SetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_SetSplineOrder)
    GetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_GetSplineOrder)
    SetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_SetNumberOfWorkUnits)
    GetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_GetNumberOfWorkUnits)
    SetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_SetUseImageDirection)
    GetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_GetUseImageDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_UseImageDirectionOff)
    __swig_destroy__ = _itkBSplineInterpolateImageFunctionPython.delete_itkBSplineInterpolateImageFunctionISS4DSS
    cast = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_cast)
...
itkBSplineInterpolateImageFunctionISS4DSS___New_orig__ = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS___New_orig__
itkBSplineInterpolateImageFunctionISS4DSS_cast = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionISS4DSS_cast
...
class itkBSplineInterpolateImageFunctionIUC4DUC(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIUC4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_Clone)
    Evaluate = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_Evaluate)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_EvaluateAtContinuousIndex)
    EvaluateDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_EvaluateDerivative)
    EvaluateDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_EvaluateDerivativeAtContinuousIndex)
    EvaluateValueAndDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_EvaluateValueAndDerivative)
    EvaluateValueAndDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_EvaluateValueAndDerivativeAtContinuousIndex)
    SetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_SetSplineOrder)
    GetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_GetSplineOrder)
    SetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_SetNumberOfWorkUnits)
    GetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_GetNumberOfWorkUnits)
    SetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_SetUseImageDirection)
    GetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_GetUseImageDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_UseImageDirectionOff)
    __swig_destroy__ = _itkBSplineInterpolateImageFunctionPython.delete_itkBSplineInterpolateImageFunctionIUC4DUC
    cast = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_cast)
...
itkBSplineInterpolateImageFunctionIUC4DUC___New_orig__ = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC___New_orig__
itkBSplineInterpolateImageFunctionIUC4DUC_cast = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUC4DUC_cast
...
class itkBSplineInterpolateImageFunctionIUS4DUS(itk.itkInterpolateImageFunctionPython.itkInterpolateImageFunctionIUS4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_Clone)
    Evaluate = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_Evaluate)
    EvaluateAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_EvaluateAtContinuousIndex)
    EvaluateDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_EvaluateDerivative)
    EvaluateDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_EvaluateDerivativeAtContinuousIndex)
    EvaluateValueAndDerivative = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_EvaluateValueAndDerivative)
    EvaluateValueAndDerivativeAtContinuousIndex = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_EvaluateValueAndDerivativeAtContinuousIndex)
    SetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_SetSplineOrder)
    GetSplineOrder = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_GetSplineOrder)
    SetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_SetNumberOfWorkUnits)
    GetNumberOfWorkUnits = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_GetNumberOfWorkUnits)
    SetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_SetUseImageDirection)
    GetUseImageDirection = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_GetUseImageDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_UseImageDirectionOff)
    __swig_destroy__ = _itkBSplineInterpolateImageFunctionPython.delete_itkBSplineInterpolateImageFunctionIUS4DUS
    cast = _swig_new_static_method(_itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_cast)
...
itkBSplineInterpolateImageFunctionIUS4DUS___New_orig__ = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS___New_orig__
itkBSplineInterpolateImageFunctionIUS4DUS_cast = _itkBSplineInterpolateImageFunctionPython.itkBSplineInterpolateImageFunctionIUS4DUS_cast
