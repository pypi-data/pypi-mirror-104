...
class itkQuadEdgeMeshPointF4GQEULLULLBBT(itk.itkPointPython.itkPointF4):
    ...
    SetEdge = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULLULLBBT_SetEdge)
    SetPoint = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULLULLBBT_SetPoint)
    GetEdge = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULLULLBBT_GetEdge)
    IsInternal = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULLULLBBT_IsInternal)
    GetValence = _swig_new_instance_method(_itkQuadEdgeMeshPointPython.itkQuadEdgeMeshPointF4GQEULLULLBBT_GetValence)
