...
class itkMapContainerULLPD4(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLPD4___New_orig__)
    Clone = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_GetElement)
    SetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_SetElement)
    InsertElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_InsertElement)
    IndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_DeleteIndex)
    Size = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_Size)
    Reserve = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_Reserve)
    Squeeze = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_Squeeze)
    Initialize = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPD4_Initialize)
    __swig_destroy__ = _itkMapContainerPython.delete_itkMapContainerULLPD4
    cast = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLPD4_cast)
...
itkMapContainerULLPD4___New_orig__ = _itkMapContainerPython.itkMapContainerULLPD4___New_orig__
itkMapContainerULLPD4_cast = _itkMapContainerPython.itkMapContainerULLPD4_cast
...
class itkMapContainerULLPF4(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLPF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_GetElement)
    SetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_SetElement)
    InsertElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_InsertElement)
    IndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_DeleteIndex)
    Size = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_Size)
    Reserve = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_Reserve)
    Squeeze = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_Squeeze)
    Initialize = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLPF4_Initialize)
    __swig_destroy__ = _itkMapContainerPython.delete_itkMapContainerULLPF4
    cast = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLPF4_cast)
...
itkMapContainerULLPF4___New_orig__ = _itkMapContainerPython.itkMapContainerULLPF4___New_orig__
itkMapContainerULLPF4_cast = _itkMapContainerPython.itkMapContainerULLPF4_cast
...
class itkMapContainerULLVD4(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLVD4___New_orig__)
    Clone = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_GetElement)
    SetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_SetElement)
    InsertElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_InsertElement)
    IndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_DeleteIndex)
    Size = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_Size)
    Reserve = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_Reserve)
    Squeeze = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_Squeeze)
    Initialize = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVD4_Initialize)
    __swig_destroy__ = _itkMapContainerPython.delete_itkMapContainerULLVD4
    cast = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLVD4_cast)
...
itkMapContainerULLVD4___New_orig__ = _itkMapContainerPython.itkMapContainerULLVD4___New_orig__
itkMapContainerULLVD4_cast = _itkMapContainerPython.itkMapContainerULLVD4_cast
...
class itkMapContainerULLVF4(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLVF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_GetElement)
    SetElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_SetElement)
    InsertElement = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_InsertElement)
    IndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_DeleteIndex)
    Size = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_Size)
    Reserve = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_Reserve)
    Squeeze = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_Squeeze)
    Initialize = _swig_new_instance_method(_itkMapContainerPython.itkMapContainerULLVF4_Initialize)
    __swig_destroy__ = _itkMapContainerPython.delete_itkMapContainerULLVF4
    cast = _swig_new_static_method(_itkMapContainerPython.itkMapContainerULLVF4_cast)
...
itkMapContainerULLVF4___New_orig__ = _itkMapContainerPython.itkMapContainerULLVF4___New_orig__
itkMapContainerULLVF4_cast = _itkMapContainerPython.itkMapContainerULLVF4_cast
