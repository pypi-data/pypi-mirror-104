...
class itkSimpleDataObjectDecoratorCD(itk.ITKCommonBasePython.itkDataObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD___New_orig__)
    Clone = _swig_new_instance_method(_itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD_Clone)
    Set = _swig_new_instance_method(_itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD_Set)
    Get = _swig_new_instance_method(_itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD_Get)
    __swig_destroy__ = _itkSimpleDataObjectDecoratorPython.delete_itkSimpleDataObjectDecoratorCD
    cast = _swig_new_static_method(_itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD_cast)
...
itkSimpleDataObjectDecoratorCD___New_orig__ = _itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD___New_orig__
itkSimpleDataObjectDecoratorCD_cast = _itkSimpleDataObjectDecoratorPython.itkSimpleDataObjectDecoratorCD_cast
