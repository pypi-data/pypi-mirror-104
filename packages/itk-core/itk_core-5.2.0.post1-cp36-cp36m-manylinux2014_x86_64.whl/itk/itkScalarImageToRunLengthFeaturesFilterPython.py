...
class itkScalarImageToRunLengthFeaturesFilterID4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_Clone)
    GetFeatureMeansOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetFeatureMeansOutput)
    GetFeatureStandardDeviationsOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetFeatureStandardDeviationsOutput)
    SetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetInput)
    GetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetInput)
    GetFeatureMeans = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetFeatureMeans)
    GetFeatureStandardDeviations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetFeatureStandardDeviations)
    SetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetRequestedFeatures)
    GetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetRequestedFeatures)
    SetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetOffsets)
    GetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetOffsets)
    SetNumberOfBinsPerAxis = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetNumberOfBinsPerAxis)
    SetPixelValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetPixelValueMinMax)
    SetDistanceValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetDistanceValueMinMax)
    SetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetMaskImage)
    SetInsidePixelValue = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetInsidePixelValue)
    GetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_GetFastCalculations)
    SetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_SetFastCalculations)
    FastCalculationsOn = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_FastCalculationsOn)
    FastCalculationsOff = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_FastCalculationsOff)
    __swig_destroy__ = _itkScalarImageToRunLengthFeaturesFilterPython.delete_itkScalarImageToRunLengthFeaturesFilterID4
    cast = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_cast)
...
itkScalarImageToRunLengthFeaturesFilterID4___New_orig__ = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4___New_orig__
itkScalarImageToRunLengthFeaturesFilterID4_cast = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterID4_cast
...
class itkScalarImageToRunLengthFeaturesFilterIF4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_Clone)
    GetFeatureMeansOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetFeatureMeansOutput)
    GetFeatureStandardDeviationsOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetFeatureStandardDeviationsOutput)
    SetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetInput)
    GetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetInput)
    GetFeatureMeans = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetFeatureMeans)
    GetFeatureStandardDeviations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetFeatureStandardDeviations)
    SetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetRequestedFeatures)
    GetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetRequestedFeatures)
    SetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetOffsets)
    GetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetOffsets)
    SetNumberOfBinsPerAxis = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetNumberOfBinsPerAxis)
    SetPixelValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetPixelValueMinMax)
    SetDistanceValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetDistanceValueMinMax)
    SetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetMaskImage)
    SetInsidePixelValue = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetInsidePixelValue)
    GetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_GetFastCalculations)
    SetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_SetFastCalculations)
    FastCalculationsOn = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_FastCalculationsOn)
    FastCalculationsOff = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_FastCalculationsOff)
    __swig_destroy__ = _itkScalarImageToRunLengthFeaturesFilterPython.delete_itkScalarImageToRunLengthFeaturesFilterIF4
    cast = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_cast)
...
itkScalarImageToRunLengthFeaturesFilterIF4___New_orig__ = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4___New_orig__
itkScalarImageToRunLengthFeaturesFilterIF4_cast = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIF4_cast
...
class itkScalarImageToRunLengthFeaturesFilterISS4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_Clone)
    GetFeatureMeansOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetFeatureMeansOutput)
    GetFeatureStandardDeviationsOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetFeatureStandardDeviationsOutput)
    SetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetInput)
    GetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetInput)
    GetFeatureMeans = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetFeatureMeans)
    GetFeatureStandardDeviations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetFeatureStandardDeviations)
    SetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetRequestedFeatures)
    GetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetRequestedFeatures)
    SetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetOffsets)
    GetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetOffsets)
    SetNumberOfBinsPerAxis = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetNumberOfBinsPerAxis)
    SetPixelValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetPixelValueMinMax)
    SetDistanceValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetDistanceValueMinMax)
    SetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetMaskImage)
    SetInsidePixelValue = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetInsidePixelValue)
    GetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_GetFastCalculations)
    SetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_SetFastCalculations)
    FastCalculationsOn = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_FastCalculationsOn)
    FastCalculationsOff = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_FastCalculationsOff)
    __swig_destroy__ = _itkScalarImageToRunLengthFeaturesFilterPython.delete_itkScalarImageToRunLengthFeaturesFilterISS4
    cast = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_cast)
...
itkScalarImageToRunLengthFeaturesFilterISS4___New_orig__ = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4___New_orig__
itkScalarImageToRunLengthFeaturesFilterISS4_cast = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterISS4_cast
...
class itkScalarImageToRunLengthFeaturesFilterIUC4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_Clone)
    GetFeatureMeansOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetFeatureMeansOutput)
    GetFeatureStandardDeviationsOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetFeatureStandardDeviationsOutput)
    SetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetInput)
    GetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetInput)
    GetFeatureMeans = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetFeatureMeans)
    GetFeatureStandardDeviations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetFeatureStandardDeviations)
    SetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetRequestedFeatures)
    GetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetRequestedFeatures)
    SetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetOffsets)
    GetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetOffsets)
    SetNumberOfBinsPerAxis = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetNumberOfBinsPerAxis)
    SetPixelValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetPixelValueMinMax)
    SetDistanceValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetDistanceValueMinMax)
    SetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetMaskImage)
    SetInsidePixelValue = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetInsidePixelValue)
    GetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_GetFastCalculations)
    SetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_SetFastCalculations)
    FastCalculationsOn = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_FastCalculationsOn)
    FastCalculationsOff = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_FastCalculationsOff)
    __swig_destroy__ = _itkScalarImageToRunLengthFeaturesFilterPython.delete_itkScalarImageToRunLengthFeaturesFilterIUC4
    cast = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_cast)
...
itkScalarImageToRunLengthFeaturesFilterIUC4___New_orig__ = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4___New_orig__
itkScalarImageToRunLengthFeaturesFilterIUC4_cast = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUC4_cast
...
class itkScalarImageToRunLengthFeaturesFilterIUS4(itk.ITKCommonBasePython.itkProcessObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_Clone)
    GetFeatureMeansOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetFeatureMeansOutput)
    GetFeatureStandardDeviationsOutput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetFeatureStandardDeviationsOutput)
    SetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetInput)
    GetInput = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetInput)
    GetFeatureMeans = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetFeatureMeans)
    GetFeatureStandardDeviations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetFeatureStandardDeviations)
    SetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetRequestedFeatures)
    GetRequestedFeatures = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetRequestedFeatures)
    SetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetOffsets)
    GetOffsets = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetOffsets)
    SetNumberOfBinsPerAxis = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetNumberOfBinsPerAxis)
    SetPixelValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetPixelValueMinMax)
    SetDistanceValueMinMax = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetDistanceValueMinMax)
    SetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetMaskImage)
    SetInsidePixelValue = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetInsidePixelValue)
    GetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_GetFastCalculations)
    SetFastCalculations = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_SetFastCalculations)
    FastCalculationsOn = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_FastCalculationsOn)
    FastCalculationsOff = _swig_new_instance_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_FastCalculationsOff)
    __swig_destroy__ = _itkScalarImageToRunLengthFeaturesFilterPython.delete_itkScalarImageToRunLengthFeaturesFilterIUS4
    cast = _swig_new_static_method(_itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_cast)
...
itkScalarImageToRunLengthFeaturesFilterIUS4___New_orig__ = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4___New_orig__
itkScalarImageToRunLengthFeaturesFilterIUS4_cast = _itkScalarImageToRunLengthFeaturesFilterPython.itkScalarImageToRunLengthFeaturesFilterIUS4_cast
