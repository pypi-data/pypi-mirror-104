...
class itkBSplineTransformInitializerBSTD43ID4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_Clone)
    GetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_GetTransform)
    SetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_SetTransform)
    GetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_GetImage)
    SetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_SetImage)
    GetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_GetTransformDomainMeshSize)
    SetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_SetTransformDomainMeshSize)
    InitializeTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_InitializeTransform)
    __swig_destroy__ = _itkBSplineTransformInitializerPython.delete_itkBSplineTransformInitializerBSTD43ID4
    cast = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_cast)
...
itkBSplineTransformInitializerBSTD43ID4___New_orig__ = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4___New_orig__
itkBSplineTransformInitializerBSTD43ID4_cast = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ID4_cast
...
class itkBSplineTransformInitializerBSTD43IF4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_Clone)
    GetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_GetTransform)
    SetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_SetTransform)
    GetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_GetImage)
    SetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_SetImage)
    GetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_GetTransformDomainMeshSize)
    SetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_SetTransformDomainMeshSize)
    InitializeTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_InitializeTransform)
    __swig_destroy__ = _itkBSplineTransformInitializerPython.delete_itkBSplineTransformInitializerBSTD43IF4
    cast = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_cast)
...
itkBSplineTransformInitializerBSTD43IF4___New_orig__ = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4___New_orig__
itkBSplineTransformInitializerBSTD43IF4_cast = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IF4_cast
...
class itkBSplineTransformInitializerBSTD43ISS4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_Clone)
    GetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_GetTransform)
    SetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_SetTransform)
    GetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_GetImage)
    SetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_SetImage)
    GetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_GetTransformDomainMeshSize)
    SetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_SetTransformDomainMeshSize)
    InitializeTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_InitializeTransform)
    __swig_destroy__ = _itkBSplineTransformInitializerPython.delete_itkBSplineTransformInitializerBSTD43ISS4
    cast = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_cast)
...
itkBSplineTransformInitializerBSTD43ISS4___New_orig__ = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4___New_orig__
itkBSplineTransformInitializerBSTD43ISS4_cast = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43ISS4_cast
...
class itkBSplineTransformInitializerBSTD43IUC4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_Clone)
    GetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_GetTransform)
    SetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_SetTransform)
    GetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_GetImage)
    SetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_SetImage)
    GetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_GetTransformDomainMeshSize)
    SetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_SetTransformDomainMeshSize)
    InitializeTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_InitializeTransform)
    __swig_destroy__ = _itkBSplineTransformInitializerPython.delete_itkBSplineTransformInitializerBSTD43IUC4
    cast = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_cast)
...
itkBSplineTransformInitializerBSTD43IUC4___New_orig__ = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4___New_orig__
itkBSplineTransformInitializerBSTD43IUC4_cast = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUC4_cast
...
class itkBSplineTransformInitializerBSTD43IUS4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_Clone)
    GetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_GetTransform)
    SetTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_SetTransform)
    GetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_GetImage)
    SetImage = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_SetImage)
    GetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_GetTransformDomainMeshSize)
    SetTransformDomainMeshSize = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_SetTransformDomainMeshSize)
    InitializeTransform = _swig_new_instance_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_InitializeTransform)
    __swig_destroy__ = _itkBSplineTransformInitializerPython.delete_itkBSplineTransformInitializerBSTD43IUS4
    cast = _swig_new_static_method(_itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_cast)
...
itkBSplineTransformInitializerBSTD43IUS4___New_orig__ = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4___New_orig__
itkBSplineTransformInitializerBSTD43IUS4_cast = _itkBSplineTransformInitializerPython.itkBSplineTransformInitializerBSTD43IUS4_cast
