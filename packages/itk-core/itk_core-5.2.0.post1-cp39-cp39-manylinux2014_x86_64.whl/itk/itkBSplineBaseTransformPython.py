...
class itkBSplineBaseTransformD43(itk.itkTransformBasePython.itkTransformD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    Clone = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_Clone)
    SetIdentity = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_SetIdentity)
    SetCoefficientImages = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_SetCoefficientImages)
    GetCoefficientImages = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_GetCoefficientImages)
    UpdateTransformParameters = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_UpdateTransformParameters)
    TransformPoint = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_TransformPoint)
    GetNumberOfWeights = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_GetNumberOfWeights)
    TransformVector = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_TransformVector)
    ComputeJacobianFromBSplineWeightsWithRespectToPosition = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_ComputeJacobianFromBSplineWeightsWithRespectToPosition)
    GetNumberOfParametersPerDimension = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_GetNumberOfParametersPerDimension)
    GetNumberOfAffectedWeights = _swig_new_instance_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_GetNumberOfAffectedWeights)
    __swig_destroy__ = _itkBSplineBaseTransformPython.delete_itkBSplineBaseTransformD43
    cast = _swig_new_static_method(_itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_cast)
...
itkBSplineBaseTransformD43_cast = _itkBSplineBaseTransformPython.itkBSplineBaseTransformD43_cast
