...
class itkVolumeSplineKernelTransformD4(itk.itkKernelTransformPython.itkKernelTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVolumeSplineKernelTransformPython.itkVolumeSplineKernelTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkVolumeSplineKernelTransformPython.itkVolumeSplineKernelTransformD4_Clone)
    __swig_destroy__ = _itkVolumeSplineKernelTransformPython.delete_itkVolumeSplineKernelTransformD4
    cast = _swig_new_static_method(_itkVolumeSplineKernelTransformPython.itkVolumeSplineKernelTransformD4_cast)
...
itkVolumeSplineKernelTransformD4___New_orig__ = _itkVolumeSplineKernelTransformPython.itkVolumeSplineKernelTransformD4___New_orig__
itkVolumeSplineKernelTransformD4_cast = _itkVolumeSplineKernelTransformPython.itkVolumeSplineKernelTransformD4_cast
