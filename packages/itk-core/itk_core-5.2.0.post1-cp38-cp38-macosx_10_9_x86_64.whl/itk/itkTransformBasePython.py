...
class itkTransformBaseTemplateD_ConstPointer(object):
    ...
    def AddObserver(self, *args) -> "unsigned long":
        ...
        add an C++ lambda function as an observer.

        A FunctionCommand object in implicitly create to hold function, and
        passed to this object as a standard observer. The command will be
        invoked for the specified event.

        The function or lambda cannot captured this object as SmartPoint
        because a circular dependency is generated which causing memory leaks.
        Sample usage:
