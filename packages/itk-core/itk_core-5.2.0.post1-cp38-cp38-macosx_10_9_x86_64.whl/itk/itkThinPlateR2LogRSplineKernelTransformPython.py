...
class itkThinPlateR2LogRSplineKernelTransformD4(itk.itkKernelTransformPython.itkKernelTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkThinPlateR2LogRSplineKernelTransformPython.itkThinPlateR2LogRSplineKernelTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkThinPlateR2LogRSplineKernelTransformPython.itkThinPlateR2LogRSplineKernelTransformD4_Clone)
    __swig_destroy__ = _itkThinPlateR2LogRSplineKernelTransformPython.delete_itkThinPlateR2LogRSplineKernelTransformD4
    cast = _swig_new_static_method(_itkThinPlateR2LogRSplineKernelTransformPython.itkThinPlateR2LogRSplineKernelTransformD4_cast)
...
itkThinPlateR2LogRSplineKernelTransformD4___New_orig__ = _itkThinPlateR2LogRSplineKernelTransformPython.itkThinPlateR2LogRSplineKernelTransformD4___New_orig__
itkThinPlateR2LogRSplineKernelTransformD4_cast = _itkThinPlateR2LogRSplineKernelTransformPython.itkThinPlateR2LogRSplineKernelTransformD4_cast
