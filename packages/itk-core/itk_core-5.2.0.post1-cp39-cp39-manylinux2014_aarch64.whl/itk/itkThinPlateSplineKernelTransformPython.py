...
class itkThinPlateSplineKernelTransformD4(itk.itkKernelTransformPython.itkKernelTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_Clone)
    __swig_destroy__ = _itkThinPlateSplineKernelTransformPython.delete_itkThinPlateSplineKernelTransformD4
    cast = _swig_new_static_method(_itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_cast)
...
itkThinPlateSplineKernelTransformD4___New_orig__ = _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4___New_orig__
itkThinPlateSplineKernelTransformD4_cast = _itkThinPlateSplineKernelTransformPython.itkThinPlateSplineKernelTransformD4_cast
