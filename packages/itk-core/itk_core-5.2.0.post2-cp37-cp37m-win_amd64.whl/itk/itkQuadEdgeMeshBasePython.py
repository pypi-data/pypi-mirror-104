...
class itkBoundingBoxULL4FMCULLQEMPF4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4___New_orig__)
    Clone = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_Clone)
    SetPoints = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_SetPoints)
    GetPoints = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetPoints)
    ComputeCorners = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_ComputeCorners)
    ComputeBoundingBox = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_ComputeBoundingBox)
    GetBounds = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetBounds)
    GetCenter = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetCenter)
    GetMinimum = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_SetMaximum)
    ConsiderPoint = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_ConsiderPoint)
    GetDiagonalLength2 = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_GetDiagonalLength2)
    IsInside = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_IsInside)
    DeepCopy = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_DeepCopy)
    __swig_destroy__ = _itkQuadEdgeMeshBasePython.delete_itkBoundingBoxULL4FMCULLQEMPF4
    cast = _swig_new_static_method(_itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_cast)
...
itkBoundingBoxULL4FMCULLQEMPF4___New_orig__ = _itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4___New_orig__
itkBoundingBoxULL4FMCULLQEMPF4_cast = _itkQuadEdgeMeshBasePython.itkBoundingBoxULL4FMCULLQEMPF4_cast
...
class itkMapContainerULLCIDQEMCTI4(itk.ITKCommonBasePython.itkObject):
    ...
    __New_orig__ = _swig_new_static_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4___New_orig__)
    Clone = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_Clone)
    CastToSTLContainer = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_CastToSTLContainer)
    CastToSTLConstContainer = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_CastToSTLConstContainer)
    ElementAt = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_ElementAt)
    CreateElementAt = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_CreateElementAt)
    GetElement = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_GetElement)
    SetElement = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_SetElement)
    InsertElement = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_InsertElement)
    IndexExists = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_IndexExists)
    GetElementIfIndexExists = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_GetElementIfIndexExists)
    CreateIndex = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_CreateIndex)
    DeleteIndex = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_DeleteIndex)
    Size = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_Size)
    Reserve = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_Reserve)
    Squeeze = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_Squeeze)
    Initialize = _swig_new_instance_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_Initialize)
    __swig_destroy__ = _itkQuadEdgeMeshBasePython.delete_itkMapContainerULLCIDQEMCTI4
    cast = _swig_new_static_method(_itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_cast)
...
itkMapContainerULLCIDQEMCTI4___New_orig__ = _itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4___New_orig__
itkMapContainerULLCIDQEMCTI4_cast = _itkQuadEdgeMeshBasePython.itkMapContainerULLCIDQEMCTI4_cast
