...
class DescribeResourceCollectionHealthPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [DescribeResourceCollectionHealth.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.DescribeResourceCollectionHealth.paginate)
        """
...
class GetResourceCollectionPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [GetResourceCollection.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.GetResourceCollection.paginate)
        """
...
class ListAnomaliesForInsightPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListAnomaliesForInsight.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.ListAnomaliesForInsight.paginate)
        """
...
class ListEventsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListEvents.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.ListEvents.paginate)
        """
...
class ListInsightsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListInsights.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.ListInsights.paginate)
        """
...
class ListNotificationChannelsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListNotificationChannels.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.ListNotificationChannels.paginate)
        """
...
class ListRecommendationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRecommendations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.ListRecommendations.paginate)
        """
...
class SearchInsightsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [SearchInsights.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/devops-guru.html#DevopsGuru.Paginator.SearchInsights.paginate)
        """
