...
(self.webpackChunkhome_assistant_frontend=self.webpackChunkhome_assistant_frontend||[]).push([[1428],{18601:(e,t,i)=>{"use strict";i.d(t,{qN:()=>r.q,Wg:()=>n});var r=i(78220);class n extends r.H{createRenderRoot(){return this.attachShadow({mode:"open",delegatesFocus:!0})}click(){this.formElement&&(this.formElement.focus(),this.formElement.click())}setAriaLabel(e){this.formElement&&this.formElement.setAttribute("aria-label",e)}firstUpdated(){super.firstUpdated(),this.mdcRoot.addEventListener("change",(e=>{this.dispatchEvent(new Event("change",e))}))}}},32333:(e,t,i)=>{"use strict";var r=i(15652);class n extends r.oi{static get properties(){return{value:{type:Number},high:{type:Number},low:{type:Number},min:{type:Number},max:{type:Number},step:{type:Number},startAngle:{type:Number},arcLength:{type:Number},handleSize:{type:Number},handleZoom:{type:Number},readonly:{type:Boolean},disabled:{type:Boolean},dragging:{type:Boolean,reflect:!0},rtl:{type:Boolean},_scale:{type:Number},valueLabel:{type:String},lowLabel:{type:String},highLabel:{type:String}}}constructor(){super(),this.min=0,this.max=100,this.step=1,this.startAngle=135,this.arcLength=270,this.handleSize=6,this.handleZoom=1.5,this.readonly=!1,this.disabled=!1,this.dragging=!1,this.rtl=!1,this._scale=1,this.attachedListeners=!1}get _start(){return this.startAngle*Math.PI/180}get _len(){return Math.min(this.arcLength*Math.PI/180,2*Math.PI-.01)}get _end(){return this._start+this._len}get _showHandle(){return!this.readonly&&(null!=this.value||null!=this.high&&null!=this.low)}_angleInside(e){let t=(this.startAngle+this.arcLength/2-e+180+360)%360-180;return t<this.arcLength/2&&t>-this.arcLength/2}_angle2xy(e){return this.rtl?{x:-Math.cos(e),y:Math.sin(e)}:{x:Math.cos(e),y:Math.sin(e)}}_xy2angle(e,t){return this.rtl&&(e=-e),(Math.atan2(t,e)-this._start+2*Math.PI)%(2*Math.PI)}_value2angle(e){const t=((e=Math.min(this.max,Math.max(this.min,e)))-this.min)/(this.max-this.min);return this._start+t*this._len}_angle2value(e){return Math.round((e/this._len*(this.max-this.min)+this.min)/this.step)*this.step}get _boundaries(){const e=this._angle2xy(this._start),t=this._angle2xy(this._end);let i=1;this._angleInside(270)||(i=Math.max(-e.y,-t.y));let r=1;this._angleInside(90)||(r=Math.max(e.y,t.y));let n=1;this._angleInside(180)||(n=Math.max(-e.x,-t.x));let o=1;return this._angleInside(0)||(o=Math.max(e.x,t.x)),{up:i,down:r,left:n,right:o,height:i+r,width:n+o}}_mouse2value(e){const t=e.type.startsWith("touch")?e.touches[0].clientX:e.clientX,i=e.type.startsWith("touch")?e.touches[0].clientY:e.clientY,r=this.shadowRoot.querySelector("svg").getBoundingClientRect(),n=this._boundaries,o=t-(r.left+n.left*r.width/n.width),s=i-(r.top+n.up*r.height/n.height),a=this._xy2angle(o,s);return this._angle2value(a)}dragStart(e){if(!this._showHandle||this.disabled)return;let t,i=e.target;if(this._rotation&&"focus"!==this._rotation.type)return;if(i.classList.contains("shadowpath"))if("touchstart"===e.type&&(t=window.setTimeout((()=>{this._rotation&&(this._rotation.cooldown=void 0)}),200)),null==this.low)i=this.shadowRoot.querySelector("#value");else{const t=this._mouse2value(e);i=Math.abs(t-this.low)<Math.abs(t-this.high)?this.shadowRoot.querySelector("#low"):this.shadowRoot.querySelector("#high")}if(i.classList.contains("overflow")&&(i=i.nextElementSibling),!i.classList.contains("handle"))return;i.setAttribute("stroke-width",2*this.handleSize*this.handleZoom*this._scale);const r="high"===i.id?this.low:this.min,n="low"===i.id?this.high:this.max;this._rotation={handle:i,min:r,max:n,start:this[i.id],type:e.type,cooldown:t},this.dragging=!0}_cleanupRotation(){const e=this._rotation.handle;e.setAttribute("stroke-width",2*this.handleSize*this._scale),this._rotation=!1,this.dragging=!1,e.blur()}dragEnd(e){if(!this._showHandle||this.disabled)return;if(!this._rotation)return;const t=this._rotation.handle;this._cleanupRotation();let i=new CustomEvent("value-changed",{detail:{[t.id]:this[t.id]},bubbles:!0,composed:!0});this.dispatchEvent(i),this.low&&this.low>=.99*this.max?this._reverseOrder=!0:this._reverseOrder=!1}drag(e){if(!this._showHandle||this.disabled)return;if(!this._rotation)return;if(this._rotation.cooldown)return window.clearTimeout(this._rotation.coldown),void this._cleanupRotation();if("focus"===this._rotation.type)return;e.preventDefault();const t=this._mouse2value(e);this._dragpos(t)}_dragpos(e){if(e<this._rotation.min||e>this._rotation.max)return;const t=this._rotation.handle;this[t.id]=e;let i=new CustomEvent("value-changing",{detail:{[t.id]:e},bubbles:!0,composed:!0});this.dispatchEvent(i)}_keyStep(e){if(!this._showHandle||this.disabled)return;if(!this._rotation)return;const t=this._rotation.handle;"ArrowLeft"!==e.key&&"ArrowDown"!==e.key||(e.preventDefault(),this.rtl?this._dragpos(this[t.id]+this.step):this._dragpos(this[t.id]-this.step)),"ArrowRight"!==e.key&&"ArrowUp"!==e.key||(e.preventDefault(),this.rtl?this._dragpos(this[t.id]-this.step):this._dragpos(this[t.id]+this.step)),"Home"===e.key&&(e.preventDefault(),this._dragpos(this.min)),"End"===e.key&&(e.preventDefault(),this._dragpos(this.max))}firstUpdated(){document.addEventListener("mouseup",this.dragEnd.bind(this)),document.addEventListener("touchend",this.dragEnd.bind(this),{passive:!1}),document.addEventListener("mousemove",this.drag.bind(this)),document.addEventListener("touchmove",this.drag.bind(this),{passive:!1}),document.addEventListener("keydown",this._keyStep.bind(this))}updated(e){if(this.shadowRoot.querySelector(".slider")){const e=window.getComputedStyle(this.shadowRoot.querySelector(".slider"));if(e&&e.strokeWidth){const t=parseFloat(e.strokeWidth);if(t>this.handleSize*this.handleZoom){const e=this._boundaries,i=`\n          ${t/2*Math.abs(e.up)}px\n          ${t/2*Math.abs(e.right)}px\n          ${t/2*Math.abs(e.down)}px\n          ${t/2*Math.abs(e.left)}px`;this.shadowRoot.querySelector("svg").style.margin=i}}}if(this.shadowRoot.querySelector("svg")&&void 0===this.shadowRoot.querySelector("svg").style.vectorEffect){e.has("_scale")&&1!=this._scale&&this.shadowRoot.querySelector("svg").querySelectorAll("path").forEach((e=>{if(e.getAttribute("stroke-width"))return;const t=parseFloat(getComputedStyle(e).getPropertyValue("stroke-width"));e.style.strokeWidth=t*this._scale+"px"}));const t=this.shadowRoot.querySelector("svg").getBoundingClientRect(),i=Math.max(t.width,t.height);this._scale=2/i}}_renderArc(e,t){const i=t-e;return e=this._angle2xy(e),t=this._angle2xy(t+.001),`\n      M ${e.x} ${e.y}\n      A 1 1,\n        0,\n        ${i>Math.PI?"1":"0"} ${this.rtl?"0":"1"},\n        ${t.x} ${t.y}\n    `}_renderHandle(e){const t=this._value2angle(this[e]),i=this._angle2xy(t),n={value:this.valueLabel,low:this.lowLabel,high:this.highLabel}[e]||"";return r.YP`
    ...
    >
      ...
      <div id="columns"></div>
      ${null!==(e=this.lovelace)&&void 0!==e&&e.editMode?o.dy`
            <ha-fab
              .label=${this.hass.localize("ui.panel.lovelace.editor.edit_card.add")}
              extended
              @click=${this._addCard}
              class=${(0,m.$)({rtl:(0,b.HE)(this.hass)})}
            >
              <ha-svg-icon slot="icon" .path=${f.qX5}></ha-svg-icon>
            </ha-fab>
          `:""}
    `}},{kind:"method",key:"firstUpdated",value:function(){this._mqls=[300,600,900,1200].map((e=>{const t=window.matchMedia(`(min-width: ${e}px)`);return t.addListener((()=>this._updateColumns())),t})),this._updateColumns()}},{kind:"method",key:"updated",value:function(e){var t,n,o;if(re(ne(r.prototype),"updated",this).call(this,e),null!==(t=this.lovelace)&&void 0!==t&&t.editMode&&!oe&&(oe=!0,Promise.all([i.e(9119),i.e(741)]).then(i.bind(i,70741))),e.has("hass")){const t=e.get("hass");if(t&&this.hass.dockedSidebar!==t.dockedSidebar&&this._updateColumns(),1===e.size)return}e.has("narrow")&&this._updateColumns();const s=e.get("lovelace");(e.has("lovelace")&&((null==s?void 0:s.config)!==(null===(n=this.lovelace)||void 0===n?void 0:n.config)||(null==s?void 0:s.editMode)!==(null===(o=this.lovelace)||void 0===o?void 0:o.editMode))||e.has("_columns"))&&this._createColumns()}},{kind:"method",key:"_addCard",value:function(){(0,h.B)(this,"ll-create-card")}},{kind:"method",key:"_createColumns",value:async function(){if(!this._columns)return;this._createColumnsIteration++;const e=this._createColumnsIteration,t=this.shadowRoot.getElementById("columns");for(;t.lastChild;)t.removeChild(t.lastChild);const i=[],r=[];for(let e=0;e<Math.min(this._columns,this.cards.length);e++){const e=document.createElement("div");e.classList.add("column"),t.appendChild(e),i.push(0),r.push(e)}let n,o;for(const[t,s]of this.cards.entries()){let a;void 0===n&&(n=(0,_.y)().then((()=>{n=void 0,o=void 0}))),void 0===o?o=new Date:(new Date).getTime()-o.getTime()>16&&(a=n);const l=(0,Z.N)(s),[c]=await Promise.all([l,a]);if(e!==this._createColumnsIteration)return;this._addCardToColumn(r[se(i,c)],t,this.lovelace.editMode)}r.forEach((e=>{e.lastChild||e.parentElement.removeChild(e)}))}},{kind:"method",key:"_addCardToColumn",value:function(e,t,i){const r=this.cards[t];if(!i||this.isStrategy)r.editMode=!1,e.appendChild(r);else{const i=document.createElement("hui-card-options");i.hass=this.hass,i.lovelace=this.lovelace,i.path=[this.index,t],r.editMode=!0,i.appendChild(r),e.appendChild(i)}}},{kind:"method",key:"_updateColumns",value:function(){if(!this._mqls)return;const e=this._mqls.reduce(((e,t)=>e+Number(t.matches)),0);this._columns=Math.max(1,e-Number(!this.narrow&&"docked"===this.hass.dockedSidebar))}},{kind:"get",static:!0,key:"styles",value:function(){return o.iv`
      :host {
        display: block;
        padding-top: 4px;
        height: 100%;
                ...
                <app-toolbar>
                  ...
                  <ha-button-menu corner="BOTTOM_START">
                    ...
                    ${"yaml"===(null===(t=this.hass.panels.lovelace)||void 0===t||null===(i=t.config)||void 0===i?void 0:i.mode)?o.dy`
                        ...
                        `:""}
                    ${null!==(r=this.hass.user)&&void 0!==r&&r.is_admin&&!this.hass.config.safe_mode?o.dy`
                          <mwc-list-item
                            graphic="icon"
    ...
    `}},{kind:"field",key:"_isVisible",value(){return e=>Boolean(this._editMode||void 0===e.visible||!0===e.visible||Array.isArray(e.visible)&&e.visible.some((e=>{var t;return e.user===(null===(t=this.hass.user)||void 0===t?void 0:t.id)})))}},{kind:"method",key:"firstUpdated",value:function(){"1"===(0,s.io)("edit")&&this.lovelace.setEditMode(!0)}},{kind:"method",key:"updated",value:function(e){je(Me(r.prototype),"updated",this).call(this,e);const t=this._viewRoot.lastChild;let i;e.has("hass")&&t&&(t.hass=this.hass),e.has("narrow")&&t&&(t.narrow=this.narrow);let n=!1;const o=this.route.path.split("/")[1];if(e.has("route")){const e=this.config.views;if(!o&&e.length)i=e.findIndex(this._isVisible),this._navigateToView(e[i].path||i,!0);else if("hass-unused-entities"===o)i="hass-unused-entities";else if(o){const t=o,r=Number(t);let n=0;for(let i=0;i<e.length;i++)if(e[i].path===t||i===r){n=i;break}i=n}}if(e.has("lovelace")){const r=e.get("lovelace");if(r&&r.config===this.lovelace.config||(n=!0),!r||r.editMode!==this.lovelace.editMode){const e=this.config&&this.config.views;(0,h.B)(this,"iron-resize"),"storage"===this.lovelace.mode&&"hass-unused-entities"===o&&(i=e.findIndex(this._isVisible),this._navigateToView(e[i].path||i,!0))}!n&&t&&(t.lovelace=this.lovelace)}(void 0!==i||n)&&(n&&void 0===i&&(i=this._curView),(0,_.T)((()=>this._selectView(i,n))))}},{kind:"get",key:"config",value:function(){return this.lovelace.config}},{kind:"get",key:"_yamlMode",value:function(){return"yaml"===this.lovelace.mode}},{kind:"get",key:"_editMode",value:function(){return this.lovelace.editMode}},{kind:"get",key:"_layout",value:function(){return this.shadowRoot.getElementById("layout")}},{kind:"get",key:"_viewRoot",value:function(){return this.shadowRoot.getElementById("view")}},{kind:"method",key:"_handleRefresh",value:function(e){(0,g.Q)(e)&&(0,h.B)(this,"config-refresh")}},{kind:"method",key:"_handleReloadResources",value:function(e){(0,g.Q)(e)&&(this.hass.callService("lovelace","reload_resources"),(0,O.g7)(this,{title:this.hass.localize("ui.panel.lovelace.reload_resources.refresh_header"),text:this.hass.localize("ui.panel.lovelace.reload_resources.refresh_body"),confirmText:this.hass.localize("ui.common.refresh"),dismissText:this.hass.localize("ui.common.not_now"),confirm:()=>location.reload()}))}},{kind:"method",key:"_handleRawEditor",value:function(e){(0,g.Q)(e)&&this.lovelace.enableFullEditMode()}},{kind:"method",key:"_handleManageDashboards",value:function(e){(0,g.Q)(e)&&(0,w.c)(this,"/config/lovelace/dashboards")}},{kind:"method",key:"_handleManageResources",value:function(e){(0,g.Q)(e)&&(0,w.c)(this,"/config/lovelace/resources")}},{kind:"method",key:"_handleUnusedEntities",value:function(e){var t;(0,g.Q)(e)&&(0,w.c)(this,`${null===(t=this.route)||void 0===t?void 0:t.prefix}/hass-unused-entities`)}},{kind:"method",key:"_showVoiceCommandDialog",value:function(){(0,j._)(this)}},{kind:"method",key:"_handleEnableEditMode",value:function(e){(0,g.Q)(e)&&(this._yamlMode?(0,O.Ys)(this,{text:"The edit UI is not available when in YAML mode."}):this.lovelace.setEditMode(!0))}},{kind:"method",key:"_editModeDisable",value:function(){this.lovelace.setEditMode(!1)}},{kind:"method",key:"_editLovelace",value:function(){B(this,this.lovelace)}},{kind:"method",key:"_navigateToView",value:function(e,t){this.lovelace.editMode?(0,w.c)(this,`${this.route.prefix}/${e}?${(0,s.j4)({edit:"1"})}`,t):(0,w.c)(this,`${this.route.prefix}/${e}`,t)}},{kind:"method",key:"_editView",value:function(){N(this,{lovelace:this.lovelace,viewIndex:this._curView})}},{kind:"method",key:"_moveViewLeft",value:function(){if(0===this._curView)return;const e=this.lovelace,t=this._curView,i=this._curView-1;this._curView=i,e.saveConfig((0,L.mA)(e.config,t,i))}},{kind:"method",key:"_moveViewRight",value:function(){if(this._curView+1===this.lovelace.config.views.length)return;const e=this.lovelace,t=this._curView,i=this._curView+1;this._curView=i,e.saveConfig((0,L.mA)(e.config,t,i))}},{kind:"method",key:"_addView",value:function(){N(this,{lovelace:this.lovelace,saveCallback:(e,t)=>{const i=t.path||e;this._navigateToView(i)}})}},{kind:"method",key:"_handleViewSelected",value:function(e){const t=e.detail.selected;if(t!==this._curView){const e=this.config.views[t].path||t;this._navigateToView(e)}!function(e,t){const i=t,r=Math.random(),n=Date.now(),o=i.scrollTop,s=0-o;e._currentAnimationId=r,function t(){const a=Date.now()-n;var l;a>200?i.scrollTop=0:e._currentAnimationId===r&&(i.scrollTop=(l=a,-s*(l/=200)*(l-2)+o),requestAnimationFrame(t.bind(e)))}.call(e)}(this,this._layout.header.scrollTarget)}},{kind:"method",key:"_selectView",value:function(e,t){if(!t&&this._curView===e)return;e=void 0===e?0:e,this._curView=e,t&&(this._viewCache={});const r=this._viewRoot;if(r.lastChild&&r.removeChild(r.lastChild),"hass-unused-entities"===e){const e=document.createElement("hui-unused-entities");return Promise.all([i.e(9494),i.e(1960),i.e(9119),i.e(7065),i.e(9123)]).then(i.bind(i,28279)).then((()=>{e.hass=this.hass,e.lovelace=this.lovelace,e.narrow=this.narrow})),void r.appendChild(e)}let n;const o=this.config.views[e];if(!o)return void this.lovelace.setEditMode(!0);!t&&this._viewCache[e]?n=this._viewCache[e]:(n=document.createElement("hui-view"),n.index=e,this._viewCache[e]=n),n.lovelace=this.lovelace,n.hass=this.hass,n.narrow=this.narrow;const s=o.background||this.config.background;s?this._appLayout.style.setProperty("--lovelace-background",s):this._appLayout.style.removeProperty("--lovelace-background"),r.appendChild(n),(0,h.B)(this,"iron-resize")}},{kind:"get",static:!0,key:"styles",value:function(){return[M.Qx,o.iv`
      ...
      `:"error"===e?o.dy`
        <hass-error-screen
          .hass=${this.hass}
          title="${(0,a.Lh)(this.hass.localize,"lovelace")}"
      ...
      <hass-loading-screen
        ...
        .narrow=${this.narrow}
      ></hass-loading-screen>
    `}},{kind:"method",key:"firstUpdated",value:function(e){We(He(r.prototype),"firstUpdated",this).call(this,e),this._fetchConfig(!1),this._unsubUpdates||this._subscribeUpdates(),window.addEventListener("connection-status",(e=>{"connected"===e.detail&&this._fetchConfig(!1)}))}},{kind:"method",key:"_regenerateConfig",value:async function(){const e=await(0,me.to)({hass:this.hass,narrow:this.narrow},Qe);this._setLovelaceConfig(e,void 0,"generated"),this._state="loaded"}},{kind:"method",key:"_subscribeUpdates",value:async function(){this._unsubUpdates=await(0,l.Gc)(this.hass.connection,this.urlPath,(()=>this._lovelaceChanged()))}},{kind:"method",key:"_closeEditor",value:function(){this._state="loaded"}},{kind:"method",key:"_lovelaceChanged",value:function(){this._ignoreNextUpdateEvent?this._ignoreNextUpdateEvent=!1:this.isConnected?(0,c.C)(this,{message:this.hass.localize("ui.panel.lovelace.changed_toast.message"),action:{action:()=>this._fetchConfig(!1),text:this.hass.localize("ui.common.refresh")},duration:0,dismissable:!1}):this._fetchConfigOnConnect=!0}},{kind:"get",key:"urlPath",value:function(){return"lovelace"===this.panel.url_path?null:this.panel.url_path}},{kind:"method",key:"_forceFetchConfig",value:function(){this._fetchConfig(!0)}},{kind:"method",key:"_fetchConfig",value:async function(e){let t,i,r,n=this.panel.config.mode;const o=window;o.llConfProm&&(r=o.llConfProm,o.llConfProm=void 0),Ye||(Ye=!0,(o.llConfProm||(0,l.eL)(this.hass.connection)).then((e=>(0,d.k)(e,this.hass.auth.data.hassUrl)))),null===this.urlPath&&r||(this.lovelace&&"yaml"===this.lovelace.mode&&(this._ignoreNextUpdateEvent=!0),r=(0,l.Q2)(this.hass.connection,this.urlPath,e));try{i=await r,t=i.strategy?await(0,me.to)({config:i,hass:this.hass,narrow:this.narrow}):i}catch(e){if("config_not_found"!==e.code)return console.log(e),this._state="error",void(this._errorMsg=e.message);t=await(0,me.to)({hass:this.hass,narrow:this.narrow},Qe),n="generated"}finally{this.lovelace&&"yaml"===this.lovelace.mode&&setTimeout((()=>{this._ignoreNextUpdateEvent=!1}),2e3)}this._state="yaml-editor"===this._state?this._state:"loaded",this._setLovelaceConfig(t,i,n)}},{kind:"method",key:"_checkLovelaceConfig",value:function(e){let t=Object.isFrozen(e)?void 0:e;return e.views.forEach(((i,r)=>{i.badges&&!i.badges.every(Boolean)&&(t=t||{...e,views:[...e.views]},t.views[r]={...i},t.views[r].badges=i.badges.filter(Boolean))})),t?n()(t):e}},{kind:"method",key:"_setLovelaceConfig",value:function(e,t,r){e=this._checkLovelaceConfig(e);const n=this.urlPath;this.lovelace={config:e,rawConfig:t,mode:r,urlPath:this.urlPath,editMode:!!this.lovelace&&this.lovelace.editMode,locale:this.hass.locale,enableFullEditMode:()=>{Ze||(Ze=!0,Promise.all([i.e(9033),i.e(3304),i.e(2118),i.e(5912)]).then(i.bind(i,95912))),this._state="yaml-editor"},setEditMode:e=>{var t,r;this.lovelace.rawConfig&&this.lovelace.rawConfig!==this.lovelace.config?this.lovelace.enableFullEditMode():e&&"generated"===this.lovelace.mode?(t=this,r={lovelace:this.lovelace,mode:this.panel.config.mode,narrow:this.narrow},p||(p=!0,(0,h.B)(t,"register-dialog",{dialogShowEvent:u,dialogTag:"hui-dialog-save-config",dialogImport:()=>Promise.all([i.e(5906),i.e(9033),i.e(3304),i.e(8082)]).then(i.bind(i,78082))})),(0,h.B)(t,u,r)):this._updateLovelace({editMode:e})},saveConfig:async e=>{const{config:t,rawConfig:i,mode:r}=this.lovelace;let o;o=(e=this._checkLovelaceConfig(e)).strategy?await(0,me.to)({config:e,hass:this.hass,narrow:this.narrow}):e;try{this._updateLovelace({config:o,rawConfig:e,mode:"storage"}),this._ignoreNextUpdateEvent=!0,await(0,l.Oh)(this.hass,n,e)}catch(e){throw console.error(e),this._updateLovelace({config:t,rawConfig:i,mode:r}),e}},deleteConfig:async()=>{const{config:e,rawConfig:t,mode:i}=this.lovelace;try{const e=await(0,me.to)({hass:this.hass,narrow:this.narrow},Qe);this._updateLovelace({config:e,rawConfig:void 0,mode:"generated",editMode:!1}),this._ignoreNextUpdateEvent=!0,await(0,l.vj)(this.hass,n)}catch(r){throw console.error(r),this._updateLovelace({config:e,rawConfig:t,mode:i}),r}}}}},{kind:"method",key:"_updateLovelace",value:function(e){this.lovelace={...this.lovelace,...e},"editMode"in e&&window.history.replaceState(null,"",(e=>{const t=window.location.pathname;return e?t+"?"+e:t})(e.editMode?(0,s.j4)({edit:"1"}):(0,s.pc)("edit")))}}]}}),o.oi);customElements.define("ha-panel-lovelace",Ge)},90222:(e,t,i)=>{"use strict";i.d(t,{mQ:()=>m,to:()=>p,ar:()=>f});var r=i(4915);const n=async(e,t)=>new Promise((i=>{const r=t(e,(e=>{r(),i(e)}))}));var o=i(57066),s=i(57292),a=i(74186),l=i(38926);let c=!1;const d="custom:",h={"original-states":class{static async generateView(e){const t=e.hass;if(t.config.state===r.UE)return{cards:[{type:"starting"}]};if(t.config.safe_mode)return{cards:[{type:"safe-mode"}]};c||(c=!0,(0,o.sG)(t.connection,(()=>{})),(0,s.q4)(t.connection,(()=>{})),(0,a.LM)(t.connection,(()=>{})));const[i,d,h,u]=await Promise.all([n(t.connection,o.sG),n(t.connection,s.q4),n(t.connection,a.LM),t.loadBackendTranslation("title")]),p=(0,l.AP)(i,d,h,t.states,u);return t.config.components.includes("geo_location")&&p&&p.cards&&p.cards.push({type:"map",geo_location_sources:["all"]}),0===p.cards.length&&p.cards.push({type:"empty-state"}),p}static async generateDashboard(e){return{views:[{strategy:{type:"original-states"},title:e.hass.config.location_name}]}}}},u=async(e,t,i,r)=>{if(!r)return t("No strategy type found");try{const t=await(async e=>{if(e in h)return h[e];if(!e.startsWith(d))throw new Error("Unknown strategy");const t=`ll-strategy-${e.substr(d.length)}`;if(!0===await Promise.race([customElements.whenDefined(t),new Promise((e=>setTimeout((()=>e(!0)),5e3)))]))throw new Error(`Timeout waiting for strategy element ${t} to be registered`);return customElements.get(t)})(r);return await t[e](i)}catch(e){return"timeout"!==e.message&&console.error(e),t(e)}},p=async(e,t)=>{var i,r;return u("generateDashboard",(e=>({views:[{title:"Error",cards:[{type:"markdown",content:`Error loading the dashboard strategy:\n> ${e}`}]}]})),e,t||(null===(i=e.config)||void 0===i||null===(r=i.strategy)||void 0===r?void 0:r.type))},f=async(e,t)=>{var i,r;return u("generateView",(e=>({cards:[{type:"markdown",content:`Error loading the view strategy:\n> ${e}`}]})),e,t||(null===(i=e.view)||void 0===i||null===(r=i.strategy)||void 0===r?void 0:r.type))},m=async e=>{const t=e.config.strategy?await p(e):{...e.config};return t.views=await Promise.all(t.views.map((i=>i.strategy?f({hass:e.hass,narrow:e.narrow,config:t,view:i}):i))),t}},27322:(e,t,i)=>{"use strict";i.d(t,{R:()=>r});const r=(e,t)=>`https://${e.config.version.includes("b")?"rc":e.config.version.includes("dev")?"next":"www"}.home-assistant.io${t}`}}]);
//# sourceMappingURL=chunk.1e79254a38a929f81042.js.map