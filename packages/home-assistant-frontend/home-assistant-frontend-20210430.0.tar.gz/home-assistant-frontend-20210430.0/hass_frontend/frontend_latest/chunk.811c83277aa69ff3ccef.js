        ...
        <div class="events">
          ${this._events.map((e=>c.dy`
              <div class="event">
                ...
                ${(0,p.mr)(new Date(e.event.time_fired),this.hass.locale)}:
