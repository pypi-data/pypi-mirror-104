    ...
    `}},{kind:"method",key:"_relatedFilterChanged",value:function(e){this._filterValue=e.detail.value,this._filterValue?(this._activeFilters=[e.detail.filter],this._filteredAutomations=e.detail.items.automation||null):this._clearFilter()}},{kind:"method",key:"_clearFilter",value:function(){this._filteredAutomations=void 0,this._activeFilters=void 0,this._filterValue=void 0}},{kind:"method",key:"_showInfo",value:function(e){e.stopPropagation();const t=e.currentTarget.automation.entity_id;(0,h.B)(this,"hass-more-info",{entityId:t})}},{kind:"method",key:"_showHelp",value:function(){(0,y.Ys)(this,{title:this.hass.localize("ui.panel.config.automation.caption"),text:i.dy`
      ...
      <ha-config-section vertical .isWide=${this.isWide}>
        ...
        <ha-card>
          ...
          ${this.config.use_blueprint.path?t&&"error"in t?F.dy`<p class="warning padding">
                ...
                </p>`:F.dy`${(null==t?void 0:t.metadata.description)?F.dy`<ha-markdown
                      class="card-content"
                      breaks
                      .content=${t.metadata.description}
                    ></ha-markdown>`:""}
                ${(null==t||null===(e=t.metadata)||void 0===e?void 0:e.input)&&Object.keys(t.metadata.input).length?Object.entries(t.metadata.input).map((([e,t])=>{var r,i;return F.dy`<ha-settings-row .narrow=${this.narrow}>
                          <span slot="heading">${(null==t?void 0:t.name)||e}</span>
                          <span slot="description">${null==t?void 0:t.description}</span>
                          ${(null==t?void 0:t.selector)?F.dy`<ha-selector
                                .hass=${this.hass}
                                .selector=${t.selector}
                                .key=${e}
      ...
      <ha-config-section vertical .isWide=${this.isWide}>
        ...
        <ha-automation-action
          ...
          .narrow=${this.narrow}
        ></ha-automation-action>
      </ha-config-section>`}},{kind:"method",key:"_runActions",value:function(e){(0,m.Es)(this.hass,e.target.stateObj.entity_id)}},{kind:"method",key:"_valueChanged",value:function(e){e.stopPropagation();const t=e.target,r=t.name;if(!r)return;let i=e.detail.value;"number"===t.type&&(i=Number(i)),(this.config[r]||"")!==i&&(0,h.B)(this,"value-changed",{value:{...this.config,[r]:i}})}},{kind:"method",key:"_modeChanged",value:function(e){var t,r;const i=null===(t=e.target)||void 0===t||null===(r=t.selectedItem)||void 0===r?void 0:r.mode;if(i===this.config.mode)return;const n={...this.config,mode:i};q.kg.includes(i)||delete n.max,(0,h.B)(this,"value-changed",{value:n})}},{kind:"method",key:"_triggerChanged",value:function(e){e.stopPropagation(),(0,h.B)(this,"value-changed",{value:{...this.config,trigger:e.detail.value}})}},{kind:"method",key:"_conditionChanged",value:function(e){e.stopPropagation(),(0,h.B)(this,"value-changed",{value:{...this.config,condition:e.detail.value}})}},{kind:"method",key:"_actionChanged",value:function(e){e.stopPropagation(),(0,h.B)(this,"value-changed",{value:{...this.config,action:e.detail.value}})}},{kind:"get",static:!0,key:"styles",value:function(){return[b.Qx,i.iv`
        ha-card {
          overflow: hidden;
        }
        span[slot="introduction"] a {
