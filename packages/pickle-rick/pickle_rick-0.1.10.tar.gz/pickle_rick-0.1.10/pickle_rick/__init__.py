...
class BasicRick:
    ...
    def __init__(self, base : Union[dict,str,TextIOWrapper] = None, deep : bool = False, args : dict = None):
        if base is None:
            return
...
class PickleRick(BasicRick):
    ...
    def __init__(self, base: Union[dict, str] = None, deep : bool = False, load_lambda : bool = False):
