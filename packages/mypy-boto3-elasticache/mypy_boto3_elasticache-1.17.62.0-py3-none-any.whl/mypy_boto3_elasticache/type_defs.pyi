...
CloudWatchLogsDestinationDetailsTypeDef = TypedDict(
    "CloudWatchLogsDestinationDetailsTypeDef", {"LogGroup": str}, total=False
)
...
EventTypeDef = TypedDict(
    "EventTypeDef",
    {"SourceIdentifier": str, "SourceType": SourceType, "Message": str, "Date": datetime},
    total=False,
)
...
KinesisFirehoseDestinationDetailsTypeDef = TypedDict(
    "KinesisFirehoseDestinationDetailsTypeDef", {"DeliveryStream": str}, total=False
)
