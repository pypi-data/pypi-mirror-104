...
class PilarDeMadeira:
    ...
    def __init__(self):
        ...
        self.flexao_composta = PegadorPilar.pega_flexao_composta()
        self.momentos = PegadorPilar.pega_momentos()
        self.classe = PegadorPilar.pega_classe()
        self.categoria = PegadorPilar.pega_categoria()
        self.duracao = PegadorPilar.pega_duracao()
