...
class VigaDeMadeira:
    ...
    def __init__(self):
        ...
        self.peso_proprio = PegadorViga.pega_peso_proprio()
        self.carga_acidental = PegadorViga.pega_carga_acidental()
        self.classe = PegadorViga.pega_classe()
        self.categoria = PegadorViga.pega_categoria()
        self.duracao = PegadorViga.pega_duracao()
...
{abre_negrito}Kmod1, Kmod2, Kmod3{fecha_negrito}: {self.kmods}
