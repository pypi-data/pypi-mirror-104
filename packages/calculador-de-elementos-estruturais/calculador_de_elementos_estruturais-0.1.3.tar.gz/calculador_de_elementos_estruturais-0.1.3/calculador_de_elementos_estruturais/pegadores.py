...
#from enunciado import EnunciadoPilar, EnunciadoViga, Enunciado
from calculador_de_elementos_estruturais.enunciado import EnunciadoViga, EnunciadoPilar, Enunciado
