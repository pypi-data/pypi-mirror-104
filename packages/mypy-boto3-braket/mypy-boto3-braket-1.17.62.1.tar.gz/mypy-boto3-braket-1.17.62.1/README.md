...
[boto3.Braket 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/braket.html#Braket) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_braket/README.md)
...
def check_value(value: CancellationStatus) -> bool:
    ...
```
