...
class GraphMetricsMixin:
    ...
    def plot_roc_curve(self, data: Iterable, show_thresholds=1, title:str="ROC curve", ax=None, **kwargs) -> None:
        """
        ...
        """
        pred = self.predict(data)
        feyn.plots.plot_roc_curve(data[self.target], pred, show_thresholds, title, ax, **kwargs)
    ...
    def plot_goodness_of_fit(self, data:Iterable, title:str = "Actuals vs Prediction", ax=None):
        ...
        return feyn.plots.plot_goodness_of_fit(y_true, y_pred, title, ax)
    ...
    def plot_residuals(self, data:Iterable, title:str = "Residuals plot", ax=None):
        ...
        return feyn.plots.plot_residuals(y_true, y_pred, title, ax)