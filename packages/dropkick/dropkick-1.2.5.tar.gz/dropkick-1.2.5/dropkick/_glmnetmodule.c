 ...
 * Generation date: Wed Apr 28 18:58:05 2021
...
/*frompyobj*/
  ...
  if (capi_x_tmp == NULL) {
    ...
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 3rd argument `x' of _glmnet.lognet to C/Fortran array" );
  ...
  if (capi_jd_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 6th argument `jd' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_ulam_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 11st argument `ulam' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_y_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 4th argument `y' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_g_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 5th argument `g' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_vp_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 7th argument `vp' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_cl_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 8th argument `cl' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_ia_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `ia' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_nin_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `nin' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_dev0_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `dev0' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_dev_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `dev' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_alm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `alm' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_a0_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `a0' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_ca_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `ca' of _glmnet.lognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
/*frompyobj*/
  ...
  if (capi_x_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 5th argument `x' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    x = (double *)(PyArray_DATA(capi_x_tmp));
  ...
  if (capi_ix_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 6th argument `ix' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_jx_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 7th argument `jx' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
  ...
  if (capi_jd_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 10th argument `jd' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    jd = (int *)(PyArray_DATA(capi_jd_tmp));
  ...
  if (capi_vp_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 11st argument `vp' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    vp = (double *)(PyArray_DATA(capi_vp_tmp));
  ...
  if (capi_ulam_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 16th argument `ulam' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ulam = (double *)(PyArray_DATA(capi_ulam_tmp));
  ...
  if (capi_y_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 8th argument `y' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    y = (double *)(PyArray_DATA(capi_y_tmp));
  ...
  if (capi_g_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 9th argument `g' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    g = (double *)(PyArray_DATA(capi_g_tmp));
  ...
  if (capi_cl_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 12nd argument `cl' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    cl = (double *)(PyArray_DATA(capi_cl_tmp));
  ...
  if (capi_ia_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `ia' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ia = (int *)(PyArray_DATA(capi_ia_tmp));
  ...
  if (capi_nin_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `nin' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nin = (int *)(PyArray_DATA(capi_nin_tmp));
  ...
  if (capi_dev0_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `dev0' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dev0 = (double *)(PyArray_DATA(capi_dev0_tmp));
  ...
  if (capi_dev_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `dev' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    dev = (double *)(PyArray_DATA(capi_dev_tmp));
  ...
  if (capi_alm_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `alm' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    alm = (double *)(PyArray_DATA(capi_alm_tmp));
  ...
  if (capi_a0_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `a0' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    a0 = (double *)(PyArray_DATA(capi_a0_tmp));
  ...
  if (capi_ca_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `ca' of _glmnet.splognet to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ca = (double *)(PyArray_DATA(capi_ca_tmp));
...
/*frompyobj*/
  ...
  if (capi_ca_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 2nd argument `ca' of _glmnet.lsolns to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ca = (double *)(PyArray_DATA(capi_ca_tmp));
  ...
  if (capi_ia_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 3rd argument `ia' of _glmnet.lsolns to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    ia = (int *)(PyArray_DATA(capi_ia_tmp));
  ...
  if (capi_nin_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting 4th argument `nin' of _glmnet.lsolns to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
    nin = (int *)(PyArray_DATA(capi_nin_tmp));
  ...
  if (capi_b_tmp == NULL) {
    PyObject *exc, *val, *tb;
    PyErr_Fetch(&exc, &val, &tb);
    PyErr_SetString(exc ? exc : _glmnet_error,"failed in converting hidden `b' of _glmnet.lsolns to C/Fortran array" );
    npy_PyErr_ChainExceptionsCause(exc, val, tb);
  } else {
...
PyMODINIT_FUNC PyInit__glmnet(void) {
  ...
  import_array();
  if (PyErr_Occurred())
    {PyErr_SetString(PyExc_ImportError, "can't initialize module _glmnet (failed to import numpy)"); return m;}
  d = PyModule_GetDict(m);
  s = PyUnicode_FromString("1.20.2");
  PyDict_SetItemString(d, "__version__", s);
  Py_DECREF(s);
  s = PyUnicode_FromString(
    "This module '_glmnet' is auto-generated with f2py (version:1.20.2).\nFunctions:\n"
...
".");
   ...
   */
  PyDict_SetItemString(d, "__glmnet_error", _glmnet_error);
  Py_DECREF(_glmnet_error);
