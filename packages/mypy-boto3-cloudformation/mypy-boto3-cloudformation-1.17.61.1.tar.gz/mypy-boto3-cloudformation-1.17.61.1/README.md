...
[boto3.CloudFormation 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/cloudformation.html#CloudFormation) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_cloudformation/README.md)
...
`mypy_boto3_cloudformation.literals` module contains literals extracted from shapes
...
def check_value(value: AccountGateStatus) -> bool:
    ...
```
