...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'alicloud', '3.1.0-alpha.1619780412+0d362212'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource alicloud 3.1.0-alpha.1619780412+0d362212`
                """)
            else:
                raise
