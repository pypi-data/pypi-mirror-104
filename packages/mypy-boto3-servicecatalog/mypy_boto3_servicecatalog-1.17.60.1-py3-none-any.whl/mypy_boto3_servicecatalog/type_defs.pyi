...
PrincipalTypeDef = TypedDict(
    "PrincipalTypeDef", {"PrincipalARN": str, "PrincipalType": PrincipalType}, total=False
)
...
ServiceActionSummaryTypeDef = TypedDict(
    "ServiceActionSummaryTypeDef",
    {"Id": str, "Name": str, "Description": str, "DefinitionType": ServiceActionDefinitionType},
    total=False,
)
...
StackInstanceTypeDef = TypedDict(
    "StackInstanceTypeDef",
    {"Account": str, "Region": str, "StackInstanceStatus": StackInstanceStatus},
    total=False,
)
...
AccessLevelFilterTypeDef = TypedDict(
    "AccessLevelFilterTypeDef", {"Key": AccessLevelFilterKey, "Value": str}, total=False
)
...
GetAWSOrganizationsAccessStatusOutputTypeDef = TypedDict(
    "GetAWSOrganizationsAccessStatusOutputTypeDef",
    {"AccessStatus": AccessStatus, "ResponseMetadata": "ResponseMetadata"},
    total=False,
)
...
UpdatePortfolioShareOutputTypeDef = TypedDict(
    "UpdatePortfolioShareOutputTypeDef",
    {"PortfolioShareToken": str, "Status": ShareStatus, "ResponseMetadata": "ResponseMetadata"},
    total=False,
)
