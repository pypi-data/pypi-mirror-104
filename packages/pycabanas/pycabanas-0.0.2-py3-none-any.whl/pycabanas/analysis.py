from pycabanas import global_routines
import numpy as np
import matplotlib.pyplot as plt
from collections import Counter
from resamplelib.jackknife import *
def classic_analysis(suceptibility,binder,correlation,L,rho):
	...
	try:
		...
		plot_histogram_q(histogram_q)
		plot_histogram_q_l(histogram_q_l)
	except:
		print('No histograms')
	return
def quantum_analysis(suceptibility,binder,correlation,L,rho):
	def compute_cumulants_gammas(q2,q4,sp):
		q2_l=sort_and_build(q2,1)
		q4_l=sort_and_build(q4,1)
		sp_l=sort_and_build(sp,1)
