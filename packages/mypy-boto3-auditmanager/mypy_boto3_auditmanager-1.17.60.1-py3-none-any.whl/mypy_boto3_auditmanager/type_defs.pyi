...
AssessmentReportsDestinationTypeDef = TypedDict(
    "AssessmentReportsDestinationTypeDef",
    {"destinationType": AssessmentReportDestinationType, "destination": str},
    total=False,
)
...
CreateDelegationRequestTypeDef = TypedDict(
    "CreateDelegationRequestTypeDef",
    {"comment": str, "controlSetId": str, "roleArn": str, "roleType": RoleType},
    total=False,
)
...
RoleTypeDef = TypedDict("RoleTypeDef", {"roleType": RoleType, "roleArn": str}, total=False)
...
SourceKeywordTypeDef = TypedDict(
    "SourceKeywordTypeDef", {"keywordInputType": KeywordInputType, "keywordValue": str}, total=False
)
...
DeregisterAccountResponseTypeDef = TypedDict(
    "DeregisterAccountResponseTypeDef", {"status": AccountStatus}, total=False
)

GetAccountStatusResponseTypeDef = TypedDict(
    "GetAccountStatusResponseTypeDef", {"status": AccountStatus}, total=False
)
...
GetAssessmentResponseTypeDef = TypedDict(
    "GetAssessmentResponseTypeDef",
    {"assessment": "AssessmentTypeDef", "userRole": "RoleTypeDef"},
    total=False,
)
...
RegisterAccountResponseTypeDef = TypedDict(
    "RegisterAccountResponseTypeDef", {"status": AccountStatus}, total=False
)
