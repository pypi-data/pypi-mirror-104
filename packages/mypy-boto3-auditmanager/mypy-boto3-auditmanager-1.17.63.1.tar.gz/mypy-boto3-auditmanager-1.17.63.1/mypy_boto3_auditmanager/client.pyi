...
class AuditManagerClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client)
    ...
    def associate_assessment_report_evidence_folder(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.associate_assessment_report_evidence_folder)
    ...
    def batch_associate_assessment_report_evidence(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.batch_associate_assessment_report_evidence)
    ...
    def batch_create_delegation_by_assessment(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.batch_create_delegation_by_assessment)
    ...
    def batch_delete_delegation_by_assessment(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.batch_delete_delegation_by_assessment)
    ...
    def batch_disassociate_assessment_report_evidence(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.batch_disassociate_assessment_report_evidence)
    ...
    def batch_import_evidence_to_assessment_control(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.batch_import_evidence_to_assessment_control)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.can_paginate)
    ...
    def create_assessment(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.create_assessment)
    ...
    def create_assessment_framework(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.create_assessment_framework)
    ...
    def create_assessment_report(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.create_assessment_report)
    ...
    def create_control(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.create_control)
    ...
    def delete_assessment(self, assessmentId: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.delete_assessment)
    ...
    def delete_assessment_framework(self, frameworkId: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.delete_assessment_framework)
    ...
    def delete_assessment_report(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.delete_assessment_report)
    ...
    def delete_control(self, controlId: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.delete_control)
    ...
    def deregister_account(self) -> DeregisterAccountResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.deregister_account)
    ...
    def deregister_organization_admin_account(self, adminAccountId: str = None) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.deregister_organization_admin_account)
    ...
    def disassociate_assessment_report_evidence_folder(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.disassociate_assessment_report_evidence_folder)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.generate_presigned_url)
    ...
    def get_account_status(self) -> GetAccountStatusResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_account_status)
    ...
    def get_assessment(self, assessmentId: str) -> GetAssessmentResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_assessment)
    ...
    def get_assessment_framework(self, frameworkId: str) -> GetAssessmentFrameworkResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_assessment_framework)
    ...
    def get_assessment_report_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_assessment_report_url)
    ...
    def get_change_logs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_change_logs)
    ...
    def get_control(self, controlId: str) -> GetControlResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_control)
    ...
    def get_delegations(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_delegations)
    ...
    def get_evidence(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_evidence)
    ...
    def get_evidence_by_evidence_folder(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_evidence_by_evidence_folder)
    ...
    def get_evidence_folder(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_evidence_folder)
    ...
    def get_evidence_folders_by_assessment(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_evidence_folders_by_assessment)
    ...
    def get_evidence_folders_by_assessment_control(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_evidence_folders_by_assessment_control)
    ...
    def get_organization_admin_account(self) -> GetOrganizationAdminAccountResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_organization_admin_account)
    ...
    def get_services_in_scope(self) -> GetServicesInScopeResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_services_in_scope)
    ...
    def get_settings(self, attribute: SettingAttribute) -> GetSettingsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.get_settings)
    ...
    def list_assessment_frameworks(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_assessment_frameworks)
    ...
    def list_assessment_reports(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_assessment_reports)
    ...
    def list_assessments(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_assessments)
    ...
    def list_controls(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_controls)
    ...
    def list_keywords_for_data_source(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_keywords_for_data_source)
    ...
    def list_notifications(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_notifications)
    ...
    def list_tags_for_resource(self, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.list_tags_for_resource)
    ...
    def register_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.register_account)
    ...
    def register_organization_admin_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.register_organization_admin_account)
    ...
    def tag_resource(self, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.tag_resource)
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.untag_resource)
    ...
    def update_assessment(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_assessment)
    ...
    def update_assessment_control(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_assessment_control)
    ...
    def update_assessment_control_set_status(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_assessment_control_set_status)
    ...
    def update_assessment_framework(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_assessment_framework)
    ...
    def update_assessment_status(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_assessment_status)
    ...
    def update_control(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_control)
    ...
    def update_settings(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.update_settings)
    ...
    def validate_assessment_report_integrity(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/auditmanager.html#AuditManager.Client.validate_assessment_report_integrity)
