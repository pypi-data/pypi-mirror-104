...
FailoverConfigTypeDef = TypedDict(
    "FailoverConfigTypeDef", {"RecoveryWindow": int, "State": State}, total=False
)
...
_RequiredResourceSpecificationTypeDef = TypedDict(
    "_RequiredResourceSpecificationTypeDef", {"ResourceType": ResourceType}
)
...
DeleteFlowResponseTypeDef = TypedDict(
    "DeleteFlowResponseTypeDef", {"FlowArn": str, "Status": Status}, total=False
)
...
StartFlowResponseTypeDef = TypedDict(
    "StartFlowResponseTypeDef", {"FlowArn": str, "Status": Status}, total=False
)

StopFlowResponseTypeDef = TypedDict(
    "StopFlowResponseTypeDef", {"FlowArn": str, "Status": Status}, total=False
)
...
UpdateFailoverConfigTypeDef = TypedDict(
    "UpdateFailoverConfigTypeDef", {"RecoveryWindow": int, "State": State}, total=False
)
