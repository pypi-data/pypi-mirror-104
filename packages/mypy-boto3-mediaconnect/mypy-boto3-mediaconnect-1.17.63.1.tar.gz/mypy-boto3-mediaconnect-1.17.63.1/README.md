...
[boto3.MediaConnect 1.17.63](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/mediaconnect.html#MediaConnect)
...
[mypy-boto3-mediaconnect docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_mediaconnect/README.md)
...
def get_structure() -> AddFlowOutputsResponseTypeDef:
    return {
      ...
    }
```
