...
class IoTWirelessClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client)
    ...
    def associate_aws_account_with_partner_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.associate_aws_account_with_partner_account)
    ...
    def associate_wireless_device_with_thing(self, Id: str, ThingArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.associate_wireless_device_with_thing)
    ...
    def associate_wireless_gateway_with_certificate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.associate_wireless_gateway_with_certificate)
    ...
    def associate_wireless_gateway_with_thing(self, Id: str, ThingArn: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.associate_wireless_gateway_with_thing)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.can_paginate)
    ...
    def create_destination(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_destination)
    ...
    def create_device_profile(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_device_profile)
    ...
    def create_service_profile(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_service_profile)
    ...
    def create_wireless_device(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_wireless_device)
    ...
    def create_wireless_gateway(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_wireless_gateway)
    ...
    def create_wireless_gateway_task(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_wireless_gateway_task)
    ...
    def create_wireless_gateway_task_definition(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.create_wireless_gateway_task_definition)
    ...
    def delete_destination(self, Name: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_destination)
    ...
    def delete_device_profile(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_device_profile)
    ...
    def delete_service_profile(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_service_profile)
    ...
    def delete_wireless_device(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_wireless_device)
    ...
    def delete_wireless_gateway(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_wireless_gateway)
    ...
    def delete_wireless_gateway_task(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_wireless_gateway_task)
    ...
    def delete_wireless_gateway_task_definition(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.delete_wireless_gateway_task_definition)
    ...
    def disassociate_aws_account_from_partner_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.disassociate_aws_account_from_partner_account)
    ...
    def disassociate_wireless_device_from_thing(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.disassociate_wireless_device_from_thing)
    ...
    def disassociate_wireless_gateway_from_certificate(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.disassociate_wireless_gateway_from_certificate)
    ...
    def disassociate_wireless_gateway_from_thing(self, Id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.disassociate_wireless_gateway_from_thing)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.generate_presigned_url)
    ...
    def get_destination(self, Name: str) -> GetDestinationResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_destination)
    ...
    def get_device_profile(self, Id: str) -> GetDeviceProfileResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_device_profile)
    ...
    def get_partner_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_partner_account)
    ...
    def get_service_endpoint(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_service_endpoint)
    ...
    def get_service_profile(self, Id: str) -> GetServiceProfileResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_service_profile)
    ...
    def get_wireless_device(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_device)
    ...
    def get_wireless_device_statistics(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_device_statistics)
    ...
    def get_wireless_gateway(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway)
    ...
    def get_wireless_gateway_certificate(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway_certificate)
    ...
    def get_wireless_gateway_firmware_information(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway_firmware_information)
    ...
    def get_wireless_gateway_statistics(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway_statistics)
    ...
    def get_wireless_gateway_task(self, Id: str) -> GetWirelessGatewayTaskResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway_task)
    ...
    def get_wireless_gateway_task_definition(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.get_wireless_gateway_task_definition)
    ...
    def list_destinations(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_destinations)
    ...
    def list_device_profiles(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_device_profiles)
    ...
    def list_partner_accounts(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_partner_accounts)
    ...
    def list_service_profiles(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_service_profiles)
    ...
    def list_tags_for_resource(self, ResourceArn: str) -> ListTagsForResourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_tags_for_resource)
    ...
    def list_wireless_devices(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_wireless_devices)
    ...
    def list_wireless_gateway_task_definitions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_wireless_gateway_task_definitions)
    ...
    def list_wireless_gateways(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.list_wireless_gateways)
    ...
    def send_data_to_wireless_device(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.send_data_to_wireless_device)
    ...
    def tag_resource(self, ResourceArn: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.tag_resource)
    ...
    def test_wireless_device(self, Id: str) -> TestWirelessDeviceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.test_wireless_device)
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.untag_resource)
    ...
    def update_destination(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.update_destination)
    ...
    def update_partner_account(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.update_partner_account)
    ...
    def update_wireless_device(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.update_wireless_device)
    ...
    def update_wireless_gateway(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/iotwireless.html#IoTWireless.Client.update_wireless_gateway)
