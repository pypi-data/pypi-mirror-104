...
CertificateListTypeDef = TypedDict(
    "CertificateListTypeDef", {"SigningAlg": SigningAlg, "Value": str}
)
...
SidewalkDeviceMetadataTypeDef = TypedDict(
    "SidewalkDeviceMetadataTypeDef",
    {"Rssi": int, "BatteryLevel": BatteryLevel, "Event": Event, "DeviceState": DeviceState},
    total=False,
)
...
SidewalkSendDataToDeviceTypeDef = TypedDict(
    "SidewalkSendDataToDeviceTypeDef", {"Seq": int, "MessageType": MessageType}, total=False
)
...
CreateWirelessGatewayTaskResponseTypeDef = TypedDict(
    "CreateWirelessGatewayTaskResponseTypeDef",
    {"WirelessGatewayTaskDefinitionId": str, "Status": WirelessGatewayTaskStatus},
    total=False,
)
...
GetServiceEndpointResponseTypeDef = TypedDict(
    "GetServiceEndpointResponseTypeDef",
    {"ServiceType": WirelessGatewayServiceType, "ServiceEndpoint": str, "ServerTrust": str},
    total=False,
)
...
GetWirelessGatewayStatisticsResponseTypeDef = TypedDict(
    "GetWirelessGatewayStatisticsResponseTypeDef",
    {"WirelessGatewayId": str, "LastUplinkReceivedAt": str, "ConnectionStatus": ConnectionStatus},
    total=False,
)
