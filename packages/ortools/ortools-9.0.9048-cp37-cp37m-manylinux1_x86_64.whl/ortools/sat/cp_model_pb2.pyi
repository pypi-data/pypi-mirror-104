...
class CumulativeConstraintProto(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal[u"capacity",b"capacity",u"demands",b"demands",u"intervals",b"intervals"]) -> None: ...
...
class ConstraintProto(google.protobuf.message.Message):
    ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal[u"constraint",b"constraint"]) -> typing_extensions.Literal["bool_or","bool_and","at_most_one","exactly_one","bool_xor","int_div","int_mod","int_max","lin_max","int_min","lin_min","int_prod","linear","all_diff","element","circuit","routes","table","automaton","inverse","reservoir","interval","no_overlap","no_overlap_2d","cumulative"]: ...
