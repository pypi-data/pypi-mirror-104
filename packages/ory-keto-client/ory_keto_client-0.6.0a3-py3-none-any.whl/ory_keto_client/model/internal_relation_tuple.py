...
class InternalRelationTuple(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, namespace, object, relation, subject, *args, **kwargs):  # noqa: E501
        """InternalRelationTuple - a model defined in OpenAPI
