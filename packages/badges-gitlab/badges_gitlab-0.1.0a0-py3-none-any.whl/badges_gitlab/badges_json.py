...
def validate_json_path(directory_path):
    """Validate Path """
...
def json_badge(directory_path, filename: str, json_string: dict):
...
# string_json = {"schemaVersion":1,"label":"hello","message":"sweet world","color":"orange"}
# json_badge("c:/test", "test", string_json)
