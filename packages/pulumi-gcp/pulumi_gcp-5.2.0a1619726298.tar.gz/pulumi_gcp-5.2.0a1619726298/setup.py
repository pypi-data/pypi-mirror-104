...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', '5.2.0-alpha.1619726298+e6210ecc'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp 5.2.0-alpha.1619726298+e6210ecc`
                """)
            else:
                raise
