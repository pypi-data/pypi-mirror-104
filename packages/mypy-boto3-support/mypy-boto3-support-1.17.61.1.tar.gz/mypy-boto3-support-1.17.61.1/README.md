...
[boto3.Support 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/support.html#Support) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_support/README.md)
...
def get_structure() -> AddAttachmentsToSetResponseTypeDef:
    return {
      ...
    }
```
