...
class DescribeCasesPaginator(Boto3Paginator):
    """
    [Paginator.DescribeCases documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/support.html#Support.Paginator.DescribeCases)
    """
    ...
    def paginate(
        ...
        """
        [DescribeCases.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/support.html#Support.Paginator.DescribeCases.paginate)
        """

class DescribeCommunicationsPaginator(Boto3Paginator):
    """
    [Paginator.DescribeCommunications documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/support.html#Support.Paginator.DescribeCommunications)
    """
    ...
    def paginate(
        ...
        """
        [DescribeCommunications.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/support.html#Support.Paginator.DescribeCommunications.paginate)
        """
