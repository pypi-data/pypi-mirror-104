...
def get_torch_pfm(model_path,weight_name='module.model.conv_net.0.weight',filter_size=8,channel_num=320,seq_len=1000,
	bed_file_path,fasta_file_path,genome_size_control_path=None,lim__=0.75,data_batch=320,all_batch=45):
    ...
    motif_ocr_seq = genome_dataset(bed_file_path,fasta_file_path,seq_len=seq_len,
               genome_size_control_path,dataset_type='classification',bw_path=None,Data_Augmentation=False)
...
def get_torch_motif(model_path,weight_name='module.model.conv_net.0.weight',filter_size=8,channel_num=320,seq_len=1000,
	bed_file_path,fasta_file_path,genome_size_control_path=None,lim__,data_batch=320,all_batch=45,meme_path):
	...
	get_meme_input_file(get_torch_pfm(model_path = model_path,weight_name= weight_name ,filter_size=filter_size,channel_num=channel_num,
		seq_len=seq_len,
	bed_file_path=bed_file_path,fasta_file_path=fasta_file_path,genome_size_control_path=genome_size_control_path,
    lim__=lim__,data_batch=data_batch,all_batch=all_batch),meme_path=meme_path)
