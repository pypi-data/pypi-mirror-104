...
AlarmIdentifierTypeDef = TypedDict(
    "AlarmIdentifierTypeDef", {"Region": CloudWatchRegion, "Name": str}
)
...
_RequiredChangeInfoTypeDef = TypedDict(
    "_RequiredChangeInfoTypeDef", {"Id": str, "Status": ChangeStatus, "SubmittedAt": datetime}
)
...
ChangeTypeDef = TypedDict(
    "ChangeTypeDef", {"Action": ChangeAction, "ResourceRecordSet": "ResourceRecordSetTypeDef"}
)
...
HealthCheckObservationTypeDef = TypedDict(
    "HealthCheckObservationTypeDef",
    {"Region": HealthCheckRegion, "IPAddress": str, "StatusReport": "StatusReportTypeDef"},
    total=False,
)
...
ResourceTagSetTypeDef = TypedDict(
    "ResourceTagSetTypeDef",
    {"ResourceType": TagResourceType, "ResourceId": str, "Tags": List["TagTypeDef"]},
    total=False,
)

ReusableDelegationSetLimitTypeDef = TypedDict(
    "ReusableDelegationSetLimitTypeDef", {"Type": ReusableDelegationSetLimitType, "Value": int}
)
...
VPCTypeDef = TypedDict("VPCTypeDef", {"VPCRegion": VPCRegion, "VPCId": str}, total=False)
...
_OptionalListResourceRecordSetsResponseTypeDef = TypedDict(
    ...
    {"NextRecordName": str, "NextRecordType": RRType, "NextRecordIdentifier": str},
    total=False,
)
...
_OptionalListTrafficPolicyInstancesByHostedZoneResponseTypeDef = TypedDict(
    ...
    {"TrafficPolicyInstanceNameMarker": str, "TrafficPolicyInstanceTypeMarker": RRType},
    total=False,
)
