...
class SavingsPlansClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.can_paginate)
    ...
    def create_savings_plan(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.create_savings_plan)
    ...
    def delete_queued_savings_plan(self, savingsPlanId: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.delete_queued_savings_plan)
    ...
    def describe_savings_plan_rates(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.describe_savings_plan_rates)
    ...
    def describe_savings_plans(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.describe_savings_plans)
    ...
    def describe_savings_plans_offering_rates(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.describe_savings_plans_offering_rates)
    ...
    def describe_savings_plans_offerings(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.describe_savings_plans_offerings)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.generate_presigned_url)
    ...
    def list_tags_for_resource(self, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.list_tags_for_resource)
    ...
    def tag_resource(self, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.tag_resource)
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/savingsplans.html#SavingsPlans.Client.untag_resource)
