...
_RequiredEvaluateOnExitTypeDef = TypedDict(
    "_RequiredEvaluateOnExitTypeDef", {"action": RetryAction}
)
...
_OptionalJobQueueDetailTypeDef = TypedDict(
    ...
    {"status": JQStatus, "statusReason": str, "tags": Dict[str, str]},
    total=False,
)
...
NetworkConfigurationTypeDef = TypedDict(
    "NetworkConfigurationTypeDef", {"assignPublicIp": AssignPublicIp}, total=False
)
...
VolumeTypeDef = TypedDict(
    "VolumeTypeDef",
    {"host": "HostTypeDef", "name": str, "efsVolumeConfiguration": "EFSVolumeConfigurationTypeDef"},
    total=False,
)
