...
LoaTypeDef = TypedDict(
    "LoaTypeDef",
    {"loaContent": Union[bytes, IO[bytes]], "loaContentType": LoaContentType},
    total=False,
)
...
MacSecKeyTypeDef = TypedDict(
    "MacSecKeyTypeDef", {"secretARN": str, "ckn": str, "state": str, "startOn": str}, total=False
)
...
AssociateMacSecKeyResponseTypeDef = TypedDict(
    "AssociateMacSecKeyResponseTypeDef",
    {"connectionId": str, "macSecKeys": List["MacSecKeyTypeDef"]},
    total=False,
)

ConfirmConnectionResponseTypeDef = TypedDict(
    "ConfirmConnectionResponseTypeDef", {"connectionState": ConnectionState}, total=False
)
...
DeleteInterconnectResponseTypeDef = TypedDict(
    "DeleteInterconnectResponseTypeDef", {"interconnectState": InterconnectState}, total=False
)
