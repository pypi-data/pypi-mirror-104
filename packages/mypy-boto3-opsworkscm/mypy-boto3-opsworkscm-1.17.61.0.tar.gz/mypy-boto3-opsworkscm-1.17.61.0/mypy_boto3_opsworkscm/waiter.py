...
class NodeAssociatedWaiter(Boto3Waiter):
    """
    [Waiter.NodeAssociated documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/opsworkscm.html#OpsWorksCM.Waiter.NodeAssociated)
    """
    ...
    def wait(
        ...
        """
        [NodeAssociated.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/opsworkscm.html#OpsWorksCM.Waiter.NodeAssociated.wait)
        """
