...
_RequiredAccessPointTypeDef = TypedDict(
    "_RequiredAccessPointTypeDef", {"Name": str, "NetworkOrigin": NetworkOrigin, "Bucket": str}
)
...
_RequiredJobManifestSpecTypeDef = TypedDict(
    "_RequiredJobManifestSpecTypeDef", {"Format": JobManifestFormat}
)
_OptionalJobManifestSpecTypeDef = TypedDict(
    "_OptionalJobManifestSpecTypeDef", {"Fields": List[JobManifestFieldName]}, total=False
)
...
_OptionalJobReportTypeDef = TypedDict(
    ...
    {"Bucket": str, "Format": JobReportFormat, "Prefix": str, "ReportScope": JobReportScope},
    total=False,
)
...
_OptionalObjectLambdaConfigurationTypeDef = TypedDict(
    ...
    {"CloudWatchMetricsEnabled": bool, "AllowedFeatures": List[ObjectLambdaAllowedFeature]},
    total=False,
)
...
_RequiredS3BucketDestinationTypeDef = TypedDict(
    ...
    {"Format": Format, "OutputSchemaVersion": OutputSchemaVersion, "AccountId": str, "Arn": str},
)
...
S3GrantTypeDef = TypedDict(
    "S3GrantTypeDef", {"Grantee": "S3GranteeTypeDef", "Permission": S3Permission}, total=False
)

S3GranteeTypeDef = TypedDict(
    "S3GranteeTypeDef",
    {"TypeIdentifier": S3GranteeTypeIdentifier, "Identifier": str, "DisplayName": str},
    total=False,
)

S3InitiateRestoreObjectOperationTypeDef = TypedDict(
    "S3InitiateRestoreObjectOperationTypeDef",
    {"ExpirationInDays": int, "GlacierJobTier": S3GlacierJobTier},
    total=False,
)

S3ObjectLockLegalHoldTypeDef = TypedDict(
    "S3ObjectLockLegalHoldTypeDef", {"Status": S3ObjectLockLegalHoldStatus}
)
...
S3RetentionTypeDef = TypedDict(
    "S3RetentionTypeDef",
    {"RetainUntilDate": datetime, "Mode": S3ObjectLockRetentionMode},
    total=False,
)
...
UpdateJobStatusResultTypeDef = TypedDict(
    "UpdateJobStatusResultTypeDef",
    {"JobId": str, "Status": JobStatus, "StatusUpdateReason": str},
    total=False,
)
