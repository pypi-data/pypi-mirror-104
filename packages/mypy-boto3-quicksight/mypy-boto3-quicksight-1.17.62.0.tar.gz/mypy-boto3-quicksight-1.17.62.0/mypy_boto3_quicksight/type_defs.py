...
AccountSettingsTypeDef = TypedDict(
    "AccountSettingsTypeDef",
    {"AccountName": str, "Edition": Edition, "DefaultNamespace": str, "NotificationEmail": str},
    total=False,
)
...
AdHocFilteringOptionTypeDef = TypedDict(
    "AdHocFilteringOptionTypeDef", {"AvailabilityStatus": DashboardBehavior}, total=False
)
...
_RequiredCastColumnTypeOperationTypeDef = TypedDict(
    "_RequiredCastColumnTypeOperationTypeDef", {"ColumnName": str, "NewColumnType": ColumnDataType}
)
...
ColumnTagTypeDef = TypedDict(
    "ColumnTagTypeDef",
    {"ColumnGeographicRole": GeoSpatialDataRole, "ColumnDescription": "ColumnDescriptionTypeDef"},
    total=False,
)
...
ExportToCSVOptionTypeDef = TypedDict(
    "ExportToCSVOptionTypeDef", {"AvailabilityStatus": DashboardBehavior}, total=False
)
...
GeoSpatialColumnGroupTypeDef = TypedDict(
    "GeoSpatialColumnGroupTypeDef",
    {"Name": str, "CountryCode": GeoSpatialCountryCode, "Columns": List[str]},
)
...
IAMPolicyAssignmentSummaryTypeDef = TypedDict(
    "IAMPolicyAssignmentSummaryTypeDef",
    {"AssignmentName": str, "AssignmentStatus": AssignmentStatus},
    total=False,
)
...
_RequiredIngestionTypeDef = TypedDict(
    ...
    {"Arn": str, "IngestionStatus": IngestionStatus, "CreatedTime": datetime},
)
...
_RequiredRowLevelPermissionDataSetTypeDef = TypedDict(
    ...
    {"Arn": str, "PermissionPolicy": RowLevelPermissionPolicy},
)
...
SheetControlsOptionTypeDef = TypedDict(
    "SheetControlsOptionTypeDef", {"VisibilityState": DashboardUIState}, total=False
)
...
ThemeErrorTypeDef = TypedDict(
    "ThemeErrorTypeDef", {"Type": ThemeErrorType, "Message": str}, total=False
)
...
AnalysisSearchFilterTypeDef = TypedDict(
    "AnalysisSearchFilterTypeDef",
    {"Operator": FilterOperator, "Name": AnalysisFilterAttribute, "Value": str},
    total=False,
)
...
_RequiredDashboardSearchFilterTypeDef = TypedDict(
    "_RequiredDashboardSearchFilterTypeDef", {"Operator": FilterOperator}
)
_OptionalDashboardSearchFilterTypeDef = TypedDict(
    "_OptionalDashboardSearchFilterTypeDef",
    {"Name": DashboardFilterAttribute, "Value": str},
    total=False,
)
