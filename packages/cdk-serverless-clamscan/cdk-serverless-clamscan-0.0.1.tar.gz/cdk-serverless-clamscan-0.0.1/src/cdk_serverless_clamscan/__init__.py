...
class ServerlessClamscan(
    ...
    **Important O&M**:
    ...
    def __init__(
        ...
        id: builtins.str,
        *,
        buckets: typing.Optional[typing.List[aws_cdk.aws_s3.Bucket]] = None,
        ...
        :param on_result: The Lambda Destination for files marked 'CLEAN' or 'INFECTED' based on the ClamAV Virus scan (Default: Creates and publishes to a new Event Bridge Bus if unspecified).
        """
        ...
        jsii.create(ServerlessClamscan, self, [scope, id, props])
...
class ServerlessClamscanProps:
    ...
    def on_result(self) -> typing.Optional[aws_cdk.aws_lambda.IDestination]:
        """The Lambda Destination for files marked 'CLEAN' or 'INFECTED' based on the ClamAV Virus scan (Default: Creates and publishes to a new Event Bridge Bus if unspecified)."""
