...
class DataConnection(BaseDataConnection):
    ...
    def _to_dict(self) -> dict:
        ...
        try:
            _dict['location'] = deepcopy(self.location.to_dict(self._wml_client))
...
class AssetLocation(BaseLocation):
    ...
    def to_dict(self, wml_client=None) -> dict:
        ...
        if self.href is None:
            if wml_client:
                _dict['href'] = wml_client.service_instance._href_definitions.get_base_asset_href(
                    self._initial_asset_id)
            else:
                _dict['href'] = f'/v2/assets/{self._initial_asset_id}'

            if not self._wsd:
                if wml_client:
                    if wml_client.default_space_id:
                        _dict['href'] = f'{_dict["href"]}?space_id={wml_client.default_space_id}'
                    else:
                        _dict['href'] = f'{_dict["href"]}?project_id={wml_client.default_project_id}'
...
class WSDAssetLocation(BaseLocation):
    ...
    def to_dict(self, wml_client=None) -> dict:
        ...
        if self.href is None:
            if wml_client:
                _dict['href'] = wml_client.service_instance._href_definitions.get_base_asset_href(self._initial_asset_id)
            else:
                _dict['href'] = f'/v2/assets/{self._initial_asset_id}'
