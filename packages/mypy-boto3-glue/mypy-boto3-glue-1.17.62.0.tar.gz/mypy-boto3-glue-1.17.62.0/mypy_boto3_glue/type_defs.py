...
BackfillErrorTypeDef = TypedDict(
    "BackfillErrorTypeDef",
    {"Code": BackfillErrorCode, "Partitions": List["PartitionValueListTypeDef"]},
    total=False,
)
...
CloudWatchEncryptionTypeDef = TypedDict(
    "CloudWatchEncryptionTypeDef",
    {"CloudWatchEncryptionMode": CloudWatchEncryptionMode, "KmsKeyArn": str},
    total=False,
)
...
_RequiredEncryptionAtRestTypeDef = TypedDict(
    "_RequiredEncryptionAtRestTypeDef", {"CatalogEncryptionMode": CatalogEncryptionMode}
)
...
_RequiredEvaluationMetricsTypeDef = TypedDict(
    "_RequiredEvaluationMetricsTypeDef", {"TransformType": TransformType}
)
...
JobBookmarksEncryptionTypeDef = TypedDict(
    "JobBookmarksEncryptionTypeDef",
    {"JobBookmarksEncryptionMode": JobBookmarksEncryptionMode, "KmsKeyArn": str},
    total=False,
)
...
LineageConfigurationTypeDef = TypedDict(
    "LineageConfigurationTypeDef", {"CrawlerLineageSettings": CrawlerLineageSettings}, total=False
)
...
OtherMetadataValueListItemTypeDef = TypedDict(
    "OtherMetadataValueListItemTypeDef", {"MetadataValue": str, "CreatedTime": str}, total=False
)
...
PredicateTypeDef = TypedDict(
    "PredicateTypeDef", {"Logical": Logical, "Conditions": List["ConditionTypeDef"]}, total=False
)
...
RecrawlPolicyTypeDef = TypedDict(
    "RecrawlPolicyTypeDef", {"RecrawlBehavior": RecrawlBehavior}, total=False
)
...
ResourceUriTypeDef = TypedDict(
    "ResourceUriTypeDef", {"ResourceType": ResourceType, "Uri": str}, total=False
)

S3EncryptionTypeDef = TypedDict(
    "S3EncryptionTypeDef", {"S3EncryptionMode": S3EncryptionMode, "KmsKeyArn": str}, total=False
)
...
ScheduleTypeDef = TypedDict(
    "ScheduleTypeDef", {"ScheduleExpression": str, "State": ScheduleState}, total=False
)

SchemaChangePolicyTypeDef = TypedDict(
    "SchemaChangePolicyTypeDef",
    {"UpdateBehavior": UpdateBehavior, "DeleteBehavior": DeleteBehavior},
    total=False,
)
...
_RequiredTransformParametersTypeDef = TypedDict(
    "_RequiredTransformParametersTypeDef", {"TransformType": TransformType}
)
...
CancelMLTaskRunResponseTypeDef = TypedDict(
    "CancelMLTaskRunResponseTypeDef",
    {"TransformId": str, "TaskRunId": str, "Status": TaskStatusType},
    total=False,
)
...
DeleteRegistryResponseTypeDef = TypedDict(
    "DeleteRegistryResponseTypeDef",
    {"RegistryName": str, "RegistryArn": str, "Status": RegistryStatus},
    total=False,
)

DeleteSchemaResponseTypeDef = TypedDict(
    "DeleteSchemaResponseTypeDef",
    {"SchemaArn": str, "SchemaName": str, "Status": SchemaStatus},
    total=False,
)
...
GetConnectionsFilterTypeDef = TypedDict(
    "GetConnectionsFilterTypeDef",
    {"MatchCriteria": List[str], "ConnectionType": ConnectionType},
    total=False,
)
...
PropertyPredicateTypeDef = TypedDict(
    "PropertyPredicateTypeDef", {"Key": str, "Value": str, "Comparator": Comparator}, total=False
)
...
RegisterSchemaVersionResponseTypeDef = TypedDict(
    "RegisterSchemaVersionResponseTypeDef",
    {"SchemaVersionId": str, "VersionNumber": int, "Status": SchemaVersionStatus},
    total=False,
)
...
SortCriterionTypeDef = TypedDict(
    "SortCriterionTypeDef", {"FieldName": str, "Sort": Sort}, total=False
)
...
TaskRunSortCriteriaTypeDef = TypedDict(
    "TaskRunSortCriteriaTypeDef",
    {"Column": TaskRunSortColumnType, "SortDirection": SortDirectionType},
)
...
TransformSortCriteriaTypeDef = TypedDict(
    "TransformSortCriteriaTypeDef",
    {"Column": TransformSortColumnType, "SortDirection": SortDirectionType},
)
