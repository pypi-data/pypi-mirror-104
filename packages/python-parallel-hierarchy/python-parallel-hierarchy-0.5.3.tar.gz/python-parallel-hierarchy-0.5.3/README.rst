...
.. plantuml::
    ...
    package kitkat {
        ...
        class KitKatFactory<A, Kit_A_Kat> {
            prefix = "Kit_"
            suffix = "_Kat"
        }
    }
    ...
    ParallelFactory <|-- KitKatFactory
    Foos *- Foo
    Bars *- Bar
    KitKatFactory *- Kit_A_Kat
...
.. code:: python
    ...
    class Foos(ParallelFactory[A, Foo], suffix="Foo"):
        """Foo Factory"""
...
.. code:: python
    ...
    class Bars(ParallelFactory[model.A, Bar], prefix="Bar"):
        """Bar Factory"""
        ...
...
.. code:: python
    ...
    class KitKatFactory(ParallelFactory[A, Kit_A_Kat], prefix="Kit_", suffix="_Kat"):
...
can't express properly.  Well, you can hand-craft a ``FooD`` class and register it with your ``Foos`` factory class.
...
.. note::
    Calling ``Foos(C)`` as a base class ensures that ``FooD`` fits properly in it's position in the parallel hierarchy.
