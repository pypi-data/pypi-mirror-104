...
def graph(eqn1: LinearEquation2D, eqn2: LinearEquation2D):
    ...
    y1, y2 = -(eqn1.c / eqn1.b), -(eqn2.c / eqn2.b)
    s1, s2 = -(eqn1.a / eqn1.b), -(eqn2.a / eqn2.b)
    l1 = f"{eqn1.a}x {'+' if eqn1.b > 0 else '-'} {abs(eqn1.b)}y = {-eqn1.c}"
    l2 = f"{eqn2.a}x {'+' if eqn2.b > 0 else '-'} {abs(eqn2.b)}y = {-eqn2.c}"
