...
from rrshare.rqFetch import (pro, stock_belong_swl,stock_belong_swl_all_level,
...
def fetch_stock_daily_adj_from_tusharepro(trade_date='20190101'):
    trade_date = trade_date.replace('-', '') #兼容设置以防日期格式为2001-10-20格式
    lastEx = None
    retry = 10
    for _ in range(retry):
...
def rq_save_swl_day_pg(start_date='2019-01-01'): #from 2015-01-04   
    t = time.localtime(time.time())
...
if __name__ == '__main__':          
    ...
    rq_save_stock_day_adj_fillna_pg('20050101')
