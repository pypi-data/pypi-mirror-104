...
class ReplaceValueByRegex(Transformation):
    ...
    def __init__(
        self, path: List[str], regex: Optional[str], regex_id: Optional[UUID], replacement: str,
    ):
...
class ExitField:
    ...
    def __repr__(self):
        return (
            f"ExitField(name= {self.name!r}, data_type= {self.data_type!r}, children= {self.children!r})"
        )
