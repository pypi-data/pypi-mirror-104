...
class Environment:
    ...
    def get_input_channel_iter(self):
        """Returns: Iterable of the input channels
        """
        return get_env_vars(environment=self.environment_variables.dump(),regex=self.input_channel_regex)

    def get_output_channel_iter(self):
        """Returns: Iterable of the output channel
        """
        return get_env_vars(environment=self.environment_variables.dump(), regex=self.output_channel_regex)

    def get_model_channel_iter(self):
        """Returns: Iterable of the model channel
        """
        return get_env_vars(environment=self.environment_variables.dump(), regex=self.model_channel_regex)
