...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceAvailable.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/docdb.html#DocDB.Waiter.DBInstanceAvailable.wait)
        """
...
class DBInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        [DBInstanceDeleted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/docdb.html#DocDB.Waiter.DBInstanceDeleted.wait)
        """
