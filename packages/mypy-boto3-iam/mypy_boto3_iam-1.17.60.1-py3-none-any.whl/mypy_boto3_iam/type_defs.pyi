...
AccessKeyMetadataTypeDef = TypedDict(
    "AccessKeyMetadataTypeDef",
    {"UserName": str, "AccessKeyId": str, "Status": statusType, "CreateDate": datetime},
    total=False,
)

_RequiredAccessKeyTypeDef = TypedDict(
    "_RequiredAccessKeyTypeDef",
    {"UserName": str, "AccessKeyId": str, "Status": statusType, "SecretAccessKey": str},
)
...
AttachedPermissionsBoundaryTypeDef = TypedDict(
    "AttachedPermissionsBoundaryTypeDef",
    {"PermissionsBoundaryType": PermissionsBoundaryAttachmentType, "PermissionsBoundaryArn": str},
    total=False,
)
...
_RequiredEvaluationResultTypeDef = TypedDict(
    ...
    {"EvalActionName": str, "EvalDecision": PolicyEvaluationDecisionType},
)
...
_RequiredPolicyGrantingServiceAccessTypeDef = TypedDict(
    "_RequiredPolicyGrantingServiceAccessTypeDef", {"PolicyName": str, "PolicyType": policyType}
)
_OptionalPolicyGrantingServiceAccessTypeDef = TypedDict(
    "_OptionalPolicyGrantingServiceAccessTypeDef",
    {"PolicyArn": str, "EntityType": policyOwnerEntityType, "EntityName": str},
    total=False,
)
...
_RequiredResourceSpecificResultTypeDef = TypedDict(
    ...
    {"EvalResourceName": str, "EvalResourceDecision": PolicyEvaluationDecisionType},
)
...
SSHPublicKeyMetadataTypeDef = TypedDict(
    "SSHPublicKeyMetadataTypeDef",
    {"UserName": str, "SSHPublicKeyId": str, "Status": statusType, "UploadDate": datetime},
)
...
_RequiredSigningCertificateTypeDef = TypedDict(
    ...
    {"UserName": str, "CertificateId": str, "CertificateBody": str, "Status": statusType},
)
...
ContextEntryTypeDef = TypedDict(
    "ContextEntryTypeDef",
    {"ContextKeyName": str, "ContextKeyValues": List[str], "ContextKeyType": ContextKeyTypeEnum},
    total=False,
)
...
GenerateCredentialReportResponseTypeDef = TypedDict(
    "GenerateCredentialReportResponseTypeDef",
    {"State": ReportStateType, "Description": str},
    total=False,
)
...
GetAccountSummaryResponseTypeDef = TypedDict(
    "GetAccountSummaryResponseTypeDef", {"SummaryMap": Dict[summaryKeyType, int]}, total=False
)
...
_RequiredGetOrganizationsAccessReportResponseTypeDef = TypedDict(
    ...
    {"JobStatus": jobStatusType, "JobCreationDate": datetime},
)
...
_RequiredGetServiceLinkedRoleDeletionStatusResponseTypeDef = TypedDict(
    "_RequiredGetServiceLinkedRoleDeletionStatusResponseTypeDef", {"Status": DeletionTaskStatusType}
)
