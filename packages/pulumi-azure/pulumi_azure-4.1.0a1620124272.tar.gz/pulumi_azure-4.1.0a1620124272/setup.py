...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', '4.1.0-alpha.1620124272+c956d4ef'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure 4.1.0-alpha.1620124272+c956d4ef`
                """)
            else:
                raise
