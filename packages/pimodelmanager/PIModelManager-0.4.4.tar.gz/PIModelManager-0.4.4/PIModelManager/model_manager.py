...
model_manager_logger.addHandler(logging.NullHandler())
...
class ModelManager:
    ...
    def __new__(cls):
        if ModelManager.__instance is None:
            ...
            model_manager_logger.info("__new__: setting model manager instance")
        else:
            model_manager_logger.info("__new__: instance already exists")
