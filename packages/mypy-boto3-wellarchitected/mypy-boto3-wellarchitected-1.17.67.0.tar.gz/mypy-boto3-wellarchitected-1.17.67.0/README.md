...
[boto3.WellArchitected 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/wellarchitected.html#WellArchitected)
...
[mypy-boto3-wellarchitected docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_wellarchitected/README.md)
...
def check_value(value: DifferenceStatus) -> bool:
    ...
```
