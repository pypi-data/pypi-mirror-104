...
[boto3.WellArchitected 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/wellarchitected.html#WellArchitected) service
compatible with
...
`mypy_boto3_wellarchitected.literals` module contains literals extracted from shapes
