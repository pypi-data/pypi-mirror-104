...
class PointBergen(Bergen):
    ...
    def __init__(self, *args, point_inward=None, point_outward=None, point_port=8000, point_type = DataPointType.GRAPHQL, scopes= [], needs_negotiation=False, **kwargs) -> None:
