...
class BaseBergen:
    ...
    async def negotiate_async(self):
        ...
        from bergen.queries.initiation import NEGOTIATION_GQL
        ...
        self._transcript = await NEGOTIATION_GQL.run_async(ward=self.main_ward, variables={"clientType": self.client_type, **self.negotiate_additionals})
        ...
        self._extensions = await datapoint_registry.configureWards()
