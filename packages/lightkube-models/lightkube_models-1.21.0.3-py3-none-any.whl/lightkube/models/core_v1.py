...
@dataclass
class EphemeralContainers(DataclassDictMixIn):
...
class ServiceSpec(DataclassDictMixIn):
    """ServiceSpec describes the attributes that a user creates on a service.
      ...
      * **internalTrafficPolicy** ``str`` - *(optional)* InternalTrafficPolicy specifies if the cluster internal traffic should be
