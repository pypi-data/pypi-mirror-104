...
class SmartDiagnosticsApi(SDKClient):
    ...
    def get_hierarchy_activity_events_post(
            self, page=None, page_limit=None, order_by=None, body=None, custom_headers=None, raw=False, **operation_config):
    ...
    def get_activity_event_categories(
        ...
        :param filter: Filter statements to narrow results by properties.
         ...
         | ---------- | ---- | --------- |
         | `ActivityLineEnabled` | Boolean | `eq, neq` |
         | `ActivityLineFlag` | String | `eq, neq, like, in` |
         | `AssetCardEnabled` | Boolean | `eq, neq` |
         | `Code` | String | `eq, neq, like, in` |
         | `Internal` | Boolean | `eq, neq` |
         | `Name` | String | `eq, neq, like, in` |
         | `OwnerType` | ActivityEventOwnerType | `eq, neq, in, lt, gt, leq,
         geq` |
        :type filter: str
        :param page: Results page. 1-based (1 returns the first page, 0 is
         invalid).
    ...
    def get_activity_event_field_values(
        ...
        :param bind_type: Optional bind type. Possible values include:
         'Group', 'Metric', 'EvidenceMetric', 'Model', 'GroupModel'
        :type bind_type: str
    ...
    def get_base_stations(
        ...
        :param filter: Filter statements to narrow results by properties.
         ...
         | `ReceiverNickname` | String | `eq, neq, like, in` |
    ...
    def get_indicator_statistics(
            self, group_ids=None, filter_ids=None, time_span="P1D", is_export=False, filter=None, page=None, page_limit=None, order_by=None, name_search=None, custom_headers=None, raw=False, **operation_config):
        ...
        :param filter_ids: A list of filterIds to filter the result
        :type filter_ids: list[str]
        :param time_span: Duration to calculate the statistics, formatted as
         an ISO 8601 duration. Defaults to one day
        :type time_span: str
        ...
        :param filter: Filter statements to narrow results by properties.
         ...
         | `IndicatorType` | MetricTypeCodes | `eq, neq, in, lt, gt, leq, geq`
         |
         | `MeasureOf` | SensorRoleTypeCodes | `eq, neq, in, lt, gt, leq, geq`
         |
         | `Name` | String | `eq, neq, like, in` |
        :type filter: str
        :param page: Results page. 1-based (1 returns the first page, 0 is
        ...
        if time_span is not None:
            query_parameters['timeSpan'] = self._serialize.query("time_span", time_span, 'str')
    ...
    def get_statistics_for_indicator(
            self, indicator_id, time_span="P1D", custom_headers=None, raw=False, **operation_config):
    ...
    def get_monitoring_point_overview1(
        ...
        return deserialized
    get_monitoring_point_overview1.metadata = {'url': '/api/v3.0/MonitoringPoints/overview'}
    ...
    def run_setup_tool_job(
        ...
        if response.status_code not in [202, 400, 401, 403, 404, 415]:
            raise HttpOperationError(self._deserialize, response)
    ...
    def get_latest_image(
        ...
        """Gets a single ThermalCameraImage object.
