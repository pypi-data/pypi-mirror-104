...
class AnalyticsModelCreateRequest(Model):
    ...
    def __init__(self, *, name: str, version: str, type, location_id: str=None, corporation_id: str=None, group_type=None, indicators=None, related_model_ids=None, properties=None, triggers=None, **kwargs) -> None:
