...
class ActivityEventHierarchyGroupResponse(Model):
    ...
    def __init__(self, *, id: str, title: str, start_date_time, created, created_by: str, location, category, hierarchy, description: str=None, end_date_time=None, activity_line_enabled: bool=None, indicators=None, **kwargs) -> None:
