...
class TaskDB:
    ...
    def test(db):
        ...
        print(obj.output_table(path=f'{db}/all_task_table_10.txt', cols_limit=10))
        print(obj.output_table(path=f'{db}/all_task_table_12.txt', cols_limit=12))
