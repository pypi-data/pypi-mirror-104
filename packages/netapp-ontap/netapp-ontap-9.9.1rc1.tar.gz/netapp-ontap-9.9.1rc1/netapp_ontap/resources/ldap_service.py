...
* subtree """
    ...
    """links,ad_domain,base_dn,base_scope,bind_as_cifs_server,bind_dn,group_dn,group_membership_filter,group_scope,is_netgroup_byhost_enabled,is_owner,ldaps_enabled,min_bind_level,netgroup_byhost_dn,netgroup_byhost_scope,netgroup_dn,netgroup_scope,port,preferred_ad_servers,query_timeout,referral_enabled,schema,servers,session_security,status,svm.links,svm.name,svm.uuid,use_start_tls,user_dn,user_scope,"""
    ...
    """ad_domain,base_dn,base_scope,bind_as_cifs_server,bind_dn,bind_password,group_dn,group_membership_filter,group_scope,is_netgroup_byhost_enabled,ldaps_enabled,min_bind_level,netgroup_byhost_dn,netgroup_byhost_scope,netgroup_dn,netgroup_scope,port,preferred_ad_servers,query_timeout,referral_enabled,schema,servers,session_security,skip_config_validation,status,svm.name,svm.uuid,use_start_tls,user_dn,user_scope,"""
...
* [`DOC /name-services/ldap`](#docs-name-services-name-services_ldap)"""
    ...
    if CLICHE_INSTALLED:
        ...
        def ldap_service_show(
            fields: List[Choices.define(["ad_domain", "base_dn", "base_scope", "bind_as_cifs_server", "bind_dn", "bind_password", "group_dn", "group_membership_filter", "group_scope", "is_netgroup_byhost_enabled", "is_owner", "ldaps_enabled", "min_bind_level", "netgroup_byhost_dn", "netgroup_byhost_scope", "netgroup_dn", "netgroup_scope", "port", "preferred_ad_servers", "query_timeout", "referral_enabled", "schema", "servers", "session_security", "skip_config_validation", "use_start_tls", "user_dn", "user_scope", "*"])]=None,
        ) -> ResourceTable:
