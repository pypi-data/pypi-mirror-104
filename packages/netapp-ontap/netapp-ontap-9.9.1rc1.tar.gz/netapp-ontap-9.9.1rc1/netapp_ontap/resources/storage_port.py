...
"""
    ...
    if CLICHE_INSTALLED:
        ...
        def storage_port_show(
            fields: List[Choices.define(["board_name", "description", "enabled", "firmware_version", "in_use", "mac_address", "mode", "name", "part_number", "redundant", "serial_number", "speed", "state", "type", "wwn", "wwpn", "*"])]=None,
        ) -> ResourceTable:
