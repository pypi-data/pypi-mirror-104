...
```
Volume({"svm": {"name": "vs1"}, "aggregates": [{"name": "aggr1"}], "name": "vol1"})
...
Volume(
    {
        ...
        "size": 20971520,
        "uuid": "d0c3359c-5448-4a9b-a077-e3295a7e9057",
        "encryption": {"state": "none", "key_id": "", "enabled": False, "type": "none"},
        "state": "online",
        ...
        "constituents": [
            {
                "space": {
                    ...
                    "over_provisioned": 0,
                    "used": 30273536,
                    "snapshot": {"reserve_percent": 5, "autodelete_enabled": False},
                    "available": 479756288,
                },
                "name": "fg__0001",
                "aggregates": {
...
* promote """
    ...
    r""" The constituents field of the volume. """
...
* zh_tw.utf_8 """
    ...
    movement = fields.Nested("netapp_ontap.models.volume_movement1.VolumeMovement1Schema", data_key="movement", unknown=EXCLUDE)
...
Example: vol_cs_dept """
    ...
    space = fields.Nested("netapp_ontap.models.volume_space1.VolumeSpace1Schema", data_key="space", unknown=EXCLUDE)
...
* [`DOC /storage/volumes`](#docs-storage-storage_volumes)"""
    ...
    if CLICHE_INSTALLED:
        ...
        def volume_show(
            fields: List[Choices.define(["access_time_enabled", "cloud_retrieval_policy", "comment", "constituents_per_aggregate", "create_time", "flexcache_endpoint_type", "is_object_store", "is_svm_root", "language", "name", "queue_for_encryption", "size", "state", "status", "style", "type", "use_mirrored_aggregates", "uuid", "*"])]=None,
        ) -> ResourceTable:
