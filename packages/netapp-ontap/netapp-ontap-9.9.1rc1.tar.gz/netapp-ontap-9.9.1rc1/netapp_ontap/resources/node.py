...
Example: node-01 """
    ...
    nvram = fields.Nested("netapp_ontap.models.node_nvram.NodeNvramSchema", data_key="nvram", unknown=EXCLUDE)
...
* [`DOC /cluster/nodes`](#docs-cluster-cluster_nodes)"""
    ...
    if CLICHE_INSTALLED:
        ...
        def node_show(
            fields: List[Choices.define(["date", "location", "membership", "model", "name", "owner", "serial_number", "state", "storage_configuration", "system_id", "system_machine_type", "uptime", "uuid", "vendor_serial_number", "*"])]=None,
        ) -> ResourceTable:
