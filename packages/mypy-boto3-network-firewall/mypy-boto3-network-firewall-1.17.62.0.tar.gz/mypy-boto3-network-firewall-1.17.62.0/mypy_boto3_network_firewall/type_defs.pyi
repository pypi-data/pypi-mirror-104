...
AttachmentTypeDef = TypedDict(
    "AttachmentTypeDef",
    {"SubnetId": str, "EndpointId": str, "Status": AttachmentStatus},
    total=False,
)
...
_OptionalFirewallPolicyResponseTypeDef = TypedDict(
    ...
    {"Description": str, "FirewallPolicyStatus": ResourceStatus, "Tags": List["TagTypeDef"]},
    total=False,
)
...
_RequiredFirewallStatusTypeDef = TypedDict(
    ...
    {"Status": FirewallStatusValue, "ConfigurationSyncStateSummary": ConfigurationSyncState},
)
...
PerObjectStatusTypeDef = TypedDict(
    "PerObjectStatusTypeDef", {"SyncStatus": PerObjectSyncStatus, "UpdateToken": str}, total=False
)
...
StatefulRuleTypeDef = TypedDict(
    "StatefulRuleTypeDef",
    {"Action": StatefulAction, "Header": "HeaderTypeDef", "RuleOptions": List["RuleOptionTypeDef"]},
)
...
_RequiredTCPFlagFieldTypeDef = TypedDict("_RequiredTCPFlagFieldTypeDef", {"Flags": List[TCPFlag]})
_OptionalTCPFlagFieldTypeDef = TypedDict(
    "_OptionalTCPFlagFieldTypeDef", {"Masks": List[TCPFlag]}, total=False
)
