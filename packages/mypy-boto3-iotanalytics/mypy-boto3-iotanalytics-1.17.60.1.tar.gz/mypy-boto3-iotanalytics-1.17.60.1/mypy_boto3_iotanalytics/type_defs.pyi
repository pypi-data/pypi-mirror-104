...
DatasetActionSummaryTypeDef = TypedDict(
    "DatasetActionSummaryTypeDef", {"actionName": str, "actionType": DatasetActionType}, total=False
)
...
DatasetContentStatusTypeDef = TypedDict(
    "DatasetContentStatusTypeDef", {"state": DatasetContentState, "reason": str}, total=False
)
...
LoggingOptionsTypeDef = TypedDict(
    "LoggingOptionsTypeDef", {"roleArn": str, "level": LoggingLevel, "enabled": bool}
)
...
ResourceConfigurationTypeDef = TypedDict(
    "ResourceConfigurationTypeDef", {"computeType": ComputeType, "volumeSizeInGB": int}
)
