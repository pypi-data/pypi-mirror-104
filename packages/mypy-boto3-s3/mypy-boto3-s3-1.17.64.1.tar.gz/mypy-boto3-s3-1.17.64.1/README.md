...
[boto3.S3 1.17.64](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/s3.html#S3) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_s3/README.md)
...
`mypy_boto3_s3.literals` module contains literals extracted from shapes
...
def check_value(value: AnalyticsS3ExportFileFormat) -> bool:
    ...
```
