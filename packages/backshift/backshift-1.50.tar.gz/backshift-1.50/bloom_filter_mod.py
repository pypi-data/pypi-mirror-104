...
class Array_then_file_seek_backend(object):
    ...
    def close(self):
        ...
        os.lseek(self.file_, 0, os.SEEK_SET)
        for index in range(self.bytes_in_memory):
...
#            sys.exit(1)
    ...
    def _match_template(self, bloom_filter):
        ...
        return (self.num_bits_m == bloom_filter.num_bits_m and
                self.num_probes_k == bloom_filter.num_probes_k and
                self.probe_bitnoer == bloom_filter.probe_bitnoer)
