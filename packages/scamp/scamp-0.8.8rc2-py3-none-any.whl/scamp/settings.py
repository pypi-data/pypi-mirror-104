...
class _ScampSettings(SimpleNamespace, SavesToJSON):
    ...
    def open_json_file(self, command=None):
        """
        Open the JSON file for these settings.

        :param command: the command-line tool with which to open the file. Defaults to a platform-specific generic open
            command.
        """
        ...
        subprocess.call([command, resolve_path(self._json_path)])
