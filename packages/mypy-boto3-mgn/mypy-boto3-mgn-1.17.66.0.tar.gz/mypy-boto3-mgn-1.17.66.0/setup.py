...
setup(
    ...
    description="Type annotations for boto3.mgn 1.17.66 service, generated by mypy-boto3-buider 4.10.0",
    classifiers=[
    ...
    keywords="boto3 mgn type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
