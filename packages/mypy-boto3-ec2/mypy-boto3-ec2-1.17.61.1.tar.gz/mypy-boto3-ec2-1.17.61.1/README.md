...
[boto3.EC2 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ec2.html#EC2) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_ec2/README.md)
...
`mypy_boto3_ec2.literals` module contains literals extracted from shapes
...
def check_value(value: AccountAttributeName) -> bool:
    ...
```
...
def get_structure() -> AcceptReservedInstancesExchangeQuoteResultTypeDef:
    return {
      ...
    }
```
