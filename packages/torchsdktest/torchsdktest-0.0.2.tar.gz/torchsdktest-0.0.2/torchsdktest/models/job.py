...
class Dataset:
    """
        ...
        :param source: (String) data source name in the torchsdktest catalog
...
class CreateJob:
    ...
    def __init__(self, uid: str, name: str, description: str = None, inputs=None, outputs=None, meta: JobMetadata = None, **context):
        """
        Description:
            create job class used to create job in torchsdktest catalog
