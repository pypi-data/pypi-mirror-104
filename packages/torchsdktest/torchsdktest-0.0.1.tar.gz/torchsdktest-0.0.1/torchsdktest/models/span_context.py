# from modules.torchsdktest.events.span_event import SpanAbortedEvent, SpanEndEvent, SpanStartEvent
from torchsdktest.models.span import Span, SpanEventType, SpanStatus
from torchsdktest.events.span_event import SpanEvent
from enum import Enum
import logging

logger = logging.getLogger('torchsdktest')
...
class SpanContext:
    ...
    def __init__(self, client=None, span: Span = None, parent=None, context_data= None):
        """
        Description:
        ...
        # start span event you initialise span context
    ...
    def create_child_span(self, uid: str, context_data: dict = None):
        """
        ...
        child_span_payload = {'span': payload}
        res = self.client.create_span(self.span.pipelineRunId, child_span_payload)
        span_context = SpanContext(client=self.client, span=res, parent=self, context_data= context_data)
