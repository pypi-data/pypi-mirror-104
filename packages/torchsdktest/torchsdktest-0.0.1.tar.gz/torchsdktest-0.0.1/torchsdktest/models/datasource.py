...
from torchsdktest.models.snapshot import SnapshotData, AssociatedItemType
from torchsdktest.models.create_asset import CreateAsset, CreateAssetRelation, RelationType, AssetMetadata
...
class DataSource:
    ...
    def get_asset(self, uid: str = None, id: int = None):
        """"
            ...
            :param id: (Int) id of the asset in torchsdktest catalog
        """
