...
class CfnInstanceAccessControlAttributeConfiguration(
    ...
    class AccessControlAttributeValueProperty:
        def __init__(
            self,
            *,
            source: typing.Union["CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueSourceListProperty", _IResolvable_da3f097b],
        ) -> None:
            '''
        ...
        def source(
            self,
        ) -> typing.Union["CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueSourceListProperty", _IResolvable_da3f097b]:
            ...
            return typing.cast(typing.Union["CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueSourceListProperty", _IResolvable_da3f097b], result)
    ...
    @jsii.data_type(
        jsii_type="aws-cdk-lib.aws_sso.CfnInstanceAccessControlAttributeConfiguration.AccessControlAttributeValueSourceListProperty",
        jsii_struct_bases=[],
        name_mapping={
    ...
    class AccessControlAttributeValueSourceListProperty:
        def __init__(
            self,
            *,
            access_control_attribute_value_source_list: typing.Optional[typing.Sequence[builtins.str]] = None,
        ) -> None:
            '''
