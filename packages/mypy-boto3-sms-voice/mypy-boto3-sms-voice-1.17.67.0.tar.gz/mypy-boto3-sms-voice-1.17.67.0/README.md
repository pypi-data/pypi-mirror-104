...
[boto3.SMSVoice 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/sms-voice.html#SMSVoice)
...
[mypy-boto3-sms-voice docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_sms_voice/README.md)
...
Both type checking and auto-complete should work for `SMSVoice` service. No
...
Type checking should work for `SMSVoice` service. No explicit type annotations
...
def check_value(value: EventType) -> bool:
    ...
```
