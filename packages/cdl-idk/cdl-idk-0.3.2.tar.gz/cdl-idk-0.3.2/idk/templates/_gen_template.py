...
class _DeveloperInsight_(InsightGenerator):
    ...
    def transform(self, data: pd.DataFrame) -> InsightData:
        ...
        return InsightData(
            # What category is this insight pertaining to
            categories=[],
            # It can be useful to automatically tag your insights contents, think meta-subjects and entities
            tags=[],
            # From 0-1, how important is the data generated in this insight relative to other instances of the same insight?
            significance=0.0,
            # This where you store the data you've generated and you want to pass to your transcribe function in ./transcription/transcribe.py
            data=dict(),
        )

    def provide_evidence(self, data: pd.DataFrame) -> go.Figure:
