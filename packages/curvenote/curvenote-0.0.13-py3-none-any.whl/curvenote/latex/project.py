...
class LatexProject:
    ...
    @classmethod
    def build_single_article(cls,
        session: Session, target_folder: str,
        project_id: Union[str, Project], article_id: str, version: int):
        ...
        try:
            ...
            raise ValueError(f"Could not add article to LaTeX project: {str(err)}") from err
    ...
    def add_article(self, project_id: Union[str, Project], article_id: str, version: int):
