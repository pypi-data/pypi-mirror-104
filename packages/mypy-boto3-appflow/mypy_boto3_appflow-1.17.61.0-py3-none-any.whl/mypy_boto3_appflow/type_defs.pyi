...
AggregationConfigTypeDef = TypedDict(
    "AggregationConfigTypeDef", {"aggregationType": AggregationType}, total=False
)
...
_RequiredFieldTypeDetailsTypeDef = TypedDict(
    "_RequiredFieldTypeDetailsTypeDef", {"fieldType": str, "filterOperators": List[Operator]}
)
...
PrefixConfigTypeDef = TypedDict(
    "PrefixConfigTypeDef", {"prefixType": PrefixType, "prefixFormat": PrefixFormat}, total=False
)
...
_OptionalUpsolverS3OutputFormatConfigTypeDef = TypedDict(
    ...
    {"fileType": FileType, "aggregationConfig": "AggregationConfigTypeDef"},
    total=False,
)
...
CreateFlowResponseTypeDef = TypedDict(
    "CreateFlowResponseTypeDef", {"flowArn": str, "flowStatus": FlowStatus}, total=False
)
...
StartFlowResponseTypeDef = TypedDict(
    "StartFlowResponseTypeDef",
    {"flowArn": str, "flowStatus": FlowStatus, "executionId": str},
    total=False,
)

StopFlowResponseTypeDef = TypedDict(
    "StopFlowResponseTypeDef", {"flowArn": str, "flowStatus": FlowStatus}, total=False
)
...
UpdateFlowResponseTypeDef = TypedDict(
    "UpdateFlowResponseTypeDef", {"flowStatus": FlowStatus}, total=False
)
