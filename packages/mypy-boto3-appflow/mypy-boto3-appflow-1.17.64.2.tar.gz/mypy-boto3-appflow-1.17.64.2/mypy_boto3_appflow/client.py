...
class AppflowClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.can_paginate)
    ...
    def create_connector_profile(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.create_connector_profile)
    ...
    def create_flow(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.create_flow)
    ...
    def delete_connector_profile(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.delete_connector_profile)
    ...
    def delete_flow(self, flowName: str, forceDelete: bool = None) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.delete_flow)
    ...
    def describe_connector_entity(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.describe_connector_entity)
    ...
    def describe_connector_profiles(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.describe_connector_profiles)
    ...
    def describe_connectors(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.describe_connectors)
    ...
    def describe_flow(self, flowName: str) -> DescribeFlowResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.describe_flow)
    ...
    def describe_flow_execution_records(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.describe_flow_execution_records)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.generate_presigned_url)
    ...
    def list_connector_entities(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.list_connector_entities)
    ...
    def list_flows(self, maxResults: int = None, nextToken: str = None) -> ListFlowsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.list_flows)
    ...
    def list_tags_for_resource(self, resourceArn: str) -> ListTagsForResourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.list_tags_for_resource)
    ...
    def start_flow(self, flowName: str) -> StartFlowResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.start_flow)
    ...
    def stop_flow(self, flowName: str) -> StopFlowResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.stop_flow)
    ...
    def tag_resource(self, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.tag_resource)
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.untag_resource)
    ...
    def update_connector_profile(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.update_connector_profile)
    ...
    def update_flow(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/appflow.html#Appflow.Client.update_flow)
