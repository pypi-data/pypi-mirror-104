...
[boto3.Appflow 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/appflow.html#Appflow) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_appflow/README.md)
...
def check_value(value: AggregationType) -> bool:
    ...
```
