...
class SymmetricOrderingGenerator(object):
    ...
    cutoff: float, default 1.0
        ...
        works differently if the symmetry is 'chemical' or 'conventional', 
        where it is defined as the cutoff radius (in Angstrom) for CNA. 
        A reasonable cutoff based on the lattice constant of the material 
        will automatically be used if cutoff < 1. Use a larger cutoff if 
        the structure is distorted. 
    ...
    secondary_symmetry : str, default None
        ...
        by the secondary symmetry. Support 6 symmetries: 'spherical',
        'cylindrical', 'planar', 'mirror_planar', 'chemical' and
        'conventional'. Note that secondary symmetry has the same 
        ...
        combining chemical environment with geometric symmetry or 
        combining symmetries with different cutoffs.
    ...
    def get_sorted_indices(self, symmetry):
        ...
        symmetry='chemical'. Returns the indices sorted by surface, 
        subsurface, subsubsurface, ..., core.

        Parameters
        ----------
        symmetry : str
            Support 6 symmetries: spherical, cylindrical, planar, 
            mirror_planar, chemical, conventional.
