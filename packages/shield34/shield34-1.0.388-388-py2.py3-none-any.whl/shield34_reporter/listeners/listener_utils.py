...
class ListenerUtils():
    ...
    @staticmethod
    def save_sdk_details(sdk_contract):
        payload = json.dumps(sdk_contract)
        headers = {'content-type': 'application/json',
                   'Authorization': 'Shield34-Project ' + SdkAuthentication.get_user_token()}
        request = requests.post(Shield34Properties.api_base_url + '/report/save-sdk-data', data=payload,
