...
[boto3.IoTDeviceAdvisor 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/iotdeviceadvisor.html#IoTDeviceAdvisor) service
compatible with
