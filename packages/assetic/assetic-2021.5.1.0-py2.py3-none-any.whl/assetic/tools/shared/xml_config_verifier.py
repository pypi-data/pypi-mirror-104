...
class XMLConfigVerifier:
    ...
    def valid_asset_cat_labels(self):
        ...
        if self._valid_asset_cat_labels is None:
            ...
            self._valid_asset_cat_labels = {
                l["Label"]: {"auto id": l["UseAutogeneratedId"]} for l in r["ResourceList"]}
    ...
    def parse_fl_layer(self, fllayer):
        ...
        for i, lyr in enumerate(lyrs, start=1):
            ...
            mappings = {
                "FL Core Fields": self.get_attributes(lyr, "fl_corefields"),
                "FL Core Defaults": self.get_attributes(lyr, "fl_coredefaults"),
