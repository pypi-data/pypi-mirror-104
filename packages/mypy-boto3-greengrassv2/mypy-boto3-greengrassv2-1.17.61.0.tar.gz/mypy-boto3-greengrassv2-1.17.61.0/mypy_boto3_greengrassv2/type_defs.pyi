...
CloudComponentStatusTypeDef = TypedDict(
    "CloudComponentStatusTypeDef",
    {"componentState": CloudComponentState, "message": str, "errors": Dict[str, str]},
    total=False,
)
...
ComponentDependencyRequirementTypeDef = TypedDict(
    "ComponentDependencyRequirementTypeDef",
    {"versionRequirement": str, "dependencyType": ComponentDependencyType},
    total=False,
)
...
CoreDeviceTypeDef = TypedDict(
    "CoreDeviceTypeDef",
    {"coreDeviceThingName": str, "status": CoreDeviceStatus, "lastStatusUpdateTimestamp": datetime},
    total=False,
)

DeploymentComponentUpdatePolicyTypeDef = TypedDict(
    "DeploymentComponentUpdatePolicyTypeDef",
    {"timeoutInSeconds": int, "action": DeploymentComponentUpdatePolicyAction},
    total=False,
)
...
_OptionalLambdaDeviceMountTypeDef = TypedDict(
    ...
    {"permission": LambdaFilesystemPermission, "addGroupOwner": bool},
    total=False,
)
...
LambdaLinuxProcessParamsTypeDef = TypedDict(
    "LambdaLinuxProcessParamsTypeDef",
    {"isolationMode": LambdaIsolationMode, "containerParams": "LambdaContainerParamsTypeDef"},
    total=False,
)
...
_RequiredGetComponentResponseTypeDef = TypedDict(
    ...
    {"recipeOutputFormat": RecipeOutputFormat, "recipe": Union[bytes, IO[bytes]]},
)
