...
ByoipCidrTypeDef = TypedDict(
    "ByoipCidrTypeDef",
    {"Cidr": str, "State": ByoipCidrState, "Events": List["ByoipCidrEventTypeDef"]},
    total=False,
)
...
CustomRoutingDestinationDescriptionTypeDef = TypedDict(
    "CustomRoutingDestinationDescriptionTypeDef",
    {"FromPort": int, "ToPort": int, "Protocols": List[ProtocolType]},
    total=False,
)
...
CustomRoutingDestinationConfigurationTypeDef = TypedDict(
    "CustomRoutingDestinationConfigurationTypeDef",
    {"FromPort": int, "ToPort": int, "Protocols": List[CustomRoutingProtocol]},
)
