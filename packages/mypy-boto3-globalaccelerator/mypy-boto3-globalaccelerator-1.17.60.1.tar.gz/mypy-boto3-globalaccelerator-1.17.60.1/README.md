...
[boto3.GlobalAccelerator 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/globalaccelerator.html#GlobalAccelerator) service
compatible with
...
`mypy_boto3_globalaccelerator.literals` module contains literals extracted from shapes
