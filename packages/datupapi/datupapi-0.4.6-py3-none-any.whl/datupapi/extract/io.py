...
class IO(Config):
    ...
    def populate_dbtable(self, df, hostname=None, db_user=None, db_passwd=None, db_name=None, port='3306', table_name=None, db_type='mysql'):
        """
        ...
        :return tables: Number of records inserted

        >>> records = populate_table_mysql(df, hostname='202.10.0.1', db_user='johndoe', db_passwd='123456', db_name='dbo.TheDataBase')
        >>> records = 1000
        """
        if db_type == 'mysql':
        ...
        try:
            ...
            df.to_sql(tenant_table_name, con=engine, if_exists='replace')
    ...
    def download_csv(self, q_name, datalake_path=None, sep=',', index_col=None, squeeze=False, num_records=None, dayfirst=False, compression='infer', encoding='utf-8', low_memory=True, date_cols=None, types=None):
    ...
    def download_object_csv(self, datalake_path=None, sep=',', index_col=None, squeeze=False, num_records=None, dayfirst=False, compression='infer', encoding='utf-8', low_memory=True, date_cols=None, types=None):
        ...
        >>> df = download_object_csv(datalake_path='as-is/folder/file')
        >>> df
              var1    var2    var3
        idx0     1       2       3
        """
    ...
    def download_all_objects_csv(self, datalake_path=None, sep=',', index_col=None, squeeze=False, num_records=None, dayfirst=False, compression='infer', encoding='utf-8', low_memory=True, date_cols=None, types=None):
        """Return a dataframe from a file stored in the datalake
    ...
    def download_excel(self, q_name, sheet_name, datalake_path=None, index_col=None, squeeze=False, num_records=None, date_cols=None, types=None, header_=0, skiprows_=None):
        """Return a dataframe from a csv file stored in the datalake
