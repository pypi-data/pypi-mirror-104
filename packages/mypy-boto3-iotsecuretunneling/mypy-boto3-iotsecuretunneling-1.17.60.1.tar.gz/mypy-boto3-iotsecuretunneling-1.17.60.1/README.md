...
[boto3.IoTSecureTunneling 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/iotsecuretunneling.html#IoTSecureTunneling) service
compatible with
...
`mypy_boto3_iotsecuretunneling.literals` module contains literals extracted from shapes
