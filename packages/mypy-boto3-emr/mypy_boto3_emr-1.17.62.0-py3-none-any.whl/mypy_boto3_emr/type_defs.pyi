...
AutoScalingPolicyStateChangeReasonTypeDef = TypedDict(
    "AutoScalingPolicyStateChangeReasonTypeDef",
    {"Code": AutoScalingPolicyStateChangeReasonCode, "Message": str},
    total=False,
)
...
CancelStepsInfoTypeDef = TypedDict(
    "CancelStepsInfoTypeDef",
    {"StepId": str, "Status": CancelStepsRequestStatus, "Reason": str},
    total=False,
)
...
ClusterStateChangeReasonTypeDef = TypedDict(
    "ClusterStateChangeReasonTypeDef",
    {"Code": ClusterStateChangeReasonCode, "Message": str},
    total=False,
)
...
_RequiredComputeLimitsTypeDef = TypedDict(
    ...
    {"UnitType": ComputeLimitsUnitType, "MinimumCapacityUnits": int, "MaximumCapacityUnits": int},
)
...
_OptionalExecutionEngineConfigTypeDef = TypedDict(
    ...
    {"Type": ExecutionEngineType, "MasterInstanceSecurityGroupId": str},
    total=False,
)
...
_RequiredInstanceFleetConfigTypeDef = TypedDict(
    "_RequiredInstanceFleetConfigTypeDef", {"InstanceFleetType": InstanceFleetType}
)
...
InstanceFleetStateChangeReasonTypeDef = TypedDict(
    "InstanceFleetStateChangeReasonTypeDef",
    {"Code": InstanceFleetStateChangeReasonCode, "Message": str},
    total=False,
)
...
_RequiredInstanceGroupConfigTypeDef = TypedDict(
    ...
    {"InstanceRole": InstanceRoleType, "InstanceType": str, "InstanceCount": int},
)
...
InstanceGroupStateChangeReasonTypeDef = TypedDict(
    "InstanceGroupStateChangeReasonTypeDef",
    {"Code": InstanceGroupStateChangeReasonCode, "Message": str},
    total=False,
)
...
InstanceStateChangeReasonTypeDef = TypedDict(
    "InstanceStateChangeReasonTypeDef",
    {"Code": InstanceStateChangeReasonCode, "Message": str},
    total=False,
)
...
_RequiredJobFlowExecutionStatusDetailTypeDef = TypedDict(
    ...
    {"State": JobFlowExecutionState, "CreationDateTime": datetime},
)
...
_RequiredPlacementGroupConfigTypeDef = TypedDict(
    "_RequiredPlacementGroupConfigTypeDef", {"InstanceRole": InstanceRoleType}
)
...
_OptionalScalingActionTypeDef = TypedDict(
    "_OptionalScalingActionTypeDef", {"Market": MarketType}, total=False
)
...
_OptionalSimpleScalingPolicyConfigurationTypeDef = TypedDict(
    ...
    {"AdjustmentType": AdjustmentType, "CoolDown": int},
    total=False,
)
...
_RequiredSpotProvisioningSpecificationTypeDef = TypedDict(
    ...
    {"TimeoutDurationMinutes": int, "TimeoutAction": SpotProvisioningTimeoutAction},
)
_OptionalSpotProvisioningSpecificationTypeDef = TypedDict(
    "_OptionalSpotProvisioningSpecificationTypeDef",
    {"BlockDurationMinutes": int, "AllocationStrategy": SpotProvisioningAllocationStrategy},
    total=False,
)
...
_OptionalStepConfigTypeDef = TypedDict(
    "_OptionalStepConfigTypeDef", {"ActionOnFailure": ActionOnFailure}, total=False
)
...
_RequiredStepExecutionStatusDetailTypeDef = TypedDict(
    ...
    {"State": StepExecutionState, "CreationDateTime": datetime},
)
...
StepStateChangeReasonTypeDef = TypedDict(
    "StepStateChangeReasonTypeDef", {"Code": StepStateChangeReasonCode, "Message": str}, total=False
)
