...
class ArthurModel(ArthurBaseJsonDataclass):
    ...
    def from_dataframe(self, data: Union[DataFrame, Series], stage: Stage) -> None:
        ...
        for idx, column in enumerate(df.columns):
            ...
            series = core_util.standardize_pd_obj(df[column], dropna=True, replacedatetime=False, attributes=self.attributes_type_dict)
    ...
    def set_reference_data(self, directory_path: Optional[str] = None, data: Optional[Union[DataFrame, Series]] = None):
        ...
        if data is not None:
            data = core_util.standardize_pd_obj(data, dropna=False, replacedatetime=False, attributes=self.attributes_type_dict)
