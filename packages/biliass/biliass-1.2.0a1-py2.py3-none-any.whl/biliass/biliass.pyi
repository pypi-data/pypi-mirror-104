...
def export(func: Any): ...
def ReadCommentsBilibiliXml(text: Union[str, bytes], fontsize: float) -> Any: ...
def ReadCommentsBilibiliProtobuf(protobuf: Union[bytes, str], fontsize: float) -> Any: ...
...
def Danmaku2ASS(input: Union[str, bytes], stage_width: int, stage_height: int, input_format: str=..., reserve_blank: float=..., font_face: str=..., font_size: float=..., text_opacity: float=..., duration_marquee: float=..., duration_still: float=..., comment_filter: Optional[str]=..., is_reduce_comments: bool=..., progress_callback: Optional[Callable[..., None]]=...) -> str: ...
