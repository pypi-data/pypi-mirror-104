...
_OptionalAttributeDimensionTypeDef = TypedDict(
    "_OptionalAttributeDimensionTypeDef", {"AttributeType": AttributeType}, total=False
)
...
CampaignEventFilterTypeDef = TypedDict(
    "CampaignEventFilterTypeDef", {"Dimensions": "EventDimensionsTypeDef", "FilterType": FilterType}
)

CampaignHookTypeDef = TypedDict(
    "CampaignHookTypeDef", {"LambdaFunctionName": str, "Mode": Mode, "WebUrl": str}, total=False
)
...
CampaignStateTypeDef = TypedDict(
    "CampaignStateTypeDef", {"CampaignStatus": CampaignStatus}, total=False
)
...
ConditionTypeDef = TypedDict(
    "ConditionTypeDef",
    {"Conditions": List["SimpleConditionTypeDef"], "Operator": Operator},
    total=False,
)
...
DefaultPushNotificationTemplateTypeDef = TypedDict(
    "DefaultPushNotificationTemplateTypeDef",
    {"Action": Action, "Body": str, "Sound": str, "Title": str, "Url": str},
    total=False,
)
...
_RequiredEndpointMessageResultTypeDef = TypedDict(
    "_RequiredEndpointMessageResultTypeDef", {"DeliveryStatus": DeliveryStatus, "StatusCode": int}
)
...
EventFilterTypeDef = TypedDict(
    "EventFilterTypeDef", {"Dimensions": "EventDimensionsTypeDef", "FilterType": FilterType}
)
...
_RequiredImportJobResourceTypeDef = TypedDict(
    "_RequiredImportJobResourceTypeDef", {"Format": Format, "RoleArn": str, "S3Url": str}
)
...
_RequiredMessageResultTypeDef = TypedDict(
    "_RequiredMessageResultTypeDef", {"DeliveryStatus": DeliveryStatus, "StatusCode": int}
)
...
RecencyDimensionTypeDef = TypedDict(
    "RecencyDimensionTypeDef", {"Duration": Duration, "RecencyType": RecencyType}
)
...
SegmentGroupListTypeDef = TypedDict(
    "SegmentGroupListTypeDef",
    {"Groups": List["SegmentGroupTypeDef"], "Include": Include},
    total=False,
)
...
_RequiredSegmentImportResourceTypeDef = TypedDict(
    ...
    {"ExternalId": str, "Format": Format, "RoleArn": str, "S3Url": str, "Size": int},
)
...
_RequiredSegmentResponseTypeDef = TypedDict(
    ...
    {"ApplicationId": str, "Arn": str, "CreationDate": str, "Id": str, "SegmentType": SegmentType},
)
...
_OptionalSetDimensionTypeDef = TypedDict(
    "_OptionalSetDimensionTypeDef", {"DimensionType": DimensionType}, total=False
)
...
_RequiredImportJobRequestTypeDef = TypedDict(
    "_RequiredImportJobRequestTypeDef", {"Format": Format, "RoleArn": str, "S3Url": str}
)
...
JourneyStateRequestTypeDef = TypedDict("JourneyStateRequestTypeDef", {"State": State}, total=False)
