...
try:
    os.remove("ampere/models/P2D/P2D_fd.c")
...
#
extension = Extension(
    name="ampere.models.P2D.P2D_fd",
    sources=["ampere/models/P2D/P2D_fd.pyx", ida_dir+"/ida.c",ida_dir+"/ida_band.c",ida_dir+"/ida_dense.c",ida_dir+"/ida_direct.c",ida_dir+"/ida_ic.c",ida_dir+"/ida_io.c",
    				ida_dir+"/nvector_serial.c",ida_dir+"/sundials_band.c",ida_dir+"/sundials_dense.c",ida_dir+"/sundials_direct.c",ida_dir+"/sundials_math.c",ida_dir+"/sundials_nvector.c"],
    library_dirs=['ida'],
    include_dirs=[numpy.get_include(), ida_dir])
