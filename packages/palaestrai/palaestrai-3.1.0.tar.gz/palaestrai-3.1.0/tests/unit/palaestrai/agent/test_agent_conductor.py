...
class TestAgentConductor(unittest.IsolatedAsyncioTestCase):
    def setUp(self):
        ...
        self.agent_params = {
            "brain": "palaestrai.agent.dummy_brain:DummyBrain",
            "brain_params": {"muscle_connection": "test_con"},
            "muscle": "palaestrai.agent.dummy_muscle:DummyMuscle",
            "muscle_params": {
                "broker_connection": "test_con",
                "brain_connection": "test_con",
            },
            "objective": "palaestrai.agent.dummy_objective:DummyObjective",
            "objective_params": {"reward": 0, "params": 1},
        ...
        self.ac = AgentConductor("test_conn", self.agent_params, 0, uuid4())
