...
class TestReceiver(unittest.TestCase):
    ...
    def test_handles_all_protocol_messages(self, _):
        ...
        all_message_types = [
            palaestrai.core.protocol.ExperimentStartRequest,
            palaestrai.core.protocol.ExperimentStartResponse,
            palaestrai.core.protocol.ExperimentShutdownRequest,
            palaestrai.core.protocol.ExperimentShutdownResponse,
