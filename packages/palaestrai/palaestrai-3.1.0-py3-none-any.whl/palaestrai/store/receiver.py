...
class StoreReceiver(threading.Thread):
    ...
    def __init__(self, queue, *args, **kwargs):
        ...
        self._message_dispatch = {
            ...
            proto.ExperimentShutdownRequest: None,
            proto.ExperimentShutdownResponse: None,
    ...
    def _write_experiment(self, msg: proto.ExperimentStartRequest):
        ...
        self._worlds_state_sensors = [
            sen
            for env in msg.experiment.env_configs
            if "world_state_sensors" in env["env_params"]
            for sen in env["env_params"]["world_state_sensors"]
        ]
