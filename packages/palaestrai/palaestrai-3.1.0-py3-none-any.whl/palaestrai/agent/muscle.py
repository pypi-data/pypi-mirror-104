...
class Muscle(ABC):
    ...
    def _handle_agent_update(
        ...
        return AgentUpdateResponse(
            ...
            experiment_run_id=request.experiment_run_id,
            actuator_information=self._last_actions[0],
    ...
    def propose_actions(
        ...
        -------
        tuple[list, list]
            A tuple of two lists, the first one will be send to the
            environment and needs to be properly scaled, the second
            one will be send to the brain.
        """
        pass
    ...
    def prepare_model(self):
        ...
        If palaestrai is used to test a trained model it hase to load
