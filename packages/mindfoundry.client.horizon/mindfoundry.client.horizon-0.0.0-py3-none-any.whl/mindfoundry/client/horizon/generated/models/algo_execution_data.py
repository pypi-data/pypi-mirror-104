...
class AlgoExecutionData:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if not isinstance(_target_price_history, Unset):
        ...
        if not isinstance(_target_predictions, Unset):
        ...
        if not isinstance(_target_predictions_upper_bound, Unset):
        ...
        if not isinstance(_target_predictions_lower_bound, Unset):
        ...
        if not isinstance(_feature_history, Unset):
        ...
        if not isinstance(_latest_target_allocations, Unset):
