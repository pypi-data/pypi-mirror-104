...
T = TypeVar("T", bound="ExpertPredictForm")


@attr.s(auto_attribs=True)
class ExpertPredictForm:
    """  """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        expert_predict_form.additional_properties = d
        return expert_predict_form
