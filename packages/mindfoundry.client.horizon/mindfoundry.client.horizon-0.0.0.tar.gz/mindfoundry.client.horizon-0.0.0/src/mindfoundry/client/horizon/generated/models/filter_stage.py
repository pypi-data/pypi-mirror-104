...
T = TypeVar("T", bound="FilterStage")


@attr.s(auto_attribs=True)
class FilterStage:
    """ Eliminate features that have low correlation with the target(s)  """

    status: StageStatus
    id_: int
    config: FilterStageConfig
    error_msg: Union[Unset, None, str] = UNSET
    type_: Union[Unset, str] = "filtering"
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        config = FilterStageConfig.from_dict(d.pop("config"))
        ...
        filter_stage.additional_properties = d
        return filter_stage
