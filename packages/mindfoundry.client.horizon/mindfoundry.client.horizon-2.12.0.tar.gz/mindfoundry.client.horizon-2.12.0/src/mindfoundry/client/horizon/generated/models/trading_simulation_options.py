...
class TradingSimulationOptions:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        rebalance_frequency: Union[Unset, RebalanceFrequency] = UNSET
        _rebalance_frequency = d.pop("rebalanceFrequency", UNSET)
        if not isinstance(_rebalance_frequency, Unset):
            rebalance_frequency = RebalanceFrequency(_rebalance_frequency)

        rebalance_weekly_day: Union[Unset, RebalanceWeeklyDay] = UNSET
        _rebalance_weekly_day = d.pop("rebalanceWeeklyDay", UNSET)
        if not isinstance(_rebalance_weekly_day, Unset):
