...
from panza.jobs._directory_layout import WorkspaceLayout, EXECUTOR_WORKSPACE_ROOT
...
with augment_syspath([workspace.moulinette_directory]):
    with new_context(
            resources_path=workspace.resources_directory,
            delivery_path=workspace.delivery_directory,
            **context
    ):
        blueprint = panza.BlueprintLoader.load_from_directory(
