...
from mypy_boto3_cloudtrail.literals import InsightType, LookupAttributeKey, ReadWriteType
...
InsightSelectorTypeDef = TypedDict(
    "InsightSelectorTypeDef", {"InsightType": InsightType}, total=False
)
...
LookupAttributeTypeDef = TypedDict(
    "LookupAttributeTypeDef", {"AttributeKey": LookupAttributeKey, "AttributeValue": str}
)
