"""
Main interface for iotthingsgraph service literal definitions.
...
Usage::
    ...
    data: DefinitionLanguage = "GRAPHQL"
    ```
"""
import sys
...
DefinitionLanguage = Literal["GRAPHQL"]
DeploymentTarget = Literal["CLOUD", "GREENGRASS"]
EntityFilterName = Literal["NAME", "NAMESPACE", "REFERENCED_ENTITY_ID", "SEMANTIC_TYPE_PATH"]
EntityType = Literal[
    "ACTION",
    "CAPABILITY",
    "DEVICE",
...
FlowExecutionEventType = Literal[
...
FlowExecutionStatus = Literal["ABORTED", "FAILED", "RUNNING", "SUCCEEDED"]
FlowTemplateFilterName = Literal["DEVICE_MODEL_ID"]
...
NamespaceDeletionStatus = Literal["FAILED", "IN_PROGRESS", "SUCCEEDED"]
NamespaceDeletionStatusErrorCodes = Literal["VALIDATION_FAILED"]
...
SystemInstanceDeploymentStatus = Literal[
    "BOOTSTRAP",
    "DELETED_IN_TARGET",
    "DEPLOYED_IN_TARGET",
    "DEPLOY_IN_PROGRESS",
...
SystemInstanceFilterName = Literal["GREENGRASS_GROUP_NAME", "STATUS", "SYSTEM_TEMPLATE_ID"]
SystemTemplateFilterName = Literal["FLOW_TEMPLATE_ID"]
UploadStatus = Literal["FAILED", "IN_PROGRESS", "SUCCEEDED"]
