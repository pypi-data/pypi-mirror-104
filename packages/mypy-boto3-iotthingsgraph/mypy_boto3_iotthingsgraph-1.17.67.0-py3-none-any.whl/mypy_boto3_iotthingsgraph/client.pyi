...
class IoTThingsGraphClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client)
    ...
    def associate_entity_to_thing(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.associate_entity_to_thing)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.can_paginate)
    ...
    def create_flow_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.create_flow_template)
    ...
    def create_system_instance(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.create_system_instance)
    ...
    def create_system_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.create_system_template)
    ...
    def delete_flow_template(self, id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.delete_flow_template)
    ...
    def delete_namespace(self) -> DeleteNamespaceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.delete_namespace)
    ...
    def delete_system_instance(self, id: str = None) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.delete_system_instance)
    ...
    def delete_system_template(self, id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.delete_system_template)
    ...
    def deploy_system_instance(self, id: str = None) -> DeploySystemInstanceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.deploy_system_instance)
    ...
    def deprecate_flow_template(self, id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.deprecate_flow_template)
    ...
    def deprecate_system_template(self, id: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.deprecate_system_template)
    ...
    def describe_namespace(self, namespaceName: str = None) -> DescribeNamespaceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.describe_namespace)
    ...
    def dissociate_entity_from_thing(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.dissociate_entity_from_thing)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.generate_presigned_url)
    ...
    def get_entities(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_entities)
    ...
    def get_flow_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_flow_template)
    ...
    def get_flow_template_revisions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_flow_template_revisions)
    ...
    def get_namespace_deletion_status(self) -> GetNamespaceDeletionStatusResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_namespace_deletion_status)
    ...
    def get_system_instance(self, id: str) -> GetSystemInstanceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_system_instance)
    ...
    def get_system_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_system_template)
    ...
    def get_system_template_revisions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_system_template_revisions)
    ...
    def get_upload_status(self, uploadId: str) -> GetUploadStatusResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.get_upload_status)
    ...
    def list_flow_execution_messages(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.list_flow_execution_messages)
    ...
    def list_tags_for_resource(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.list_tags_for_resource)
    ...
    def search_entities(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_entities)
    ...
    def search_flow_executions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_flow_executions)
    ...
    def search_flow_templates(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_flow_templates)
    ...
    def search_system_instances(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_system_instances)
    ...
    def search_system_templates(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_system_templates)
    ...
    def search_things(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.search_things)
    ...
    def tag_resource(self, resourceArn: str, tags: List["TagTypeDef"]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.tag_resource)
    ...
    def undeploy_system_instance(self, id: str = None) -> UndeploySystemInstanceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.undeploy_system_instance)
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.untag_resource)
    ...
    def update_flow_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.update_flow_template)
    ...
    def update_system_template(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.update_system_template)
    ...
    def upload_entity_definitions(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Client.upload_entity_definitions)
    ...
    def get_paginator(self, operation_name: Literal["search_entities"]) -> SearchEntitiesPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Paginator.SearchEntities)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_iotthingsgraph/paginators.html#searchentitiespaginator)
        """
    @overload
    def get_paginator(
    ...
    def get_paginator(self, operation_name: Literal["search_things"]) -> SearchThingsPaginator:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iotthingsgraph.html#IoTThingsGraph.Paginator.SearchThings)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_iotthingsgraph/paginators.html#searchthingspaginator)
        """
