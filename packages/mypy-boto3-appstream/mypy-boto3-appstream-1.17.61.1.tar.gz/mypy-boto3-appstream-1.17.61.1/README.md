...
[boto3.AppStream 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/appstream.html#AppStream) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_appstream/README.md)
...
def check_value(value: AccessEndpointType) -> bool:
    ...
```
