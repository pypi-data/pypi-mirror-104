...
class Text:
	...
	def set_data(self, new_value_for_current: str) -> None:
		"""SCPI: DISPlay[:WINDow]:TEXT[:DATA] \n
		Snippet: driver.display.window.text.set_data(new_value_for_current = '1') \n
		Displays a text message box on the front display. \n
			:param new_value_for_current: Text message for display.
		"""
		param = Conversions.value_to_quoted_str(new_value_for_current)
	...
	def clear_with_opc(self) -> None:
		...
		"""
		self._core.io.write_with_opc(f'DISPlay:WINDow:TEXT:CLEar')
