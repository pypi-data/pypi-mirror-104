...
class RsNgx:
	"""217 total commands, 19 Sub-groups, 1 group commands"""
	_driver_options = "SupportedInstrModels = NGP/NGL/NGM/NGU, SupportedIdnPatterns = NGP/NGL/NGM/NGU, SimulationIdnString = 'Rohde&Schwarz,NGP,100001,3.0.0.0039'"
	...
	def __init__(self, resource_name: str, id_query: bool = True, reset: bool = False, options: str = None, direct_session: object = None):
		...
		self._core.driver_version = '3.0.0.0039'
	...
	def assert_minimum_version(min_version: str) -> None:
		...
		curr_version_list = '3.0.0.0039'.split('.')
		...
		for i in range(count):
			...
			if curr > minimum:
				break
			if curr < minimum:
				raise RsInstrException(f"Assertion for minimum RsNgx version failed. Current version: '3.0.0.0039', minimum required version: '{min_version}'")
	...
	@property
	def arbitrary(self):
		"""arbitrary commands group. 4 Sub-classes, 7 commands."""
	...
	def calibration(self):
		"""calibration commands group. 2 Sub-classes, 7 commands."""
	...
	@property
	def log(self):
		"""log commands group. 7 Sub-classes, 2 commands."""
	...
	@property
	def source(self):
		"""source commands group. 7 Sub-classes, 0 commands."""
	...
	@property
	def output(self):
		"""output commands group. 5 Sub-classes, 3 commands."""
	...
	@property
	def system(self):
		"""system commands group. 9 Sub-classes, 3 commands."""
	...
	def flog(self):
		...
		if not hasattr(self, '_flog'):
			...
			self._flog = Flog(self._core, self._base)
		return self._flog
	...
	def interfaces(self):
		...
		if not hasattr(self, '_interfaces'):
			...
			self._interfaces = Interfaces(self._core, self._base)
	...
	def read(self) -> Measurement:
		...
		Queries the currently voltage-current measurement pair and returns them separated by comma. \n
