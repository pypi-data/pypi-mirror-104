...
class DataServicesResource(object):
    ...
    class __Accounts(Consumer):
        ...
        def update(self, account: Body):
            """This call will update an alert request with the specified parameters."""
        ...
        class __Customers(Consumer):
            ...
            def list(self, dealer_account: Query(type=str) = None):
                """This call will return detailed customer information for all accounts or for the dealer specified."""
