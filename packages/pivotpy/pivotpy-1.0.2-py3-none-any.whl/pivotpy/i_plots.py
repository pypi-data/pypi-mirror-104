...
__all__ = ['get_rgb_data', 'flip_even_patches', 'rgb2plotly', 'plotly2html', 'plotly_rgb_lines', 'irgb',
...
# Cell
def rgb2plotly(rgb_data=None,mode='markers',max_width=None,showlegend=False,name='',labels=['s','p','d'],symbol=0,start=0):
    """
...
def plotly_dos_lines(path_evr     = None,
        ...
        cl_dos = sp.collect_dos(path_evr=path_evr,elim=elim,
