...
[boto3.SNS 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/sns.html#SNS) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_sns/README.md)
...
`mypy_boto3_sns.literals` module contains literals extracted from shapes
...
def check_value(value: ListEndpointsByPlatformApplicationPaginatorName) -> bool:
    ...
```
...
def get_structure() -> CheckIfPhoneNumberIsOptedOutResponseTypeDef:
    return {
      ...
    }
```
