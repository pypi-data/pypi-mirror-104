...
class itkConstantVelocityFieldTransformD4(itk.itkDisplacementFieldTransformPython.itkDisplacementFieldTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_Clone)
    SetConstantVelocityField = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetConstantVelocityField)
    GetModifiableConstantVelocityField = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetModifiableConstantVelocityField)
    GetConstantVelocityField = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetConstantVelocityField)
    SetConstantVelocityFieldInterpolator = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetConstantVelocityFieldInterpolator)
    GetModifiableConstantVelocityFieldInterpolator = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetModifiableConstantVelocityFieldInterpolator)
    GetConstantVelocityFieldInterpolator = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetConstantVelocityFieldInterpolator)
    GetConstantVelocityFieldSetTime = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetConstantVelocityFieldSetTime)
    UpdateTransformParameters = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_UpdateTransformParameters)
    GetInverse = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetInverse)
    IntegrateVelocityField = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_IntegrateVelocityField)
    SetCalculateNumberOfIntegrationStepsAutomatically = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetCalculateNumberOfIntegrationStepsAutomatically)
    GetCalculateNumberOfIntegrationStepsAutomatically = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetCalculateNumberOfIntegrationStepsAutomatically)
    CalculateNumberOfIntegrationStepsAutomaticallyOn = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_CalculateNumberOfIntegrationStepsAutomaticallyOn)
    CalculateNumberOfIntegrationStepsAutomaticallyOff = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_CalculateNumberOfIntegrationStepsAutomaticallyOff)
    SetLowerTimeBound = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetLowerTimeBound)
    GetLowerTimeBound = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetLowerTimeBound)
    SetUpperTimeBound = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetUpperTimeBound)
    GetUpperTimeBound = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetUpperTimeBound)
    SetNumberOfIntegrationSteps = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_SetNumberOfIntegrationSteps)
    GetNumberOfIntegrationSteps = _swig_new_instance_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_GetNumberOfIntegrationSteps)
    __swig_destroy__ = _itkConstantVelocityFieldTransformPython.delete_itkConstantVelocityFieldTransformD4
    cast = _swig_new_static_method(_itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_cast)
...
itkConstantVelocityFieldTransformD4___New_orig__ = _itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4___New_orig__
itkConstantVelocityFieldTransformD4_cast = _itkConstantVelocityFieldTransformPython.itkConstantVelocityFieldTransformD4_cast
