...
class itkSpatialObjectToImageFilterSO2ID2(itk.itkImageSourcePython.itkImageSourceID2):
    ...
    example{Core/SpatialObjects/ConvertSpatialObjectToImage,Convert
...
def spatial_object_to_image_filter(*args,  spacing: Sequence[float]=..., direction=..., inside_value: float=..., outside_value: float=..., origin: Sequence[float]=..., children_depth: int=..., size: Sequence[int]=..., use_object_value: bool=...,**kwargs)-> itkt.ImageSourceReturn:
    """Functional interface for SpatialObjectToImageFilter"""
    import itk

    kwarg_typehints = { 'spacing':spacing,'direction':direction,'inside_value':inside_value,'outside_value':outside_value,'origin':origin,'children_depth':children_depth,'size':size,'use_object_value':use_object_value }
