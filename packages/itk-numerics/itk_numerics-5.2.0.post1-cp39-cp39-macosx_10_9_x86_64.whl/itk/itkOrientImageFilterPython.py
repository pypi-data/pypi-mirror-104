...
class itkOrientImageFilterICD3ICD3(itk.itkImageToImageFilterBPython.itkImageToImageFilterICD3ICD3):
    ...
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3___New_orig__)
    Clone = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_Clone)
    GetGivenCoordinateOrientation = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GetGivenCoordinateOrientation)
    SetGivenCoordinateOrientation = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetGivenCoordinateOrientation)
    SetGivenCoordinateDirection = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetGivenCoordinateDirection)
    GetDesiredCoordinateOrientation = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GetDesiredCoordinateOrientation)
    SetDesiredCoordinateOrientation = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetDesiredCoordinateOrientation)
    SetDesiredCoordinateDirection = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetDesiredCoordinateDirection)
    UseImageDirectionOn = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_UseImageDirectionOn)
    UseImageDirectionOff = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_UseImageDirectionOff)
    GetUseImageDirection = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GetUseImageDirection)
    SetUseImageDirection = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetUseImageDirection)
    GetPermuteOrder = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GetPermuteOrder)
    GetFlipAxes = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GetFlipAxes)
    SetDesiredCoordinateOrientationToAxial = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetDesiredCoordinateOrientationToAxial)
    SetDesiredCoordinateOrientationToCoronal = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetDesiredCoordinateOrientationToCoronal)
    SetDesiredCoordinateOrientationToSagittal = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_SetDesiredCoordinateOrientationToSagittal)
    GenerateOutputInformation = _swig_new_instance_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_GenerateOutputInformation)
    ...
    cast = _swig_new_static_method(_itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_cast)
...
itkOrientImageFilterICD3ICD3___New_orig__ = _itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3___New_orig__
itkOrientImageFilterICD3ICD3_cast = _itkOrientImageFilterPython.itkOrientImageFilterICD3ICD3_cast
