...
class itkContourExtractor2DImageFilterID2(itk.itkImageToPathFilterPython.itkImageToPathFilterID2PLPP2):
    ...
    There is an ambiguous case in the marching squares algorithm: if a
    given 2x2-pixel square has two high-valued and two low-valued pixels,
    each pair diagonally adjacent. (Note that high-valued and low-valued
    are with respect to the contour value sought when LabelContours is
    false. When LabelContours is true, high-valued means the label being
    traced and low-valued means any other label.) In this case, the
    default behavior is that the low-valued pixels are connected into the
    same contour via an isthmus that separates the high-valued pixels into
    separate contours. To reverse this, call VertexConnectHighPixelsOn().
    Note that when LabelContours is true, the default behavior will leave
    all four pixels in separate contours. In this case,
    VertexConnectHighPixels equal to true can instead create contours that
    ...
    By default values are interpreted as intensities relative to a contour
    value. First calling LabelContoursOn() changes this behavior to
    instead interpret each value as a label. Boundaries are computed for
    each label separately and all are returned. The value of LabelContours
    affects the interpretation of VertexConnectHighPixels; see above.
    ...
    Pincus.https://www.insight-journal.org/browse/publication/72
    ...
    SetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterID2_SetLabelContours)
    GetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterID2_GetLabelContours)
    LabelContoursOn = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterID2_LabelContoursOn)
    LabelContoursOff = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterID2_LabelContoursOff)
...
class itkContourExtractor2DImageFilterIF2(itk.itkImageToPathFilterPython.itkImageToPathFilterIF2PLPP2):
    ...
    SetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIF2_SetLabelContours)
    GetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIF2_GetLabelContours)
    LabelContoursOn = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIF2_LabelContoursOn)
    LabelContoursOff = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIF2_LabelContoursOff)
...
class itkContourExtractor2DImageFilterISS2(itk.itkImageToPathFilterPython.itkImageToPathFilterISS2PLPP2):
    ...
    SetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterISS2_SetLabelContours)
    GetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterISS2_GetLabelContours)
    LabelContoursOn = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterISS2_LabelContoursOn)
    LabelContoursOff = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterISS2_LabelContoursOff)
...
class itkContourExtractor2DImageFilterIUC2(itk.itkImageToPathFilterPython.itkImageToPathFilterIUC2PLPP2):
    ...
    SetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUC2_SetLabelContours)
    GetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUC2_GetLabelContours)
    LabelContoursOn = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUC2_LabelContoursOn)
    LabelContoursOff = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUC2_LabelContoursOff)
...
class itkContourExtractor2DImageFilterIUS2(itk.itkImageToPathFilterPython.itkImageToPathFilterIUS2PLPP2):
    ...
    SetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUS2_SetLabelContours)
    GetLabelContours = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUS2_GetLabelContours)
    LabelContoursOn = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUS2_LabelContoursOn)
    LabelContoursOff = _swig_new_instance_method(_itkContourExtractor2DImageFilterPython.itkContourExtractor2DImageFilterIUS2_LabelContoursOff)
