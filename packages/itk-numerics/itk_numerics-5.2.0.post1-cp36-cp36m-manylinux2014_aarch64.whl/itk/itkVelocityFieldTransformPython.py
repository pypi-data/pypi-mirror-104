...
class itkVelocityFieldTransformD4(itk.itkDisplacementFieldTransformPython.itkDisplacementFieldTransformD4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4___New_orig__)
    Clone = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_Clone)
    SetVelocityField = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_SetVelocityField)
    GetModifiableVelocityField = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetModifiableVelocityField)
    GetVelocityField = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetVelocityField)
    SetVelocityFieldInterpolator = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_SetVelocityFieldInterpolator)
    GetModifiableVelocityFieldInterpolator = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetModifiableVelocityFieldInterpolator)
    GetVelocityFieldInterpolator = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetVelocityFieldInterpolator)
    GetVelocityFieldSetTime = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetVelocityFieldSetTime)
    UpdateTransformParameters = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_UpdateTransformParameters)
    GetInverse = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetInverse)
    IntegrateVelocityField = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_IntegrateVelocityField)
    SetLowerTimeBound = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_SetLowerTimeBound)
    GetLowerTimeBound = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetLowerTimeBound)
    SetUpperTimeBound = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_SetUpperTimeBound)
    GetUpperTimeBound = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetUpperTimeBound)
    SetNumberOfIntegrationSteps = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_SetNumberOfIntegrationSteps)
    GetNumberOfIntegrationSteps = _swig_new_instance_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_GetNumberOfIntegrationSteps)
    __swig_destroy__ = _itkVelocityFieldTransformPython.delete_itkVelocityFieldTransformD4
    cast = _swig_new_static_method(_itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_cast)
...
itkVelocityFieldTransformD4___New_orig__ = _itkVelocityFieldTransformPython.itkVelocityFieldTransformD4___New_orig__
itkVelocityFieldTransformD4_cast = _itkVelocityFieldTransformPython.itkVelocityFieldTransformD4_cast
