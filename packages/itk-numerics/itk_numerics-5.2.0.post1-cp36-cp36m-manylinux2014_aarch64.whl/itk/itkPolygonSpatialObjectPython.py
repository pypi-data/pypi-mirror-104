...
class listitkPolygonSpatialObject2_Pointer(collections.abc.MutableSequence):
...
class listitkPolygonSpatialObject3_Pointer(collections.abc.MutableSequence):
...
class listitkPolygonSpatialObject4_Pointer(collections.abc.MutableSequence):
    r"""Proxy of C++ std::list< itkPolygonSpatialObject4_Pointer > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___nonzero__)
    __bool__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___bool__)
    __len__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___len__)
    __getslice__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___getslice__)
    __setslice__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___setslice__)
    __delslice__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___delslice__)
    __delitem__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___delitem__)
    __getitem__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___getitem__)
    __setitem__ = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer___setitem__)
    pop = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_pop)
    append = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_append)
    empty = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_empty)
    size = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_size)
    swap = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_swap)
    begin = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_begin)
    end = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_end)
    rbegin = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_rbegin)
    rend = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_rend)
    clear = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_clear)
    get_allocator = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_get_allocator)
    pop_back = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_pop_back)
    erase = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_erase)
    ...
    push_back = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_push_back)
    front = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_front)
    back = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_back)
    assign = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_assign)
    resize = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_resize)
    insert = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_insert)
    pop_front = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_pop_front)
    push_front = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_push_front)
    reverse = _swig_new_instance_method(_itkPolygonSpatialObjectPython.listitkPolygonSpatialObject4_Pointer_reverse)
...
class itkPolygonSpatialObject2(itk.itkPointBasedSpatialObjectPython.itkPointBasedSpatialObject2):
    ...
    IsClosedOn = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject2_IsClosedOn)
    IsClosedOff = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject2_IsClosedOff)
...
class itkPolygonSpatialObject3(itk.itkPointBasedSpatialObjectPython.itkPointBasedSpatialObject3):
    ...
    IsClosedOn = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject3_IsClosedOn)
    IsClosedOff = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject3_IsClosedOff)
...
class itkPolygonSpatialObject4(itk.itkPointBasedSpatialObjectPython.itkPointBasedSpatialObject4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4___New_orig__)
    Clone = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_Clone)
    GetOrientationInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_GetOrientationInObjectSpace)
    SetThicknessInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_SetThicknessInObjectSpace)
    GetThicknessInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_GetThicknessInObjectSpace)
    SetIsClosed = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_SetIsClosed)
    GetIsClosed = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_GetIsClosed)
    IsClosedOn = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_IsClosedOn)
    IsClosedOff = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_IsClosedOff)
    MeasureAreaInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_MeasureAreaInObjectSpace)
    MeasureVolumeInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_MeasureVolumeInObjectSpace)
    MeasurePerimeterInObjectSpace = _swig_new_instance_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_MeasurePerimeterInObjectSpace)
    __swig_destroy__ = _itkPolygonSpatialObjectPython.delete_itkPolygonSpatialObject4
    cast = _swig_new_static_method(_itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_cast)
...
itkPolygonSpatialObject4___New_orig__ = _itkPolygonSpatialObjectPython.itkPolygonSpatialObject4___New_orig__
itkPolygonSpatialObject4_cast = _itkPolygonSpatialObjectPython.itkPolygonSpatialObject4_cast
