...
class vectoritkContourSpatialObjectPoint2(collections.abc.MutableSequence):
...
class vectoritkContourSpatialObjectPoint3(collections.abc.MutableSequence):
...
class vectoritkContourSpatialObjectPoint4(collections.abc.MutableSequence):
    r"""Proxy of C++ std::vector< itkContourSpatialObjectPoint4 > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___nonzero__)
    __bool__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___bool__)
    __len__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___len__)
    __getslice__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___getslice__)
    __setslice__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___setslice__)
    __delslice__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___delslice__)
    __delitem__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___delitem__)
    __getitem__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___getitem__)
    __setitem__ = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4___setitem__)
    pop = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_pop)
    append = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_append)
    empty = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_empty)
    size = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_size)
    swap = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_swap)
    begin = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_begin)
    end = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_end)
    rbegin = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_rbegin)
    rend = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_rend)
    clear = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_clear)
    get_allocator = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_get_allocator)
    pop_back = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_pop_back)
    erase = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_erase)
    ...
    push_back = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_push_back)
    front = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_front)
    back = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_back)
    assign = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_assign)
    resize = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_resize)
    insert = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_insert)
    reserve = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_reserve)
    capacity = _swig_new_instance_method(_itkContourSpatialObjectPointPython.vectoritkContourSpatialObjectPoint4_capacity)
...
class itkContourSpatialObjectPoint4(itk.itkSpatialObjectPointPython.itkSpatialObjectPoint4):
    ...
    GetPickedPointInObjectSpace = _swig_new_instance_method(_itkContourSpatialObjectPointPython.itkContourSpatialObjectPoint4_GetPickedPointInObjectSpace)
    SetPickedPointInObjectSpace = _swig_new_instance_method(_itkContourSpatialObjectPointPython.itkContourSpatialObjectPoint4_SetPickedPointInObjectSpace)
    GetNormalInObjectSpace = _swig_new_instance_method(_itkContourSpatialObjectPointPython.itkContourSpatialObjectPoint4_GetNormalInObjectSpace)
    SetNormalInObjectSpace = _swig_new_instance_method(_itkContourSpatialObjectPointPython.itkContourSpatialObjectPoint4_SetNormalInObjectSpace)
