...
def discrete_gaussian_image_filter(*args: itkt.ImageLike,  variance: Union[Sequence[float], float]=..., maximum_error: Union[Sequence[float], float]=..., maximum_kernel_width: int=..., filter_dimensionality: int=..., input_boundary_condition: itkt.ImageBoundaryCondition=..., real_boundary_condition: itkt.ImageBoundaryCondition=..., sigma_array: Sequence[float]=..., sigma: float=..., use_image_spacing: bool=...,**kwargs)-> itkt.ImageSourceReturn:
