...
def spatial_object_to_image_filter(*args,  spacing: Sequence[float]=..., direction=..., inside_value: int=..., outside_value: int=..., origin: Sequence[float]=..., children_depth: int=..., size: Sequence[int]=..., use_object_value: bool=...,**kwargs)-> itkt.ImageSourceReturn:
