...
[boto3.KinesisVideoSignalingChannels 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/kinesis-video-signaling.html#KinesisVideoSignalingChannels) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_kinesis_video_signaling/README.md)
...
`mypy_boto3_kinesis_video_signaling.literals` module contains literals extracted from shapes
...
def check_value(value: Service) -> bool:
    ...
```
