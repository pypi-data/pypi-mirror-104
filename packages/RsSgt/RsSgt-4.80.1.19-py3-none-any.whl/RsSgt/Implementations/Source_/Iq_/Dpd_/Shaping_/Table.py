...
class Table:
	...
	def set_interp(self, ipartnterpolation: enums.Interpolation) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:TABLe:INTerp \n
		Snippet: driver.source.iq.dpd.shaping.table.set_interp(ipartnterpolation = enums.Interpolation.LINear) \n
		Enables a linear (voltage or power) interpolation between the defined correction values. \n
			:param ipartnterpolation: OFF| POWer| LINear POWer Linear power interpolation LINear Linear voltage interpolation
		"""
	...
	def set_invert(self, ipartnvert_values: bool) -> None:
		"""SCPI: [SOURce<HW>]:IQ:DPD:SHAPing:[TABLe]:INVert \n
		Snippet: driver.source.iq.dpd.shaping.table.set_invert(ipartnvert_values = False) \n
		Inverts the defined correction values. \n
