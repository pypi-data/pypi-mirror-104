...
class Cid:
	...
	def set(self, ul_ue_cell_id: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.cid.set(ul_ue_cell_id = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:CID \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.cid.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the UE-specific cell ID. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
