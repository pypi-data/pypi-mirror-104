...
class N3Pdsch:
	...
	def set(self, n_3_pdsch: enums.EutraSlN3Pdsch, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdisc.n3Pdsch.set(n_3_pdsch = enums.EutraSlN3Pdsch._1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraSlN3Pdsch:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDISc:N3PDsch \n
		Snippet: value: enums.EutraSlN3Pdsch = driver.source.bb.eutra.ul.ue.sl.rdisc.n3Pdsch.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the PDSCH resource index. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
