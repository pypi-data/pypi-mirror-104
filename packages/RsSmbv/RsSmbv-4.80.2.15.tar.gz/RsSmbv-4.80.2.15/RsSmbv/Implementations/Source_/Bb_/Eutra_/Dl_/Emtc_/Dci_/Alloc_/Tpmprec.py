...
class Tpmprec:
	...
	def set(self, dci_tpmi_prec: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.tpmprec.set(dci_tpmi_prec = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:TPMPrec \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.tpmprec.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field TPMI information for precoding. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
