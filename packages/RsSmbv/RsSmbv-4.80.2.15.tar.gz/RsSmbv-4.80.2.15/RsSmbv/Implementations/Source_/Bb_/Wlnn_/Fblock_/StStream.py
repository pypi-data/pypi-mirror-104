...
class StStream:
	...
	def set(self, ststream: int, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:STSTream \n
		Snippet: driver.source.bb.wlnn.fblock.stStream.set(ststream = 1, frameBlock = repcap.FrameBlock.Default) \n
