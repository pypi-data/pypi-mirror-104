...
class ScSpacing:
	...
	def set(self, subcarr_spacing: enums.EutraSubCarrierSpacing, userEquipment=repcap.UserEquipment.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:SCSPacing \n
		Snippet: driver.source.bb.eutra.ul.ue.niot.scSpacing.set(subcarr_spacing = enums.EutraSubCarrierSpacing.S15, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraSubCarrierSpacing:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:SCSPacing \n
		Snippet: value: enums.EutraSubCarrierSpacing = driver.source.bb.eutra.ul.ue.niot.scSpacing.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the subcarrier spacing. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
