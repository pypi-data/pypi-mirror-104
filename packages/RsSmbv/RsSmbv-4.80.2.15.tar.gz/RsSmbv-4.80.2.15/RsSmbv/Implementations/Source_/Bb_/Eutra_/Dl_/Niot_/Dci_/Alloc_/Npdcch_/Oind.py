...
class Oind:
	...
	def set(self, order_ind: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.npdcch.oind.set(order_ind = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:NPDCch:OIND \n
		Snippet: value: bool = driver.source.bb.eutra.dl.niot.dci.alloc.npdcch.oind.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field NPDCCH order indicator. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
