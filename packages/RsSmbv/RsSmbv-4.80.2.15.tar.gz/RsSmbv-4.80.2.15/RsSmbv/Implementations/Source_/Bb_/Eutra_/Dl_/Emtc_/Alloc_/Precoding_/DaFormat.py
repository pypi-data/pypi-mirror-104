...
class DaFormat:
	...
	def set(self, coord_map_mode: enums.CoordMapMode, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.precoding.daFormat.set(coord_map_mode = enums.CoordMapMode.CARTesian, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> enums.CoordMapMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:PRECoding:DAFormat \n
		Snippet: value: enums.CoordMapMode = driver.source.bb.eutra.dl.emtc.alloc.precoding.daFormat.get(allocationNull = repcap.AllocationNull.Default) \n
		Switches between the cartesian and cylindrical coordinates representation. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
