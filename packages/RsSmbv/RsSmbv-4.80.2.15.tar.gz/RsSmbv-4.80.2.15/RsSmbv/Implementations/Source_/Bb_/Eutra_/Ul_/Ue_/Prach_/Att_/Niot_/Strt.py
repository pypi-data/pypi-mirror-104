...
class Strt:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, attenuationNull=repcap.AttenuationNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.ue.prach.att.niot.strt.get(userEquipment = repcap.UserEquipment.Default, attenuationNull = repcap.AttenuationNull.Default) \n
