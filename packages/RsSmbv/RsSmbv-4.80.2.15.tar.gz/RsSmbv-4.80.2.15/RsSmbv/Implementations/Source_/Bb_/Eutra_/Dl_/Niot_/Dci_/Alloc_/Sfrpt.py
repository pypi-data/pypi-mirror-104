...
class Sfrpt:
	...
	def set(self, sf_repetition: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.sfrpt.set(sf_repetition = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:SFRPt \n
		Snippet: value: int = driver.source.bb.eutra.dl.niot.dci.alloc.sfrpt.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field repetitions of DCI subframes. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
