...
class Toffset:
	...
	def set(self, to_ffset: int, mobileStation=repcap.MobileStation.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:DPCCh:TOFFset \n
		Snippet: driver.source.bb.w3Gpp.mstation.dpcch.toffset.set(to_ffset = 1, mobileStation = repcap.MobileStation.Default) \n
