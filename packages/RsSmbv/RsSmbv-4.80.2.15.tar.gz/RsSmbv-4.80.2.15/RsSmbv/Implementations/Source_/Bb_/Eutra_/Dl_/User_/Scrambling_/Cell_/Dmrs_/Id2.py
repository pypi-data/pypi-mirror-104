...
class Id2:
	...
	def set(self, ident: int, userIx=repcap.UserIx.Default, cell=repcap.Cell.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.scrambling.cell.dmrs.id2.set(ident = 1, userIx = repcap.UserIx.Default, cell = repcap.Cell.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default, cell=repcap.Cell.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:SCRambling:CELL<ST>:DMRS:ID2 \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.scrambling.cell.dmrs.id2.get(userIx = repcap.UserIx.Default, cell = repcap.Cell.Default) \n
		Sets the DMRS scrambling identity. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
			:param cell: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Cell')
