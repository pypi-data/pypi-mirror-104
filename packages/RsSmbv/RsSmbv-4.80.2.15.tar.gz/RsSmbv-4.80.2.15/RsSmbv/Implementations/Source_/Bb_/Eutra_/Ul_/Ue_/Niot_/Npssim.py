...
class Npssim:
	...
	def set(self, np_usch_all_symb: bool, userEquipment=repcap.UserEquipment.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:NPSSim \n
		Snippet: driver.source.bb.eutra.ul.ue.niot.npssim.set(np_usch_all_symb = False, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:NPSSim \n
		Snippet: value: bool = driver.source.bb.eutra.ul.ue.niot.npssim.get(userEquipment = repcap.UserEquipment.Default) \n
		Enables simultaneous transmission of NPUSCH and SRS. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
