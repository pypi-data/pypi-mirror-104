...
class Indi:
	...
	def set(self, starting_ndi: bool, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.asPy.ul.indi.set(starting_ndi = False, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:UL:INDI \n
		Snippet: value: bool = driver.source.bb.eutra.dl.user.asPy.ul.indi.get(userIx = repcap.UserIx.Default) \n
		Sets the new data indicator flag at the beginning of the sequence. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
