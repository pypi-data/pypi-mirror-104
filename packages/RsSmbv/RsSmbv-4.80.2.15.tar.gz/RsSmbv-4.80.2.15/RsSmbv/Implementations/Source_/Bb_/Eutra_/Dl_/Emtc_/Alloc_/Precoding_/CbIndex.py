...
class CbIndex:
	...
	def set(self, prec_code_book_idx: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.precoding.cbIndex.set(prec_code_book_idx = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:PRECoding:CBINdex \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.alloc.precoding.cbIndex.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the codebook index. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
