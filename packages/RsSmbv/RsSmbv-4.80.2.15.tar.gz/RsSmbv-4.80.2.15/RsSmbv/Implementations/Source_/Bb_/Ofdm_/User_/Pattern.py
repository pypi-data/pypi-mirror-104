...
class Pattern:
	...
	def set(self, structure: PatternStruct, userNull=repcap.UserNull.Default) -> None:
		...
		Snippet: driver.source.bb.ofdm.user.pattern.set(value = [PROPERTY_STRUCT_NAME](), userNull = repcap.UserNull.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:OFDM:USER{userNull_cmd_val}:PATTern', structure)
