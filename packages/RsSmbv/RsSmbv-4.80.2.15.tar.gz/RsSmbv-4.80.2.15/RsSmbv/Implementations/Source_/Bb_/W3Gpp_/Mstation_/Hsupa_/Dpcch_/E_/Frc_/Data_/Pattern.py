...
class Pattern:
	...
	def set(self, structure: PatternStruct, mobileStation=repcap.MobileStation.Default) -> None:
		...
		Snippet: driver.source.bb.w3Gpp.mstation.hsupa.dpcch.e.frc.data.pattern.set(value = [PROPERTY_STRUCT_NAME](), mobileStation = repcap.MobileStation.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:W3GPp:MSTation{mobileStation_cmd_val}:HSUPa:DPCCh:E:FRC:DATA:PATTern', structure)
