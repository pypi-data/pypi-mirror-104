...
class Pattern:
	...
	def set(self, structure: PatternStruct, output=repcap.Output.Default) -> None:
		...
		Snippet: driver.source.bb.dab.trigger.output.pattern.set(value = [PROPERTY_STRUCT_NAME](), output = repcap.Output.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:DAB:TRIGger:OUTPut{output_cmd_val}:PATTern', structure)
