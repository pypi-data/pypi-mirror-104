...
class Scheme:
	...
	def set(self, prec_mult_ant_sche: enums.EutraDlpRecMultAntScheme, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.precoding.scheme.set(prec_mult_ant_sche = enums.EutraDlpRecMultAntScheme.BF, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> enums.EutraDlpRecMultAntScheme:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:PRECoding:SCHeme \n
		Snippet: value: enums.EutraDlpRecMultAntScheme = driver.source.bb.eutra.dl.emtc.alloc.precoding.scheme.get(allocationNull = repcap.AllocationNull.Default) \n
		Selects the precoding scheme. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
