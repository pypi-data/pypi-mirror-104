...
class Strv:
	"""Strv commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("strv", core, parent)

	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:STRV \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.strv.get(allocationNull = repcap.AllocationNull.Default) \n
