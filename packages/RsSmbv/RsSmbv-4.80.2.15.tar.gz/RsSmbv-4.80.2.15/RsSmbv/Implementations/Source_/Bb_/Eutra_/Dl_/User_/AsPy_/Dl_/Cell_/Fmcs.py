...
class Fmcs:
	...
	def set(self, fixed_mcs: int, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.asPy.dl.cell.fmcs.set(fixed_mcs = 1, userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
		Sets the MCS value. \n
	...
	def get(self, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:DL:CELL<ST0>:FMCS \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.asPy.dl.cell.fmcs.get(userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
		Sets the MCS value. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
