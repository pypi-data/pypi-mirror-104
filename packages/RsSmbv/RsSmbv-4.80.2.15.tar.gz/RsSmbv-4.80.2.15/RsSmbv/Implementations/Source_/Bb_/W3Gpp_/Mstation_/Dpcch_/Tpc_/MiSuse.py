...
class MiSuse:
	...
	def set(self, mis_use: bool, mobileStation=repcap.MobileStation.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:DPCCh:TPC:MISuse \n
		Snippet: driver.source.bb.w3Gpp.mstation.dpcch.tpc.miSuse.set(mis_use = False, mobileStation = repcap.MobileStation.Default) \n
