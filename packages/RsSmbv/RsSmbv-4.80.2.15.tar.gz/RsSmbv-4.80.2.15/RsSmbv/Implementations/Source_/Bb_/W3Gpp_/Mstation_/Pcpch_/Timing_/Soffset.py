...
class Soffset:
	...
	def set(self, so_ffset: int, mobileStation=repcap.MobileStation.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:PCPCh:TIMing:SOFFset \n
		Snippet: driver.source.bb.w3Gpp.mstation.pcpch.timing.soffset.set(so_ffset = 1, mobileStation = repcap.MobileStation.Default) \n
