...
class Cbua:
	...
	def set(self, cb_use_alt: bool, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.apm.cbua.set(cb_use_alt = False, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:APM:CBUA \n
		Snippet: value: bool = driver.source.bb.eutra.dl.user.apm.cbua.get(userIx = repcap.UserIx.Default) \n
		Applies the enhanced 4 Tx codebook. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
