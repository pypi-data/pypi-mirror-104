...
class State:
	...
	def set(self, rmc_state: bool, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rmc.state.set(rmc_state = False, userEquipment = repcap.UserEquipment.Default) \n
		Activates the selected RMC. \n
			:param rmc_state: 0| 1| OFF| ON
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RMC:STATe \n
		Snippet: value: bool = driver.source.bb.eutra.ul.ue.sl.rmc.state.get(userEquipment = repcap.UserEquipment.Default) \n
		Activates the selected RMC. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
			:return: rmc_state: 0| 1| OFF| ON"""
		userEquipment_cmd_val = self._base.get_repcap_cmd_value(userEquipment, repcap.UserEquipment)
