...
class F4Naport:
	"""F4Naport commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("f4Naport", core, parent)
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraPucchNumAp:
		...
		Snippet: value: enums.EutraPucchNumAp = driver.source.bb.eutra.ul.ue.pucch.f4Naport.get(userEquipment = repcap.UserEquipment.Default) \n
