...
class Duplexing:
	...
	def set(self, ulca_duplex_mode: enums.EutraDuplexMode, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ca.cell.duplexing.set(ulca_duplex_mode = enums.EutraDuplexMode.FDD, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> enums.EutraDuplexMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:CA:CELL<CH0>:DUPLexing \n
		Snippet: value: enums.EutraDuplexMode = driver.source.bb.eutra.ul.ca.cell.duplexing.get(cellNull = repcap.CellNull.Default) \n
		Selects the duplexing mode of the component carriers. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
