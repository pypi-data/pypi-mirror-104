...
class Cell:
	...
	def set(self, cell_id: int, carrier=repcap.Carrier.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.carrier.niot.cell.set(cell_id = 1, carrier = repcap.Carrier.Default) \n
	...
	def get(self, carrier=repcap.Carrier.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CARRier<CH>:NIOT:CELL \n
		Snippet: value: int = driver.source.bb.eutra.dl.carrier.niot.cell.get(carrier = repcap.Carrier.Default) \n
		Sets the narrowband physical cell identifier. \n
			:param carrier: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Carrier')
