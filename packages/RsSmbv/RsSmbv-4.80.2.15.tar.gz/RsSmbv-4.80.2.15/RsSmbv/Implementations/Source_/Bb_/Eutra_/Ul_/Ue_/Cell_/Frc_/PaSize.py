...
class PaSize:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, cellNull=repcap.CellNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.ue.cell.frc.paSize.get(userEquipment = repcap.UserEquipment.Default, cellNull = repcap.CellNull.Default) \n
		Queries the payload size for the selected FRC (BB:EUTRa:UL:FRC:TYPE) . \n
