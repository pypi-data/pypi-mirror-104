...
class Nrep:
	...
	def set(self, dci_rep_num: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.nrep.set(dci_rep_num = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:NREP \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.nrep.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field repetition number. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
