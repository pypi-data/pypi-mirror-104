...
class Tpcpusch:
	...
	def set(self, dci_tpc_cmd_pusch: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.tpcpusch.set(dci_tpc_cmd_pusch = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:TPCPusch \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.tpcpusch.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field TPC command for scheduled PUSCH. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
