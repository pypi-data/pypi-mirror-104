...
class SlssId:
	...
	def set(self, slss_id: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.sync.slssId.set(slss_id = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:SYNC:SLSSid \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.sync.slssId.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the sidelink synchronization signal ID. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
