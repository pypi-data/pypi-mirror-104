...
class Sformat:
	...
	def set(self, sf_ormat: int, mobileStation=repcap.MobileStation.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:PRACh:SFORmat \n
		Snippet: driver.source.bb.w3Gpp.mstation.prach.sformat.set(sf_ormat = 1, mobileStation = repcap.MobileStation.Default) \n
