...
class PraMask:
	...
	def set(self, dci_prach_mask_idx: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.praMask.set(dci_prach_mask_idx = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:PRAMask \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.praMask.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field PRACH mask index. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
