...
class SrbSubchan:
	...
	def set(self, start_rb_subchan: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.v2X.srbSubchan.set(start_rb_subchan = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:V2X:SRBSubchan \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.v2X.srbSubchan.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the first RB in the subchannel. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
