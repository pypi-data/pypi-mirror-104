...
class Hack:
	...
	def set(self, hack_resource: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.hack.set(hack_resource = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:HACK \n
		Snippet: value: int = driver.source.bb.eutra.dl.niot.dci.alloc.hack.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field HARQ-ACK resource field. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
