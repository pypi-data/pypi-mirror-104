...
class Nsubbands:
	...
	def set(self, num_subbands: enums.NumbersB, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdata.nsubbands.set(num_subbands = enums.NumbersB._1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.NumbersB:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDATa:NSUBbands \n
		Snippet: value: enums.NumbersB = driver.source.bb.eutra.ul.ue.sl.rdata.nsubbands.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the number of subbands. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
