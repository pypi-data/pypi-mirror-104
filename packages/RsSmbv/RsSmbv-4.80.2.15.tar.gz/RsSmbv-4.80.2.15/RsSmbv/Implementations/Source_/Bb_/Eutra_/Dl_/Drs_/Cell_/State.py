...
class State:
	...
	def set(self, drs_state: bool, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.drs.cell.state.set(drs_state = False, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:DRS:CELL<CH0>:STATe \n
		Snippet: value: bool = driver.source.bb.eutra.dl.drs.cell.state.get(cellNull = repcap.CellNull.Default) \n
		Enables the selected DRS occasion configuration. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
