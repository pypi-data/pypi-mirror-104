...
class Cbw:
	...
	def set(self, chan_band_width: enums.Nr5Gcbw, cellNull=repcap.CellNull.Nr0) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:NODE:CELL<CH0>:CBW \n
		Snippet: driver.source.bb.nr5G.node.cell.cbw.set(chan_band_width = enums.Nr5Gcbw.BW10, cellNull = repcap.CellNull.Nr0) \n
