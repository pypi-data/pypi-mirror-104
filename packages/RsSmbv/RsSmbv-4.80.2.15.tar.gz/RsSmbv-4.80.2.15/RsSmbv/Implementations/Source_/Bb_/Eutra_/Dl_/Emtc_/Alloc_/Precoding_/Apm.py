...
class Apm:
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> enums.EutraBfapMapMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:PRECoding:APM \n
		Snippet: value: enums.EutraBfapMapMode = driver.source.bb.eutra.dl.emtc.alloc.precoding.apm.get(allocationNull = repcap.AllocationNull.Default) \n
