...
class Harq:
	...
	def set(self, dci_harq_proc_num: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.harq.set(dci_harq_proc_num = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:HARQ \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.harq.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field HARQ process number. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
