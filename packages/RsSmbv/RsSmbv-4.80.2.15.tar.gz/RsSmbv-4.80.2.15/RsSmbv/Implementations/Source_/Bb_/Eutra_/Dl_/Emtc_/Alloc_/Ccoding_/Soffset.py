...
class Soffset:
	...
	def set(self, chan_cod_sfn_offse: float, allocationNull=repcap.AllocationNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:CCODing:SOFFset \n
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.ccoding.soffset.set(chan_cod_sfn_offse = 1.0, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:CCODing:SOFFset \n
		Snippet: value: float = driver.source.bb.eutra.dl.emtc.alloc.ccoding.soffset.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the start SFN value. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
