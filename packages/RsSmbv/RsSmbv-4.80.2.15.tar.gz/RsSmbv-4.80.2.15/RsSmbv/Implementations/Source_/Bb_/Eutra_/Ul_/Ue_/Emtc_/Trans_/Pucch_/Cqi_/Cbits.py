...
class Cbits:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.ue.emtc.trans.pucch.cqi.cbits.get(userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
