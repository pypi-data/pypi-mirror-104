...
class SsOffset:
	...
	def set(self, search_space_offs: enums.EutraNbiotSearchSpaceOffset, userIx=repcap.UserIx.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.niot.ssOffset.set(search_space_offs = enums.EutraNbiotSearchSpaceOffset.O0, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> enums.EutraNbiotSearchSpaceOffset:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:NIOT:SSOFfset \n
		Snippet: value: enums.EutraNbiotSearchSpaceOffset = driver.source.bb.eutra.dl.user.niot.ssOffset.get(userIx = repcap.UserIx.Default) \n
		Shifts the search space start. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
