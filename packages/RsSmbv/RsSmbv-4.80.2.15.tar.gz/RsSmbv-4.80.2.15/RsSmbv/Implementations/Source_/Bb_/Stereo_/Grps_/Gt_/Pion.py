...
class Pion:
	...
	def set(self, pi_on: List[str], groupNull=repcap.GroupNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:STEReo:GRPS:GT<ST0>:PION \n
		Snippet: driver.source.bb.stereo.grps.gt.pion.set(pi_on = ['raw1', 'raw2', 'raw3'], groupNull = repcap.GroupNull.Default) \n
