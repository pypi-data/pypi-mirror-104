...
class Tbsi:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, allocationNull=repcap.AllocationNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.alloc.ccoding.tbsi.get(userEquipment = repcap.UserEquipment.Default, allocationNull = repcap.AllocationNull.Default) \n
