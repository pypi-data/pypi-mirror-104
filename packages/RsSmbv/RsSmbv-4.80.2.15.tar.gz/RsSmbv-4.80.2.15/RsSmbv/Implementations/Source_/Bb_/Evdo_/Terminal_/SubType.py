...
class SubType:
	...
	def set(self, subtype: enums.EvdoLayer, terminal=repcap.Terminal.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EVDO:TERMinal<ST>:SUBType \n
		Snippet: driver.source.bb.evdo.terminal.subType.set(subtype = enums.EvdoLayer.S1, terminal = repcap.Terminal.Default) \n
	...
	def get(self, terminal=repcap.Terminal.Default) -> enums.EvdoLayer:
		"""SCPI: [SOURce<HW>]:BB:EVDO:TERMinal<ST>:SUBType \n
		Snippet: value: enums.EvdoLayer = driver.source.bb.evdo.terminal.subType.get(terminal = repcap.Terminal.Default) \n
		Selects the physical layer subtype for the selected access terminal. \n
			:param terminal: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Terminal')
