...
class Modulation:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, cellNull=repcap.CellNull.Default) -> enums.ModulationB:
		...
		Snippet: value: enums.ModulationB = driver.source.bb.eutra.ul.ue.cell.frc.modulation.get(userEquipment = repcap.UserEquipment.Default, cellNull = repcap.CellNull.Default) \n
