...
class UdConf:
	...
	def set(self, dlc_atdd_uldl_conf: int, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CA:CELL<CH0>:UDConf \n
		Snippet: driver.source.bb.eutra.dl.ca.cell.udConf.set(dlc_atdd_uldl_conf = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CA:CELL<CH0>:UDConf \n
		Snippet: value: int = driver.source.bb.eutra.dl.ca.cell.udConf.get(cellNull = repcap.CellNull.Default) \n
		Sets the Uplink-Downlink Configuration number. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
