...
class SpsConf:
	...
	def set(self, ulca_tdd_ss_conf: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ca.cell.spsConf.set(ulca_tdd_ss_conf = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:CA:CELL<CH0>:SPSConf \n
		Snippet: value: int = driver.source.bb.eutra.ul.ca.cell.spsConf.get(cellNull = repcap.CellNull.Default) \n
		Sets the special subframeconfiguration number. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
