...
class Rba:
	...
	def set(self, dci_rba: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.rba.set(dci_rba = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:RBA \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.rba.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI filed resource block assignment. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
