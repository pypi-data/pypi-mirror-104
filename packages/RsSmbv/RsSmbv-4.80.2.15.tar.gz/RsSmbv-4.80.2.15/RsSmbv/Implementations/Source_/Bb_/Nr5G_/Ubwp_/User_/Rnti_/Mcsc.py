...
class Mcsc:
	...
	def set(self, mcs_crnti: int, userNull=repcap.UserNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NR5G:UBWP:USER<CH0>:RNTI:MCSC \n
		Snippet: driver.source.bb.nr5G.ubwp.user.rnti.mcsc.set(mcs_crnti = 1, userNull = repcap.UserNull.Default) \n
