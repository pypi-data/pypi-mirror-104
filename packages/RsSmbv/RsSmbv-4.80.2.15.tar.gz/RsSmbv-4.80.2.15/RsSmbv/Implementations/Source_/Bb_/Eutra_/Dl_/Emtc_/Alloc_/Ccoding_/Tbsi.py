...
class Tbsi:
	...
	def set(self, chan_cod_tbs_index: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.ccoding.tbsi.set(chan_cod_tbs_index = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:CCODing:TBSI \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.alloc.ccoding.tbsi.get(allocationNull = repcap.AllocationNull.Default) \n
		Queries the resulting transport block size index. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
