...
class Permittivity:
	...
	def set(self, permittyvity: float, vehicle=repcap.Vehicle.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:RECeiver:[V<ST>]:ENVironment:GSR:PERMittivity \n
		Snippet: driver.source.bb.gnss.receiver.v.environment.gsr.permittivity.set(permittyvity = 1.0, vehicle = repcap.Vehicle.Default) \n
