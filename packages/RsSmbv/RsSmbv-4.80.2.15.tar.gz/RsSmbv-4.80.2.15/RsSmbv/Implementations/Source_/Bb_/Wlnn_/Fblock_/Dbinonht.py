...
class Dbinonht:
	...
	def set(self, dbi_nonht: enums.WlannFbDynBwInNonHt, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:DBINonht \n
		Snippet: driver.source.bb.wlnn.fblock.dbinonht.set(dbi_nonht = enums.WlannFbDynBwInNonHt.DYN, frameBlock = repcap.FrameBlock.Default) \n
