...
class Valid:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> bool:
		...
		Snippet: value: bool = driver.source.bb.eutra.dl.subf.encc.pdcch.extc.item.sespace.chk.valid.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
