...
class EsSupported:
	...
	def set(self, esensbres: bool, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:ESSupported \n
		Snippet: driver.source.bb.nfc.cblock.esSupported.set(esensbres = False, commandBlock = repcap.CommandBlock.Default) \n
