...
class SfrNumber:
	...
	def set(self, dci_sf_rep_number: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.sfrNumber.set(dci_sf_rep_number = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:SFRNumber \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.sfrNumber.get(allocationNull = repcap.AllocationNull.Default) \n
		If method RsSmbv.Source.Bb.Eutra.Dl.User.Epdcch.Cell.Set.Repmpdcch.set ≥2, sets the DCI field DCI subframe repetition
		number. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
