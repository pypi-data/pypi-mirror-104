...
class SuConfiguration:
	...
	def set(self, ulca_srs_subf_conf: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ca.cell.suConfiguration.set(ulca_srs_subf_conf = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:CA:CELL<CH0>:SUConfiguration \n
		Snippet: value: int = driver.source.bb.eutra.ul.ca.cell.suConfiguration.get(cellNull = repcap.CellNull.Default) \n
		Sets the SRS subframe configuration per component carrier. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
