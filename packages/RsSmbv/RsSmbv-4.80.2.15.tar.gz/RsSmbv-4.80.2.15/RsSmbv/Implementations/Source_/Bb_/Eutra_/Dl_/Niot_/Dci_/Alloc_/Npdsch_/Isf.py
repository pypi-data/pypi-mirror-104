...
class Isf:
	...
	def set(self, dci_isf: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.npdsch.isf.set(dci_isf = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:NPDSch:ISF \n
		Snippet: value: int = driver.source.bb.eutra.dl.niot.dci.alloc.npdsch.isf.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI feild resource assignment field (ISF) . \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
