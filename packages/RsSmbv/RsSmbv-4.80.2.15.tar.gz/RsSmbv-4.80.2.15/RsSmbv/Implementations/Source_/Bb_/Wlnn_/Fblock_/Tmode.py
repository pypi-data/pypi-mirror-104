...
class Tmode:
	...
	def set(self, tm_ode: enums.WlannFbTxMode, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:TMODe \n
		Snippet: driver.source.bb.wlnn.fblock.tmode.set(tm_ode = enums.WlannFbTxMode.CCK, frameBlock = repcap.FrameBlock.Default) \n
