...
class UdConf:
	...
	def set(self, ulca_tdd_ul_dl_conf: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ca.cell.udConf.set(ulca_tdd_ul_dl_conf = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:CA:CELL<CH0>:UDConf \n
		Snippet: value: int = driver.source.bb.eutra.ul.ca.cell.udConf.get(cellNull = repcap.CellNull.Default) \n
		Sets the Uplink-Downlink Configuration number. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
