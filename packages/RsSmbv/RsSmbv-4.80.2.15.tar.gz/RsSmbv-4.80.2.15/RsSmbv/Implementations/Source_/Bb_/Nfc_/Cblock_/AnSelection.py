...
class AnSelection:
	...
	def set(self, anselection: enums.NfcAckNack, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:ANSelection \n
		Snippet: driver.source.bb.nfc.cblock.anSelection.set(anselection = enums.NfcAckNack.ACK, commandBlock = repcap.CommandBlock.Default) \n
