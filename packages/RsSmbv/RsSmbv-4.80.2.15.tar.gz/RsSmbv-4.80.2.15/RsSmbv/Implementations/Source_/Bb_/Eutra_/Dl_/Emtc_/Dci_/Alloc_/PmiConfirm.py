...
class PmiConfirm:
	...
	def set(self, dci_pmi_confirm: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.pmiConfirm.set(dci_pmi_confirm = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:PMIConfirm \n
		Snippet: value: bool = driver.source.bb.eutra.dl.emtc.dci.alloc.pmiConfirm.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field PMI confirmation for precoding. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
