...
class Hopp:
	...
	def set(self, hopping_interval: enums.EutraIotHoppingIvl, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.emtc.hopp.set(hopping_interval = enums.EutraIotHoppingIvl.H1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraIotHoppingIvl:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:EMTC:HOPP \n
		Snippet: value: enums.EutraIotHoppingIvl = driver.source.bb.eutra.ul.ue.emtc.hopp.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the narrowband hopping interval. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
