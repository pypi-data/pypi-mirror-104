...
class Soffset:
	...
	def set(self, so_ffset: int, userIx=repcap.UserIx.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EVDO:USER<ST>:PACKet:SOFFset \n
		Snippet: driver.source.bb.evdo.user.packet.soffset.set(so_ffset = 1, userIx = repcap.UserIx.Default) \n
