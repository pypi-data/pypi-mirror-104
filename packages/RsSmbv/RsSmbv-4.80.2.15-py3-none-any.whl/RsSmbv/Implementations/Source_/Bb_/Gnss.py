...
class Gnss:
	...
	def set_tmode(self, sm_ode: enums.SimMode) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TMODe \n
		Snippet: driver.source.bb.gnss.set_tmode(sm_ode = enums.SimMode.NAVigation) \n
		Sets the test mode. \n
			:param sm_ode: TRACking| NAVigation| SINGle
		"""
		param = Conversions.enum_scalar_to_str(sm_ode, enums.SimMode)
