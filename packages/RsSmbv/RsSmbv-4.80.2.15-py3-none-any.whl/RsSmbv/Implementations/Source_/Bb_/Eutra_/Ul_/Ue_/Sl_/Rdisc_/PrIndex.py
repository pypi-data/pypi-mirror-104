...
class PrIndex:
	...
	def set(self, prb_index: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdisc.prIndex.set(prb_index = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDISc:PRINdex \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.rdisc.prIndex.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the physical resource block index. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
