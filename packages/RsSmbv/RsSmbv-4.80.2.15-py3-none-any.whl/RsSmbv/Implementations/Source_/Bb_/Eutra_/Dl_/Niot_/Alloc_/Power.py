...
class Power:
	...
	def set(self, power: float, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.alloc.power.set(power = 1.0, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> float:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:ALLoc<CH0>:POWer \n
		Snippet: value: float = driver.source.bb.eutra.dl.niot.alloc.power.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the power of the selected allocation. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
