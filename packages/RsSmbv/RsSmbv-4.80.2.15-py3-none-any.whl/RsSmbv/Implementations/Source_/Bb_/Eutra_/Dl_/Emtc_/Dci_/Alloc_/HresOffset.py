...
class HresOffset:
	...
	def set(self, dci_harq_res_offs: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.hresOffset.set(dci_harq_res_offs = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:HRESoffset \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.hresOffset.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field HARQ-ACK ressource offset. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
