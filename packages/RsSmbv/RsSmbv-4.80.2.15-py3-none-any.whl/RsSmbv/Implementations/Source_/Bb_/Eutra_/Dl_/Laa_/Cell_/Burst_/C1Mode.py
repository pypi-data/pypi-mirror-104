...
class C1Mode:
	...
	def set(self, dc_i_1_cm_ode: enums.EutraLaadci1CMode, cellNull=repcap.CellNull.Default, burstNull=repcap.BurstNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:LAA:CELL<CH0>:BURSt<ST0>:C1Mode \n
		Snippet: driver.source.bb.eutra.dl.laa.cell.burst.c1Mode.set(dc_i_1_cm_ode = enums.EutraLaadci1CMode.MANual, cellNull = repcap.CellNull.Default, burstNull = repcap.BurstNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default, burstNull=repcap.BurstNull.Default) -> enums.EutraLaadci1CMode:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:LAA:CELL<CH0>:BURSt<ST0>:C1Mode \n
		Snippet: value: enums.EutraLaadci1CMode = driver.source.bb.eutra.dl.laa.cell.burst.c1Mode.get(cellNull = repcap.CellNull.Default, burstNull = repcap.BurstNull.Default) \n
		Defines how the DCI format 1C is sent. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
			:param burstNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Burst')
