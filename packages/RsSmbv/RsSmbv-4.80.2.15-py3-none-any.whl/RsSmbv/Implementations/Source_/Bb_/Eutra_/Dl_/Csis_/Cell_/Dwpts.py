...
class Dwpts:
	...
	def set(self, dw_pts: bool, cellNull=repcap.CellNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CSIS:[CELL<CH0>]:DWPTs \n
		Snippet: driver.source.bb.eutra.dl.csis.cell.dwpts.set(dw_pts = False, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CSIS:[CELL<CH0>]:DWPTs \n
		Snippet: value: bool = driver.source.bb.eutra.dl.csis.cell.dwpts.get(cellNull = repcap.CellNull.Default) \n
		Enables transmission of the CSI-RS in the Downlink Pilot Time Slot (DwPTS) parts of the TDD frame. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
