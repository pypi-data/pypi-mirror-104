...
class NumBursts:
	...
	def set(self, number_of_bursts: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.laa.cell.numBursts.set(number_of_bursts = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:LAA:CELL<CH0>:NUMBursts \n
		Snippet: value: int = driver.source.bb.eutra.dl.laa.cell.numBursts.get(cellNull = repcap.CellNull.Default) \n
		Set the number of LAA bursts. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
