...
class Nretrans:
	...
	def set(self, num_retrans: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdisc.nretrans.set(num_retrans = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDISc:NRETrans \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.rdisc.nretrans.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the number of PSDCH retransmissions. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
