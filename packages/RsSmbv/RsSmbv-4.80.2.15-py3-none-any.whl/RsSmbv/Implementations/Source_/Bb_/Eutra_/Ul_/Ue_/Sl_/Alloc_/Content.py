...
class Content:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, allocationNull=repcap.AllocationNull.Default) -> enums.EutraUlSidelinkContentType:
		...
		Snippet: value: enums.EutraUlSidelinkContentType = driver.source.bb.eutra.ul.ue.sl.alloc.content.get(userEquipment = repcap.UserEquipment.Default, allocationNull = repcap.AllocationNull.Default) \n
