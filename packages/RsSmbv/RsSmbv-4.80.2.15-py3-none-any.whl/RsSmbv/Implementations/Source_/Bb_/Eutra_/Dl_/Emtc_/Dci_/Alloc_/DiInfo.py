...
class DiInfo:
	"""DiInfo commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("diInfo", core, parent)
	...
	def set(self, dci_di_info: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.diInfo.set(dci_di_info = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:DIINfo \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.diInfo.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field direct indication information. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
