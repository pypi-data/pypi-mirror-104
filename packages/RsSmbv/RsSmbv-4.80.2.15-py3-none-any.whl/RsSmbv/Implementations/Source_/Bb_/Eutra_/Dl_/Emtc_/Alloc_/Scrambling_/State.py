...
class State:
	...
	def set(self, scram_state: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.alloc.scrambling.state.set(scram_state = False, allocationNull = repcap.AllocationNull.Default) \n
		Enables scrambling. \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:ALLoc<CH0>:SCRambling:STATe \n
		Snippet: value: bool = driver.source.bb.eutra.dl.emtc.alloc.scrambling.state.get(allocationNull = repcap.AllocationNull.Default) \n
		Enables scrambling. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
