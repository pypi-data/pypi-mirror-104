...
class Ueid:
	...
	def set(self, ueid: int, userIx=repcap.UserIx.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:UEID \n
		Snippet: driver.source.bb.eutra.dl.user.ueid.set(ueid = 1, userIx = repcap.UserIx.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:UEID \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.ueid.get(userIx = repcap.UserIx.Default) \n
		Sets the user equipment ID. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
