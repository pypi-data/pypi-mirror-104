...
class Pucch:
	"""Pucch commands group definition. 10 total commands, 0 Sub-groups, 10 group commands"""
	...
	def get_n_1_n_max(self) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.pucch.get_n_1_n_max() \n
	...
	def get_n_2_max(self) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.pucch.get_n_2_max() \n
	...
	def get_n_3_max(self) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.pucch.get_n_3_max() \n
	...
	def get_n_4_max(self) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.pucch.get_n_4_max() \n
		Queries the range of possible number of PUCCH format x transmissions from different users in one subframe. \n
	...
	def get_n_5_max(self) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.ul.pucch.get_n_5_max() \n
		Queries the range of possible number of PUCCH format x transmissions from different users in one subframe. \n
