...
class ArbLen:
	"""ArbLen commands group definition. 1 total commands, 0 Sub-groups, 1 group commands"""

	def __init__(self, core: Core, parent):
		self._core = core
		self._base = CommandsGroup("arbLen", core, parent)

	def get(self, userIx=repcap.UserIx.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:ARBLen \n
		Snippet: value: int = driver.source.bb.eutra.dl.user.asPy.arbLen.get(userIx = repcap.UserIx.Default) \n
