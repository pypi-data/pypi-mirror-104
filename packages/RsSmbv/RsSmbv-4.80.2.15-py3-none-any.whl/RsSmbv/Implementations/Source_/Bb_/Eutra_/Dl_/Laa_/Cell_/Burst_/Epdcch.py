...
class Epdcch:
	...
	def set(self, epdcch_format: enums.EutraPdccFmtLaa, cellNull=repcap.CellNull.Default, burstNull=repcap.BurstNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.laa.cell.burst.epdcch.set(epdcch_format = enums.EutraPdccFmtLaa.F2, cellNull = repcap.CellNull.Default, burstNull = repcap.BurstNull.Default) \n
		...
		burstNull_cmd_val = self._base.get_repcap_cmd_value(burstNull, repcap.BurstNull)
	...
	def get(self, cellNull=repcap.CellNull.Default, burstNull=repcap.BurstNull.Default) -> enums.EutraPdccFmtLaa:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:LAA:CELL<CH0>:BURSt<ST0>:EPDCch \n
		Snippet: value: enums.EutraPdccFmtLaa = driver.source.bb.eutra.dl.laa.cell.burst.epdcch.get(cellNull = repcap.CellNull.Default, burstNull = repcap.BurstNull.Default) \n
		Sets the (E) PDCCH format. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
			:param burstNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Burst')
