...
class Fmt:
	...
	def set(self, np_dcch_fmt: int, allocationNull=repcap.AllocationNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:NPDCch:FMT \n
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.npdcch.fmt.set(np_dcch_fmt = 1, allocationNull = repcap.AllocationNull.Default) \n
		Sets the NPDCCH format. \n
			:param np_dcch_fmt: integer Range: 0 to 1
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')"""
		param = Conversions.decimal_value_to_str(np_dcch_fmt)
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:NPDCch:FMT \n
		Snippet: value: int = driver.source.bb.eutra.dl.niot.dci.alloc.npdcch.fmt.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the NPDCCH format. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
			:return: np_dcch_fmt: integer Range: 0 to 1"""
		allocationNull_cmd_val = self._base.get_repcap_cmd_value(allocationNull, repcap.AllocationNull)
