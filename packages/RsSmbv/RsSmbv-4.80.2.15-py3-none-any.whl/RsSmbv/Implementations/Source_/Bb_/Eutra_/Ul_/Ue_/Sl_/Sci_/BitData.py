...
class BitData:
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, indexNull=repcap.IndexNull.Default) -> List[str]:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:SCI<CH0>:BITData \n
		Snippet: value: List[str] = driver.source.bb.eutra.ul.ue.sl.sci.bitData.get(userEquipment = repcap.UserEquipment.Default, indexNull = repcap.IndexNull.Default) \n
