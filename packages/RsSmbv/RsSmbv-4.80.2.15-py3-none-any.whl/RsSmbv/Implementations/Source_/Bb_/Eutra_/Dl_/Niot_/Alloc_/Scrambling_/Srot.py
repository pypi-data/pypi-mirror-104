...
class Srot:
	...
	def set(self, symbol_rotation: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.alloc.scrambling.srot.set(symbol_rotation = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:ALLoc<CH0>:SCRambling:SROT \n
		Snippet: value: bool = driver.source.bb.eutra.dl.niot.alloc.scrambling.srot.get(allocationNull = repcap.AllocationNull.Default) \n
		Enables NPBCH scrambling with symbol rotation. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
