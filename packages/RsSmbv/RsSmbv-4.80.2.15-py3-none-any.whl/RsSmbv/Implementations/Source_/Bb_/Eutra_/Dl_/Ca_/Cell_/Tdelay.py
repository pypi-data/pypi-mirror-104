...
class Tdelay:
	...
	def set(self, time_delay: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.ca.cell.tdelay.set(time_delay = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CA:CELL<CH0>:TDELay \n
		Snippet: value: int = driver.source.bb.eutra.dl.ca.cell.tdelay.get(cellNull = repcap.CellNull.Default) \n
		Sets the time delay of the SCell relative to the PCell. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
