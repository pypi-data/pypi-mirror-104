...
class Ndi:
	...
	def set(self, dl_ndi: bool, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.asPy.dl.cell.seqElem.tb2.ndi.set(dl_ndi = False, userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:DL:CELL<ST0>:SEQelem:TB2:NDI \n
		Snippet: value: bool = driver.source.bb.eutra.dl.user.asPy.dl.cell.seqElem.tb2.ndi.get(userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
		Enables the new data indicator flag. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
