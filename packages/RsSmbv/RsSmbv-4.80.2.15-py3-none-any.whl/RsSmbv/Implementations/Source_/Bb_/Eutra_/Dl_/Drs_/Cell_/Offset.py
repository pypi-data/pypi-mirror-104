...
class Offset:
	...
	def set(self, drs_offset: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.drs.cell.offset.set(drs_offset = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:DRS:CELL<CH0>:OFFSet \n
		Snippet: value: int = driver.source.bb.eutra.dl.drs.cell.offset.get(cellNull = repcap.CellNull.Default) \n
		Offsets the DRS start within the DRS occasion. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
