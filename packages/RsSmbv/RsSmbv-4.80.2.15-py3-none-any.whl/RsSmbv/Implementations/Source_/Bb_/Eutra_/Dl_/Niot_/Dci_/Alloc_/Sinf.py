...
class Sinf:
	...
	def set(self, sys_inf_mod: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.sinf.set(sys_inf_mod = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:SINF \n
		Snippet: value: bool = driver.source.bb.eutra.dl.niot.dci.alloc.sinf.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field system info modification. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
