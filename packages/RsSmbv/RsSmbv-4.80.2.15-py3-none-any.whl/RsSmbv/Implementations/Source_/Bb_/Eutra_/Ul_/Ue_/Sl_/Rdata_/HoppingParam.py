...
class HoppingParam:
	...
	def set(self, hopping_param: int, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rdata.hoppingParam.set(hopping_param = 1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RDATa:HOPPingparam \n
		Snippet: value: int = driver.source.bb.eutra.ul.ue.sl.rdata.hoppingParam.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the frequency hopping parameter. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
