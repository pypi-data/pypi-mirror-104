...
class Mcch:
	...
	def get_data(self) -> enums.DataSourceA:
		...
		Snippet: value: enums.DataSourceA = driver.source.bb.eutra.dl.mbsfn.ai.mcch.get_data() \n
	...
	def set_data(self, data_source: enums.DataSourceA) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:MBSFn:AI:MCCH:DATA \n
		Snippet: driver.source.bb.eutra.dl.mbsfn.ai.mcch.set_data(data_source = enums.DataSourceA.DLISt) \n
		Sets the data source used for the MCCH. \n
