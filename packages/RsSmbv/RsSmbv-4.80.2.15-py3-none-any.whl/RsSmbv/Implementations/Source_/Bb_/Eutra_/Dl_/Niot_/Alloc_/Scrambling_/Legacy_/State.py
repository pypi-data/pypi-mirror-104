...
class State:
	...
	def set(self, scram_state: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.alloc.scrambling.legacy.state.set(scram_state = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:ALLoc<CH0>:SCRambling:LEGacy:STATe \n
		Snippet: value: bool = driver.source.bb.eutra.dl.niot.alloc.scrambling.legacy.state.get(allocationNull = repcap.AllocationNull.Default) \n
		If disabled, scrambling according to LTE Rel. 14 is applied. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
