...
class Crsseq:
	...
	def set(self, crs_seq_info: enums.NumbersE, carrier=repcap.Carrier.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.carrier.niot.crsseq.set(crs_seq_info = enums.NumbersE._0, carrier = repcap.Carrier.Default) \n
	...
	def get(self, carrier=repcap.Carrier.Default) -> enums.NumbersE:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CARRier<CH>:NIOT:CRSSeq \n
		Snippet: value: enums.NumbersE = driver.source.bb.eutra.dl.carrier.niot.crsseq.get(carrier = repcap.Carrier.Default) \n
		Sets the CRS sequence info. \n
			:param carrier: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Carrier')
