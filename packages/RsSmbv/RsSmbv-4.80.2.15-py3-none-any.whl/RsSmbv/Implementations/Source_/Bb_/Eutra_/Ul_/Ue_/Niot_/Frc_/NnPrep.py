...
class NnPrep:
	...
	def set(self, no_npusch_rep: enums.EutraUlNoNpuschrEpNbIoTaLl, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.niot.frc.nnPrep.set(no_npusch_rep = enums.EutraUlNoNpuschrEpNbIoTaLl._1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraUlNoNpuschrEpNbIoTaLl:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:FRC:NNPRep \n
		Snippet: value: enums.EutraUlNoNpuschrEpNbIoTaLl = driver.source.bb.eutra.ul.ue.niot.frc.nnPrep.get(userEquipment = repcap.UserEquipment.Default) \n
		Queries the number of NPUSCH repetitions. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
