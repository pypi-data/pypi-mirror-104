...
class Rmc:
	...
	def set(self, rmc: enums.EutraSlV2XrMc, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.rmc.rmc.set(rmc = enums.EutraSlV2XrMc.R821, userEquipment = repcap.UserEquipment.Default) \n
		Selects the RMC. \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraSlV2XrMc:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:RMC:RMC \n
		Snippet: value: enums.EutraSlV2XrMc = driver.source.bb.eutra.ul.ue.sl.rmc.rmc.get(userEquipment = repcap.UserEquipment.Default) \n
		Selects the RMC. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
