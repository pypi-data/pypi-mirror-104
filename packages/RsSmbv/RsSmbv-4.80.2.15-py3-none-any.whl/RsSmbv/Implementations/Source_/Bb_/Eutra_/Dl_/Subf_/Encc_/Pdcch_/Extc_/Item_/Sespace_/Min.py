...
class Min:
	...
	def get(self, subframeNull=repcap.SubframeNull.Default, itemNull=repcap.ItemNull.Default) -> int:
		...
		Snippet: value: int = driver.source.bb.eutra.dl.subf.encc.pdcch.extc.item.sespace.min.get(subframeNull = repcap.SubframeNull.Default, itemNull = repcap.ItemNull.Default) \n
