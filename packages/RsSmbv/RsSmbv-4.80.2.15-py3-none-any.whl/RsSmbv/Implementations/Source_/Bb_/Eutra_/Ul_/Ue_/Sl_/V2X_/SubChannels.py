...
class SubChannels:
	...
	def set(self, num_subchannels: enums.EutraSlV2XnUmSubchannels, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.sl.v2X.subChannels.set(num_subchannels = enums.EutraSlV2XnUmSubchannels._1, userEquipment = repcap.UserEquipment.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> enums.EutraSlV2XnUmSubchannels:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:SL:V2X:SUBChannels \n
		Snippet: value: enums.EutraSlV2XnUmSubchannels = driver.source.bb.eutra.ul.ue.sl.v2X.subChannels.get(userEquipment = repcap.UserEquipment.Default) \n
		Sets the number of subchannels. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
