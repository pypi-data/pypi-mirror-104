...
class Scid:
	...
	def set(self, scrambling_id: int, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.csis.cell.scid.set(scrambling_id = 1, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, cellNull=repcap.CellNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CSIS:[CELL<CH0>]:SCID \n
		Snippet: value: int = driver.source.bb.eutra.dl.csis.cell.scid.get(cellNull = repcap.CellNull.Default) \n
		Sets the additional scrambling identity n_ID used to generate the NonZeroTxPower CSI-RS. \n
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
