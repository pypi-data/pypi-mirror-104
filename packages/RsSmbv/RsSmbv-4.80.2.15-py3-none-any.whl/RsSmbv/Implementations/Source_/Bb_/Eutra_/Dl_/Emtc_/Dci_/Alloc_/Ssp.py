...
class Ssp:
	...
	def set(self, dci_search_space: enums.EutraSearchSpaceEmtc, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.ssp.set(dci_search_space = enums.EutraSearchSpaceEmtc.T0CM, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> enums.EutraSearchSpaceEmtc:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:SSP \n
		Snippet: value: enums.EutraSearchSpaceEmtc = driver.source.bb.eutra.dl.emtc.dci.alloc.ssp.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the search space for the selected DCI. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
