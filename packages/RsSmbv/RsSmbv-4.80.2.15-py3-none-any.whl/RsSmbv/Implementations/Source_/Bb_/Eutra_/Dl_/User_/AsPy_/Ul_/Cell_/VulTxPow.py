...
class VulTxPow:
	...
	def set(self, vary_ul_tx_pow: bool, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.user.asPy.ul.cell.vulTxPow.set(vary_ul_tx_pow = False, userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
	...
	def get(self, userIx=repcap.UserIx.Default, cellNull=repcap.CellNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:USER<CH>:AS:UL:CELL<ST0>:VULTxpow \n
		Snippet: value: bool = driver.source.bb.eutra.dl.user.asPy.ul.cell.vulTxPow.get(userIx = repcap.UserIx.Default, cellNull = repcap.CellNull.Default) \n
		Enables variation of the UL Tx power. \n
			:param userIx: optional repeated capability selector. Default value: Nr1 (settable in the interface 'User')
			:param cellNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Cell')
