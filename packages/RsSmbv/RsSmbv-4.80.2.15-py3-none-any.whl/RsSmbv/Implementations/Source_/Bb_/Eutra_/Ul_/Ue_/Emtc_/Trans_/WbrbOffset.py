...
class WbrbOffset:
	...
	def set(self, wide_band_rb_offs: enums.EutraEmtcVrbOffs, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:EMTC:TRANs<CH>:WBRBoffset \n
		Snippet: driver.source.bb.eutra.ul.ue.emtc.trans.wbrbOffset.set(wide_band_rb_offs = enums.EutraEmtcVrbOffs.OS0, userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default, transmission=repcap.Transmission.Default) -> enums.EutraEmtcVrbOffs:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:EMTC:TRANs<CH>:WBRBoffset \n
		Snippet: value: enums.EutraEmtcVrbOffs = driver.source.bb.eutra.ul.ue.emtc.trans.wbrbOffset.get(userEquipment = repcap.UserEquipment.Default, transmission = repcap.Transmission.Default) \n
		Shifts the selected number of resource blocks within the wideband. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
			:param transmission: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Trans')
