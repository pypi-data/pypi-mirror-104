...
class Idelay:
	...
	def set(self, sched_delay: int, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.niot.dci.alloc.idelay.set(sched_delay = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:NIOT:DCI:ALLoc<CH0>:IDELay \n
		Snippet: value: int = driver.source.bb.eutra.dl.niot.dci.alloc.idelay.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field scheduling delay field (IDelay) . \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
