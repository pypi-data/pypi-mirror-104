...
class Ndind:
	...
	def set(self, dci_new_data_ind: bool, allocationNull=repcap.AllocationNull.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.ndind.set(dci_new_data_ind = False, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:NDINd \n
		Snippet: value: bool = driver.source.bb.eutra.dl.emtc.dci.alloc.ndind.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field new data indicator. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
