...
class PraPreamble:
	...
	def set(self, dci_prach_preambl: int, allocationNull=repcap.AllocationNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:PRAPreamble \n
		Snippet: driver.source.bb.eutra.dl.emtc.dci.alloc.praPreamble.set(dci_prach_preambl = 1, allocationNull = repcap.AllocationNull.Default) \n
	...
	def get(self, allocationNull=repcap.AllocationNull.Default) -> int:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:EMTC:DCI:ALLoc<CH0>:PRAPreamble \n
		Snippet: value: int = driver.source.bb.eutra.dl.emtc.dci.alloc.praPreamble.get(allocationNull = repcap.AllocationNull.Default) \n
		Sets the DCI field preamble index. \n
			:param allocationNull: optional repeated capability selector. Default value: Nr0 (settable in the interface 'Alloc')
