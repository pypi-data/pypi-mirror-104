...
class State:
	...
	def set(self, state: bool, userEquipment=repcap.UserEquipment.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.ul.ue.niot.frc.state.set(state = False, userEquipment = repcap.UserEquipment.Default) \n
		Enables the FRC. \n
	...
	def get(self, userEquipment=repcap.UserEquipment.Default) -> bool:
		"""SCPI: [SOURce<HW>]:BB:EUTRa:UL:UE<ST>:NIOT:FRC:STATe \n
		Snippet: value: bool = driver.source.bb.eutra.ul.ue.niot.frc.state.get(userEquipment = repcap.UserEquipment.Default) \n
		Enables the FRC. \n
			:param userEquipment: optional repeated capability selector. Default value: Nr1 (settable in the interface 'Ue')
