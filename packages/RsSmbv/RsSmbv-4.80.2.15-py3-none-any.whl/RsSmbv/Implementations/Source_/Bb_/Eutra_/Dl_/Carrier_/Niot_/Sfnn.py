...
class Sfnn:
	...
	def set(self, carrier=repcap.Carrier.Default) -> None:
		...
		Snippet: driver.source.bb.eutra.dl.carrier.niot.sfnn.set(carrier = repcap.Carrier.Default) \n
	...
	def set_with_opc(self, carrier=repcap.Carrier.Default) -> None:
		carrier_cmd_val = self._base.get_repcap_cmd_value(carrier, repcap.Carrier)
		"""SCPI: [SOURce<HW>]:BB:EUTRa:DL:CARRier<CH>:NIOT:SFNN \n
		Snippet: driver.source.bb.eutra.dl.carrier.niot.sfnn.set_with_opc(carrier = repcap.Carrier.Default) \n
		Sets all SFs to invalid. \n
