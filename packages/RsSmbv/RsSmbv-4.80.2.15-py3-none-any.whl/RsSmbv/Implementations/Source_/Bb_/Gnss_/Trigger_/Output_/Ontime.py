...
class Ontime:
	...
	def set(self, on_time: float, output=repcap.Output.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:TRIGger:OUTPut<CH>:ONTime \n
		Snippet: driver.source.bb.gnss.trigger.output.ontime.set(on_time = 1.0, output = repcap.Output.Default) \n
		Sets the number of chips during which the marker output is on or off. \n
			:param on_time: float Range: 0.000000011 to 0.1822215935
