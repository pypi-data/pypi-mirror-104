...
class Behaviour:
	...
	def set(self, atitude_behaviou: enums.AttitMode, vehicle=repcap.Vehicle.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:RECeiver:[V<ST>]:ATTitude:[BEHaviour] \n
		Snippet: driver.source.bb.gnss.receiver.v.attitude.behaviour.set(atitude_behaviou = enums.AttitMode.CONStant, vehicle = repcap.Vehicle.Default) \n
