...
class Gps:
	"""Gps commands group definition. 4 total commands, 0 Sub-groups, 4 group commands"""
	...
	def set_max(self, maximum_sv_s: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:GPS:MAX \n
		Snippet: driver.source.bb.gnss.sv.selection.gps.set_max(maximum_sv_s = 1) \n
		Sets the minimum and maximum number of satellites per GNSS system that can be included in the satellite constellation. \n
	...
	def set_min(self, minimum_sv_s: int) -> None:
		"""SCPI: [SOURce<HW>]:BB:GNSS:SV:SELection:GPS:MIN \n
		Snippet: driver.source.bb.gnss.sv.selection.gps.set_min(minimum_sv_s = 1) \n
		Sets the minimum and maximum number of satellites per GNSS system that can be included in the satellite constellation. \n
