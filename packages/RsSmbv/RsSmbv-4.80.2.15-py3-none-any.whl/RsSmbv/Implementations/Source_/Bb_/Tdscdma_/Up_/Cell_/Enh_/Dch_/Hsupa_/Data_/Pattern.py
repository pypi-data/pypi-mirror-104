...
class Pattern:
	...
	def set(self, structure: PatternStruct, cell=repcap.Cell.Default) -> None:
		...
		Snippet: driver.source.bb.tdscdma.up.cell.enh.dch.hsupa.data.pattern.set(value = [PROPERTY_STRUCT_NAME](), cell = repcap.Cell.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:TDSCdma:UP:CELL{cell_cmd_val}:ENH:DCH:HSUPA:DATA:PATTern', structure)
