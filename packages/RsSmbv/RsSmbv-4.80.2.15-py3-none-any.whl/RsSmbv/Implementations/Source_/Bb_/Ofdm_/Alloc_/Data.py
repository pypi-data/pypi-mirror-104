...
class Data:
	...
	def set(self, datasource: enums.C5Gds, allocationNull=repcap.AllocationNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:OFDM:ALLoc<CH0>:DATA \n
		Snippet: driver.source.bb.ofdm.alloc.data.set(datasource = enums.C5Gds.DLISt, allocationNull = repcap.AllocationNull.Default) \n
