...
class Data:
	...
	def set(self, datasource: enums.DataSourceA, userNull=repcap.UserNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:OFDM:USER<CH0>:DATA \n
		Snippet: driver.source.bb.ofdm.user.data.set(datasource = enums.DataSourceA.DLISt, userNull = repcap.UserNull.Default) \n
		...
		param = Conversions.enum_scalar_to_str(datasource, enums.DataSourceA)
