...
class Windex:
	...
	def set(self, wi_ndex: enums.NumbersG, baseStation=repcap.BaseStation.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:C2K:BSTation<ST>:PDCHannel:WINDex \n
		Snippet: driver.source.bb.c2K.bstation.pdChannel.windex.set(wi_ndex = enums.NumbersG._0, baseStation = repcap.BaseStation.Default) \n
