...
class Toffset:
	...
	def set(self, to_ffset: int, baseStation=repcap.BaseStation.Default, subpacket=repcap.Subpacket.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:C2K:BSTation<ST>:PDCHannel:SUBPacket<DI>:TOFFset \n
		Snippet: driver.source.bb.c2K.bstation.pdChannel.subPacket.toffset.set(to_ffset = 1, baseStation = repcap.BaseStation.Default, subpacket = repcap.Subpacket.Default) \n
