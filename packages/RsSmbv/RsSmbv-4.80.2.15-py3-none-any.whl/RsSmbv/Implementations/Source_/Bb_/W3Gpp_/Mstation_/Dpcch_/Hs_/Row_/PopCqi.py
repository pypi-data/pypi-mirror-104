...
class PopCqi:
	...
	def set(self, po_pcqi: float, mobileStation=repcap.MobileStation.Default, rowNull=repcap.RowNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:MSTation<ST>:DPCCh:HS:ROW<CH0>:POPCqi \n
		Snippet: driver.source.bb.w3Gpp.mstation.dpcch.hs.row.popCqi.set(po_pcqi = 1.0, mobileStation = repcap.MobileStation.Default, rowNull = repcap.RowNull.Default) \n
