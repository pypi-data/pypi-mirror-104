...
class MiSuse:
	...
	def set(self, mis_use: bool, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:CHANnel<CH0>:DPCCh:TPC:MISuse \n
		Snippet: driver.source.bb.w3Gpp.bstation.channel.dpcch.tpc.miSuse.set(mis_use = False, baseStation = repcap.BaseStation.Default, channelNull = repcap.ChannelNull.Default) \n
