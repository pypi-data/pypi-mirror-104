...
class Ueid:
	...
	def set(self, ueid: int, baseStation=repcap.BaseStation.Default, channelNull=repcap.ChannelNull.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:W3GPp:BSTation<ST>:CHANnel<CH0>:HSDPa:HSET:UEID \n
		Snippet: driver.source.bb.w3Gpp.bstation.channel.hsdpa.hset.ueid.set(ueid = 1, baseStation = repcap.BaseStation.Default, channelNull = repcap.ChannelNull.Default) \n
