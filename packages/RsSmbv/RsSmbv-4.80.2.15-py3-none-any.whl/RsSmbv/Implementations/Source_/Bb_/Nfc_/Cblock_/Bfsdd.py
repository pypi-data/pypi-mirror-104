...
class Bfsdd:
	...
	def set(self, bf_sdd: enums.NfcBitFrmSdd, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:BFSDd \n
		Snippet: driver.source.bb.nfc.cblock.bfsdd.set(bf_sdd = enums.NfcBitFrmSdd.SDD0, commandBlock = repcap.CommandBlock.Default) \n
