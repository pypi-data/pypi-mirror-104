...
class Mtr1:
	...
	def set(self, mtr_1: enums.NfcMinTr1, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:MTR1 \n
		Snippet: driver.source.bb.nfc.cblock.mtr1.set(mtr_1 = enums.NfcMinTr1.TR10, commandBlock = repcap.CommandBlock.Default) \n
