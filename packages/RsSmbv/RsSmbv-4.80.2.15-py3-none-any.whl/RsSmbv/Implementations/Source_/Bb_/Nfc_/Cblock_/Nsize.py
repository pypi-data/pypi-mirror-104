...
class Nsize:
	...
	def set(self, nfcid_1_sz: enums.NfcNfcid1Sz, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:NSIZe \n
		Snippet: driver.source.bb.nfc.cblock.nsize.set(nfcid_1_sz = enums.NfcNfcid1Sz.DOUBle, commandBlock = repcap.CommandBlock.Default) \n
