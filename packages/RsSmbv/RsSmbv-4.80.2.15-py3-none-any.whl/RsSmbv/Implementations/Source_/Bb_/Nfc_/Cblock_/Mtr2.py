...
class Mtr2:
	...
	def set(self, mtr_2: enums.NfcMinTr2, commandBlock=repcap.CommandBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:NFC:CBLock<CH>:MTR2 \n
		Snippet: driver.source.bb.nfc.cblock.mtr2.set(mtr_2 = enums.NfcMinTr2.TR20, commandBlock = repcap.CommandBlock.Default) \n
