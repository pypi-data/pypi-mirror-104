...
class Pattern:
	...
	def set(self, structure: PatternStruct, vdbTransmitter=repcap.VdbTransmitter.Default) -> None:
		...
		Snippet: driver.source.bb.gbas.vdb.data.pattern.set(value = [PROPERTY_STRUCT_NAME](), vdbTransmitter = repcap.VdbTransmitter.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:GBAS:VDB{vdbTransmitter_cmd_val}:DATA:PATTern', structure)
