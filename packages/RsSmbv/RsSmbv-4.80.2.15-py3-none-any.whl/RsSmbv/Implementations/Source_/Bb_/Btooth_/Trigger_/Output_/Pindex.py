...
class Pindex:
	...
	def set(self, pi_ndex: int, output=repcap.Output.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:BTOoth:TRIGger:OUTPut<CH>:PINDex \n
		Snippet: driver.source.bb.btooth.trigger.output.pindex.set(pi_ndex = 1, output = repcap.Output.Default) \n
