...
class IaWindow:
	...
	def set(self, iawindow: List[str], frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:BFConfiguration:IAWindow \n
		Snippet: driver.source.bb.wlnn.fblock.bfConfiguration.iaWindow.set(iawindow = ['raw1', 'raw2', 'raw3'], frameBlock = repcap.FrameBlock.Default) \n
