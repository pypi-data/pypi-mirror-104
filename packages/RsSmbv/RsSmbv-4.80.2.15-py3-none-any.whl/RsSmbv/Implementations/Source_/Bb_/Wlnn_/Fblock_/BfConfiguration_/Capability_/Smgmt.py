...
class Smgmt:
	...
	def set(self, smg_mt: bool, frameBlock=repcap.FrameBlock.Default) -> None:
		"""SCPI: [SOURce<HW>]:BB:WLNN:FBLock<CH>:BFConfiguration:CAPability:SMGMt \n
		Snippet: driver.source.bb.wlnn.fblock.bfConfiguration.capability.smgmt.set(smg_mt = False, frameBlock = repcap.FrameBlock.Default) \n
