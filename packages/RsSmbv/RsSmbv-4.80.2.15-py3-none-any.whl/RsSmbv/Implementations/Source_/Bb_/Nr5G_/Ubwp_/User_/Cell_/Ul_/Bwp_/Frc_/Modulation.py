...
class Modulation:
	...
	def get(self, userNull=repcap.UserNull.Default, cellNull=repcap.CellNull.Default, bwPartNull=repcap.BwPartNull.Default) -> enums.ModType:
		...
		Snippet: value: enums.ModType = driver.source.bb.nr5G.ubwp.user.cell.ul.bwp.frc.modulation.get(userNull = repcap.UserNull.Default, cellNull = repcap.CellNull.Default, bwPartNull = repcap.BwPartNull.Default) \n
