...
class Pattern:
	...
	def set(self, structure: PatternStruct, cellNull=repcap.CellNull.Nr0, ssPbchNull=repcap.SsPbchNull.Default) -> None:
		...
		Snippet: driver.source.bb.nr5G.node.cell.sspbch.position.pattern.set(value = [PROPERTY_STRUCT_NAME](), cellNull = repcap.CellNull.Nr0, ssPbchNull = repcap.SsPbchNull.Default) \n
		...
		self._core.io.write_struct(f'SOURce<HwInstance>:BB:NR5G:NODE:CELL{cellNull_cmd_val}:SSPBch{ssPbchNull_cmd_val}:POSition:PATTern', structure)
