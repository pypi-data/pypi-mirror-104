...
class Browser(webdriver.Chrome):
    ...
    def __init__(self, hide=True, clean=True, pictures=False, **kwargs):
        ...
        if not pictures:
            Browser = webdriver.Chrome(options=self.__options, service_args=['--silent'], desired_capabilities=self.__caps)
        else:
            Browser = webdriver.Chrome(service_args=['--silent'], desired_capabilities=self.__caps)
