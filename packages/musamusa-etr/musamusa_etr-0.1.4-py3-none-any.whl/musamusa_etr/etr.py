...
# DEFAULT_PARSINGTOOLS is the default value of ETR.parsingtools
#
...
# (pimydoc)ETR.options
# ⋅ETR.options is a dict(str:None|bool|func) describing what to when reading/writing.
# ⋅
# ⋅
...
class ETR:
    ...
    def __init__(self,
        ...
        """
            ...
            o (None/dict)parsingtools, a dict of regexes and list of
              ...
              parsingtools is an update of DEFAULT_PARSINGTOOLS, i.e. <parsingtools>
              may contain only one value which will modify the copy of DEFAULT_PARSINGTOOLS.

              Default parsingtools are defined in the DEFAULT_PARSINGTOOLS variable.
              See DEFAULT_PARSINGTOOLS initialization to understant <parsingtools>
              format.
        ...
        if parsingtools:
            self.parsingtools.update(parsingtools)
    ...
    def initialize_parsingtools_with_reasonable_values(self):
        """
            ...
            Wrapper around:
                self.parsingtools = copy.deepcopy(DEFAULT_PARSINGTOOLS)
