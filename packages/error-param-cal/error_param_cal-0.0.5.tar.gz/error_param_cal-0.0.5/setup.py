...
setup(
    ...
    url="https://github.com/SuhasVS95/Hypothesis_Testing_Error_parameters_Calculator",
    license="MIT",
    keywords=['python', 'sample_size', 'Type I Error', 'Type II Error',"False Positive","False Negative","Power of Test"],
    classifiers=[
