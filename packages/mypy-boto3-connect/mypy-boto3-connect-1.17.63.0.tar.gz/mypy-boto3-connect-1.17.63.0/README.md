...
[boto3.Connect 1.17.63](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/connect.html#Connect) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_connect/README.md)
...
def check_value(value: Channel) -> bool:
    ...
```
