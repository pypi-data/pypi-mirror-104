...
class Ui_TrackerWindow(object):
    def setupUi(self, TrackerWindow):
        ...
        self.tab_widget.setMinimumSize(QSize(290, 0))
        self.tab_widget.setMaximumSize(QSize(320, 16777215))
        ...
        sizePolicy1.setHeightForWidth(self.pickups_scroll_area.sizePolicy().hasHeightForWidth())
        self.pickups_scroll_area.setSizePolicy(sizePolicy1)
        ...
        self.pickups_scroll_contents.setGeometry(QRect(0, 0, 285, 409))
        ...
        sizePolicy1.setHeightForWidth(self.elevators_scroll_area.sizePolicy().hasHeightForWidth())
        self.elevators_scroll_area.setSizePolicy(sizePolicy1)
        ...
        self.elevators_scroll_contents = QWidget()
        self.elevators_scroll_contents.setObjectName(u"elevators_scroll_contents")
        self.elevators_scroll_contents.setGeometry(QRect(0, 0, 285, 409))
        self.elevators_scroll_layout = QVBoxLayout(self.elevators_scroll_contents)
        self.elevators_scroll_layout.setSpacing(6)
        self.elevators_scroll_layout.setContentsMargins(11, 11, 11, 11)
        self.elevators_scroll_layout.setObjectName(u"elevators_scroll_layout")
        self.elevators_scroll_layout.setContentsMargins(0, 0, 0, 0)
        self.elevators_scroll_area.setWidget(self.elevators_scroll_contents)
        ...
        self.translator_gate_scroll_contents.setGeometry(QRect(0, 0, 314, 407))
        ...
        self.graph_map_world_combo = QComboBox(self.tab_graph_map)
        self.graph_map_world_combo.setObjectName(u"graph_map_world_combo")

        self.tab_graph_map_layout.addWidget(self.graph_map_world_combo)
        ...
        sizePolicy2.setHeightForWidth(self.actions_title_label.sizePolicy().hasHeightForWidth())
        self.actions_title_label.setSizePolicy(sizePolicy2)
