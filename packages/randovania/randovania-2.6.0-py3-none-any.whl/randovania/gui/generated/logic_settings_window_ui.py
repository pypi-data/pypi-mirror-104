...
class Ui_LogicSettingsWindow(object):
    def setupUi(self, LogicSettingsWindow):
        ...
        self.excluded_locations_area_contents.setGeometry(QRect(0, 0, 745, 358))
        ...
        self.elevator_parent_layout = QVBoxLayout(self.elevator_tab)
        ...
        self.elevator_scroll_area = QScrollArea(self.elevator_tab)
        ...
        self.elevator_scroll_area_contents.setGeometry(QRect(0, -20, 741, 643))
        ...
        self.elevators_combo = QComboBox(self.elevator_scroll_area_contents)
