...
class Ui_EchoesUserPreferencesDialog(object):
    ...
    def retranslateUi(self, EchoesUserPreferencesDialog):
        ...
        self.unvisited_room_names_check.setText(QCoreApplication.translate("EchoesUserPreferencesDialog", u"Always display room names on map", None))
        self.elevator_sound_check.setText(QCoreApplication.translate("EchoesUserPreferencesDialog", u"Keep Elevator/Teleporter transition sound effect", None))
