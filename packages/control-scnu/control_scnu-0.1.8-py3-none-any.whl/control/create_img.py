...
def getfont():
    ...
    fontpath='/home/pi/class/fonts/'+font[0]+'.ttf'
    # print(fontpath)
    return fontpath
...
#随机位置
def getlocation():
    location=(random.randint(0,image_size-fontsize),random.randint(0,image_size-fontsize))
    # print(location)
    return (location)
...
'''
#生成数字图像
creat_number_img(10,'C:/Users/HP/Desktop/captcha')
'''