...
[boto3.Route53Domains 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/route53domains.html#Route53Domains) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_route53domains/README.md)
...
`mypy_boto3_route53domains.literals` module contains literals extracted from shapes
...
def check_value(value: ContactType) -> bool:
    ...
```
