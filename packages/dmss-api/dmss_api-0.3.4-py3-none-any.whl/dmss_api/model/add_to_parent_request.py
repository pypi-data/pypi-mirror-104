...
class AddToParentRequest(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, type, parent_id, attribute, *args, **kwargs):  # noqa: E501
        """AddToParentRequest - a model defined in OpenAPI
