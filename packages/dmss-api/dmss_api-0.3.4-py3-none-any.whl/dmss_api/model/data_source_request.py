...
class DataSourceRequest(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            'name': (str,),  # noqa: E501
            'repositories': ({str: (Repository,)},),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, name, repositories, *args, **kwargs):  # noqa: E501
        """DataSourceRequest - a model defined in OpenAPI
