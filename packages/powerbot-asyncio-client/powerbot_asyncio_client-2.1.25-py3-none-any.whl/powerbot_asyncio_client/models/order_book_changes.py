...
class OrderBookChanges(object):
    ...
    def __init__(self, message_class=None, emitted_at=None, contract_id=None, contract_type=None, delivery_area=None, active_since=None, revision=None, sequence_number=None, delta=None, orders=None):  # noqa: E501
        """OrderBookChanges - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(OrderBookChanges, dict):
