...
class ReportApi(object):
    ...
    def get_report_for_period_with_http_info(self, delivery_area, delivery_day_from, delivery_day_to, **kwargs):  # noqa: E501
        ...
        if 'delivery_day_from_starting_hour' in params and params['delivery_day_from_starting_hour'] > 23:  # noqa: E501
            raise ValueError("Invalid value for parameter `delivery_day_from_starting_hour` when calling `get_report_for_period`, must be a value less than or equal to `23`")  # noqa: E501
        if 'delivery_day_from_starting_hour' in params and params['delivery_day_from_starting_hour'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `delivery_day_from_starting_hour` when calling `get_report_for_period`, must be a value greater than or equal to `0`")  # noqa: E501
        if 'delivery_day_to_ending_hour' in params and params['delivery_day_to_ending_hour'] > 23:  # noqa: E501
            raise ValueError("Invalid value for parameter `delivery_day_to_ending_hour` when calling `get_report_for_period`, must be a value less than or equal to `23`")  # noqa: E501
        if 'delivery_day_to_ending_hour' in params and params['delivery_day_to_ending_hour'] < 0:  # noqa: E501
            raise ValueError("Invalid value for parameter `delivery_day_to_ending_hour` when calling `get_report_for_period`, must be a value greater than or equal to `0`")  # noqa: E501
        collection_formats = {}
