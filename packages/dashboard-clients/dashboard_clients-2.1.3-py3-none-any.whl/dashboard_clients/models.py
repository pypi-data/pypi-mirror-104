...
class TileType(enum.Enum):
    ...
    Subheading = 14  # A tile which displays a subheading
    CohortPreviewDetails = 15  # A tile which shows information about a cohort preview including it's size and name
    CohortPreviewGenderBreakdown = 16  # A tile which shows the gender breakdown for a cohort preview
    CohortPreviewAgeBreakdown = 17  # A tile which shows the age breakdown for a cohort preview
    CohortPreviewGenderAgeBreakdown = 18  # A tile which shows the age range and gender combination breakdown for a cohort preview
    CohortPreviewEventDistribution = 19  # A tile which shows the stack event distribution for a cohort preview
    CohortPreviewGeographicBreakdown = 20  # A tile which shows the geographic breakdown for a cohort preview
