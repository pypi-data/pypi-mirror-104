...
[boto3.CodeBuild 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/codebuild.html#CodeBuild) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_codebuild/README.md)
...
def check_value(value: ArtifactNamespace) -> bool:
    ...
```
...
def get_structure() -> BatchDeleteBuildsOutputTypeDef:
    return {
      ...
    }
```
