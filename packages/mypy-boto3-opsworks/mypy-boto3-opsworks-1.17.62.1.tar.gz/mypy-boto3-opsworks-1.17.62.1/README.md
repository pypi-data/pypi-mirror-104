...
[boto3.OpsWorks 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/opsworks.html#OpsWorks) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_opsworks/README.md)
...
def check_value(value: AppAttributesKeys) -> bool:
    ...
```
