...
class DescribeEcsClustersPaginator(Boto3Paginator):
    """
    [Paginator.DescribeEcsClusters documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/opsworks.html#OpsWorks.Paginator.DescribeEcsClusters)
    """
    ...
    def paginate(
        ...
        """
        [DescribeEcsClusters.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/opsworks.html#OpsWorks.Paginator.DescribeEcsClusters.paginate)
        """
