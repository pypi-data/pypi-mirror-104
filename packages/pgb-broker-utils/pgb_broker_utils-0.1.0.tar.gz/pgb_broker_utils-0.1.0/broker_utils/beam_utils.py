#!/usr/bin/env python3
# -*- coding: UTF-8 -*-
"""The ``beam_utils`` module contains common functions used by the broker in
Apache Beam jobs.
"""
...
class StripCutouts(DoFn):
    ...
    def process(self, alertDict):
        cutouts = [
            self.schema_map['cutoutScience'],
            self.schema_map['cutoutTemplate'],
            self.schema_map['cutoutDifference']
        ]
