...
from gihadocs.commands.build import build
from gihadocs.config import load_config
...
def _init_asyncio_patch():
    ...
    As Tornado has decided to leave this to users to set, GiHaDocs needs
...
def serve(config_file=None, dev_addr=None, strict=None, theme=None,
    ...
    """
    Start the GiHaDocs development server
    ...
    # string is returned. And it makes GiHaDocs temp dirs easier to identify.
    site_dir = tempfile.mkdtemp(prefix='gihadocs_')
