...
DEFAULT_SCHEMA = (
    ...
    # Reserved for internal use, stores the gihadocs.yml config file.
    ...
    # The GiHaDocs theme for the documentation.
    ('theme', config_options.Theme(default='gihadocs')),
    ...
    # this should look like, ['UA-27795084-5', 'gihadocs.org']
    ...
    # enabling strict mode causes GiHaDocs to stop the build when a problem is
    ...
    # GiHaDocs itself. A good example here would be including the current
    # project version.
