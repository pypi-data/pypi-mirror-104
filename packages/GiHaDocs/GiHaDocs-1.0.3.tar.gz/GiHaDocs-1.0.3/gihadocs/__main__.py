...
from gihadocs import __version__                            # noqa: E402
from gihadocs import utils                                  # noqa: E402
from gihadocs import exceptions                             # noqa: E402
from gihadocs import config                                 # noqa: E402
from gihadocs.commands import build, gh_deploy, new, serve  # noqa: E402
...
class State:
    ...
    def __init__(self, log_name='gihadocs', level=logging.INFO):
...
config_help = "Provide a specific GiHaDocs config"
dev_addr_help = ("IP address and port to serve documentation locally (default: "
                 "localhost:1106)")
strict_help = ("Enable strict mode. This will cause GiHaDocs to abort the build "
               "on any warnings.")
...
commit_message_help = ("A commit message to use when committing to the "
                       "Github Pages remote branch. Commit {sha} and GiHaDocs {version} are available as expansions")
...
ignore_version_help = "Ignore check that build is not being deployed with an older version of GiHaDocs."
...
def cli():
    """
    GiHaDocs - Project documentation with Markdown.
    """
...
def build_command(clean, **kwargs):
    """Build the GiHaDocs documentation"""
