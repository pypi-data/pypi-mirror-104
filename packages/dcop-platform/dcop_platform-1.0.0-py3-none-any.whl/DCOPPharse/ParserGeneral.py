...
class ParserGeneral:
    ...
    def parseContent(self,problem):
        ...
        if self.parseRelations(self.root.find('relations'),problem) == False:
    ...
    def parseConstraints(self,element,problem,variableNameAgentIds):
        ...
        for i in range(0,nbConstraints):
            ...
            leftAgentId = variableNameAgentIds[constraintedParts[0]]
            rightAgentId = variableNameAgentIds[constraintedParts[1]]
