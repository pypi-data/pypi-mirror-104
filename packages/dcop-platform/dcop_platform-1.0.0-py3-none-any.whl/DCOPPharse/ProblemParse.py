...
class ProblemParser:
    ...
    def generateCommunicationStructure(self,problem):
        ...
        ACO蚁群算法，本平台暂时不涉及
        '''
        # varOrdering =  PriorityGeneration(problem.neighbourAgents)
        # varOrdering.setRootHeuristics(MostConnectedHeuristic(problem))
        # varOrdering.setNextNodeHeuristics(MostConnectedHeuristic(problem))
...
if __name__ == '__main__':
    parser=ProblemParser('C:\\Users\\Klaus\\Desktop\\DCOP\\RandomDCOP_10_10_1.xml', "DFS")
