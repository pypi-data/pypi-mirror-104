...
[boto3.GlueDataBrew 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/databrew.html#GlueDataBrew) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_databrew/README.md)
...
def check_value(value: CompressionFormat) -> bool:
    ...
```
...
def get_structure() -> BatchDeleteRecipeVersionResponseTypeDef:
    return {
      ...
    }
```
