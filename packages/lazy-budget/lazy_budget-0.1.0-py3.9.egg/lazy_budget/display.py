...
class BasicStatsDisplay(BaseBudgetStatsDisplay):
    def get_display_data(self):
        data = {
            ...
            "available / day": format_money(self.budget_stats.available_per_day, locale=self.locale),
            "can spend today": format_money(self.budget_stats.can_spend_today, locale=self.locale),
        }
        ...
        data.update({
            "spent today": format_money(self.budget_stats.spent_today, locale=self.locale),
            "avg spent / day": format_money(self.budget_stats.avg_spent_per_day, locale=self.locale),
            "currently keeping": format_money(self.budget_stats.currently_keeping, locale=self.locale),
        })
        return data
