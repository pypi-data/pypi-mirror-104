...
[boto3.KMS 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/kms.html#KMS) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_kms/README.md)
...
`mypy_boto3_kms.literals` module contains literals extracted from shapes
...
def check_value(value: AlgorithmSpec) -> bool:
    ...
```
