...
f12=Font(os.path.join(DIR,'Werner12-Regular.ttf'),True,False,True,list('.,;:"/ '),1.1)
...
f24=Font(os.path.join(DIR,'Werner18-Regular.ttf'),True,True,False,list(' +%,./()[]:;'),1.3)
f25=Font(os.path.join(DIR,'mathilde.regular.otf'),False,False,True,list(' +%,.-/()[]:;'),1.1)
f26=Font(os.path.join(DIR,'Werner_new1-Regular.ttf'),True,True,False,list(' []'),1.1)
