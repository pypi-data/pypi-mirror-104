...
_RequiredEncryptionConfigurationTypeDef = TypedDict(
    "_RequiredEncryptionConfigurationTypeDef", {"encryptionType": EncryptionType}
)
...
ImageFailureTypeDef = TypedDict(
    "ImageFailureTypeDef",
    {"imageId": "ImageIdentifierTypeDef", "failureCode": ImageFailureCode, "failureReason": str},
    total=False,
)
...
ImageScanStatusTypeDef = TypedDict(
    "ImageScanStatusTypeDef", {"status": ScanStatus, "description": str}, total=False
)
...
LayerFailureTypeDef = TypedDict(
    "LayerFailureTypeDef",
    {"layerDigest": str, "failureCode": LayerFailureCode, "failureReason": str},
    total=False,
)
...
LifecyclePolicyRuleActionTypeDef = TypedDict(
    "LifecyclePolicyRuleActionTypeDef", {"type": ImageActionType}, total=False
)
...
DescribeImagesFilterTypeDef = TypedDict(
    "DescribeImagesFilterTypeDef", {"tagStatus": TagStatus}, total=False
)
...
LifecyclePolicyPreviewFilterTypeDef = TypedDict(
    "LifecyclePolicyPreviewFilterTypeDef", {"tagStatus": TagStatus}, total=False
)

ListImagesFilterTypeDef = TypedDict(
    "ListImagesFilterTypeDef", {"tagStatus": TagStatus}, total=False
)
...
PutImageTagMutabilityResponseTypeDef = TypedDict(
    "PutImageTagMutabilityResponseTypeDef",
    {"registryId": str, "repositoryName": str, "imageTagMutability": ImageTagMutability},
    total=False,
)
