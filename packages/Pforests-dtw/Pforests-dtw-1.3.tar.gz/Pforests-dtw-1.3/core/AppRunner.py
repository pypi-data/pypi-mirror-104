...
params = '/Users/morad/PycharmProjects/PForests/ -name=ElectricDevices -train=/Users/morad/PycharmProjects/PForests/datasets/Chinatown/Chinatown_TRAIN.arff ' \
         '-test=/Users/morad/PycharmProjects/PForests/datasets/Chinatown/Chinatown_TEST.arff -repeat=1 -trees=10 -candidates=5 -targetlast=True ' \
         '-calculate=accuracy '
#scenario.get_args()
