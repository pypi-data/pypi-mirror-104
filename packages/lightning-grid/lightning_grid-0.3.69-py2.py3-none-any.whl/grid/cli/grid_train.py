...
def _print_submission_message(instance_type: str, provider: str, credential_id: str, entrypoint: str, grid_name: str,
                              datastore_name: str, datastore_version: int, datastore_mount_dir: str, use_spot: bool):
...
def train(ctx, script: str, entrypoint: str, config: Optional[Dict], name: Optional[str], credential: Optional[str],
    ...
    _print_submission_message(
        ...
        datastore_version=_grid_config['compute']['train']['datastore_version'],
        datastore_mount_dir=_grid_config['compute']['train']['datastore_mount_dir'],
        use_spot=use_spot,
    )
