...
DEFAULT_REQUIREMENTS = DEFAULT_DATA.joinpath('requirements.txt')
...
def debug(
	...
	app = App(path=app_directory)
	installation_folder = phantom_home.joinpath('apps', f'{app.package_name}_{app.id}')
	PYTHON_PATH_ENTRIES = [
		installation_folder,
...
def main():
	...
	test_parser.add_argument(
		'--app_directory', type=Path, help=app_directory_help, default=Path())
	...
	debug_parser.add_argument(
		'--phantom_home', type=Path, default=Path('/opt/phantom'))
