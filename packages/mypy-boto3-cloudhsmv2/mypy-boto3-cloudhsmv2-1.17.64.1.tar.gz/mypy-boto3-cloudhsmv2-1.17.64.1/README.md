...
[boto3.CloudHSMV2 1.17.64](https://boto3.amazonaws.com/v1/documentation/api/1.17.64/reference/services/cloudhsmv2.html#CloudHSMV2) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_cloudhsmv2/README.md)
...
def check_value(value: BackupPolicy) -> bool:
    ...
```
