...
BackupRetentionPolicyTypeDef = TypedDict(
    "BackupRetentionPolicyTypeDef", {"Type": BackupRetentionType, "Value": str}, total=False
)
...
InitializeClusterResponseTypeDef = TypedDict(
    "InitializeClusterResponseTypeDef", {"State": ClusterState, "StateMessage": str}, total=False
)
