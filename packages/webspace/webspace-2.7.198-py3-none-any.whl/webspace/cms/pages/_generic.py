...
PricingEntry = get_class('cms.blocks.entries', 'PricingEntry')
ReviewEntry = get_class('cms.blocks.entries', 'ReviewEntry')
...
class AGenericPage(Page):
    ...
    page_script = models.TextField(default='', blank=True)
