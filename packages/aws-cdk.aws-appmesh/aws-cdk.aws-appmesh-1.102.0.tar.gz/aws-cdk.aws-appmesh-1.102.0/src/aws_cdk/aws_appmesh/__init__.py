    ...
    class VirtualGatewayClientPolicyTlsProperty:
        def __init__(
            ...
            *,
            ...
            ports: typing.Optional[typing.Union[typing.Sequence[jsii.Number], aws_cdk.core.IResolvable]] = None,
        ) -> None:
            '''
...
class HttpRouteMatch:
    def __init__(
        ...
        *,
        ...
        headers: typing.Optional[typing.Sequence[HttpHeaderMatch]] = None,
