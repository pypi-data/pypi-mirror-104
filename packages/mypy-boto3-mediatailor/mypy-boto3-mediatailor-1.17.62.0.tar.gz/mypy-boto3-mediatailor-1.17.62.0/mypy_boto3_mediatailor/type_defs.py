...
AccessConfigurationTypeDef = TypedDict(
    "AccessConfigurationTypeDef", {"AccessType": AccessType}, total=False
)
...
AvailSuppressionTypeDef = TypedDict(
    "AvailSuppressionTypeDef", {"Mode": Mode, "Value": str}, total=False
)
...
DashConfigurationTypeDef = TypedDict(
    "DashConfigurationTypeDef",
    {"ManifestEndpointPrefix": str, "MpdLocation": str, "OriginManifestType": OriginManifestType},
    total=False,
)
...
DashConfigurationForPutTypeDef = TypedDict(
    "DashConfigurationForPutTypeDef",
    {"MpdLocation": str, "OriginManifestType": OriginManifestType},
    total=False,
)
