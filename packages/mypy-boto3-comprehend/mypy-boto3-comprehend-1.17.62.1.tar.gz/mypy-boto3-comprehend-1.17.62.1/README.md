...
[boto3.Comprehend 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/comprehend.html#Comprehend) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_comprehend/README.md)
...
def check_value(value: DocumentClassifierDataFormat) -> bool:
    ...
```
