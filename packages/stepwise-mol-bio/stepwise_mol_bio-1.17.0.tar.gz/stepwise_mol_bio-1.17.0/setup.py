...
entry_points = \
{'freezerbox.make': ['aliquot = stepwise_mol_bio.aliquot:Aliquot',
                     'digest = stepwise_mol_bio.digest:RestrictionDigest',
                     'inverse-pcr = stepwise_mol_bio.invpcr:InversePcr',
