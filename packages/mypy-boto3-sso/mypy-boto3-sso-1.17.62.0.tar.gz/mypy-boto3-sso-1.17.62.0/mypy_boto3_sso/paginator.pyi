...
class ListAccountRolesPaginator(Boto3Paginator):
    """
    [Paginator.ListAccountRoles documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/sso.html#SSO.Paginator.ListAccountRoles)
    """
    ...
    def paginate(
        ...
        """
        [ListAccountRoles.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/sso.html#SSO.Paginator.ListAccountRoles.paginate)
        """

class ListAccountsPaginator(Boto3Paginator):
    """
    [Paginator.ListAccounts documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/sso.html#SSO.Paginator.ListAccounts)
    """
    ...
    def paginate(
        ...
        """
        [ListAccounts.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/sso.html#SSO.Paginator.ListAccounts.paginate)
        """
