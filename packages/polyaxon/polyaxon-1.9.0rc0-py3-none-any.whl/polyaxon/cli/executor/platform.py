...
def run(
    ...
    if upload:
        ...
        run_meta_info[META_ARTIFACTS_PATHS] = upload_to or DEFAULT_UPLOADS_PATH
        run_meta_info[META_IS_UPLOADING] = True
    ...
    if eager:
        ...
        op_specs = [
            i
            for i in get_eager_matrix_operations(
