...
from polyaxon.metadata.keys import META_ARTIFACTS_PATHS
...
class RunClient:
    ...
    def restart(
        ...
        **kwargs,
        ...
        copy_paths = to_list(copy_paths, check_none=True)
        if copy or copy_paths:
            if copy_paths:
                body.meta_info = {META_ARTIFACTS_PATHS: copy_paths}
