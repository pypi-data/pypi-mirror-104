...
from mypy_boto3_amplify.literals import DomainStatus, JobStatus, JobType, Platform, Stage
...
_RequiredStepTypeDef = TypedDict(
    ...
    {"stepName": str, "startTime": datetime, "status": JobStatus, "endTime": datetime},
)
