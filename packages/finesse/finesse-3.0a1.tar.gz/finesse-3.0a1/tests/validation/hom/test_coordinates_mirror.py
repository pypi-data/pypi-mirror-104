...
def test_mirror_pitch_yaw_mode_content():
    ...
    The beam has a waist at the mirror. The mirror is misaligned
    by a positive pitch/yaw. As we have right-handed coordinates
    for the components, this means the beam is deflected in a
    negative direction in x/y. Or this means that the 10/01 mode
