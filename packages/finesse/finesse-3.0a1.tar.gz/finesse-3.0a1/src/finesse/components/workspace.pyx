...
cdef class ConnectorMatrixSimulationInfo:
    def __init__(self, bint refill, object connections=None, object noise_sources=None):
        self.fn_rhs_c = None
        self.fn_rhs_py = None
...
cdef class ConnectorWorkspace(ElementWorkspace):
    ...
    def __init__(
        ...
        self.sim = sim
        self.carrier = ConnectorMatrixSimulationInfo(carrier_refill, carrier_connections)
        self.signal = ConnectorMatrixSimulationInfo(signal_refill, signal_connections, noise_sources)
