...
class DenseMatrix:
    ...
    Create a matrix with memory views of different submatrices for giving to components:
        ...
        > DM = DenseMatrix("abc")
        >
        > DM.add_diagonal_elements(5, 0, 'a')
        > DM.add_diagonal_elements(5, 1, 'b')
        > DM.add_diagonal_elements(5, 2, 'c')
        > DM.add_diagonal_elements(2, 3, 'd')
        >
        > v1 = DM.get_sub_matrix_view(0, 1, 'b')
        > v2 = DM.get_sub_diagonal_view(0, 2, 'b')
        > v3 = DM.get_sub_matrix_view(3, 1, 'b')
        >
        > DM.construct()
        >
        > v1[:] = 1
    ...
    class SubMatrixView:
        ...
        def __init__(self, Matrix, _from, _to, name, mtype):
            ...
            self._to = _to
            self.type = mtype
            Matrix.add_submatrix(_from, _to, name, self, mtype)
    ...
    def get_sub_matrix_view(self, from_node, to_node, name):
        return DenseMatrix.SubMatrixView(self, from_node, to_node, name, "m")

    def get_sub_diagonal_view(self, from_node, to_node, name):
        return DenseMatrix.SubMatrixView(self, from_node, to_node, name, "d")

    def add_diagonal_elements(self, Neqs, index, name):
    ...
    def add_submatrix(self, _from, _to, name, callback=None, type_="m"):
