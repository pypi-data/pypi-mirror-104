...
class IMUDataProcessing:
    ...
    def joint_rom(df):
        ...
        df_rom = pd.DataFrame({'Flex/Ext_ROM':romRawRoll               ,'Adu/Abd_ROM':romRawPitch               ,'Int/Ext_Rot_ROM':romRawYaw               ,
                               'Flex/Ext_CF_ROM':romRollCF             ,'Adu/Abd_CF_ROM':romPitchCF             ,'Int/Ext_Rot_CF_ROM':romYawCF             ,
                               'Flex/Ext_CF_GD_ROM':romRollCfGd        ,'Adu/Abd_CF_GD_ROM':romPitchCfGd        ,'Int/Ext_Rot_CF_GD_ROM':romYawCfGd        ,
                               'Flex/Ext_CF_GN_ROM':romRollCfGn        ,'Adu/Abd_CF_GN_ROM':romPitchCfGn        ,'Int/Ext_Rot_CF_GN_ROM':romYawCfGn        ,
                               'Flex/Ext_Kalman_GD_ROM':romRollKalmanGd,'Adu/Abd_Kalman_GD_ROM':romPitchKalmanGd,'Int/Ext_Rot_Kalman_GD_ROM':romYawKalmanGd,
                               'Flex/Ext_Kalman_GN_ROM':romRollKalmanGn,'Adu/Abd_Kalman_GN_ROM':romPitchKalmanGn,'Int/Ext_Rot_Kalman_GN_ROM':romYawKalmanGn,
                               'Flex/Ext_Madgwick_ROM':romRollMad      ,'Adu/Abd_Madgwick_ROM':romPitchMad      ,'Int/Ext_Rot_Madgwick_ROM':romYawMad})
