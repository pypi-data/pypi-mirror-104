...
class IMUDataProcessing:
    ...
    def patternIC(all_x, all_y,poly_degree = 1,IC = 1.96,df = True,plot=False,figuresize=(12,9),title='Trajectory IC-95',x_label='Cycle (%)',y_label='Angle (°)',label1='Data 1',label2='Data 2',label3='IC'):
