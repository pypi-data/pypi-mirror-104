...
class IMUDataProcessing:
    ...
    def joint_measures(df_first_joint,df_second_joint,patternRoll=False,patternPitch=False,patternYaw=False,init=0,end=None,freq=75,threshold=None,cycle=2,bias=0,poly_degree=9,IC=1.96):
        ...
        if patternRoll:
            rR,rawRrom = IMUDataProcessing.pattern_extraction(df['Flex/Ext'],df['Time'],threshold=thre[0], bias=bias, cycle=cycle);
            ...
            CFR,CFRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF'],df['Time'],threshold=thre[3], bias=bias, cycle=cycle);
            ...
            CFGDR,CFGDRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF_GD'],df['Time'],threshold=thre[6], bias=bias, cycle=cycle);
            ...
            CFGNR,CFGNRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_CF_GN'],df['Time'],threshold=thre[9], bias=bias, cycle=cycle);
            ...
            KGDR,KGDRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GD'],df['Time'],threshold=thre[12], bias=bias, cycle=cycle);
            ...
            KGNR,KGNRRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Kalman_GN'],df['Time'],threshold=thre[15], bias=bias, cycle=cycle);
            ...
            MADR,MADRrom=IMUDataProcessing.pattern_extraction(df['Flex/Ext_Madgwick'],df['Time'],threshold=thre[18], bias=bias, cycle=cycle);
        ...
        if patternPitch:    
            rP,rawProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd'],df['Time'],threshold=thre[1], bias=bias, cycle=cycle);
            ...
            CFP,CFProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF'],df['Time'],threshold=thre[4], bias=bias, cycle=cycle);
            ...
            CFGDP,CFGDProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF_GD'],df['Time'],threshold=thre[7], bias=bias, cycle=cycle);
            ...
            CFGNP,CFGNProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_CF_GN'],df['Time'],threshold=thre[10], bias=bias, cycle=cycle);
            ...
            KGDP,KGDProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GD'],df['Time'],threshold=thre[13], bias=bias, cycle=cycle);
            ...
            KGNP,KGNProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Kalman_GN'],df['Time'],threshold=thre[16], bias=bias, cycle=cycle);
            ...
            MADP,MADProm=IMUDataProcessing.pattern_extraction(df['Adu/Abd_Madgwick'],df['Time'],threshold=thre[19], bias=bias, cycle=cycle);
        ...
        if patternYaw:
            rY,rawYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot'],df['Time'],threshold=thre[2], bias=bias, cycle=cycle);
            ...
            CFY,CFYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF'],df['Time'],threshold=thre[5], bias=bias, cycle=cycle);
            ...
            CFGDY,CFGDYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GD'],df['Time'],thre[8], bias=bias, cycle=cycle);
            ...
            CFGNY,CFGNYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_CF_GN'],df['Time'],threshold=thre[11], bias=bias, cycle=cycle);
            ...
            KGDY,KGDYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GD'],df['Time'],threshold=thre[14], bias=bias, cycle=cycle);
            ...
            KGNY,KGNYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Kalman_GN'],df['Time'],threshold=thre[17], bias=bias, cycle=cycle);
            ...
            MADY,MADYrom=IMUDataProcessing.pattern_extraction(df['Int/Ext_Rot_Madgwick'],df['Time'],threshold=thre[20], bias=bias, cycle=cycle);
        ...
        df_rom = pd.DataFrame({
                        'Flex/Ext':romRawRoll               ,'Adu/Abd':romRawPitch               ,'Int/Ext_Rot':romRawYaw               ,
                        'Flex/Ext_CF':romRollCF             ,'Adu/Abd_CF':romPitchCF             ,'Int/Ext_Rot_CF':romYawCF             ,
                        'Flex/Ext_CF_GD':romRollCfGd        ,'Adu/Abd_CF_GD':romPitchCfGd        ,'Int/Ext_Rot_CF_GD':romYawCfGd        ,
                        'Flex/Ext_CF_GN':romRollCfGn        ,'Adu/Abd_CF_GN':romPitchCfGn        ,'Int/Ext_Rot_CF_GN':romYawCfGn        ,
                        'Flex/Ext_Kalman_GD':romRollKalmanGd,'Adu/Abd_Kalman_GD':romPitchKalmanGd,'Int/Ext_Rot_Kalman_GD':romYawKalmanGd,
                        'Flex/Ext_Kalman_GN':romRollKalmanGn,'Adu/Abd_Kalman_GN':romPitchKalmanGn,'Int/Ext_Rot_Kalman_GN':romYawKalmanGn,
                        'Flex/Ext_Madgwick':romRollMad      ,'Adu/Abd_Madgwick':romPitchMad      ,'Int/Ext_Rot_Madgwick':romYawMad      
                        })

        return df ,df_rom,df_metrics  
    ...
    def pattern_extraction(jointAngle,time,threshold,cycle=2,df=True,plot=False,bias=0):
        ...
        for i in range(int(len(zero_crossings)/(mCicloqtd+1))-1): 
            ...
            if plot == True:
                plt.plot(tempo, IMUDataProcessing.low_pass_filter(jointAngle[zero_crossings[0+ciclo]:zero_crossings[mCicloqtd+ciclo]]));
    ...
    def patternIC(all_x, all_y,poly_degree = 1,IC = 1.96,df = True,plot=False,figuresize=(12,9),title='Trajectory IC-95',x_label='X Axis',y_label='Y Axis',label1='Data 1',label2='Data 2',label3='IC'):
        ...
        if plot == True:
            ...
            plt.fill_between(IMUDataProcessing.low_pass_filter(np.sort(all_x)),yupsorted, ydownsorted,color='r',alpha=.1);
    ...
    def data_comparison(Time_Data_Array,statistics_1,statistics_2, plot = True, label1 = 'Data 1', label2 = 'Data 2'):
         ...
         'patter_extraction' and 'patternIC' 
         function.
         ...
         statistics_1: ndarray
           Data 1 output from patternIC.
         statistics_2: float
           Data 2 output from patternIC.
         plot: bool optional
