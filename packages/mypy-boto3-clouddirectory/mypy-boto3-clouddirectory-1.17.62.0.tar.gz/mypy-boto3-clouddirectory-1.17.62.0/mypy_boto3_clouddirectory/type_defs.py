...
DirectoryTypeDef = TypedDict(
    "DirectoryTypeDef",
    {"Name": str, "DirectoryArn": str, "State": DirectoryState, "CreationDateTime": datetime},
    total=False,
)
...
FacetTypeDef = TypedDict(
    "FacetTypeDef", {"Name": str, "ObjectType": ObjectType, "FacetStyle": FacetStyle}, total=False
)
...
LinkAttributeActionTypeDef = TypedDict(
    "LinkAttributeActionTypeDef",
    {"AttributeActionType": UpdateActionType, "AttributeUpdateValue": "TypedAttributeValueTypeDef"},
    total=False,
)
...
_RequiredTypedAttributeValueRangeTypeDef = TypedDict(
    "_RequiredTypedAttributeValueRangeTypeDef", {"StartMode": RangeMode, "EndMode": RangeMode}
)
...
FacetAttributeUpdateTypeDef = TypedDict(
    "FacetAttributeUpdateTypeDef",
    {"Attribute": "FacetAttributeTypeDef", "Action": UpdateActionType},
    total=False,
)
...
TypedLinkFacetAttributeUpdateTypeDef = TypedDict(
    "TypedLinkFacetAttributeUpdateTypeDef",
    {"Attribute": "TypedLinkAttributeDefinitionTypeDef", "Action": UpdateActionType},
)
