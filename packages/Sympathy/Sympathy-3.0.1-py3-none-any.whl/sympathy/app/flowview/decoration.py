...
STATUS_TOOLTIPS = {
    ...
    'GreenMigration': 'Sympathy is automatically handling migrations for this node',
    'YellowMigration': 'This node can be manually upgraded to a newer version',
    'RedMigration': 'This version of this node is no longer supported',
}
...
def get_icon(icon):
    ...
    if STATUS_ICONS is None:
        STATUS_ICONS = {
            ...
            'GreenMigration': QtSvg.QSvgRenderer(
                util.icon_path('green_migration.svg')),
            'YellowMigration': QtSvg.QSvgRenderer(
                util.icon_path('yellow_migration.svg')),
            'RedMigration': QtSvg.QSvgRenderer(
