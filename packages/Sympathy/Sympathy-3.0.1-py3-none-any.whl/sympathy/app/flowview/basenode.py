...
class BaseNodeView(MovableElementViewInterface):
    ...
    def _update_migrations_icon(self):
        ...
        if status == 'red':
            self._migrations_icon.set_icon_type('RedMigration')
        elif status == 'yellow':
            self._migrations_icon.set_icon_type('YellowMigration')
        elif status == 'green':
            self._migrations_icon.set_icon_type('GreenMigration')
        else:
            self._migrations_icon.set_icon_type('None')
