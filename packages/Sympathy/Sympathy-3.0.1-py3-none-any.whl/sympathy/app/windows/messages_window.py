...
from .. credentials import SecretsMessageDetails
from .. credentials import LoginMessageDetails
...
class MessageView(QtWidgets.QWidget):
    ...
    def _init_gui(self):
        ...
        self._secrets_message_details = SecretsMessageDetails(self._font)
        self._login_message_details = LoginMessageDetails(self._font)
        details_widgets = [
            self._text_message_details, self._stream_message_details,
            self._secrets_message_details, self._login_message_details]
