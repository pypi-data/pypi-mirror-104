...
class TranslateClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.can_paginate)
    ...
    def create_parallel_data(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.create_parallel_data)
    ...
    def delete_parallel_data(self, Name: str) -> DeleteParallelDataResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.delete_parallel_data)
    ...
    def delete_terminology(self, Name: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.delete_terminology)
    ...
    def describe_text_translation_job(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.describe_text_translation_job)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.generate_presigned_url)
    ...
    def get_parallel_data(self, Name: str) -> GetParallelDataResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.get_parallel_data)
    ...
    def get_terminology(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.get_terminology)
    ...
    def import_terminology(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.import_terminology)
    ...
    def list_parallel_data(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.list_parallel_data)
    ...
    def list_terminologies(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.list_terminologies)
    ...
    def list_text_translation_jobs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.list_text_translation_jobs)
    ...
    def start_text_translation_job(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.start_text_translation_job)
    ...
    def stop_text_translation_job(self, JobId: str) -> StopTextTranslationJobResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.stop_text_translation_job)
    ...
    def translate_text(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.translate_text)
    ...
    def update_parallel_data(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Client.update_parallel_data)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/translate.html#Translate.Paginator.ListTerminologies)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_translate/paginators.html#listterminologiespaginator)
        """
