...
def get_divisions():
    ...
    """
    info = get_file_data('json/divisions.json')
    return info
...
def get_districts():
    ...
    """
    info = get_file_data('json/districts.json')
    return info
...
def get_postcodes():
    ...
    """
    info = get_file_data('json/postcodes.json')
    return info
...
def get_upazilas():
    ...
    """
    info = get_file_data('json/upazilas.json')
    return info
