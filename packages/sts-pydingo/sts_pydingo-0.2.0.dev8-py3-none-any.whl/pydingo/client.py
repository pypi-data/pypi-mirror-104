...
class Client(object):
    ...
    def camera_brightness(self):
        return self.conn.remote_call('cameraBrightness')
    ...
    def camera_exposure(self):
        return self.conn.remote_call('cameraExposure')
    ...
    def set_camera_brightness(self, value):
        return self.conn.remote_call('setCameraBrightness', value)

    def set_camera_exposure(self, value):
        return self.conn.remote_call('setCameraExposure', value)
    ...
    def save_state(self):
        self.conn.remote_call('saveState')
