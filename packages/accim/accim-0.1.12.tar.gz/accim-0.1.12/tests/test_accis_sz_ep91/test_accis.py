...
def test_addAccis():
    ...
    expectedNames = [
        'TestModel_SingleZone_V910_pymod[AS_EN16798[CA_1[CM_1[AT_0.1[simplified.idf',
        'TestModel_SingleZone_V910_pymod[AS_EN16798[CA_1[CM_1[AT_0.1[standard.idf',
        'TestModel_SingleZone_V910_pymod[AS_EN16798[CA_1[CM_1[AT_0.1[timestep.idf'
        ]
