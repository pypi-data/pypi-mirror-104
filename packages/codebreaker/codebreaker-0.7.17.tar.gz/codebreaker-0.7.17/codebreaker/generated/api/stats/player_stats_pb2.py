...
from codebreaker.generated.api.stats import events_pb2 as api_dot_stats_dot_events__pb2
from codebreaker.generated.api.stats import per_possession_stats_pb2 as api_dot_stats_dot_per__possession__stats__pb2
from codebreaker.generated.api.stats import rumble_pb2 as api_dot_stats_dot_rumble__pb2
from codebreaker.generated.api.stats import dropshot_pb2 as api_dot_stats_dot_dropshot__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[api_dot_stats_dot_stats__pb2.DESCRIPTOR,api_dot_stats_dot_events__pb2.DESCRIPTOR,api_dot_stats_dot_per__possession__stats__pb2.DESCRIPTOR,api_dot_stats_dot_rumble__pb2.DESCRIPTOR,api_dot_stats_dot_dropshot__pb2.DESCRIPTOR,])
...
_PLAYERSTATS.fields_by_name['possession'].message_type = api_dot_stats_dot_stats__pb2._POSSESSION
_PLAYERSTATS.fields_by_name['positional_tendencies'].message_type = api_dot_stats_dot_stats__pb2._POSITIONALTENDENCIES
_PLAYERSTATS.fields_by_name['averages'].message_type = api_dot_stats_dot_stats__pb2._AVERAGES
_PLAYERSTATS.fields_by_name['hit_counts'].message_type = api_dot_stats_dot_stats__pb2._HITCOUNTS
_PLAYERSTATS.fields_by_name['camera_changes'].message_type = api_dot_stats_dot_events__pb2._CAMERACHANGE
_PLAYERSTATS.fields_by_name['controller'].message_type = _CONTROLLER
_PLAYERSTATS.fields_by_name['speed'].message_type = api_dot_stats_dot_stats__pb2._SPEED
_PLAYERSTATS.fields_by_name['relative_positioning'].message_type = _RELATIVEPOSITIONING
_PLAYERSTATS.fields_by_name['per_possession_stats'].message_type = api_dot_stats_dot_per__possession__stats__pb2._PERPOSSESSIONSTATS
_PLAYERSTATS.fields_by_name['rumble_stats'].message_type = api_dot_stats_dot_rumble__pb2._RUMBLESTATS
...
_PLAYERSTATS.fields_by_name['dropshot_stats'].message_type = api_dot_stats_dot_dropshot__pb2._DROPSHOTSTATS
_PLAYERSTATS.fields_by_name['demo_stats'].message_type = _DEMOSTATS
_CARRYDRIBBLES.fields_by_name['carry_stats'].message_type = api_dot_stats_dot_stats__pb2._DETAILEDCARRYSTATS
...
RelativePositioning = _reflection.GeneratedProtocolMessageType('RelativePositioning', (_message.Message,), {
...
CarryDribbles = _reflection.GeneratedProtocolMessageType('CarryDribbles', (_message.Message,), {
...
CumulativeKickoffStats = _reflection.GeneratedProtocolMessageType('CumulativeKickoffStats', (_message.Message,), {
...
DemoStats = _reflection.GeneratedProtocolMessageType('DemoStats', (_message.Message,), {
