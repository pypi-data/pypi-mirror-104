...
from codebreaker.generated.api import team_pb2 as api_dot_team__pb2
...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  ,
  dependencies=[api_dot_player__id__pb2.DESCRIPTOR,api_dot_stats_dot_stats__pb2.DESCRIPTOR,api_dot_stats_dot_rumble__pb2.DESCRIPTOR,api_dot_team__pb2.DESCRIPTOR,])
...
_HIT.fields_by_name['player_id'].message_type = api_dot_player__id__pb2._PLAYERID
_HIT.fields_by_name['ball_data'].message_type = _BALLDATA
_BUMP.fields_by_name['attacker_id'].message_type = api_dot_player__id__pb2._PLAYERID
_BUMP.fields_by_name['victim_id'].message_type = api_dot_player__id__pb2._PLAYERID
_CAMERACHANGE.fields_by_name['player_id'].message_type = api_dot_player__id__pb2._PLAYERID
_FIFTYFIFTY.fields_by_name['players'].message_type = api_dot_player__id__pb2._PLAYERID
_FIFTYFIFTY.fields_by_name['winner'].message_type = api_dot_player__id__pb2._PLAYERID
_BALLCARRY.fields_by_name['player_id'].message_type = api_dot_player__id__pb2._PLAYERID
_BALLCARRY.fields_by_name['carry_stats'].message_type = api_dot_stats_dot_stats__pb2._DETAILEDCARRYSTATS
_RUMBLEITEMEVENT.fields_by_name['item'].enum_type = api_dot_stats_dot_rumble__pb2._POWERUP
_RUMBLEITEMEVENT.fields_by_name['player_id'].message_type = api_dot_player__id__pb2._PLAYERID
_RUMBLEITEMEVENT.fields_by_name['victim_id'].message_type = api_dot_player__id__pb2._PLAYERID
...
BallData = _reflection.GeneratedProtocolMessageType('BallData', (_message.Message,), {
...
CameraChange = _reflection.GeneratedProtocolMessageType('CameraChange', (_message.Message,), {
...
FiftyFifty = _reflection.GeneratedProtocolMessageType('FiftyFifty', (_message.Message,), {
...
Kickoff = _reflection.GeneratedProtocolMessageType('Kickoff', (_message.Message,), {
  'DESCRIPTOR' : _KICKOFF,
  '__module__' : 'api.stats.events_pb2'
...
BallCarry = _reflection.GeneratedProtocolMessageType('BallCarry', (_message.Message,), {
...
RumbleItemEvent = _reflection.GeneratedProtocolMessageType('RumbleItemEvent', (_message.Message,), {
