...
from codebreaker.controls.controls import ControlsCreator
from codebreaker.extras.per_goal_analysis import PerGoalAnalysis
from codebreaker.json_parser.game import Game
from codebreaker.json_parser.sanity_check.sanity_check import SanityChecker
...
def analyze_replay_file(replay_path: str, controls: ControlsCreator = None,
    ...
    :param logging_level: Sets the logging level globally across codebreaker
    ...
    if logging_level != logging.NOTSET:
        logging.getLogger('codebreaker').setLevel(logging_level)
...
if __name__ == '__main__':
    from codebreaker.tests.analysis_test import __test_replays
