...
[boto3.IoTJobsDataPlane 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/iot-jobs-data.html#IoTJobsDataPlane)
...
[mypy-boto3-iot-jobs-data docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_iot_jobs_data/README.md)
...
def get_structure() -> DescribeJobExecutionResponseTypeDef:
    return {
      ...
    }
```
