...
AquaConfigurationTypeDef = TypedDict(
    "AquaConfigurationTypeDef",
    {"AquaStatus": AquaStatus, "AquaConfigurationStatus": AquaConfigurationStatus},
    total=False,
)
...
ClusterAssociatedToScheduleTypeDef = TypedDict(
    "ClusterAssociatedToScheduleTypeDef",
    {"ClusterIdentifier": str, "ScheduleAssociationState": ScheduleState},
    total=False,
)
...
NodeConfigurationOptionTypeDef = TypedDict(
    "NodeConfigurationOptionTypeDef",
    {"NodeType": str, "NumberOfNodes": int, "EstimatedDiskUtilizationPercent": float, "Mode": Mode},
    total=False,
)
...
EndpointAccessListTypeDef = TypedDict(
    "EndpointAccessListTypeDef",
    {"EndpointAccessList": List["EndpointAccessTypeDef"], "Marker": str},
    total=False,
)

EndpointAuthorizationListTypeDef = TypedDict(
    "EndpointAuthorizationListTypeDef",
    {"EndpointAuthorizationList": List["EndpointAuthorizationTypeDef"], "Marker": str},
    total=False,
)
...
NodeConfigurationOptionsFilterTypeDef = TypedDict(
    "NodeConfigurationOptionsFilterTypeDef",
    {"Name": NodeConfigurationOptionsFilterName, "Operator": OperatorType, "Values": List[str]},
    total=False,
)
...
PartnerIntegrationOutputMessageTypeDef = TypedDict(
    "PartnerIntegrationOutputMessageTypeDef", {"DatabaseName": str, "PartnerName": str}, total=False
)
...
ScheduledActionFilterTypeDef = TypedDict(
    "ScheduledActionFilterTypeDef", {"Name": ScheduledActionFilterName, "Values": List[str]}
)
...
_RequiredSnapshotSortingEntityTypeDef = TypedDict(
    "_RequiredSnapshotSortingEntityTypeDef", {"Attribute": SnapshotAttributeToSortBy}
)
_OptionalSnapshotSortingEntityTypeDef = TypedDict(
    "_OptionalSnapshotSortingEntityTypeDef", {"SortOrder": SortByOrder}, total=False
)
