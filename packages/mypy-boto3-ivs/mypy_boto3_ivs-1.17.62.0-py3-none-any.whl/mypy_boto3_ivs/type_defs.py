...
DestinationConfigurationTypeDef = TypedDict(
    "DestinationConfigurationTypeDef", {"s3": "S3DestinationConfigurationTypeDef"}, total=False
)
...
_OptionalRecordingConfigurationTypeDef = TypedDict(
    "_OptionalRecordingConfigurationTypeDef", {"name": str, "tags": Dict[str, str]}, total=False
)
...
S3DestinationConfigurationTypeDef = TypedDict(
    "S3DestinationConfigurationTypeDef", {"bucketName": str}
)
...
_OptionalListRecordingConfigurationsResponseTypeDef = TypedDict(
    "_OptionalListRecordingConfigurationsResponseTypeDef", {"nextToken": str}, total=False
)
