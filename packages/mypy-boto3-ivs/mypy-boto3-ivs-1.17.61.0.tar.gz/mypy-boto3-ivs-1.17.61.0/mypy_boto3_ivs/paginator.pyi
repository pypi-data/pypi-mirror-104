...
class ListChannelsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListChannels.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ivs.html#IVS.Paginator.ListChannels.paginate)
        """
...
class ListPlaybackKeyPairsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListPlaybackKeyPairs.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ivs.html#IVS.Paginator.ListPlaybackKeyPairs.paginate)
        """
...
class ListRecordingConfigurationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListRecordingConfigurations.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ivs.html#IVS.Paginator.ListRecordingConfigurations.paginate)
        """
...
class ListStreamKeysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreamKeys.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ivs.html#IVS.Paginator.ListStreamKeys.paginate)
        """
...
class ListStreamsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        [ListStreams.paginate documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/ivs.html#IVS.Paginator.ListStreams.paginate)
        """
