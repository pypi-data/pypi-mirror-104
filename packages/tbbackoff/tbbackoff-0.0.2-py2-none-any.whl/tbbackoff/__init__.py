...
class RateLimit(object):
    ...
    def __init__(self, bucket=20, token_time=None, max_retries=10, wait_callback=lambda x: None,
            empty_bucket_callback=lambda : None, backoff_callback=lambda x: None):
    ...
    def under_pressure(self):
        return (time.time() - self.last_pressure) < (self.backoff * 3)
    ...
    def set_backoff(self, secs):
        self.backoff = secs
        self.backoff_callback(secs)
