...
BackendAPIAuthTypeTypeDef = TypedDict(
    "BackendAPIAuthTypeTypeDef",
    {"Mode": Mode, "Settings": "BackendAPIAppSyncAuthSettingsTypeDef"},
    total=False,
)

BackendAPIConflictResolutionTypeDef = TypedDict(
    "BackendAPIConflictResolutionTypeDef", {"ResolutionStrategy": ResolutionStrategy}, total=False
)
...
_RequiredCreateBackendAuthForgotPasswordConfigTypeDef = TypedDict(
    "_RequiredCreateBackendAuthForgotPasswordConfigTypeDef", {"DeliveryMethod": DeliveryMethod}
)
...
_RequiredCreateBackendAuthMFAConfigTypeDef = TypedDict(
    "_RequiredCreateBackendAuthMFAConfigTypeDef", {"MFAMode": MFAMode}
)
...
SettingsTypeDef = TypedDict(
    "SettingsTypeDef", {"MfaTypes": List[MfaTypesElement], "SmsMessage": str}, total=False
)
...
UpdateBackendAuthMFAConfigTypeDef = TypedDict(
    "UpdateBackendAuthMFAConfigTypeDef",
    {"MFAMode": MFAMode, "Settings": "SettingsTypeDef"},
    total=False,
)
...
UpdateBackendAuthPasswordPolicyConfigTypeDef = TypedDict(
    "UpdateBackendAuthPasswordPolicyConfigTypeDef",
    {"AdditionalConstraints": List[AdditionalConstraintsElement], "MinimumLength": float},
    total=False,
)
...
GetBackendAPIModelsResponseTypeDef = TypedDict(
    "GetBackendAPIModelsResponseTypeDef", {"Models": str, "Status": Status}, total=False
)
