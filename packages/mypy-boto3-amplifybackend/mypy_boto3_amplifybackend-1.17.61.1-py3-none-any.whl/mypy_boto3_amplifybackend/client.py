...
class AmplifyBackendClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.can_paginate)
    ...
    def clone_backend(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.clone_backend)
    ...
    def create_backend(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.create_backend)
    ...
    def create_backend_api(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.create_backend_api)
    ...
    def create_backend_auth(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.create_backend_auth)
    ...
    def create_backend_config(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.create_backend_config)
    ...
    def create_token(self, AppId: str) -> CreateTokenResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.create_token)
    ...
    def delete_backend(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.delete_backend)
    ...
    def delete_backend_api(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.delete_backend_api)
    ...
    def delete_backend_auth(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.delete_backend_auth)
    ...
    def delete_token(self, AppId: str, SessionId: str) -> DeleteTokenResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.delete_token)
    ...
    def generate_backend_api_models(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.generate_backend_api_models)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.generate_presigned_url)
    ...
    def get_backend(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_backend)
    ...
    def get_backend_api(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_backend_api)
    ...
    def get_backend_api_models(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_backend_api_models)
    ...
    def get_backend_auth(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_backend_auth)
    ...
    def get_backend_job(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_backend_job)
    ...
    def get_token(self, AppId: str, SessionId: str) -> GetTokenResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.get_token)
    ...
    def list_backend_jobs(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.list_backend_jobs)
    ...
    def remove_all_backends(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.remove_all_backends)
    ...
    def remove_backend_config(self, AppId: str) -> RemoveBackendConfigResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.remove_backend_config)
    ...
    def update_backend_api(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.update_backend_api)
    ...
    def update_backend_auth(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.update_backend_auth)
    ...
    def update_backend_config(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.update_backend_config)
    ...
    def update_backend_job(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Client.update_backend_job)
    ...
    def get_paginator(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/amplifybackend.html#AmplifyBackend.Paginator.ListBackendJobs)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_amplifybackend/paginators.html#listbackendjobspaginator)
        """
