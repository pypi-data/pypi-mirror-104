...
ICD10CMTraitTypeDef = TypedDict(
    "ICD10CMTraitTypeDef", {"Name": ICD10CMTraitName, "Score": float}, total=False
)
...
RxNormTraitTypeDef = TypedDict(
    "RxNormTraitTypeDef", {"Name": RxNormTraitName, "Score": float}, total=False
)

TraitTypeDef = TypedDict("TraitTypeDef", {"Name": AttributeName, "Score": float}, total=False)
