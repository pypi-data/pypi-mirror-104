...
[boto3.ComprehendMedical 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/comprehendmedical.html#ComprehendMedical) service
compatible with
...
`mypy_boto3_comprehendmedical.literals` module contains literals extracted from shapes
