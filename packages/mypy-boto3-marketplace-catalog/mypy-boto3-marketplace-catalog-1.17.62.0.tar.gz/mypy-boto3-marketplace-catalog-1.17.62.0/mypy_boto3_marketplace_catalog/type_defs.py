...
_RequiredChangeTypeDef = TypedDict(
    "_RequiredChangeTypeDef", {"ChangeType": str, "Entity": "EntityTypeDef", "Details": str}
)
_OptionalChangeTypeDef = TypedDict("_OptionalChangeTypeDef", {"ChangeName": str}, total=False)
