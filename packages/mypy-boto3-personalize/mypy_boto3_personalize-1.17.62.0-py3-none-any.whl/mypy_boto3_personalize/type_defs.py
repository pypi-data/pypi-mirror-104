...
_RequiredDatasetExportJobOutputTypeDef = TypedDict(
    "_RequiredDatasetExportJobOutputTypeDef", {"s3DataDestination": "S3DataConfigTypeDef"}
)
_OptionalDatasetExportJobOutputTypeDef = TypedDict(
    "_OptionalDatasetExportJobOutputTypeDef", {"ResponseMetadata": "ResponseMetadata"}, total=False
)


class DatasetExportJobOutputTypeDef(
    _RequiredDatasetExportJobOutputTypeDef, _OptionalDatasetExportJobOutputTypeDef
):
    pass
...
CreateDatasetExportJobResponseTypeDef = TypedDict(
    "CreateDatasetExportJobResponseTypeDef", {"datasetExportJobArn": str}, total=False
)
...
ListDatasetExportJobsResponseTypeDef = TypedDict(
    "ListDatasetExportJobsResponseTypeDef",
    {"datasetExportJobs": List["DatasetExportJobSummaryTypeDef"], "nextToken": str},
    total=False,
)
