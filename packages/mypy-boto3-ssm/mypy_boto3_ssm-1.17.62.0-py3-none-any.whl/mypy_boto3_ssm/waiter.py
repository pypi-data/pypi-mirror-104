...
class CommandExecutedWaiter(Boto3Waiter):
    """
    [Waiter.CommandExecuted documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/ssm.html#SSM.Waiter.CommandExecuted)
    """
    ...
    def wait(
        ...
        """
        [CommandExecuted.wait documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/ssm.html#SSM.Waiter.CommandExecuted.wait)
        """
