...
class ServiceResourceQueuesCollection(ResourceCollection):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.queues)
...
class QueueDeadLetterSourceQueuesCollection(ResourceCollection):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.dead_letter_source_queues)
...
class Message(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.Message)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sqs/service_resource.html#message)
    """
    ...
    def Queue(self) -> "_Queue":
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Message.Queue)
    ...
    def change_visibility(self, VisibilityTimeout: int) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Message.change_visibility)
    ...
    def delete(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Message.delete)
    ...
    def get_available_subresources(self) -> List[str]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Message.get_available_subresources)
...
class Queue(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.Queue)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sqs/service_resource.html#queue)
    """
    ...
    def Message(self, receipt_handle: str) -> _Message:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.Message)
    ...
    def add_permission(self, Label: str, AWSAccountIds: List[str], Actions: List[str]) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.add_permission)
    ...
    def change_message_visibility_batch(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.change_message_visibility_batch)
    ...
    def delete(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.delete)
    ...
    def delete_messages(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.delete_messages)
    ...
    def get_available_subresources(self) -> List[str]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.get_available_subresources)
    ...
    def load(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.load)
    ...
    def purge(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.purge)
    ...
    def receive_messages(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.receive_messages)
    ...
    def reload(self) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.reload)
    ...
    def remove_permission(self, Label: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.remove_permission)
    ...
    def send_message(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.send_message)
    ...
    def send_messages(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.send_messages)
    ...
    def set_attributes(self, Attributes: Dict[QueueAttributeName, str]) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.Queue.set_attributes)
...
class SQSServiceResource(Boto3ServiceResource):
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource)[Show boto3-stubs documentation](https://vemel.github.io/boto3_stubs_docs/mypy_boto3_sqs/service_resource.html)
    """
    ...
    def Message(self, queue_url: str, receipt_handle: str) -> _Message:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.Message)
    ...
    def Queue(self, url: str) -> _Queue:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.Queue)
    ...
    def create_queue(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.create_queue)
    ...
    def get_available_subresources(self) -> List[str]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.get_available_subresources)
    ...
    def get_queue_by_name(self, QueueName: str, QueueOwnerAWSAccountId: str = None) -> _Queue:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.65/reference/services/sqs.html#SQS.ServiceResource.get_queue_by_name)
