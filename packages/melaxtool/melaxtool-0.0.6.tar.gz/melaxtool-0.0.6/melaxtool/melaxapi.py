...
class NlpResult:
    ...
    def visualization(self, width=1080, height=600):
        self.width = width
        self.height = height
    ...
    def _repr_html_(self):
        ...
        return self.iframe.format(src=self.src + "/#/test-nlp",
                                  data=str(base64.b64encode(json.dumps(self.data).encode("utf-8")), "utf-8"),
                                  width=self.width,
                                  height=self.height,
                                  params=params)
    ...
    def __init__(self, code, msg, url, cache='no', dic={}):
        self.url = url
        self.data = dic
        self.code = code
        self.msg = msg
    ...
    def invoke(self, text: str, pipeline: str):
        ...
        if rsp.status_code == 200:
            ...
            if nlprsp and 'code' in nlprsp and nlprsp['code'] == 200:
                ...
                return NlpResult(code=200, msg='', url=self.url,
...
response = client.invoke(input, "clinical:1")
