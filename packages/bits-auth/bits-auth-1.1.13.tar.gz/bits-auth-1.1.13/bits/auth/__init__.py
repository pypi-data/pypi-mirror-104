...
class Auth(object):
    ...
    def gaia(self):
        ...
        os.environ["BIGQUERY_IMPORTS_BUCKET"] = settings.get("bigquery_bucket")
        os.environ["CONFIG_BUCKET"] = settings.get("config_bucket")
        os.environ["FIRESTORE_IMPORTS_BUCKET"] = settings.get("firestore_bucket")
        return Gaia()
