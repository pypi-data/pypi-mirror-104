...
setup(
    ...
    scripts=["mGenerate_conf_analysis.py","mGenerate_PyMOL_Session.py"],
...
#mGenerate_PyMOL_Session.py cannot be included here because it is not a .py file, must find another way to add it
