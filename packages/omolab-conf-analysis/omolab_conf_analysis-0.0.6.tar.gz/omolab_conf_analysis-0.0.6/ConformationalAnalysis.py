...
class ConformationalAnalysis(object):
    attempts_left = 10
    for attempt in range(10):  # user has ten times to get a correct path, otherwise must restart
        try:
            ...
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/cycloheptadecane_file_test2"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/cycloheptadecane_file_test"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/cyclooctane_file_test"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/pentane_file_test"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/xyz_file_test"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/1_4_dioxepane_file_test"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/1fluoro4propylcyclohexane"
            # user_input_directory = "/Users/matthewnwerem/Chapman University/OMO Research Group - Project Conf. Analysis - Nwerem - proj_conf_analysis/Code Versions/Conformational_Analysis/test_files/cis_1fluoro4propylcyclohexane"
    ...
    for attempt in range(10):  # user has ten times to get a correct num of pcs desired, otherwise must restart
        try:
            ...
            while testPCs:
                ...
                userPCA_model, user_num_components,original_df = pca.pca_model(userPCA_Components, xyz_df)
    ...
    attempts_left = 10
    os.chmod('mGenerate_PyMOL_Session.sh', stat.S_IRWXU)
    print("______________________________________________________")
