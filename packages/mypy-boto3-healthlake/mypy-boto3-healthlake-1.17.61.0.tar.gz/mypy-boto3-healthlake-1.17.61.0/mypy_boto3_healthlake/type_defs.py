...
from mypy_boto3_healthlake.literals import DatastoreStatus, FHIRVersion, JobStatus, PreloadDataType
...
PreloadDataConfigTypeDef = TypedDict(
    "PreloadDataConfigTypeDef", {"PreloadDataType": PreloadDataType}
)
...
_RequiredStartFHIRExportJobResponseTypeDef = TypedDict(
    "_RequiredStartFHIRExportJobResponseTypeDef", {"JobId": str, "JobStatus": JobStatus}
)
...
_RequiredStartFHIRImportJobResponseTypeDef = TypedDict(
    "_RequiredStartFHIRImportJobResponseTypeDef", {"JobId": str, "JobStatus": JobStatus}
)
