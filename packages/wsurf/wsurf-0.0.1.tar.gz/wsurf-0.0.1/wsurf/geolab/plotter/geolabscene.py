""" A viewer for GeoLab scene. Adds a button to open up the engine.
"""
...
# A decorated scene.
###############################################################################
class GeolabSecondaryScene(DecoratedScene):
...
# A decorated scene.
###############################################################################
class GeolabBaseScene(DecoratedScene):
