...
class ObjectPermission(models.Model):
    ...
    **Attributes:**
    ...
    """
    role = models.ForeignKey("Role", verbose_name=_(u"Role"), blank=True, null=True, on_delete=models.CASCADE)
...
class PrincipalRoleRelation(models.Model):
    ...
    """
    user = models.ForeignKey(User, verbose_name=_(u"User"), blank=True, null=True, on_delete=models.CASCADE)
    group = models.ForeignKey(Group, verbose_name=_(u"Group"), blank=True, null=True, on_delete=models.CASCADE)
    role = models.ForeignKey(Role, verbose_name=_(u"Role"), on_delete=models.CASCADE)
    content_type = models.ForeignKey(ContentType, verbose_name=_(u"Content type"), blank=True, null=True, on_delete=models.CASCADE)
