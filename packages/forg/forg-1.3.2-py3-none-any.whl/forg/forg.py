...
def forg():
    ...
    new_row = {'video': VIDEOEXT}
    extensoes_df = pd.DataFrame(extensoes_list)
    extensoes_df.query(".docx")
    ...
    for value in extensoes.values():
      if formato in value:
        print(value)
        print(extensoes[value])
        #values.append(extensoes.)
