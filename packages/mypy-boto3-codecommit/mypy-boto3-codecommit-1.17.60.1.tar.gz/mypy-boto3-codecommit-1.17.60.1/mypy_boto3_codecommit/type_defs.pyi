...
ApprovalRuleOverriddenEventMetadataTypeDef = TypedDict(
    "ApprovalRuleOverriddenEventMetadataTypeDef",
    {"revisionId": str, "overrideStatus": OverrideStatus},
    total=False,
)
...
ApprovalStateChangedEventMetadataTypeDef = TypedDict(
    "ApprovalStateChangedEventMetadataTypeDef",
    {"revisionId": str, "approvalStatus": ApprovalState},
    total=False,
)

ApprovalTypeDef = TypedDict(
    "ApprovalTypeDef", {"userArn": str, "approvalState": ApprovalState}, total=False
)
...
FileMetadataTypeDef = TypedDict(
    "FileMetadataTypeDef",
    {"absolutePath": str, "blobId": str, "fileMode": FileModeTypeEnum},
    total=False,
)

FileModesTypeDef = TypedDict(
    "FileModesTypeDef",
    {"source": FileModeTypeEnum, "destination": FileModeTypeEnum, "base": FileModeTypeEnum},
    total=False,
)
...
FileTypeDef = TypedDict(
    "FileTypeDef",
    {"blobId": str, "absolutePath": str, "relativePath": str, "fileMode": FileModeTypeEnum},
    total=False,
)
...
LocationTypeDef = TypedDict(
    "LocationTypeDef",
    {"filePath": str, "filePosition": int, "relativeFileVersion": RelativeFileVersionEnum},
    total=False,
)
...
MergeMetadataTypeDef = TypedDict(
    "MergeMetadataTypeDef",
    {"isMerged": bool, "mergedBy": str, "mergeCommitId": str, "mergeOption": MergeOptionTypeEnum},
    total=False,
)

MergeOperationsTypeDef = TypedDict(
    "MergeOperationsTypeDef", {"source": ChangeTypeEnum, "destination": ChangeTypeEnum}, total=False
)

ObjectTypesTypeDef = TypedDict(
    "ObjectTypesTypeDef",
    {"source": ObjectTypeEnum, "destination": ObjectTypeEnum, "base": ObjectTypeEnum},
    total=False,
)
...
_RequiredReplaceContentEntryTypeDef = TypedDict(
    "_RequiredReplaceContentEntryTypeDef", {"filePath": str, "replacementType": ReplacementTypeEnum}
)
_OptionalReplaceContentEntryTypeDef = TypedDict(
    "_OptionalReplaceContentEntryTypeDef",
    {"content": Union[bytes, IO[bytes]], "fileMode": FileModeTypeEnum},
    total=False,
)
...
_RequiredRepositoryTriggerTypeDef = TypedDict(
    ...
    {"name": str, "destinationArn": str, "events": List[RepositoryTriggerEventEnum]},
)
...
SetFileModeEntryTypeDef = TypedDict(
    "SetFileModeEntryTypeDef", {"filePath": str, "fileMode": FileModeTypeEnum}
)
