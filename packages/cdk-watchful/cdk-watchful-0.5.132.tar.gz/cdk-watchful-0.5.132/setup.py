    ...
    """
{
    ...
    "install_requires": [
        ...
        "aws-cdk.aws-cloudwatch-actions>=1.94.1, <2.0.0",
        "aws-cdk.aws-cloudwatch>=1.94.1, <2.0.0",
        "aws-cdk.aws-dynamodb>=1.94.1, <2.0.0",
        "aws-cdk.aws-ecs-patterns>=1.94.1, <2.0.0",
        "aws-cdk.aws-ecs>=1.94.1, <2.0.0",
        "aws-cdk.aws-elasticloadbalancingv2>=1.94.1, <2.0.0",
