...
[boto3.ComputeOptimizer 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/compute-optimizer.html#ComputeOptimizer) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_compute_optimizer/README.md)
...
`mypy_boto3_compute_optimizer.literals` module contains literals extracted from shapes
...
def check_value(value: EBSFilterName) -> bool:
    ...
```
