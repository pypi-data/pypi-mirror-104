...
[boto3.MarketplaceMetering 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/meteringmarketplace.html#MarketplaceMetering)
...
[mypy-boto3-meteringmarketplace docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_meteringmarketplace/README.md)
...
def get_structure() -> BatchMeterUsageResultTypeDef:
    return {
      ...
    }
```
