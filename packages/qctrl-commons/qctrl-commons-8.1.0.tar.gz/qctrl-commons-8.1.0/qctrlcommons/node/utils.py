...
def validate_function_output_shapes(
    ...
    validate_values_shape : Callable[[tuple, tuple, str, str], tuple]
    ...
    values_shape = validate_values_shape(x_values_shape, y_values_shape, "x", "y")

    return batch_shape, values_shape
...
def validate_tensor_and_function_output_shapes(
    ...
    """
    if tensor_first:
        values_shape = validate_values_shape(t_shape, f_values_shape, t_name, f_name)
    else:
        values_shape = validate_values_shape(f_values_shape, t_shape, f_name, t_name)

    return f_batch_shape, values_shape
