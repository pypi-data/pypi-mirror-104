...
from typing import (
    Tuple, List, Any, Optional, TYPE_CHECKING, Iterator, Union as Union_, Dict,
...
class BaseNode(VisitableMixIn):
    ...
    def initargs(self,
                 stmt: Optional["rql.stmts.Statement"]) -> Tuple[Any, ...]:
    ...
    def get_nodes(self, klass: Type["BaseNode"]) -> List["BaseNode"]:
    ...
    def iget_nodes(self, klass: Type["BaseNode"]) -> Iterator["BaseNode"]:
    ...
    # this function does not seem to be used anywhere
    def go_to_index_path(self, path) -> "rql.base.BaseNode":
        if not path:
            return self
    ...
    def replace(
            self,
            old_child: "rql.base.BaseNode",
            new_child: "rql.base.BaseNode"
...
class Node(BaseNode):
    ...
    def __init__(self):
        self.parent: Optional["rql.base.BaseNode"] = None
        self.children: List["rql.base.BaseNode"] = []

    def append(self, child: "rql.base.BaseNode"):
    ...
    def insert(self, index: int, child: "rql.base.BaseNode"):
        """insert a child node"""
