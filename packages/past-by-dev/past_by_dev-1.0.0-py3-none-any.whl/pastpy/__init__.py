class Past:
    def __init__(self, past):
        ...
        def SPR2SPA(test_string):
            ...
            test_list =    ['get', 'eat','die','love','loves','live','lives','enjoys','enjoy','does','come','comes','do','need','needs','like','likes']
            replace_list = ['got','ate','died','loved','loved','lived','lived','enjoyed','enjoyed','did','came','came','did','needed','needed','liked','liked'] 
            ...
            for word in res:
                ...
                print(f"#{indexNumber}  Sentence : "+replacedSentence)
                # someVar = res.index()
