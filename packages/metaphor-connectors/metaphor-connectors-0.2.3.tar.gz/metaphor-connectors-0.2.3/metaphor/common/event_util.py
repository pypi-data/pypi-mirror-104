...
class EventUtil:
    ...
    with resources.open_text(common, "metadata_change_event.json") as f:
    ...
    def _build_event() -> MetadataChangeEvent:
        ...
        # event.event_header.time = datetime.now()  TODO: fix json validation on datetime [ch880]
        return event
