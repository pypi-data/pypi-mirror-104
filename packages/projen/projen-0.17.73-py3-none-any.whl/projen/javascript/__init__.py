...
class Projenrc(
    ...
    def __init__(
        ...
        *,
        ...
        '''
        :param project: -
        :param comments: (experimental) Include commented out properties. Default: true
        :param filename: (experimental) The name of the projenrc file. Default: ".projenrc.js"

        :stability: experimental
        '''
        options = ProjenrcOptions(comments=comments, filename=filename)

        jsii.create(Projenrc, self, [project, options])


@jsii.data_type(
    jsii_type="projen.javascript.ProjenrcOptions",
    jsii_struct_bases=[],
    name_mapping={"comments": "comments", "filename": "filename"},
)
class ProjenrcOptions:
    ...
    def comments(self) -> typing.Optional[builtins.bool]:
        '''(experimental) Include commented out properties.
