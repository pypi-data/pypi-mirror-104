...
general_errors_dict = {'AR_busy':
                       ...
                       'car_have_rfid':
                           {'check_func': check_funcs.check_car_has_rfid,
                            ...
                            'error_text': "У данного авто установлена метка RFID."
                                          "\nНажмите 'Принять' еще раз для ручного пропуска.",
                            'shown': False,
                            'skippable': True,
                       ...
                       'tara_without_brutto_try':
                           {'check_func': check_funcs.check_brutto_on_exit,
                            ...
                            'error_text': "У данной машины нет брутто. (Проткол ТКО - въезд=брутто, выезд=тара)"
                                          "\nПожалуйста, взвесьте сначала брутто с другой стороны весов.",
                            'shown': False,
                            'skippable': False,
                            'tests': {'correct_values': {'course': 'OUT', 'have_brutto': True, 'car_protocol': 'rfid'},
                                      'incorrect_values': {'course': 'OUT', 'have_brutto': False, 'car_protocol': 'rfid'}}
                            },
...
orup_brutto_errors = {'other_instead_tko':
                          ...
                          'incorrect_car_number':
                              {'check_func': check_funcs.check_car_number,
                               ...
                               'tests': {'correct_values': {'car_number': 'ВХ060ХА702'},
                                         'incorrect_values': {'car_number': 'ТХ'}}
                               },
                          ...
                          'debtor_carrier':
                              {'check_func': check_funcs.check_carrier_debtor,
                               'description': 'Организация в списке должников (статус 0 или False)',
                               'error_text': "У данной организации имеется задолженности или иные ограничения.\n"
                                             "Рекомендуется связаться с руководством для уточнения.",
                               'shown': False,
                               'skippable': True,
