...
operator = OrupErrorsOperator(canvas, imgs[0], imgs[1], xpos=100, ypos=100, text_font="'Roboto' 25")
canvas.pack(fill=BOTH, expand=YES)

# Кнопочку для вызова туда же
Button(root, text='Show Error', bg='white', command=lambda: operator.check_brutto_orup(**args)).pack()
