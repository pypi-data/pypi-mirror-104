...
[boto3.Cloud9 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/cloud9.html#Cloud9) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_cloud9/README.md)
...
def check_value(value: ConnectionType) -> bool:
    ...
```
