...
from gihadocs.config.base import Config
...
class URLTest(unittest.TestCase):
    ...
    def test_invalid_url(self):
        ...
        option = config_options.URL()
        self.assertRaises(config_options.ValidationError,
                          option.validate, "www.gihadocs.org")
...
class RepoURLTest(unittest.TestCase):
    ...
    def test_repo_name_github(self):
        ...
        config = {'repo_url': "https://github.com/gihadocs/gihadocs"}
...
class DirTest(unittest.TestCase):
    ...
    def test_config_dir_prepended(self):
        ...
        cfg = Config(
            [('dir', config_options.Dir())],
            config_file_path=os.path.join(base_path, 'gihadocs.yml'),
        )
...
class SiteDirTest(unittest.TestCase):
    ...
    def validate_config(self, config):
        ...
        fname = os.path.join(os.path.abspath('..'), 'gihadocs.yml')
    ...
    def test_doc_dir_in_site_dir(self):
        ...
        parent_dir = gihadocs.__file__.split(os.sep)[-3]
...
class ThemeTest(unittest.TestCase):
    ...
    def test_theme_as_string(self):
        ...
        value = option.validate("gihadocs")
        self.assertEqual({'name': 'gihadocs'}, value)

    def test_uninstalled_theme_as_string(self):

        option = config_options.Theme()
        self.assertRaises(config_options.ValidationError,
                          option.validate, "gihadocs2")

    def test_theme_default(self):
        option = config_options.Theme(default='gihadocs')
        value = option.validate(None)
        self.assertEqual({'name': 'gihadocs'}, value)
