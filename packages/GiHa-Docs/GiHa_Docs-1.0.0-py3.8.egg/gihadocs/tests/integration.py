"""
# GiHaDocs Integration tests

This is a simple integration test that builds the GiHaDocs
documentation against all of the builtin themes.

From the root of the GiHaDocs git repo, use:

    python -m gihadocs.tests.integration --help


TODOs
    - Build with different configuration options.
    - Build documentation other than just GiHaDocs as it is relatively simple.
"""
...
from gihadocs import utils

log = logging.getLogger('gihadocs')

DIR = os.path.dirname(__file__)
MKDOCS_CONFIG = os.path.abspath(os.path.join(DIR, '../../gihadocs.yml'))
...
def main(output=None):
    ...
    base_cmd = ['gihadocs', 'build', '-s', '-v', '--site-dir', ]
