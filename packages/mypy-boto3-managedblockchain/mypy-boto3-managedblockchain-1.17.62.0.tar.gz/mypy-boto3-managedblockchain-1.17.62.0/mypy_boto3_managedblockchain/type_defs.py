...
NetworkFabricAttributesTypeDef = TypedDict(
    "NetworkFabricAttributesTypeDef",
    {"OrderingServiceEndpoint": str, "Edition": Edition},
    total=False,
)

NetworkFabricConfigurationTypeDef = TypedDict(
    "NetworkFabricConfigurationTypeDef", {"Edition": Edition}
)
...
VoteSummaryTypeDef = TypedDict(
    "VoteSummaryTypeDef", {"Vote": VoteValue, "MemberName": str, "MemberId": str}, total=False
)
