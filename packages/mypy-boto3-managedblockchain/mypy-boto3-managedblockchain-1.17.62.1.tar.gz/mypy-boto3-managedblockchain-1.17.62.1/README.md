...
[boto3.ManagedBlockchain 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/managedblockchain.html#ManagedBlockchain) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_managedblockchain/README.md)
...
`mypy_boto3_managedblockchain.literals` module contains literals extracted from shapes
...
def check_value(value: Edition) -> bool:
    ...
```
