...
_RequiredAlgorithmSpecificationTypeDef = TypedDict(
    "_RequiredAlgorithmSpecificationTypeDef", {"TrainingInputMode": TrainingInputMode}
)
...
_RequiredAlgorithmStatusItemTypeDef = TypedDict(
    "_RequiredAlgorithmStatusItemTypeDef", {"Name": str, "Status": DetailedAlgorithmStatus}
)
...
ArtifactSourceTypeTypeDef = TypedDict(
    "ArtifactSourceTypeTypeDef", {"SourceIdType": ArtifactSourceIdType, "Value": str}
)
...
_OptionalAthenaDatasetDefinitionTypeDef = TypedDict(
    ...
    {"WorkGroup": str, "KmsKeyId": str, "OutputCompression": AthenaResultCompressionType},
    total=False,
)
...
AutoMLCandidateStepTypeDef = TypedDict(
    "AutoMLCandidateStepTypeDef",
    {"CandidateStepType": CandidateStepType, "CandidateStepArn": str, "CandidateStepName": str},
)
...
_OptionalAutoMLChannelTypeDef = TypedDict(
    "_OptionalAutoMLChannelTypeDef", {"CompressionType": CompressionType}, total=False
)
...
AutoMLJobObjectiveTypeDef = TypedDict("AutoMLJobObjectiveTypeDef", {"MetricName": AutoMLMetricEnum})
...
AutoMLPartialFailureReasonTypeDef = TypedDict(
    "AutoMLPartialFailureReasonTypeDef", {"PartialFailureMessage": str}, total=False
)

AutoMLS3DataSourceTypeDef = TypedDict(
    "AutoMLS3DataSourceTypeDef", {"S3DataType": AutoMLS3DataType, "S3Uri": str}
)
...
CandidateArtifactLocationsTypeDef = TypedDict(
    "CandidateArtifactLocationsTypeDef", {"Explainability": str}
)
...
CaptureOptionTypeDef = TypedDict("CaptureOptionTypeDef", {"CaptureMode": CaptureMode})
...
_OptionalChannelSpecificationTypeDef = TypedDict(
    ...
    {"Description": str, "IsRequired": bool, "SupportedCompressionTypes": List[CompressionType]},
    total=False,
)
...
ConditionStepMetadataTypeDef = TypedDict(
    "ConditionStepMetadataTypeDef", {"Outcome": ConditionOutcome}, total=False
)
...
DataProcessingTypeDef = TypedDict(
    "DataProcessingTypeDef",
    {"InputFilter": str, "OutputFilter": str, "JoinSource": JoinSource},
    total=False,
)
...
FeatureDefinitionTypeDef = TypedDict(
    "FeatureDefinitionTypeDef", {"FeatureName": str, "FeatureType": FeatureType}, total=False
)
...
_OptionalFeatureGroupSummaryTypeDef = TypedDict(
    ...
    {"FeatureGroupStatus": FeatureGroupStatus, "OfflineStoreStatus": "OfflineStoreStatusTypeDef"},
    total=False,
)
...
_OptionalFilterTypeDef = TypedDict(
    "_OptionalFilterTypeDef", {"Operator": Operator, "Value": str}, total=False
)
...
_RequiredHyperParameterAlgorithmSpecificationTypeDef = TypedDict(
    "_RequiredHyperParameterAlgorithmSpecificationTypeDef", {"TrainingInputMode": TrainingInputMode}
)
...
_RequiredHyperParameterTuningJobConfigTypeDef = TypedDict(
    ...
    {"Strategy": HyperParameterTuningJobStrategyType, "ResourceLimits": "ResourceLimitsTypeDef"},
)
...
_RequiredImageConfigTypeDef = TypedDict(
    "_RequiredImageConfigTypeDef", {"RepositoryAccessMode": RepositoryAccessMode}
)
...
InferenceExecutionConfigTypeDef = TypedDict(
    "InferenceExecutionConfigTypeDef", {"Mode": InferenceExecutionMode}
)
...
_RequiredInputConfigTypeDef = TypedDict(
    "_RequiredInputConfigTypeDef", {"S3Uri": str, "DataInputConfig": str, "Framework": Framework}
)
...
_OptionalIntegerParameterRangeTypeDef = TypedDict(
    "_OptionalIntegerParameterRangeTypeDef", {"ScalingType": HyperParameterScalingType}, total=False
)
...
LabelingJobDataAttributesTypeDef = TypedDict(
    "LabelingJobDataAttributesTypeDef", {"ContentClassifiers": List[ContentClassifier]}, total=False
)
...
_RequiredModelPackageStatusItemTypeDef = TypedDict(
    "_RequiredModelPackageStatusItemTypeDef", {"Name": str, "Status": DetailedModelPackageStatus}
)
...
_RequiredMonitoringClusterConfigTypeDef = TypedDict(
    ...
    {"InstanceCount": int, "InstanceType": ProcessingInstanceType, "VolumeSizeInGB": int},
)
...
_OptionalMonitoringS3OutputTypeDef = TypedDict(
    ...
    {"S3UploadMode": ProcessingS3UploadMode, "ResponseMetadata": "ResponseMetadata"},
    total=False,
)
...
_OptionalMonitoringScheduleSummaryTypeDef = TypedDict(
    ...
    {"EndpointName": str, "MonitoringJobDefinitionName": str, "MonitoringType": MonitoringType},
    total=False,
)
...
MultiModelConfigTypeDef = TypedDict(
    "MultiModelConfigTypeDef", {"ModelCacheSetting": ModelCacheSetting}, total=False
)
...
_RequiredOfflineStoreStatusTypeDef = TypedDict(
    "_RequiredOfflineStoreStatusTypeDef", {"Status": OfflineStoreStatusValue}
)
...
_RequiredProcessingS3InputTypeDef = TypedDict(
    "_RequiredProcessingS3InputTypeDef", {"S3Uri": str, "S3DataType": ProcessingS3DataType}
)
...
_RequiredProcessingS3OutputTypeDef = TypedDict(
    ...
    {"S3Uri": str, "LocalPath": str, "S3UploadMode": ProcessingS3UploadMode},
)
...
_OptionalRedshiftDatasetDefinitionTypeDef = TypedDict(
    ...
    {"KmsKeyId": str, "OutputCompression": RedshiftResultCompressionType},
    total=False,
)
...
_RequiredResourceConfigTypeDef = TypedDict(
    ...
    {"InstanceType": TrainingInstanceType, "InstanceCount": int, "VolumeSizeInGB": int},
)
...
ResourceSpecTypeDef = TypedDict(
    "ResourceSpecTypeDef",
    {"SageMakerImageArn": str, "SageMakerImageVersionArn": str, "InstanceType": AppInstanceType},
    total=False,
)
...
_RequiredS3DataSourceTypeDef = TypedDict(
    "_RequiredS3DataSourceTypeDef", {"S3DataType": S3DataType, "S3Uri": str}
)
_OptionalS3DataSourceTypeDef = TypedDict(
    "_OptionalS3DataSourceTypeDef",
    {"S3DataDistributionType": S3DataDistribution, "AttributeNames": List[str]},
    total=False,
)
...
_RequiredSecondaryStatusTransitionTypeDef = TypedDict(
    "_RequiredSecondaryStatusTransitionTypeDef", {"Status": SecondaryStatus, "StartTime": datetime}
)
...
SharingSettingsTypeDef = TypedDict(
    "SharingSettingsTypeDef",
    {"NotebookOutputOption": NotebookOutputOption, "S3OutputPath": str, "S3KmsKeyId": str},
    total=False,
)
...
_RequiredTargetPlatformTypeDef = TypedDict(
    "_RequiredTargetPlatformTypeDef", {"Os": TargetPlatformOs, "Arch": TargetPlatformArch}
)
_OptionalTargetPlatformTypeDef = TypedDict(
    "_OptionalTargetPlatformTypeDef", {"Accelerator": TargetPlatformAccelerator}, total=False
)
...
_OptionalTransformInputTypeDef = TypedDict(
    ...
    {"ContentType": str, "CompressionType": CompressionType, "SplitType": SplitType},
    total=False,
)
...
_RequiredTransformResourcesTypeDef = TypedDict(
    ...
    {"InstanceType": TransformInstanceType, "InstanceCount": int},
)
...
TransformS3DataSourceTypeDef = TypedDict(
    "TransformS3DataSourceTypeDef", {"S3DataType": S3DataType, "S3Uri": str}
)
...
TrialComponentStatusTypeDef = TypedDict(
    "TrialComponentStatusTypeDef",
    {"PrimaryStatus": TrialComponentPrimaryStatus, "Message": str},
    total=False,
)
...
GetSagemakerServicecatalogPortfolioStatusOutputTypeDef = TypedDict(
    "GetSagemakerServicecatalogPortfolioStatusOutputTypeDef",
    {"Status": SagemakerServicecatalogStatus, "ResponseMetadata": "ResponseMetadata"},
    total=False,
)
...
RetentionPolicyTypeDef = TypedDict(
    "RetentionPolicyTypeDef", {"HomeEfsFileSystem": RetentionType}, total=False
)
...
VariantPropertyTypeDef = TypedDict(
    "VariantPropertyTypeDef", {"VariantPropertyType": VariantPropertyType}
)
