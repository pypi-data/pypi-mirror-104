...
[boto3.LexRuntimeV2 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/lexv2-runtime.html#LexRuntimeV2) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_lexv2_runtime/README.md)
...
`mypy_boto3_lexv2_runtime.literals` module contains literals extracted from shapes
...
def check_value(value: ConfirmationState) -> bool:
    ...
```
