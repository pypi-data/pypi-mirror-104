...
[boto3.TranscribeService 1.17.67](https://boto3.amazonaws.com/v1/documentation/api/1.17.67/reference/services/transcribe.html#TranscribeService)
...
[mypy-boto3-transcribe docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_transcribe/README.md)
...
def check_value(value: BaseModelName) -> bool:
    ...
```
