...
[boto3.MTurk 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/mturk.html#MTurk) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_mturk/README.md)
...
`mypy_boto3_mturk.literals` module contains literals extracted from shapes
...
def check_value(value: AssignmentStatus) -> bool:
    ...
```
