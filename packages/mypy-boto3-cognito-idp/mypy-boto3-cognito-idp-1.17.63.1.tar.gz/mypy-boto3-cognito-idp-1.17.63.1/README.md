...
[boto3.CognitoIdentityProvider 1.17.63](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/cognito-idp.html#CognitoIdentityProvider)
...
[mypy-boto3-cognito-idp docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_cognito_idp/README.md)
...
def check_value(value: AccountTakeoverEventActionType) -> bool:
    ...
```
