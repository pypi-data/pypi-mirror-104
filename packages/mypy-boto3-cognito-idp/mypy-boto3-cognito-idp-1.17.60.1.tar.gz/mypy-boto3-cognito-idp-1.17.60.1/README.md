...
[boto3.CognitoIdentityProvider 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/cognito-idp.html#CognitoIdentityProvider) service
compatible with
...
`mypy_boto3_cognito_idp.literals` module contains literals extracted from shapes
