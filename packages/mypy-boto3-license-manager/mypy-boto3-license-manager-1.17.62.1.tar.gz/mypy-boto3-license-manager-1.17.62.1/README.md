...
[boto3.LicenseManager 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/license-manager.html#LicenseManager) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_license_manager/README.md)
...
`mypy_boto3_license_manager.literals` module contains literals extracted from shapes
...
def check_value(value: AllowedOperation) -> bool:
    ...
```
...
def get_structure() -> AcceptGrantResponseTypeDef:
    return {
      ...
    }
```
