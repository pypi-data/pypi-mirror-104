...
class Agent(Insight, Channel, Catalog, Dataset):
    ...
    def load_dataset(self, dataset_slug, aliases:list=[], filters:list=[]):
        ...
        if(dataset == None):
            logging.error("Please insert a correct dataset slug")
            return
    ...
    def create_datacard(self, channel_name: str, title: str, search: str = "", slug: str = None, replace: bool = False):
        ...
        channel = self.get_channel(self._agentId, channel_name)
        if channel != None:
