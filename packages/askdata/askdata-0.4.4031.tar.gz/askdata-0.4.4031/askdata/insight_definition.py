...
class Insight_Definition:
    ...
    def add_list(self, query_id, title_parameter, description_parameter, action_label,
        ...
        self.edit_list(list_id, query_id, title_parameter,
                       description_parameter, action_label, action_url, max_results, list_name)
        return list_id


    def edit_list(self, list_id, query_id, title_parameter, description_parameter, action_label,
                  action_url, max_results,list_name="List"):
