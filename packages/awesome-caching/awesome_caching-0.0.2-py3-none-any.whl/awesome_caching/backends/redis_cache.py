# -*- coding: utf-8 -*-
"""
    awesome_caching.backends.redis_cache
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~

    The redis cache backend. A caching backend that doesn't cache.
"""
import logging
...
class RedisCache(BaseCache):
    ...
    def set_many(self, mapping: dict, timeout: int = None):
        timeout = self._normalize_timeout(timeout)
...
class RedisClusterCache(RedisCache):
    ...
    The first argument can be either a string denoting address of the Redis
    server or an object resembling an instance of a redis_cluster.RedisCluster
    class.
    ...
    def __init__(
        ...
        try:
            ...
            raise RuntimeError("no redis_cluster module found")
