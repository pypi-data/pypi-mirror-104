...
ActionThresholdTypeDef = TypedDict(
    "ActionThresholdTypeDef", {"ActionThresholdValue": float, "ActionThresholdType": ThresholdType}
)
...
_RequiredBudgetTypeDef = TypedDict(
    "_RequiredBudgetTypeDef", {"BudgetName": str, "TimeUnit": TimeUnit, "BudgetType": BudgetType}
)
...
_OptionalNotificationTypeDef = TypedDict(
    ...
    {"ThresholdType": ThresholdType, "NotificationState": NotificationState},
    total=False,
)
...
SsmActionDefinitionTypeDef = TypedDict(
    "SsmActionDefinitionTypeDef",
    {"ActionSubType": ActionSubType, "Region": str, "InstanceIds": List[str]},
)

SubscriberTypeDef = TypedDict(
    "SubscriberTypeDef", {"SubscriptionType": SubscriptionType, "Address": str}
)
...
ExecuteBudgetActionResponseTypeDef = TypedDict(
    "ExecuteBudgetActionResponseTypeDef",
    {"AccountId": str, "BudgetName": str, "ActionId": str, "ExecutionType": ExecutionType},
)
