...
class SolvingOptions(object):
    r""" Parameters for tuning the search"""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    direction = property(_pyBiDirectionalCpp.SolvingOptions_direction_get, _pyBiDirectionalCpp.SolvingOptions_direction_set, doc=r""" string with direction of search. Either: forward, backward, or both""")
    method = property(_pyBiDirectionalCpp.SolvingOptions_method_get, _pyBiDirectionalCpp.SolvingOptions_method_set, doc=r""" string with method to determine the next direction of search""")
    time_limit = property(_pyBiDirectionalCpp.SolvingOptions_time_limit_get, _pyBiDirectionalCpp.SolvingOptions_time_limit_set, doc=r""" double with time limit in seconds""")
    threshold = property(_pyBiDirectionalCpp.SolvingOptions_threshold_get, _pyBiDirectionalCpp.SolvingOptions_threshold_set, doc=r""" double with threshold to stop search with total cost <= threshold""")
    elementary = property(_pyBiDirectionalCpp.SolvingOptions_elementary_get, _pyBiDirectionalCpp.SolvingOptions_elementary_set, doc=r""" bool with whether output path is required to be elementary""")
    bounds_pruning = property(_pyBiDirectionalCpp.SolvingOptions_bounds_pruning_get, _pyBiDirectionalCpp.SolvingOptions_bounds_pruning_set, doc=r""" bool with whether lower bounds based on shortest paths are used to prune labels. Experimental!""")

    def __init__(self):
        _pyBiDirectionalCpp.SolvingOptions_swiginit(self, _pyBiDirectionalCpp.new_SolvingOptions())
    __swig_destroy__ = _pyBiDirectionalCpp.delete_SolvingOptions

# Register SolvingOptions in _pyBiDirectionalCpp:
_pyBiDirectionalCpp.SolvingOptions_swigregister(SolvingOptions)
...
class BiDirectionalCpp(object):
    ...
    options = property(_pyBiDirectionalCpp.BiDirectionalCpp_options_get, _pyBiDirectionalCpp.BiDirectionalCpp_options_set, doc=r""" Search options for the algorithm""")
...
def additiveBackwardREF(cumulative_resource: "DoubleVector", edge_resource_consumption: "DoubleVector") -> "std::vector< double,std::allocator< double > >":
    r""" Default additive REF for backward labels"""
    return _pyBiDirectionalCpp.additiveBackwardREF(cumulative_resource, edge_resource_consumption)
