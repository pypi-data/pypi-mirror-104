...
[boto3.NetworkManager 1.17.63](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/networkmanager.html#NetworkManager) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_networkmanager/README.md)
...
`mypy_boto3_networkmanager.literals` module contains literals extracted from shapes
...
def check_value(value: ConnectionState) -> bool:
    ...
```
