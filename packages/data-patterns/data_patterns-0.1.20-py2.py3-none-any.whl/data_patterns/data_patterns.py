...
class PatternMiner:
    ...
    def __init__(self,*args, **kwargs):
        ...
        # self.logfile = self.__process_key('logfile', None, "logger.log", *args, **kwargs)
        # self.loglevel = self.__process_key('loglevel', None, logging.DEBUG, *args, **kwargs)
        ...
        for idx in df_patterns.index:
            ...
            try:
                ...
                if total > 0:
                    ...
                    conf = 0
                pd.set_option('mode.chained_assignment', None)  # strange, suppress slice error
