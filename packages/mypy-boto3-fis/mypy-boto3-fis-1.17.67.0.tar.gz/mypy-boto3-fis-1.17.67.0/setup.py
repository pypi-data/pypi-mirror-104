...
setup(
    ...
    description="Type annotations for boto3.FIS 1.17.67 service, generated by mypy-boto3-buider 4.10.0",
    classifiers=[
    ...
    keywords="boto3 fis type-annotations boto3-stubs mypy typeshed autocomplete auto-generated",
