...
DurationTypeDef = TypedDict("DurationTypeDef", {"unit": DurationUnit, "value": int}, total=False)
...
GatewayRouteStatusTypeDef = TypedDict(
    "GatewayRouteStatusTypeDef", {"status": GatewayRouteStatusCode}
)
...
_OptionalHttpRetryPolicyTypeDef = TypedDict(
    ...
    {"httpRetryEvents": List[str], "tcpRetryEvents": List[TcpRetryPolicyEvent]},
    total=False,
)
...
_OptionalHttpRouteMatchTypeDef = TypedDict(
    ...
    {"headers": List["HttpRouteHeaderTypeDef"], "method": HttpMethod, "scheme": HttpScheme},
    total=False,
)
...
_RequiredListenerTlsTypeDef = TypedDict(
    ...
    {"certificate": "ListenerTlsCertificateTypeDef", "mode": ListenerTlsMode},
)
...
MeshStatusTypeDef = TypedDict("MeshStatusTypeDef", {"status": MeshStatusCode}, total=False)
...
PortMappingTypeDef = TypedDict("PortMappingTypeDef", {"port": int, "protocol": PortProtocol})
...
RouteStatusTypeDef = TypedDict("RouteStatusTypeDef", {"status": RouteStatusCode})
...
VirtualGatewayPortMappingTypeDef = TypedDict(
    "VirtualGatewayPortMappingTypeDef", {"port": int, "protocol": VirtualGatewayPortProtocol}
)
...
VirtualGatewayStatusTypeDef = TypedDict(
    "VirtualGatewayStatusTypeDef", {"status": VirtualGatewayStatusCode}
)
...
VirtualNodeStatusTypeDef = TypedDict("VirtualNodeStatusTypeDef", {"status": VirtualNodeStatusCode})
...
VirtualRouterStatusTypeDef = TypedDict(
    "VirtualRouterStatusTypeDef", {"status": VirtualRouterStatusCode}
)
...
VirtualServiceStatusTypeDef = TypedDict(
    "VirtualServiceStatusTypeDef", {"status": VirtualServiceStatusCode}
)
