...
from edge_impulse_sdk.models.create_user_response import CreateUserResponse  # noqa: E501
...
class TestCreateUserResponse(unittest.TestCase):
    ...
    def testCreateUserResponse(self):
        ...
        # model = edge_impulse_sdk.models.create_user_response.CreateUserResponse()  # noqa: E501
        pass
