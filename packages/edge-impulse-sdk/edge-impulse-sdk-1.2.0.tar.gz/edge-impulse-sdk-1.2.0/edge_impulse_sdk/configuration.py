...
class Configuration(six.with_metaclass(TypeWithDefault, object)):
    ...
    def __init__(self, host="https://studio.edgeimpulse.com/v1",
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("edge_impulse_sdk")
            ...
            'JWTHttpHeaderAuthentication':
                {
                    ...
                    'in': 'header',
                    'key': 'x-jwt-token',
                    'value': self.get_api_key_with_prefix('x-jwt-token')
                },
        }
