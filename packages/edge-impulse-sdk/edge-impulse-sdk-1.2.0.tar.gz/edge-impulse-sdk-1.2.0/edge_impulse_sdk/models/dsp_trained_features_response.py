...
class DspTrainedFeaturesResponse(object):
    ...
    attribute_map = {
        ...
        'data': 'data',
        'skip_first_features': 'skipFirstFeatures'
    }

    def __init__(self, success=None, error=None, total_sample_count=None, data=None, skip_first_features=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._data = None
        self._skip_first_features = None
    ...
    @property
    def skip_first_features(self):
        """Gets the skip_first_features of this DspTrainedFeaturesResponse.  # noqa: E501

        When showing the processed features, skip the first X features. This is used in dimensionality reduction where artificial features are introduced in the response (on the first few positions).  # noqa: E501

        :return: The skip_first_features of this DspTrainedFeaturesResponse.  # noqa: E501
        :rtype: int
        """
        return self._skip_first_features

    @skip_first_features.setter
    def skip_first_features(self, skip_first_features):
        """Sets the skip_first_features of this DspTrainedFeaturesResponse.

        When showing the processed features, skip the first X features. This is used in dimensionality reduction where artificial features are introduced in the response (on the first few positions).  # noqa: E501

        :param skip_first_features: The skip_first_features of this DspTrainedFeaturesResponse.  # noqa: E501
        :type: int
        """
        if self.local_vars_configuration.client_side_validation and skip_first_features is None:  # noqa: E501
            raise ValueError("Invalid value for `skip_first_features`, must not be `None`")  # noqa: E501

        self._skip_first_features = skip_first_features
