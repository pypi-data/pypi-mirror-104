...
LoadBalancerStateTypeDef = TypedDict(
    "LoadBalancerStateTypeDef", {"Code": LoadBalancerStateEnum, "Reason": str}, total=False
)
...
TargetHealthTypeDef = TypedDict(
    "TargetHealthTypeDef",
    {"State": TargetHealthStateEnum, "Reason": TargetHealthReasonEnum, "Description": str},
    total=False,
)
...
SetIpAddressTypeOutputTypeDef = TypedDict(
    "SetIpAddressTypeOutputTypeDef",
    {"IpAddressType": IpAddressType, "ResponseMetadata": "ResponseMetadata"},
    total=False,
)
