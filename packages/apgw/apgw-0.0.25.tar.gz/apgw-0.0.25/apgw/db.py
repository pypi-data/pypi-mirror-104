...
from apgw.types import (ConnectArgs, ConnectionArgs, InsertAssignments,
                        LimitOffset, Record, RecordsAndCount)
...
class DBBase:
    ...
    def set_connect(
        self, custom_connect: Callable[[ConnectArgs], Connection]
    ) -> "DBBase":
        self.connect = custom_connect
        return self
