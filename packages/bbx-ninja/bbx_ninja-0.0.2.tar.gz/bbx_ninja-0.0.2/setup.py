...
setup(
  ...
  description = 'BBX created for easing my life.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/gabinguo/bbx/releases/download/v0.0.1/bbx_ninja.tar',    # I explain this later on
  keywords = ['Scripts', 'Python', 'Anything'],   # Keywords that define your package best
