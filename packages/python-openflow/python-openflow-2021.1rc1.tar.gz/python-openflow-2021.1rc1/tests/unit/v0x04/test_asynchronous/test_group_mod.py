...
class TestGroupModRaw(TestStruct):
    """Test GroupMod using a dump file."""

    @classmethod
    def setUpClass(cls):
        """Configure raw file and its object in parent class (TestDump)."""
        super().setUpClass()
        super().set_raw_dump_file('v0x04', 'ofpt_group_mod')

        super().set_raw_dump_object(GroupMod, xid=4,
                                    command=0,
                                    group_type=2,
                                    # pad=0,
                                    group_id=8
        ...
        super().set_minimum_size(16)  # FIXME: confirm minimum size
