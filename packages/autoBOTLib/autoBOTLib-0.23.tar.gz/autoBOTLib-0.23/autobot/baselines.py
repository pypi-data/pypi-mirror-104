...
# -- Learnable linear combination of the feature types (e.g. LR with one weight per feature type) done

# - Complete the experimental evaluation with the missing feature configurations, i.e.:

# -- Manually fitted models with document embeddings done

# -- Manually fitted models with the full concatenated feature vector that autoBOT uses done
