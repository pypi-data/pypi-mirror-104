...
[boto3.CloudWatchLogs 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/logs.html#CloudWatchLogs) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_logs/README.md)
...
`mypy_boto3_logs.literals` module contains literals extracted from shapes
...
def get_structure() -> CreateExportTaskResponseTypeDef:
    return {
      ...
    }
```
