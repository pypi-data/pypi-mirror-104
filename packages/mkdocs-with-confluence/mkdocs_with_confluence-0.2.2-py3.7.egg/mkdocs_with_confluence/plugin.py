        ...
        if self.enabled:
            ...
            try:
                ...
                try:
                    ...
                    print(f"ERR({e}): No second parent! Assuming self.config[\"parent_page_name\"] {self.config['parent_page_name']}...")
                    parent = None
                if self.config["verbose"]:
                    print(f"{parent}")
                if not parent:
                ...
                try:
                    ...
                    if self.config["debug"]:
                        print("WARN(({e}): No images found in markdown. Proceed..")
