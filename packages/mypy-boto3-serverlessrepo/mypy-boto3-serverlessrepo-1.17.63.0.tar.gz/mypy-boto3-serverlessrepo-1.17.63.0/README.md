...
[boto3.ServerlessApplicationRepository 1.17.63](https://boto3.amazonaws.com/v1/documentation/api/1.17.63/reference/services/serverlessrepo.html#ServerlessApplicationRepository) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_serverlessrepo/README.md)
...
`mypy_boto3_serverlessrepo.literals` module contains literals extracted from shapes
...
def check_value(value: Capability) -> bool:
    ...
```
