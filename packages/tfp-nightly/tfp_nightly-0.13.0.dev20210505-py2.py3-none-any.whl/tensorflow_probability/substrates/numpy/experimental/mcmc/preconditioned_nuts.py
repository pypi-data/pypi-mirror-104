...
#   `tensorflow_probability/substrates/numpy/experimental/mcmc/preconditioned_nuts.py`
...
from tensorflow_probability.substrates.numpy.experimental.mcmc import preconditioning_utils as pu
