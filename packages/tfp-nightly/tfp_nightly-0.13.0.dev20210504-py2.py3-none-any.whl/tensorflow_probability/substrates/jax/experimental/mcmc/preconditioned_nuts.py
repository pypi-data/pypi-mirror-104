...
#   `tensorflow_probability/substrates/jax/experimental/mcmc/preconditioned_nuts.py`
...
from tensorflow_probability.substrates.jax.experimental.mcmc import preconditioning_utils as pu
