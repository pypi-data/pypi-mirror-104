...
class DockerHubConfig:
    def __init__(
        ...
        self.pull_expire_date = pull_expire_date or datetime.datetime.now() - datetime.timedelta(days=2, )
        self.push_expire_date = push_expire_date or datetime.datetime.now() - datetime.timedelta(days=5, )
