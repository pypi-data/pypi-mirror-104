...
class ApplicationApi(object):
    ...
    def login_application(self, api_key, **kwargs):  # noqa: E501
        ...
        >>> thread = api.login_application(api_key, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.login_application_with_http_info(api_key, **kwargs)  # noqa: E501
        else:
            (data) = self.login_application_with_http_info(api_key, **kwargs)  # noqa: E501
            return data

    def login_application_with_http_info(self, api_key, **kwargs):  # noqa: E501
        """Logs into Leia API  # noqa: E501

        Logs an application into Leia API using its API key. Returns a token that will have to be set in all subsequent requests, to identify the logged in application   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.login_application_with_http_info(api_key, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method login_application" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('api_key' not in params or
            ...
            raise ValueError("Missing the required parameter `api_key` when calling `login_application`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'api_key' in params:
            path_params['api_key'] = params['api_key']  # noqa: E501
    ...
    def logout_application(self, token, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.logout_application_with_http_info(token, **kwargs)  # noqa: E501
            return data

    def logout_application_with_http_info(self, token, **kwargs):  # noqa: E501
        """Logs out from Leia API  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method logout_application" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('token' not in params or
            ...
            raise ValueError("Missing the required parameter `token` when calling `logout_application`")  # noqa: E501
    ...
    def who_am_i(self, token, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.who_am_i_with_http_info(token, **kwargs)  # noqa: E501
            return data

    def who_am_i_with_http_info(self, token, **kwargs):  # noqa: E501
        """Gets the currently connected application  # noqa: E501
        ...
        if ('token' not in params or
                params['token'] is None):
            raise ValueError("Missing the required parameter `token` when calling `who_am_i`")  # noqa: E501
