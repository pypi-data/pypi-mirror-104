...
class DocumentAdminApi(object):
    ...
    def admin_transform_document_async_with_http_info(self, token, application_id, document_ids, output_type, **kwargs):  # noqa: E501
        ...
        all_params = ['token', 'application_id', 'document_ids', 'output_type', 'body', 'input_tag', 'output_tag', 'execute_after_id', 'page_range', 'callback_url', 'transform_params']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
