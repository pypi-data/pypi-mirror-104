...
class ApplicationServicesApi(object):
    ...
    def get_application_service_usage_metrics(self, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_application_service_usage_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_application_service_usage_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get application service metrics  # noqa: E501

        Retrieves all application service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_application_service_usage_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(UsageMetric, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_application_service_usage_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_application_service_usage_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/application_services/usage_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='UsageMetric',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_file_share_usage_metrics(self, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_file_share_usage_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_file_share_usage_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get file share service metrics  # noqa: E501

        Retrieves all file share service metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_file_share_usage_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_file_share_usage_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_file_share_usage_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/file_share_services/usage_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_application_services(self, **kwargs):  # noqa: E501
        ...
        :param str protocol_type: ApplicationService protocol type
        :param str name: Query the service by name
        :param str hostname: ApplicationService hostname query lookup
        :param str hostname_or_service_name: Perform a query based on the following       (hostname == hostname_or_service_name)            OR       (servicename == hostname_or_service_name AND hostname == localhost) 
        :param int port: ApplicationService port query lookup
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_application_services_with_http_info(**kwargs)  # noqa: E501

    def list_application_services_with_http_info(self, **kwargs):  # noqa: E501
        """Get a subset of the ApplicationServices  # noqa: E501

        Retrieves all ApplicationServices owned by the Organisation.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_application_services_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'updated_since', 'protocol_type', 'name', 'hostname', 'hostname_or_service_name', 'port']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'protocol_type' in local_var_params and local_var_params['protocol_type'] is not None:  # noqa: E501
            query_params.append(('protocol_type', local_var_params['protocol_type']))  # noqa: E501
        ...
        if 'hostname_or_service_name' in local_var_params and local_var_params['hostname_or_service_name'] is not None:  # noqa: E501
            query_params.append(('hostname_or_service_name', local_var_params['hostname_or_service_name']))  # noqa: E501
    ...
    def list_service_forwarders(self, **kwargs):  # noqa: E501
        ...
        :param str connector_id: connector id in query
        :param str app_service_connector_id: application service connector id in query
        :param datetime updated_since: query since updated
        :param int limit: limit the number of rows in the response
        :param list[str] org_ids: The list of org ids to search for. Each org will be searched for independently.
        :param _preload_content: if False, the urllib3.HTTPResponse object will
    ...
    def list_service_forwarders_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['org_id', 'name', 'app_service_id', 'connector_id', 'app_service_connector_id', 'updated_since', 'limit', 'org_ids']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'connector_id' in local_var_params and local_var_params['connector_id'] is not None:  # noqa: E501
            query_params.append(('connector_id', local_var_params['connector_id']))  # noqa: E501
        if 'app_service_connector_id' in local_var_params and local_var_params['app_service_connector_id'] is not None:  # noqa: E501
            query_params.append(('app_service_connector_id', local_var_params['app_service_connector_id']))  # noqa: E501
        if 'updated_since' in local_var_params and local_var_params['updated_since'] is not None:  # noqa: E501
            query_params.append(('updated_since', local_var_params['updated_since']))  # noqa: E501
        if 'limit' in local_var_params and local_var_params['limit'] is not None:  # noqa: E501
            query_params.append(('limit', local_var_params['limit']))  # noqa: E501
