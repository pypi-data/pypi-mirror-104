...
class ApplicationsApi(object):
    ...
    def get_all_usage_metrics(self, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_all_usage_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_all_usage_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get all resource metrics for the Applications API  # noqa: E501

        Retrieves all resource metrics for the Applications API for a specified the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_all_usage_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(UsageMetrics, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_usage_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
            ...
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_all_usage_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v1/resources/usage_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='UsageMetrics',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_application_usage_metrics(self, org_id, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_application_usage_metrics_with_http_info(org_id, **kwargs)  # noqa: E501

    def get_application_usage_metrics_with_http_info(self, org_id, **kwargs):  # noqa: E501
        """Get application metrics  # noqa: E501

        Retrieves all application metrics related to the org_id.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_application_usage_metrics_with_http_info(org_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_application_usage_metrics" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'org_id' is set
        if self.api_client.client_side_validation and ('org_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['org_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `org_id` when calling `get_application_usage_metrics`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/v2/applications/usage_metrics', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
