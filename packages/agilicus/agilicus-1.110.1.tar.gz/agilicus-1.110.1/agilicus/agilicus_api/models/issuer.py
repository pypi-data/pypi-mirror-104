...
class Issuer(object):
    ...
    openapi_types = {
        ...
        'upstream_group_mappings': 'list[UpstreamGroupMapping]',
        'name_slug': 'str'
    }
    ...
    attribute_map = {
        ...
        'clients': 'clients',
        'upstream_group_mappings': 'upstream_group_mappings',
        'name_slug': 'name_slug'
    }

    def __init__(self, id=None, issuer=None, enabled=True, org_id=None, theme_file_id=None, upstream_redirect_uri=None, managed_upstreams=None, oidc_upstreams=None, local_auth_upstreams=None, clients=None, upstream_group_mappings=None, name_slug=None, local_vars_configuration=None):  # noqa: E501
        ...
        self._clients = None
        self._upstream_group_mappings = None
        ...
        if upstream_group_mappings is not None:
            self.upstream_group_mappings = upstream_group_mappings
    ...
    def upstream_group_mappings(self):
        """Gets the upstream_group_mappings of this Issuer.  # noqa: E501

        List of upstream group mappings  # noqa: E501

        :return: The upstream_group_mappings of this Issuer.  # noqa: E501
        :rtype: list[UpstreamGroupMapping]
        """
        return self._upstream_group_mappings

    @upstream_group_mappings.setter
    def upstream_group_mappings(self, upstream_group_mappings):
        """Sets the upstream_group_mappings of this Issuer.

        List of upstream group mappings  # noqa: E501

        :param upstream_group_mappings: The upstream_group_mappings of this Issuer.  # noqa: E501
        :type: list[UpstreamGroupMapping]
        """

        self._upstream_group_mappings = upstream_group_mappings
