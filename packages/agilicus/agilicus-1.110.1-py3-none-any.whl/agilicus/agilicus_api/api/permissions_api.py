...
class PermissionsApi(object):
    ...
    def bulk_delete_resource_permission(self, **kwargs):  # noqa: E501
        ...
        return self.bulk_delete_resource_permission_with_http_info(**kwargs)  # noqa: E501

    def bulk_delete_resource_permission_with_http_info(self, **kwargs):  # noqa: E501
        """Delete a set of resource permissions matching the resource id  # noqa: E501

        Delete a set of resource permissions matching the resource  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.bulk_delete_resource_permission_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'resource_id', 'resource_type']  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method bulk_delete_resource_permission" % key
                )
        ...
        return self.api_client.call_api(
            '/v1/resource_permissions', 'DELETE',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_resource_roles(self, **kwargs):  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_resource_roles_with_http_info(**kwargs)  # noqa: E501

    def list_resource_roles_with_http_info(self, **kwargs):  # noqa: E501
        """List all ResourceRoles  # noqa: E501

        List all ResourceRoles  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_resource_roles_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['org_id', 'resource_type', 'resource_role_name', 'limit']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_resource_roles_for_type(self, resource_type, **kwargs):  # noqa: E501
        """List all ResourceRoles  # noqa: E501
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_resource_roles_for_type_with_http_info(resource_type, **kwargs)  # noqa: E501

    def list_resource_roles_for_type_with_http_info(self, resource_type, **kwargs):  # noqa: E501
        """List all ResourceRoles  # noqa: E501

        List all ResourceRoles for a given resource type.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_resource_roles_for_type_with_http_info(resource_type, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_resource_roles_for_type" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'resource_type' is set
        if self.api_client.client_side_validation and ('resource_type' not in local_var_params or  # noqa: E501
                                                        local_var_params['resource_type'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `resource_type` when calling `list_resource_roles_for_type`")  # noqa: E501

        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] > 500:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `list_resource_roles_for_type`, must be a value less than or equal to `500`")  # noqa: E501
        if self.api_client.client_side_validation and 'limit' in local_var_params and local_var_params['limit'] < 1:  # noqa: E501
            raise ApiValueError("Invalid value for parameter `limit` when calling `list_resource_roles_for_type`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
