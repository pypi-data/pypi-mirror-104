...
class ServiceForwarderSpec(object):
    ...
    def bind_address(self, bind_address):
        ...
        if (self.local_vars_configuration.client_side_validation and
                bind_address is not None and len(bind_address) > 255):
            raise ValueError("Invalid value for `bind_address`, length must be less than or equal to `255`")  # noqa: E501
    ...
    def application_service_id(self, application_service_id):
        ...
        :type: str
        """
        if self.local_vars_configuration.client_side_validation and application_service_id is None:  # noqa: E501
            raise ValueError("Invalid value for `application_service_id`, must not be `None`")  # noqa: E501
