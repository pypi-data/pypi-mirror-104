...
class ConnectorsApi(object):
    ...
    def create_agent_csr(self, connector_id, cert_signing_req, **kwargs):  # noqa: E501
        ...
        :param str private_key_id: query by private key id
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
    ...
    def create_agent_csr_with_http_info(self, connector_id, cert_signing_req, **kwargs):  # noqa: E501
        ...
        all_params = ['connector_id', 'cert_signing_req', 'private_key_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        query_params = []
        if 'private_key_id' in local_var_params and local_var_params['private_key_id'] is not None:  # noqa: E501
            query_params.append(('private_key_id', local_var_params['private_key_id']))  # noqa: E501
    ...
    def get_agent_info(self, connector_id, **kwargs):  # noqa: E501
        ...
        :param bool service_forwarders: Perform a query that returns the service forwarders in the response. 
    ...
    def get_agent_info_with_http_info(self, connector_id, **kwargs):  # noqa: E501
        ...
        all_params = ['connector_id', 'org_id', 'allow_list', 'service_forwarders', 'authz_public_key']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'service_forwarders' in local_var_params and local_var_params['service_forwarders'] is not None:  # noqa: E501
            query_params.append(('service_forwarders', local_var_params['service_forwarders']))  # noqa: E501
    ...
    def list_agent_csr_with_http_info(self, connector_id, **kwargs):  # noqa: E501
        ...
        all_params = ['connector_id', 'private_key_id', 'limit', 'org_id', 'reason', 'not_valid_after']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
