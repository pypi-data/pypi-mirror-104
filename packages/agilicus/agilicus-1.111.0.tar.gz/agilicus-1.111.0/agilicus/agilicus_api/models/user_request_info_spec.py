...
class UserRequestInfoSpec(object):
    ...
    def requested_resource(self):
        ...
        The resource the user is requesting. For example an application name if the request_type is application. If the request_type is fileshare, this would be the file share name.   # noqa: E501
    ...
    def requested_resource_type(self):
        ...
        The type of request a user is making. Note that `application_access` and `file_share_access` are deprecated. They have been replaced with `application` and `fileshare` respectively.   # noqa: E501
    ...
    def requested_resource_type(self, requested_resource_type):
        ...
        allowed_values = ["application_access", "file_share_access", "application", "fileshare", "application_service"]  # noqa: E501
