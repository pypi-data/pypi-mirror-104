...
@click.option("--remote-certificate-uri-base", type=str)
@click.option("--local-certificate-uri-base", type=str)
@click.pass_context
...
@click.option("--org-id", default=None)
@click.option("--user-id", default=None)
@click.option("--group_names_from_upstream", multiple=True)
@click.option("--group_guids_from_upstream", multiple=True)
@click.pass_context
