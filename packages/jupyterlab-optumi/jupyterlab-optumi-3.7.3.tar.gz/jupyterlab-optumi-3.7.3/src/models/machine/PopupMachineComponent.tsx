                            ...
                            <DialogContent style={{ padding: '0px', flexGrow: 1, overflowY: 'auto' }}>
                                {this.state.selectedPanel == Page.CAPABILITY ? (
                                    ...
                                    <>
                                        ...
                                        {placedApp && (
                                            <div style={{ margin: '6px' }}>
                                                {(placedApp.interactive ? 'Session' : 'Job') + " '" + placedApp.name + "' (" + placedApp.annotationOrRunNum + ") is " + (((placedApp.requisitioning.completed && !placedApp.requisitioning.error) && !placedApp.running.completed) ? 'running on' : 'waiting for') + ' this machine'}
                                            </div>
                                        )}
                                    </>
