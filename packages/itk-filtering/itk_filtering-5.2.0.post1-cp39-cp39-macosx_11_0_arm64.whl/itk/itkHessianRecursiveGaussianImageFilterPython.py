...
class itkHessianRecursiveGaussianImageFilterID4(itk.itkImageToImageFilterBPython.itkImageToImageFilterID4ISSRTD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4___New_orig__)
    Clone = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_Clone)
    SetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_GetSigma)
    SetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_SetNormalizeAcrossScale)
    GetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_GetNormalizeAcrossScale)
    GenerateInputRequestedRegion = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_GenerateInputRequestedRegion)
    ...
    cast = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_cast)
...
itkHessianRecursiveGaussianImageFilterID4___New_orig__ = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4___New_orig__
itkHessianRecursiveGaussianImageFilterID4_cast = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterID4_cast
...
class itkHessianRecursiveGaussianImageFilterIF4(itk.itkImageToImageFilterBPython.itkImageToImageFilterIF4ISSRTD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_Clone)
    SetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_GetSigma)
    SetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_SetNormalizeAcrossScale)
    GetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_GetNormalizeAcrossScale)
    GenerateInputRequestedRegion = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_GenerateInputRequestedRegion)
    ...
    cast = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_cast)
...
itkHessianRecursiveGaussianImageFilterIF4___New_orig__ = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4___New_orig__
itkHessianRecursiveGaussianImageFilterIF4_cast = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIF4_cast
...
class itkHessianRecursiveGaussianImageFilterISS4(itk.itkImageToImageFilterBPython.itkImageToImageFilterISS4ISSRTD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_Clone)
    SetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_GetSigma)
    SetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_SetNormalizeAcrossScale)
    GetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_GetNormalizeAcrossScale)
    GenerateInputRequestedRegion = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_GenerateInputRequestedRegion)
    ...
    cast = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_cast)
...
itkHessianRecursiveGaussianImageFilterISS4___New_orig__ = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4___New_orig__
itkHessianRecursiveGaussianImageFilterISS4_cast = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterISS4_cast
...
class itkHessianRecursiveGaussianImageFilterIUC4(itk.itkImageToImageFilterBPython.itkImageToImageFilterIUC4ISSRTD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_Clone)
    SetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_GetSigma)
    SetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_SetNormalizeAcrossScale)
    GetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_GetNormalizeAcrossScale)
    GenerateInputRequestedRegion = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_GenerateInputRequestedRegion)
    ...
    cast = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_cast)
...
itkHessianRecursiveGaussianImageFilterIUC4___New_orig__ = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4___New_orig__
itkHessianRecursiveGaussianImageFilterIUC4_cast = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUC4_cast
...
class itkHessianRecursiveGaussianImageFilterIUS4(itk.itkImageToImageFilterBPython.itkImageToImageFilterIUS4ISSRTD44):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_Clone)
    SetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_GetSigma)
    SetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_SetNormalizeAcrossScale)
    GetNormalizeAcrossScale = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_GetNormalizeAcrossScale)
    GenerateInputRequestedRegion = _swig_new_instance_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_GenerateInputRequestedRegion)
    ...
    cast = _swig_new_static_method(_itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_cast)
...
itkHessianRecursiveGaussianImageFilterIUS4___New_orig__ = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4___New_orig__
itkHessianRecursiveGaussianImageFilterIUS4_cast = _itkHessianRecursiveGaussianImageFilterPython.itkHessianRecursiveGaussianImageFilterIUS4_cast
