...
class itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_Clone)
    GetVariance = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_GetVariance)
    GetMaximumError = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_GetMaximumError)
    GetBackgroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_GetBackgroundValue)
    SetBackgroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_SetBackgroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_GetForegroundValue)
    SetForegroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_SetForegroundValue)
    SetVariance = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_SetVariance)
    SetMaximumError = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_SetMaximumError)
    ...
    cast = _swig_new_static_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_cast)
...
itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4___New_orig__ = _itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4___New_orig__
itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_cast = _itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterID4ID4_cast
...
class itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_Clone)
    GetVariance = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_GetVariance)
    GetMaximumError = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_GetMaximumError)
    GetBackgroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_GetBackgroundValue)
    SetBackgroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_SetBackgroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_GetForegroundValue)
    SetForegroundValue = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_SetForegroundValue)
    SetVariance = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_SetVariance)
    SetMaximumError = _swig_new_instance_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_SetMaximumError)
    ...
    cast = _swig_new_static_method(_itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_cast)
...
itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4___New_orig__ = _itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4___New_orig__
itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_cast = _itkZeroCrossingBasedEdgeDetectionImageFilterPython.itkZeroCrossingBasedEdgeDetectionImageFilterIF4IF4_cast
