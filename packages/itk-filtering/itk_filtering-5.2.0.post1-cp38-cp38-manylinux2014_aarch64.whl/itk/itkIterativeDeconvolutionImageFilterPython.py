...
class itkIterativeDeconvolutionImageFilterID4ID4(itk.itkFFTConvolutionImageFilterPython.itkFFTConvolutionImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_SetNumberOfIterations)
    GetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_GetNumberOfIterations)
    GetModifiableCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_GetModifiableCurrentEstimate)
    GetCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_GetCurrentEstimate)
    SetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_SetStopIteration)
    GetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_GetStopIteration)
    GetIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_GetIteration)
    __swig_destroy__ = _itkIterativeDeconvolutionImageFilterPython.delete_itkIterativeDeconvolutionImageFilterID4ID4
    cast = _swig_new_static_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_cast)
...
itkIterativeDeconvolutionImageFilterID4ID4_cast = _itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterID4ID4_cast
...
class itkIterativeDeconvolutionImageFilterIF4IF4(itk.itkFFTConvolutionImageFilterPython.itkFFTConvolutionImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_SetNumberOfIterations)
    GetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_GetNumberOfIterations)
    GetModifiableCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_GetModifiableCurrentEstimate)
    GetCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_GetCurrentEstimate)
    SetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_SetStopIteration)
    GetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_GetStopIteration)
    GetIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_GetIteration)
    __swig_destroy__ = _itkIterativeDeconvolutionImageFilterPython.delete_itkIterativeDeconvolutionImageFilterIF4IF4
    cast = _swig_new_static_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_cast)
...
itkIterativeDeconvolutionImageFilterIF4IF4_cast = _itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIF4IF4_cast
...
class itkIterativeDeconvolutionImageFilterISS4ISS4(itk.itkFFTConvolutionImageFilterPython.itkFFTConvolutionImageFilterISS4ISS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_SetNumberOfIterations)
    GetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_GetNumberOfIterations)
    GetModifiableCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_GetModifiableCurrentEstimate)
    GetCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_GetCurrentEstimate)
    SetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_SetStopIteration)
    GetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_GetStopIteration)
    GetIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_GetIteration)
    __swig_destroy__ = _itkIterativeDeconvolutionImageFilterPython.delete_itkIterativeDeconvolutionImageFilterISS4ISS4
    cast = _swig_new_static_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_cast)
...
itkIterativeDeconvolutionImageFilterISS4ISS4_cast = _itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterISS4ISS4_cast
...
class itkIterativeDeconvolutionImageFilterIUC4IUC4(itk.itkFFTConvolutionImageFilterPython.itkFFTConvolutionImageFilterIUC4IUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_SetNumberOfIterations)
    GetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_GetNumberOfIterations)
    GetModifiableCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_GetModifiableCurrentEstimate)
    GetCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_GetCurrentEstimate)
    SetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_SetStopIteration)
    GetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_GetStopIteration)
    GetIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_GetIteration)
    __swig_destroy__ = _itkIterativeDeconvolutionImageFilterPython.delete_itkIterativeDeconvolutionImageFilterIUC4IUC4
    cast = _swig_new_static_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_cast)
...
itkIterativeDeconvolutionImageFilterIUC4IUC4_cast = _itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUC4IUC4_cast
...
class itkIterativeDeconvolutionImageFilterIUS4IUS4(itk.itkFFTConvolutionImageFilterPython.itkFFTConvolutionImageFilterIUS4IUS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    SetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_SetNumberOfIterations)
    GetNumberOfIterations = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_GetNumberOfIterations)
    GetModifiableCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_GetModifiableCurrentEstimate)
    GetCurrentEstimate = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_GetCurrentEstimate)
    SetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_SetStopIteration)
    GetStopIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_GetStopIteration)
    GetIteration = _swig_new_instance_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_GetIteration)
    __swig_destroy__ = _itkIterativeDeconvolutionImageFilterPython.delete_itkIterativeDeconvolutionImageFilterIUS4IUS4
    cast = _swig_new_static_method(_itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_cast)
...
itkIterativeDeconvolutionImageFilterIUS4IUS4_cast = _itkIterativeDeconvolutionImageFilterPython.itkIterativeDeconvolutionImageFilterIUS4IUS4_cast
