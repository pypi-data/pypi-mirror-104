...
def itkShapeLabelMapFilterLM4_New():
    return itkShapeLabelMapFilterLM4.New()

class itkShapeLabelMapFilterLM4(itk.itkInPlaceLabelMapFilterPython.itkInPlaceLabelMapFilterLM4):
    r"""
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4___New_orig__)
    Clone = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_Clone)
    SetComputeFeretDiameter = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_SetComputeFeretDiameter)
    GetComputeFeretDiameter = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_GetComputeFeretDiameter)
    ComputeFeretDiameterOn = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputeFeretDiameterOn)
    ComputeFeretDiameterOff = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputeFeretDiameterOff)
    SetComputePerimeter = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_SetComputePerimeter)
    GetComputePerimeter = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_GetComputePerimeter)
    ComputePerimeterOn = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputePerimeterOn)
    ComputePerimeterOff = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputePerimeterOff)
    SetComputeOrientedBoundingBox = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_SetComputeOrientedBoundingBox)
    GetComputeOrientedBoundingBox = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_GetComputeOrientedBoundingBox)
    ComputeOrientedBoundingBoxOn = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputeOrientedBoundingBoxOn)
    ComputeOrientedBoundingBoxOff = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_ComputeOrientedBoundingBoxOff)
    SetLabelImage = _swig_new_instance_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_SetLabelImage)
    __swig_destroy__ = _itkShapeLabelMapFilterPython.delete_itkShapeLabelMapFilterLM4
    cast = _swig_new_static_method(_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_cast)

    def New(*args, **kargs):
        """New() -> itkShapeLabelMapFilterLM4

        Create a new object of the class itkShapeLabelMapFilterLM4 and set the input and the parameters if some
        named or non-named arguments are passed to that method.
        ...
        Ex:
          ...
          itkShapeLabelMapFilterLM4.New(reader, threshold=10)

        is (most of the time) equivalent to:

          obj = itkShapeLabelMapFilterLM4.New()
          obj.SetInput(0, reader.GetOutput())
          obj.SetThreshold(10)
        """
        obj = itkShapeLabelMapFilterLM4.__New_orig__()
        from itk.support import template_class
        template_class.New(obj, *args, **kargs)
        return obj
    New = staticmethod(New)
...
# Register itkShapeLabelMapFilterLM4 in _itkShapeLabelMapFilterPython:
_itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_swigregister(itkShapeLabelMapFilterLM4)
itkShapeLabelMapFilterLM4___New_orig__ = _itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4___New_orig__
itkShapeLabelMapFilterLM4_cast = _itkShapeLabelMapFilterPython.itkShapeLabelMapFilterLM4_cast
