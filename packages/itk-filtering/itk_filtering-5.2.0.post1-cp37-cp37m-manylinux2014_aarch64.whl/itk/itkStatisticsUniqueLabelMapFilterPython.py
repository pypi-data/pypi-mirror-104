...
class itkStatisticsUniqueLabelMapFilterLM4(itk.itkShapeUniqueLabelMapFilterPython.itkShapeUniqueLabelMapFilterLM4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkStatisticsUniqueLabelMapFilterPython.itkStatisticsUniqueLabelMapFilterLM4___New_orig__)
    Clone = _swig_new_instance_method(_itkStatisticsUniqueLabelMapFilterPython.itkStatisticsUniqueLabelMapFilterLM4_Clone)
    __swig_destroy__ = _itkStatisticsUniqueLabelMapFilterPython.delete_itkStatisticsUniqueLabelMapFilterLM4
    cast = _swig_new_static_method(_itkStatisticsUniqueLabelMapFilterPython.itkStatisticsUniqueLabelMapFilterLM4_cast)
...
itkStatisticsUniqueLabelMapFilterLM4___New_orig__ = _itkStatisticsUniqueLabelMapFilterPython.itkStatisticsUniqueLabelMapFilterLM4___New_orig__
itkStatisticsUniqueLabelMapFilterLM4_cast = _itkStatisticsUniqueLabelMapFilterPython.itkStatisticsUniqueLabelMapFilterLM4_cast
...
def statistics_unique_label_map_filter(*args: itkt.ImageLike,  reverse_ordering: bool=..., attribute: int=...,**kwargs)-> itkt.ImageSourceReturn:
