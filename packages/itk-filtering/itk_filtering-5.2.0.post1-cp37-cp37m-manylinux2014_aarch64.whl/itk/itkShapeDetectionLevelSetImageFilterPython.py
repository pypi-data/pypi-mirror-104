...
class itkShapeDetectionLevelSetImageFilterID4ID4D(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterID4ID4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterID4ID4D___New_orig__)
    Clone = _swig_new_instance_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterID4ID4D_Clone)
    __swig_destroy__ = _itkShapeDetectionLevelSetImageFilterPython.delete_itkShapeDetectionLevelSetImageFilterID4ID4D
    cast = _swig_new_static_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterID4ID4D_cast)
...
itkShapeDetectionLevelSetImageFilterID4ID4D___New_orig__ = _itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterID4ID4D___New_orig__
itkShapeDetectionLevelSetImageFilterID4ID4D_cast = _itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterID4ID4D_cast
...
class itkShapeDetectionLevelSetImageFilterIF4IF4F(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterIF4IF4F):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterIF4IF4F___New_orig__)
    Clone = _swig_new_instance_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterIF4IF4F_Clone)
    __swig_destroy__ = _itkShapeDetectionLevelSetImageFilterPython.delete_itkShapeDetectionLevelSetImageFilterIF4IF4F
    cast = _swig_new_static_method(_itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterIF4IF4F_cast)
...
itkShapeDetectionLevelSetImageFilterIF4IF4F___New_orig__ = _itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterIF4IF4F___New_orig__
itkShapeDetectionLevelSetImageFilterIF4IF4F_cast = _itkShapeDetectionLevelSetImageFilterPython.itkShapeDetectionLevelSetImageFilterIF4IF4F_cast
