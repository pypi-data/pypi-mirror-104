...
class itkFastMarchingUpwindGradientImageFilterID4ID4(itk.itkFastMarchingImageFilterPython.itkFastMarchingImageFilterID4ID4):
    ...
    NoTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterID4ID4_NoTargets
    
    OneTarget = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterID4ID4_OneTarget
    
    SomeTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterID4ID4_SomeTargets
    
    AllTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterID4ID4_AllTargets
...
class itkFastMarchingUpwindGradientImageFilterIF4IF4(itk.itkFastMarchingImageFilterPython.itkFastMarchingImageFilterIF4IF4):
    ...
    NoTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterIF4IF4_NoTargets
    
    OneTarget = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterIF4IF4_OneTarget
    
    SomeTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterIF4IF4_SomeTargets
    
    AllTargets = _itkFastMarchingUpwindGradientImageFilterPython.itkFastMarchingUpwindGradientImageFilterIF4IF4_AllTargets
