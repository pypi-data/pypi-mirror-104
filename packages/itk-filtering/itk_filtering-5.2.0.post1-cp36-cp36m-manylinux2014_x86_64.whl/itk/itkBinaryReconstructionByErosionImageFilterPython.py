...
class itkBinaryReconstructionByErosionImageFilterISS4(itk.itkImageToImageFilterAPython.itkImageToImageFilterISS4ISS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_Clone)
    SetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_SetFullyConnected)
    GetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_GetFullyConnected)
    FullyConnectedOn = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_FullyConnectedOn)
    FullyConnectedOff = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_FullyConnectedOff)
    ...
    SetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_SetBackgroundValue)
    GetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_GetBackgroundValue)
    SetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_SetForegroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_GetForegroundValue)
    SetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_SetMarkerImage)
    GetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_GetMarkerImage)
    SetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_GetMaskImage)
    ...
    cast = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_cast)
...
itkBinaryReconstructionByErosionImageFilterISS4___New_orig__ = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4___New_orig__
itkBinaryReconstructionByErosionImageFilterISS4_cast = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterISS4_cast
...
class itkBinaryReconstructionByErosionImageFilterIUC4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUC4IUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_Clone)
    SetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_SetFullyConnected)
    GetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_GetFullyConnected)
    FullyConnectedOn = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_FullyConnectedOn)
    FullyConnectedOff = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_FullyConnectedOff)
    ...
    SetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_SetBackgroundValue)
    GetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_GetBackgroundValue)
    SetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_SetForegroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_GetForegroundValue)
    SetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_SetMarkerImage)
    GetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_GetMarkerImage)
    SetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_GetMaskImage)
    ...
    cast = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_cast)
...
itkBinaryReconstructionByErosionImageFilterIUC4___New_orig__ = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4___New_orig__
itkBinaryReconstructionByErosionImageFilterIUC4_cast = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUC4_cast
...
class itkBinaryReconstructionByErosionImageFilterIUS4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUS4IUS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_Clone)
    SetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_SetFullyConnected)
    GetFullyConnected = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_GetFullyConnected)
    FullyConnectedOn = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_FullyConnectedOn)
    FullyConnectedOff = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_FullyConnectedOff)
    ...
    SetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_SetBackgroundValue)
    GetBackgroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_GetBackgroundValue)
    SetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_SetForegroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_GetForegroundValue)
    SetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_SetMarkerImage)
    GetMarkerImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_GetMarkerImage)
    SetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_SetMaskImage)
    GetMaskImage = _swig_new_instance_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_GetMaskImage)
    ...
    cast = _swig_new_static_method(_itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_cast)
...
itkBinaryReconstructionByErosionImageFilterIUS4___New_orig__ = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4___New_orig__
itkBinaryReconstructionByErosionImageFilterIUS4_cast = _itkBinaryReconstructionByErosionImageFilterPython.itkBinaryReconstructionByErosionImageFilterIUS4_cast
