...
class itkMaskedFFTNormalizedCorrelationImageFilterID4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterID4ID4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4ID4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterID4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterID4IF4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterID4IF4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4ID4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIF4IF4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterISS4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4ID4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterISS4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterISS4IF4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUC4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4ID4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUC4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUC4IF4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUS4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4ID4_cast
...
class itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIUS4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_Clone)
    SetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetFixedImage)
    GetFixedImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetFixedImage)
    SetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetMovingImage)
    GetMovingImage = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetMovingImage)
    SetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetFixedImageMask)
    GetFixedImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetFixedImageMask)
    SetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetMovingImageMask)
    GetMovingImageMask = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetMovingImageMask)
    SetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetRequiredNumberOfOverlappingPixels)
    GetRequiredNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetRequiredNumberOfOverlappingPixels)
    GetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetRequiredFractionOfOverlappingPixels)
    SetRequiredFractionOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_SetRequiredFractionOfOverlappingPixels)
    GetMaximumNumberOfOverlappingPixels = _swig_new_instance_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_GetMaximumNumberOfOverlappingPixels)
    ...
    cast = _swig_new_static_method(_itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_cast)
...
itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4___New_orig__ = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4___New_orig__
itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_cast = _itkMaskedFFTNormalizedCorrelationImageFilterPython.itkMaskedFFTNormalizedCorrelationImageFilterIUS4IF4_cast
