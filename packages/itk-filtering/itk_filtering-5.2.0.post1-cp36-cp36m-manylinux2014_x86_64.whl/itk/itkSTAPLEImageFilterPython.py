...
class itkSTAPLEImageFilterID4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_Clone)
    SetForegroundValue = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_SetForegroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetForegroundValue)
    GetSensitivity = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetSensitivity)
    GetSpecificity = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetSpecificity)
    SetMaximumIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_SetMaximumIterations)
    GetMaximumIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetMaximumIterations)
    SetConfidenceWeight = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_SetConfidenceWeight)
    GetConfidenceWeight = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetConfidenceWeight)
    GetElapsedIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_GetElapsedIterations)
    ...
    cast = _swig_new_static_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_cast)
...
itkSTAPLEImageFilterID4ID4___New_orig__ = _itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4___New_orig__
itkSTAPLEImageFilterID4ID4_cast = _itkSTAPLEImageFilterPython.itkSTAPLEImageFilterID4ID4_cast
...
class itkSTAPLEImageFilterIF4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_Clone)
    SetForegroundValue = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_SetForegroundValue)
    GetForegroundValue = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetForegroundValue)
    GetSensitivity = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetSensitivity)
    GetSpecificity = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetSpecificity)
    SetMaximumIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_SetMaximumIterations)
    GetMaximumIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetMaximumIterations)
    SetConfidenceWeight = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_SetConfidenceWeight)
    GetConfidenceWeight = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetConfidenceWeight)
    GetElapsedIterations = _swig_new_instance_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_GetElapsedIterations)
    ...
    cast = _swig_new_static_method(_itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_cast)
...
itkSTAPLEImageFilterIF4IF4___New_orig__ = _itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4___New_orig__
itkSTAPLEImageFilterIF4IF4_cast = _itkSTAPLEImageFilterPython.itkSTAPLEImageFilterIF4IF4_cast
