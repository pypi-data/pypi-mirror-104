...
class itkParallelSparseFieldLevelSetImageFilterID4ID4(itk.itkFiniteDifferenceImageFilterPython.itkFiniteDifferenceImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_Clone)
    SetNumberOfLayers = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_SetNumberOfLayers)
    GetNumberOfLayers = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_GetNumberOfLayers)
    SetIsoSurfaceValue = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_SetIsoSurfaceValue)
    GetIsoSurfaceValue = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_GetIsoSurfaceValue)
    GetActiveListForIndex = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_GetActiveListForIndex)
    ...
    cast = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_cast)
...
itkParallelSparseFieldLevelSetImageFilterID4ID4___New_orig__ = _itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4___New_orig__
itkParallelSparseFieldLevelSetImageFilterID4ID4_cast = _itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterID4ID4_cast
...
class itkParallelSparseFieldLevelSetImageFilterIF4IF4(itk.itkFiniteDifferenceImageFilterPython.itkFiniteDifferenceImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_Clone)
    SetNumberOfLayers = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_SetNumberOfLayers)
    GetNumberOfLayers = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_GetNumberOfLayers)
    SetIsoSurfaceValue = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_SetIsoSurfaceValue)
    GetIsoSurfaceValue = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_GetIsoSurfaceValue)
    GetActiveListForIndex = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_GetActiveListForIndex)
    ...
    cast = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_cast)
...
itkParallelSparseFieldLevelSetImageFilterIF4IF4___New_orig__ = _itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4___New_orig__
itkParallelSparseFieldLevelSetImageFilterIF4IF4_cast = _itkParallelSparseFieldLevelSetImageFilterPython.itkParallelSparseFieldLevelSetImageFilterIF4IF4_cast
...
class itkSparseFieldLayerPSFLSNI4(itk.ITKCommonBasePython.itkObject):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4___New_orig__)
    Clone = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_Clone)
    Front = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_Front)
    PopFront = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_PopFront)
    PushFront = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_PushFront)
    Unlink = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_Unlink)
    Empty = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_Empty)
    Size = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_Size)
    SplitRegions = _swig_new_instance_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_SplitRegions)
    __swig_destroy__ = _itkParallelSparseFieldLevelSetImageFilterPython.delete_itkSparseFieldLayerPSFLSNI4
    cast = _swig_new_static_method(_itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_cast)
...
itkSparseFieldLayerPSFLSNI4___New_orig__ = _itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4___New_orig__
itkSparseFieldLayerPSFLSNI4_cast = _itkParallelSparseFieldLevelSetImageFilterPython.itkSparseFieldLayerPSFLSNI4_cast
