...
class itkGaussianImageSourceID4(itk.itkParametricImageSourcePython.itkParametricImageSourceID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4___New_orig__)
    Clone = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_Clone)
    SetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_SetScale)
    GetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_GetScale)
    SetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_SetNormalized)
    GetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_GetNormalized)
    NormalizedOn = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_NormalizedOn)
    NormalizedOff = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_NormalizedOff)
    SetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_GetSigma)
    SetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_SetMean)
    GetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_GetMean)
    __swig_destroy__ = _itkGaussianImageSourcePython.delete_itkGaussianImageSourceID4
    cast = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceID4_cast)
...
itkGaussianImageSourceID4___New_orig__ = _itkGaussianImageSourcePython.itkGaussianImageSourceID4___New_orig__
itkGaussianImageSourceID4_cast = _itkGaussianImageSourcePython.itkGaussianImageSourceID4_cast
...
class itkGaussianImageSourceIF4(itk.itkParametricImageSourcePython.itkParametricImageSourceIF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_Clone)
    SetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_SetScale)
    GetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_GetScale)
    SetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_SetNormalized)
    GetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_GetNormalized)
    NormalizedOn = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_NormalizedOn)
    NormalizedOff = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_NormalizedOff)
    SetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_GetSigma)
    SetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_SetMean)
    GetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_GetMean)
    __swig_destroy__ = _itkGaussianImageSourcePython.delete_itkGaussianImageSourceIF4
    cast = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIF4_cast)
...
itkGaussianImageSourceIF4___New_orig__ = _itkGaussianImageSourcePython.itkGaussianImageSourceIF4___New_orig__
itkGaussianImageSourceIF4_cast = _itkGaussianImageSourcePython.itkGaussianImageSourceIF4_cast
...
class itkGaussianImageSourceISS4(itk.itkParametricImageSourcePython.itkParametricImageSourceISS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4___New_orig__)
    Clone = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_Clone)
    SetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_SetScale)
    GetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_GetScale)
    SetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_SetNormalized)
    GetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_GetNormalized)
    NormalizedOn = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_NormalizedOn)
    NormalizedOff = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_NormalizedOff)
    SetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_GetSigma)
    SetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_SetMean)
    GetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_GetMean)
    __swig_destroy__ = _itkGaussianImageSourcePython.delete_itkGaussianImageSourceISS4
    cast = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceISS4_cast)
...
itkGaussianImageSourceISS4___New_orig__ = _itkGaussianImageSourcePython.itkGaussianImageSourceISS4___New_orig__
itkGaussianImageSourceISS4_cast = _itkGaussianImageSourcePython.itkGaussianImageSourceISS4_cast
...
class itkGaussianImageSourceIUC4(itk.itkParametricImageSourcePython.itkParametricImageSourceIUC4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4___New_orig__)
    Clone = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_Clone)
    SetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_SetScale)
    GetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_GetScale)
    SetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_SetNormalized)
    GetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_GetNormalized)
    NormalizedOn = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_NormalizedOn)
    NormalizedOff = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_NormalizedOff)
    SetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_GetSigma)
    SetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_SetMean)
    GetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_GetMean)
    __swig_destroy__ = _itkGaussianImageSourcePython.delete_itkGaussianImageSourceIUC4
    cast = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_cast)
...
itkGaussianImageSourceIUC4___New_orig__ = _itkGaussianImageSourcePython.itkGaussianImageSourceIUC4___New_orig__
itkGaussianImageSourceIUC4_cast = _itkGaussianImageSourcePython.itkGaussianImageSourceIUC4_cast
...
class itkGaussianImageSourceIUS4(itk.itkParametricImageSourcePython.itkParametricImageSourceIUS4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4___New_orig__)
    Clone = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_Clone)
    SetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_SetScale)
    GetScale = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_GetScale)
    SetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_SetNormalized)
    GetNormalized = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_GetNormalized)
    NormalizedOn = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_NormalizedOn)
    NormalizedOff = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_NormalizedOff)
    SetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_SetSigma)
    GetSigma = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_GetSigma)
    SetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_SetMean)
    GetMean = _swig_new_instance_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_GetMean)
    __swig_destroy__ = _itkGaussianImageSourcePython.delete_itkGaussianImageSourceIUS4
    cast = _swig_new_static_method(_itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_cast)
...
itkGaussianImageSourceIUS4___New_orig__ = _itkGaussianImageSourcePython.itkGaussianImageSourceIUS4___New_orig__
itkGaussianImageSourceIUS4_cast = _itkGaussianImageSourcePython.itkGaussianImageSourceIUS4_cast
