...
class itkCannyEdgeDetectionImageFilterID4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_Clone)
    GetVariance = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_GetVariance)
    GetMaximumError = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_GetMaximumError)
    SetVariance = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_SetVariance)
    SetMaximumError = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_SetMaximumError)
    SetUpperThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_SetUpperThreshold)
    GetUpperThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_GetUpperThreshold)
    SetLowerThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_SetLowerThreshold)
    GetLowerThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_GetLowerThreshold)
    GetNonMaximumSuppressionImage = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_GetNonMaximumSuppressionImage)
    ...
    cast = _swig_new_static_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_cast)
...
itkCannyEdgeDetectionImageFilterID4ID4___New_orig__ = _itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4___New_orig__
itkCannyEdgeDetectionImageFilterID4ID4_cast = _itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterID4ID4_cast
...
class itkCannyEdgeDetectionImageFilterIF4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_Clone)
    GetVariance = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_GetVariance)
    GetMaximumError = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_GetMaximumError)
    SetVariance = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_SetVariance)
    SetMaximumError = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_SetMaximumError)
    SetUpperThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_SetUpperThreshold)
    GetUpperThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_GetUpperThreshold)
    SetLowerThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_SetLowerThreshold)
    GetLowerThreshold = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_GetLowerThreshold)
    GetNonMaximumSuppressionImage = _swig_new_instance_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_GetNonMaximumSuppressionImage)
    ...
    cast = _swig_new_static_method(_itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_cast)
...
itkCannyEdgeDetectionImageFilterIF4IF4___New_orig__ = _itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4___New_orig__
itkCannyEdgeDetectionImageFilterIF4IF4_cast = _itkCannyEdgeDetectionImageFilterPython.itkCannyEdgeDetectionImageFilterIF4IF4_cast
