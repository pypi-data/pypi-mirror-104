...
class mapitkStatisticsLabelObjectUL4(collections.abc.MutableMapping):
    r"""Proxy of C++ std::map< unsigned long,itkStatisticsLabelObjectUL4_Pointer,std::less< unsigned long > > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___nonzero__)
    __bool__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___bool__)
    __len__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___len__)
    def __iter__(self):
        return self.key_iterator()
    def iterkeys(self):
        return self.key_iterator()
    ...
    def iteritems(self):
        return self.iterator()
    __getitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___getitem__)
    __delitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___delitem__)
    has_key = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_has_key)
    keys = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_keys)
    values = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_values)
    items = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_items)
    __contains__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___contains__)
    key_iterator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_key_iterator)
    value_iterator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_value_iterator)
    __setitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4___setitem__)
    asdict = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_asdict)
    ...
    empty = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_empty)
    size = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_size)
    swap = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_swap)
    begin = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_begin)
    end = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_end)
    rbegin = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_rbegin)
    rend = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_rend)
    clear = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_clear)
    get_allocator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_get_allocator)
    count = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_count)
    erase = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_erase)
    find = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_find)
    lower_bound = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_lower_bound)
    upper_bound = _swig_new_instance_method(_itkStatisticsLabelObjectPython.mapitkStatisticsLabelObjectUL4_upper_bound)
...
class vectoritkStatisticsLabelObjectUL4(collections.abc.MutableSequence):
    r"""Proxy of C++ std::vector< itkStatisticsLabelObjectUL4_Pointer > class."""

    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___nonzero__)
    __bool__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___bool__)
    __len__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___len__)
    __getslice__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___getslice__)
    __setslice__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___setslice__)
    __delslice__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___delslice__)
    __delitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___delitem__)
    __getitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___getitem__)
    __setitem__ = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4___setitem__)
    pop = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_pop)
    append = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_append)
    empty = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_empty)
    size = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_size)
    swap = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_swap)
    begin = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_begin)
    end = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_end)
    rbegin = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_rbegin)
    rend = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_rend)
    clear = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_clear)
    get_allocator = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_get_allocator)
    pop_back = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_pop_back)
    erase = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_erase)
    ...
    push_back = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_push_back)
    front = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_front)
    back = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_back)
    assign = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_assign)
    resize = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_resize)
    insert = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_insert)
    reserve = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_reserve)
    capacity = _swig_new_instance_method(_itkStatisticsLabelObjectPython.vectoritkStatisticsLabelObjectUL4_capacity)
...
class itkStatisticsLabelObjectUL4(itk.itkShapeLabelObjectPython.itkShapeLabelObjectUL4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4___New_orig__)
    Clone = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_Clone)
    GetAttributeFromName = _swig_new_static_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetAttributeFromName)
    GetNameFromAttribute = _swig_new_static_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetNameFromAttribute)
    GetMinimum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMinimum)
    SetMinimum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMinimum)
    GetMaximum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMaximum)
    SetMaximum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMaximum)
    GetMean = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMean)
    SetMean = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMean)
    GetSum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetSum)
    SetSum = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetSum)
    GetStandardDeviation = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetStandardDeviation)
    SetStandardDeviation = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetStandardDeviation)
    GetVariance = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetVariance)
    SetVariance = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetVariance)
    GetMedian = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMedian)
    SetMedian = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMedian)
    GetMaximumIndex = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMaximumIndex)
    SetMaximumIndex = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMaximumIndex)
    GetMinimumIndex = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetMinimumIndex)
    SetMinimumIndex = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetMinimumIndex)
    GetCenterOfGravity = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetCenterOfGravity)
    SetCenterOfGravity = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetCenterOfGravity)
    GetWeightedPrincipalMoments = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetWeightedPrincipalMoments)
    SetWeightedPrincipalMoments = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetWeightedPrincipalMoments)
    GetWeightedPrincipalAxes = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetWeightedPrincipalAxes)
    SetWeightedPrincipalAxes = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetWeightedPrincipalAxes)
    GetSkewness = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetSkewness)
    SetSkewness = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetSkewness)
    GetKurtosis = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetKurtosis)
    SetKurtosis = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetKurtosis)
    GetWeightedElongation = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetWeightedElongation)
    SetWeightedElongation = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetWeightedElongation)
    GetHistogram = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetHistogram)
    SetHistogram = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetHistogram)
    GetWeightedFlatness = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetWeightedFlatness)
    SetWeightedFlatness = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_SetWeightedFlatness)
    GetWeightedPrincipalAxesToPhysicalAxesTransform = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetWeightedPrincipalAxesToPhysicalAxesTransform)
    GetPhysicalAxesToWeightedPrincipalAxesTransform = _swig_new_instance_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetPhysicalAxesToWeightedPrincipalAxesTransform)
    __swig_destroy__ = _itkStatisticsLabelObjectPython.delete_itkStatisticsLabelObjectUL4
    cast = _swig_new_static_method(_itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_cast)
...
itkStatisticsLabelObjectUL4___New_orig__ = _itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4___New_orig__
itkStatisticsLabelObjectUL4_GetAttributeFromName = _itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetAttributeFromName
itkStatisticsLabelObjectUL4_GetNameFromAttribute = _itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_GetNameFromAttribute
itkStatisticsLabelObjectUL4_cast = _itkStatisticsLabelObjectPython.itkStatisticsLabelObjectUL4_cast
