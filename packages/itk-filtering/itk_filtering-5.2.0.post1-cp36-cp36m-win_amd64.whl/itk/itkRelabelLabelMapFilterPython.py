...
class itkRelabelLabelMapFilterLM4_Superclass(itk.itkInPlaceLabelMapFilterPython.itkInPlaceLabelMapFilterLM4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass___New_orig__)
    Clone = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_Clone)
    SetReverseOrdering = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_SetReverseOrdering)
    GetReverseOrdering = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_GetReverseOrdering)
    ReverseOrderingOn = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_ReverseOrderingOn)
    ReverseOrderingOff = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_ReverseOrderingOff)
    __swig_destroy__ = _itkRelabelLabelMapFilterPython.delete_itkRelabelLabelMapFilterLM4_Superclass
    cast = _swig_new_static_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_cast)
...
itkRelabelLabelMapFilterLM4_Superclass___New_orig__ = _itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass___New_orig__
itkRelabelLabelMapFilterLM4_Superclass_cast = _itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Superclass_cast
...
class itkRelabelLabelMapFilterLM2(itkRelabelLabelMapFilterLM2_Superclass):
    ...
    paper:https://www.insight-journal.org/browse/publication/176 Gaetan
...
class itkRelabelLabelMapFilterLM4(itkRelabelLabelMapFilterLM4_Superclass):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4___New_orig__)
    Clone = _swig_new_instance_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_Clone)
    __swig_destroy__ = _itkRelabelLabelMapFilterPython.delete_itkRelabelLabelMapFilterLM4
    cast = _swig_new_static_method(_itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_cast)
...
itkRelabelLabelMapFilterLM4___New_orig__ = _itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4___New_orig__
itkRelabelLabelMapFilterLM4_cast = _itkRelabelLabelMapFilterPython.itkRelabelLabelMapFilterLM4_cast
