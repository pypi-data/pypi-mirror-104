...
class itkLevelSetFunctionID4(itk.itkFiniteDifferenceFunctionPython.itkFiniteDifferenceFunctionID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4___New_orig__)
    Clone = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_Clone)
    AdvectionField = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_AdvectionField)
    PropagationSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_PropagationSpeed)
    CurvatureSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_CurvatureSpeed)
    LaplacianSmoothingSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_LaplacianSmoothingSpeed)
    SetAdvectionWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetAdvectionWeight)
    GetAdvectionWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetAdvectionWeight)
    SetPropagationWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetPropagationWeight)
    GetPropagationWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetPropagationWeight)
    SetCurvatureWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetCurvatureWeight)
    GetCurvatureWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetCurvatureWeight)
    SetLaplacianSmoothingWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetLaplacianSmoothingWeight)
    GetLaplacianSmoothingWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetLaplacianSmoothingWeight)
    SetEpsilonMagnitude = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetEpsilonMagnitude)
    GetEpsilonMagnitude = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetEpsilonMagnitude)
    ComputeUpdate = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_ComputeUpdate)
    Initialize = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_Initialize)
    ComputeCurvatureTerm = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_ComputeCurvatureTerm)
    ComputeMeanCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_ComputeMeanCurvature)
    ComputeMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_ComputeMinimalCurvature)
    Compute3DMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_Compute3DMinimalCurvature)
    SetUseMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetUseMinimalCurvature)
    GetUseMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetUseMinimalCurvature)
    UseMinimalCurvatureOn = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_UseMinimalCurvatureOn)
    UseMinimalCurvatureOff = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_UseMinimalCurvatureOff)
    SetMaximumCurvatureTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetMaximumCurvatureTimeStep)
    GetMaximumCurvatureTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetMaximumCurvatureTimeStep)
    SetMaximumPropagationTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetMaximumPropagationTimeStep)
    GetMaximumPropagationTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetMaximumPropagationTimeStep)
    __swig_destroy__ = _itkLevelSetFunctionPython.delete_itkLevelSetFunctionID4
    cast = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionID4_cast)
...
itkLevelSetFunctionID4___New_orig__ = _itkLevelSetFunctionPython.itkLevelSetFunctionID4___New_orig__
itkLevelSetFunctionID4_SetMaximumCurvatureTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetMaximumCurvatureTimeStep
itkLevelSetFunctionID4_GetMaximumCurvatureTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetMaximumCurvatureTimeStep
itkLevelSetFunctionID4_SetMaximumPropagationTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionID4_SetMaximumPropagationTimeStep
itkLevelSetFunctionID4_GetMaximumPropagationTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionID4_GetMaximumPropagationTimeStep
itkLevelSetFunctionID4_cast = _itkLevelSetFunctionPython.itkLevelSetFunctionID4_cast
...
class itkLevelSetFunctionIF4(itk.itkFiniteDifferenceFunctionPython.itkFiniteDifferenceFunctionIF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4___New_orig__)
    Clone = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_Clone)
    AdvectionField = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_AdvectionField)
    PropagationSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_PropagationSpeed)
    CurvatureSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_CurvatureSpeed)
    LaplacianSmoothingSpeed = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_LaplacianSmoothingSpeed)
    SetAdvectionWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetAdvectionWeight)
    GetAdvectionWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetAdvectionWeight)
    SetPropagationWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetPropagationWeight)
    GetPropagationWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetPropagationWeight)
    SetCurvatureWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetCurvatureWeight)
    GetCurvatureWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetCurvatureWeight)
    SetLaplacianSmoothingWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetLaplacianSmoothingWeight)
    GetLaplacianSmoothingWeight = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetLaplacianSmoothingWeight)
    SetEpsilonMagnitude = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetEpsilonMagnitude)
    GetEpsilonMagnitude = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetEpsilonMagnitude)
    ComputeUpdate = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_ComputeUpdate)
    Initialize = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_Initialize)
    ComputeCurvatureTerm = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_ComputeCurvatureTerm)
    ComputeMeanCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_ComputeMeanCurvature)
    ComputeMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_ComputeMinimalCurvature)
    Compute3DMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_Compute3DMinimalCurvature)
    SetUseMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetUseMinimalCurvature)
    GetUseMinimalCurvature = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetUseMinimalCurvature)
    UseMinimalCurvatureOn = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_UseMinimalCurvatureOn)
    UseMinimalCurvatureOff = _swig_new_instance_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_UseMinimalCurvatureOff)
    SetMaximumCurvatureTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetMaximumCurvatureTimeStep)
    GetMaximumCurvatureTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetMaximumCurvatureTimeStep)
    SetMaximumPropagationTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetMaximumPropagationTimeStep)
    GetMaximumPropagationTimeStep = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetMaximumPropagationTimeStep)
    __swig_destroy__ = _itkLevelSetFunctionPython.delete_itkLevelSetFunctionIF4
    cast = _swig_new_static_method(_itkLevelSetFunctionPython.itkLevelSetFunctionIF4_cast)
...
itkLevelSetFunctionIF4___New_orig__ = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4___New_orig__
itkLevelSetFunctionIF4_SetMaximumCurvatureTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetMaximumCurvatureTimeStep
itkLevelSetFunctionIF4_GetMaximumCurvatureTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetMaximumCurvatureTimeStep
itkLevelSetFunctionIF4_SetMaximumPropagationTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4_SetMaximumPropagationTimeStep
itkLevelSetFunctionIF4_GetMaximumPropagationTimeStep = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4_GetMaximumPropagationTimeStep
itkLevelSetFunctionIF4_cast = _itkLevelSetFunctionPython.itkLevelSetFunctionIF4_cast
