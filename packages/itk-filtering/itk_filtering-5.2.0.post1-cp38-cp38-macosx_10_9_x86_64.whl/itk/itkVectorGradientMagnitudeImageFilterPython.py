...
class itkVectorGradientMagnitudeImageFilterIVF22D(itk.itkImageToImageFilterBPython.itkImageToImageFilterIVF22ID2):
    ...
    mode that is used.  The method UseImageSpacingOn will cause
    ...
    coordinates (versus isotropic image space). UseImageSpacingOff turns
    this functionality off. Default is UseImageSpacingOn. The parameter
    UseImageSpacing can be set directly with the method
