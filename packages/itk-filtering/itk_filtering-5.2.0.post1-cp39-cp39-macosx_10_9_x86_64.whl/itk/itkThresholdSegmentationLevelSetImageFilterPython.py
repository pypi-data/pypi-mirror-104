...
class itkThresholdSegmentationLevelSetImageFilterID4ID4D(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterID4ID4D):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D___New_orig__)
    Clone = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_Clone)
    SetUpperThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetUpperThreshold)
    SetLowerThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetLowerThreshold)
    GetUpperThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetUpperThreshold)
    GetLowerThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetLowerThreshold)
    SetEdgeWeight = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetEdgeWeight)
    GetEdgeWeight = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetEdgeWeight)
    SetSmoothingIterations = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetSmoothingIterations)
    GetSmoothingIterations = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetSmoothingIterations)
    SetSmoothingTimeStep = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetSmoothingTimeStep)
    GetSmoothingTimeStep = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetSmoothingTimeStep)
    SetSmoothingConductance = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_SetSmoothingConductance)
    GetSmoothingConductance = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_GetSmoothingConductance)
    ...
    cast = _swig_new_static_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_cast)
...
itkThresholdSegmentationLevelSetImageFilterID4ID4D___New_orig__ = _itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D___New_orig__
itkThresholdSegmentationLevelSetImageFilterID4ID4D_cast = _itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterID4ID4D_cast
...
class itkThresholdSegmentationLevelSetImageFilterIF4IF4F(itk.itkSegmentationLevelSetImageFilterPython.itkSegmentationLevelSetImageFilterIF4IF4F):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F___New_orig__)
    Clone = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_Clone)
    SetUpperThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetUpperThreshold)
    SetLowerThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetLowerThreshold)
    GetUpperThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetUpperThreshold)
    GetLowerThreshold = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetLowerThreshold)
    SetEdgeWeight = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetEdgeWeight)
    GetEdgeWeight = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetEdgeWeight)
    SetSmoothingIterations = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetSmoothingIterations)
    GetSmoothingIterations = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetSmoothingIterations)
    SetSmoothingTimeStep = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetSmoothingTimeStep)
    GetSmoothingTimeStep = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetSmoothingTimeStep)
    SetSmoothingConductance = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_SetSmoothingConductance)
    GetSmoothingConductance = _swig_new_instance_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_GetSmoothingConductance)
    ...
    cast = _swig_new_static_method(_itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_cast)
...
itkThresholdSegmentationLevelSetImageFilterIF4IF4F___New_orig__ = _itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F___New_orig__
itkThresholdSegmentationLevelSetImageFilterIF4IF4F_cast = _itkThresholdSegmentationLevelSetImageFilterPython.itkThresholdSegmentationLevelSetImageFilterIF4IF4F_cast
