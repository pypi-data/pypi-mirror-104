...
class itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4(itk.itkFastMarchingStoppingCriterionBasePython.itkFastMarchingStoppingCriterionBaseID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_Clone)
    SetTargetCondition = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_SetTargetCondition)
    GetTargetCondition = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_GetTargetCondition)
    SetTargetOffset = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_SetTargetOffset)
    GetTargetOffset = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_GetTargetOffset)
    SetNumberOfTargetsToBeReached = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_SetNumberOfTargetsToBeReached)
    SetTargetNodes = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_SetTargetNodes)
    SetCurrentNode = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_SetCurrentNode)
    ...
    cast = _swig_new_static_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_cast)
...
itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4___New_orig__ = _itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4___New_orig__
itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_cast = _itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionID4ID4_cast
...
class itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4(itk.itkFastMarchingStoppingCriterionBasePython.itkFastMarchingStoppingCriterionBaseIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_Clone)
    SetTargetCondition = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_SetTargetCondition)
    GetTargetCondition = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_GetTargetCondition)
    SetTargetOffset = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_SetTargetOffset)
    GetTargetOffset = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_GetTargetOffset)
    SetNumberOfTargetsToBeReached = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_SetNumberOfTargetsToBeReached)
    SetTargetNodes = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_SetTargetNodes)
    SetCurrentNode = _swig_new_instance_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_SetCurrentNode)
    ...
    cast = _swig_new_static_method(_itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_cast)
...
itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4___New_orig__ = _itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4___New_orig__
itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_cast = _itkFastMarchingReachedTargetNodesStoppingCriterionPython.itkFastMarchingReachedTargetNodesStoppingCriterionIF4IF4_cast
