...
class itkBinaryImageToShapeLabelMapFilterIUC4LM4(itk.ITKLabelMapBasePython.itkImageToImageFilterIUC4LM4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4___New_orig__)
    Clone = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_Clone)
    SetFullyConnected = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetFullyConnected)
    GetFullyConnected = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetFullyConnected)
    FullyConnectedOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_FullyConnectedOn)
    FullyConnectedOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_FullyConnectedOff)
    ...
    SetOutputBackgroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetOutputBackgroundValue)
    GetOutputBackgroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetOutputBackgroundValue)
    SetInputForegroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetInputForegroundValue)
    GetInputForegroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetInputForegroundValue)
    SetComputeFeretDiameter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetComputeFeretDiameter)
    GetComputeFeretDiameter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetComputeFeretDiameter)
    ComputeFeretDiameterOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputeFeretDiameterOn)
    ComputeFeretDiameterOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputeFeretDiameterOff)
    SetComputePerimeter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetComputePerimeter)
    GetComputePerimeter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetComputePerimeter)
    ComputePerimeterOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputePerimeterOn)
    ComputePerimeterOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputePerimeterOff)
    SetComputeOrientedBoundingBox = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_SetComputeOrientedBoundingBox)
    GetComputeOrientedBoundingBox = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_GetComputeOrientedBoundingBox)
    ComputeOrientedBoundingBoxOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputeOrientedBoundingBoxOn)
    ComputeOrientedBoundingBoxOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_ComputeOrientedBoundingBoxOff)
    __swig_destroy__ = _itkBinaryImageToShapeLabelMapFilterPython.delete_itkBinaryImageToShapeLabelMapFilterIUC4LM4
    cast = _swig_new_static_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_cast)
...
itkBinaryImageToShapeLabelMapFilterIUC4LM4___New_orig__ = _itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4___New_orig__
itkBinaryImageToShapeLabelMapFilterIUC4LM4_cast = _itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUC4LM4_cast
...
class itkBinaryImageToShapeLabelMapFilterIUS4LM4(itk.ITKLabelMapBasePython.itkImageToImageFilterIUS4LM4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4___New_orig__)
    Clone = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_Clone)
    SetFullyConnected = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetFullyConnected)
    GetFullyConnected = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetFullyConnected)
    FullyConnectedOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_FullyConnectedOn)
    FullyConnectedOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_FullyConnectedOff)
    ...
    SetOutputBackgroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetOutputBackgroundValue)
    GetOutputBackgroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetOutputBackgroundValue)
    SetInputForegroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetInputForegroundValue)
    GetInputForegroundValue = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetInputForegroundValue)
    SetComputeFeretDiameter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetComputeFeretDiameter)
    GetComputeFeretDiameter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetComputeFeretDiameter)
    ComputeFeretDiameterOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputeFeretDiameterOn)
    ComputeFeretDiameterOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputeFeretDiameterOff)
    SetComputePerimeter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetComputePerimeter)
    GetComputePerimeter = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetComputePerimeter)
    ComputePerimeterOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputePerimeterOn)
    ComputePerimeterOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputePerimeterOff)
    SetComputeOrientedBoundingBox = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_SetComputeOrientedBoundingBox)
    GetComputeOrientedBoundingBox = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_GetComputeOrientedBoundingBox)
    ComputeOrientedBoundingBoxOn = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputeOrientedBoundingBoxOn)
    ComputeOrientedBoundingBoxOff = _swig_new_instance_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_ComputeOrientedBoundingBoxOff)
    __swig_destroy__ = _itkBinaryImageToShapeLabelMapFilterPython.delete_itkBinaryImageToShapeLabelMapFilterIUS4LM4
    cast = _swig_new_static_method(_itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_cast)
...
itkBinaryImageToShapeLabelMapFilterIUS4LM4___New_orig__ = _itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4___New_orig__
itkBinaryImageToShapeLabelMapFilterIUS4LM4_cast = _itkBinaryImageToShapeLabelMapFilterPython.itkBinaryImageToShapeLabelMapFilterIUS4LM4_cast
