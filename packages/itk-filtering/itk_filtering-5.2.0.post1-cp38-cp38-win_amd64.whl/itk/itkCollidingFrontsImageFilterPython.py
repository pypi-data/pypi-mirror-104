...
class itkCollidingFrontsImageFilterID4ID4(itk.itkImageToImageFilterAPython.itkImageToImageFilterID4ID4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4___New_orig__)
    Clone = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_Clone)
    SetSeedPoints1 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_SetSeedPoints1)
    GetSeedPoints1 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_GetSeedPoints1)
    SetSeedPoints2 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_SetSeedPoints2)
    GetSeedPoints2 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_GetSeedPoints2)
    SetNegativeEpsilon = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_SetNegativeEpsilon)
    GetNegativeEpsilon = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_GetNegativeEpsilon)
    SetApplyConnectivity = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_SetApplyConnectivity)
    GetApplyConnectivity = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_GetApplyConnectivity)
    ApplyConnectivityOn = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_ApplyConnectivityOn)
    ApplyConnectivityOff = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_ApplyConnectivityOff)
    SetStopOnTargets = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_SetStopOnTargets)
    GetStopOnTargets = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_GetStopOnTargets)
    StopOnTargetsOn = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_StopOnTargetsOn)
    StopOnTargetsOff = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_StopOnTargetsOff)
    ...
    cast = _swig_new_static_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_cast)
...
itkCollidingFrontsImageFilterID4ID4___New_orig__ = _itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4___New_orig__
itkCollidingFrontsImageFilterID4ID4_cast = _itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterID4ID4_cast
...
class itkCollidingFrontsImageFilterIF4IF4(itk.itkImageToImageFilterAPython.itkImageToImageFilterIF4IF4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4___New_orig__)
    Clone = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_Clone)
    SetSeedPoints1 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_SetSeedPoints1)
    GetSeedPoints1 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_GetSeedPoints1)
    SetSeedPoints2 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_SetSeedPoints2)
    GetSeedPoints2 = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_GetSeedPoints2)
    SetNegativeEpsilon = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_SetNegativeEpsilon)
    GetNegativeEpsilon = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_GetNegativeEpsilon)
    SetApplyConnectivity = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_SetApplyConnectivity)
    GetApplyConnectivity = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_GetApplyConnectivity)
    ApplyConnectivityOn = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_ApplyConnectivityOn)
    ApplyConnectivityOff = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_ApplyConnectivityOff)
    SetStopOnTargets = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_SetStopOnTargets)
    GetStopOnTargets = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_GetStopOnTargets)
    StopOnTargetsOn = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_StopOnTargetsOn)
    StopOnTargetsOff = _swig_new_instance_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_StopOnTargetsOff)
    ...
    cast = _swig_new_static_method(_itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_cast)
...
itkCollidingFrontsImageFilterIF4IF4___New_orig__ = _itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4___New_orig__
itkCollidingFrontsImageFilterIF4IF4_cast = _itkCollidingFrontsImageFilterPython.itkCollidingFrontsImageFilterIF4IF4_cast
