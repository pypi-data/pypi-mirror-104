...
class itkFixedArrayPD24(object):
    ...
    data = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD24_data)
...
class itkFixedArrayPD38(object):
    ...
    data = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD38_data)
...
class itkFixedArrayPD416(object):
    ...
    __eq__ = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416___eq__)
    __ne__ = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416___ne__)
    SetElement = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_SetElement)
    GetElement = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_GetElement)
    GetDataPointer = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_GetDataPointer)
    data = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_data)
    cbegin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_cbegin)
    begin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_begin)
    cend = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_cend)
    end = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_end)
    crbegin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_crbegin)
    rbegin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_rbegin)
    crend = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_crend)
    rend = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_rend)
    Size = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_Size)
    size = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_size)
    Fill = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_Fill)
    swap = _swig_new_instance_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_swap)
    Filled = _swig_new_static_method(_itkShapeLabelObjectPython.itkFixedArrayPD416_Filled)
...
itkFixedArrayPD416_Filled = _itkShapeLabelObjectPython.itkFixedArrayPD416_Filled
...
class itkShapeLabelObjectUL4(itk.itkLabelObjectPython.itkLabelObjectUL4):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __New_orig__ = _swig_new_static_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4___New_orig__)
    Clone = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_Clone)
    GetAttributeFromName = _swig_new_static_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetAttributeFromName)
    GetNameFromAttribute = _swig_new_static_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetNameFromAttribute)
    GetBoundingBox = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetBoundingBox)
    SetBoundingBox = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetBoundingBox)
    GetPhysicalSize = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPhysicalSize)
    SetPhysicalSize = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPhysicalSize)
    GetNumberOfPixels = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetNumberOfPixels)
    SetNumberOfPixels = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetNumberOfPixels)
    GetCentroid = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetCentroid)
    SetCentroid = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetCentroid)
    GetNumberOfPixelsOnBorder = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetNumberOfPixelsOnBorder)
    SetNumberOfPixelsOnBorder = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetNumberOfPixelsOnBorder)
    GetPerimeterOnBorder = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPerimeterOnBorder)
    SetPerimeterOnBorder = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPerimeterOnBorder)
    GetFeretDiameter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetFeretDiameter)
    SetFeretDiameter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetFeretDiameter)
    GetPrincipalMoments = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPrincipalMoments)
    SetPrincipalMoments = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPrincipalMoments)
    GetPrincipalAxes = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPrincipalAxes)
    SetPrincipalAxes = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPrincipalAxes)
    GetElongation = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetElongation)
    SetElongation = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetElongation)
    GetPerimeter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPerimeter)
    SetPerimeter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPerimeter)
    GetRoundness = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetRoundness)
    SetRoundness = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetRoundness)
    GetEquivalentSphericalRadius = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetEquivalentSphericalRadius)
    SetEquivalentSphericalRadius = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetEquivalentSphericalRadius)
    GetEquivalentSphericalPerimeter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetEquivalentSphericalPerimeter)
    SetEquivalentSphericalPerimeter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetEquivalentSphericalPerimeter)
    GetEquivalentEllipsoidDiameter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetEquivalentEllipsoidDiameter)
    SetEquivalentEllipsoidDiameter = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetEquivalentEllipsoidDiameter)
    GetFlatness = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetFlatness)
    SetFlatness = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetFlatness)
    GetPerimeterOnBorderRatio = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPerimeterOnBorderRatio)
    SetPerimeterOnBorderRatio = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetPerimeterOnBorderRatio)
    GetOrientedBoundingBoxOrigin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetOrientedBoundingBoxOrigin)
    SetOrientedBoundingBoxOrigin = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetOrientedBoundingBoxOrigin)
    GetOrientedBoundingBoxSize = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetOrientedBoundingBoxSize)
    SetOrientedBoundingBoxSize = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_SetOrientedBoundingBoxSize)
    GetRegion = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetRegion)
    GetOrientedBoundingBoxDirection = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetOrientedBoundingBoxDirection)
    GetOrientedBoundingBoxVertices = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetOrientedBoundingBoxVertices)
    GetPrincipalAxesToPhysicalAxesTransform = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPrincipalAxesToPhysicalAxesTransform)
    GetPhysicalAxesToPrincipalAxesTransform = _swig_new_instance_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetPhysicalAxesToPrincipalAxesTransform)
    __swig_destroy__ = _itkShapeLabelObjectPython.delete_itkShapeLabelObjectUL4
    cast = _swig_new_static_method(_itkShapeLabelObjectPython.itkShapeLabelObjectUL4_cast)
...
itkShapeLabelObjectUL4___New_orig__ = _itkShapeLabelObjectPython.itkShapeLabelObjectUL4___New_orig__
itkShapeLabelObjectUL4_GetAttributeFromName = _itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetAttributeFromName
itkShapeLabelObjectUL4_GetNameFromAttribute = _itkShapeLabelObjectPython.itkShapeLabelObjectUL4_GetNameFromAttribute
itkShapeLabelObjectUL4_cast = _itkShapeLabelObjectPython.itkShapeLabelObjectUL4_cast
