...
[boto3.AppConfig 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/appconfig.html#AppConfig) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_appconfig/README.md)
...
def check_value(value: DeploymentEventType) -> bool:
    ...
```
