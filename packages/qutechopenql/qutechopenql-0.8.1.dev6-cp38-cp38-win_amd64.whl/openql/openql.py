...
def get_architectures():
    ...
    """
    return _openql.get_architectures()
...
def get_platform_docs():
    ...
    """
    return _openql.get_platform_docs()
...
def get_compiler_docs():
    r"""
    get_compiler_docs() -> std::string
    ...
    """
    return _openql.get_compiler_docs()
class Pass(object):
    r"""
    ...
    def get_pass_documentation(self):
        r"""
        get_pass_documentation(Pass self) -> std::string
        ...
        """
        return _openql.Pass_get_pass_documentation(self)
    ...
    def get_options(self, only_set=False):
        r"""
        get_options(Pass self, bool only_set=False) -> std::string
        ...
        """
        return _openql.Pass_get_options(self, only_set)

    def print_strategy(self):
        r"""
        print_strategy(Pass self)
        ...
        """
        return _openql.Pass_print_strategy(self)

    def get_strategy(self):
        r"""
        get_strategy(Pass self) -> std::string
        ...
        """
        return _openql.Pass_get_strategy(self)

    def set_option(self, option, value, must_exist=True):
        r"""
        set_option(Pass self, std::string const & option, std::string const & value, bool must_exist=True) -> size_t
        ...
        """
        return _openql.Pass_set_option(self, option, value, must_exist)

    def set_option_recursively(self, option, value, must_exist=True):
        r"""
        set_option_recursively(Pass self, std::string const & option, std::string const & value, bool must_exist=True) -> size_t
        ...
        """
        return _openql.Pass_set_option_recursively(self, option, value, must_exist)
    ...
    def construct(self):
        ...
        """
        return _openql.Pass_construct(self)

    def is_constructed(self):
        r"""
        is_constructed(Pass self) -> bool
        ...
        """
        return _openql.Pass_is_constructed(self)

    def is_group(self):
        r"""
        is_group(Pass self) -> bool
        ...
        """
        return _openql.Pass_is_group(self)

    def is_collapsible(self):
        r"""
        is_collapsible(Pass self) -> bool
        ...
        """
        return _openql.Pass_is_collapsible(self)

    def is_root(self):
        r"""
        is_root(Pass self) -> bool
        ...
        """
        return _openql.Pass_is_root(self)

    def is_conditional(self):
        r"""
        is_conditional(Pass self) -> bool
        ...
        """
        return _openql.Pass_is_conditional(self)

    def append_sub_pass(self, *args):
        r"""
        append_sub_pass(Pass self, std::string const & type_name="", std::string const & instance_name="", mapss options={}) -> Pass
        ...
        """
        return _openql.Pass_append_sub_pass(self, *args)

    def prefix_sub_pass(self, *args):
        r"""
        prefix_sub_pass(Pass self, std::string const & type_name="", std::string const & instance_name="", mapss options={}) -> Pass
        ...
        """
        return _openql.Pass_prefix_sub_pass(self, *args)

    def insert_sub_pass_after(self, *args):
        r"""
        insert_sub_pass_after(Pass self, std::string const & target, std::string const & type_name="", std::string const & instance_name="", mapss options={}) -> Pass
        ...
        """
        return _openql.Pass_insert_sub_pass_after(self, *args)

    def insert_sub_pass_before(self, *args):
        r"""
        insert_sub_pass_before(Pass self, std::string const & target, std::string const & type_name="", std::string const & instance_name="", mapss options={}) -> Pass
        ...
        """
        return _openql.Pass_insert_sub_pass_before(self, *args)

    def group_sub_pass(self, *args):
        r"""
        group_sub_pass(Pass self, std::string const & target, std::string const & sub_name="main") -> Pass
        ...
        """
        return _openql.Pass_group_sub_pass(self, *args)

    def group_sub_passes(self, _from, to, group_name):
        r"""
        group_sub_passes(Pass self, std::string const & _from, std::string const & to, std::string const & group_name) -> Pass
        ...
        """
        return _openql.Pass_group_sub_passes(self, _from, to, group_name)

    def flatten_subgroup(self, *args):
        r"""
        flatten_subgroup(Pass self, std::string const & target, std::string const & name_prefix="")
        ...
        """
        return _openql.Pass_flatten_subgroup(self, *args)

    def get_sub_pass(self, target):
        r"""
        get_sub_pass(Pass self, std::string const & target) -> Pass
        ...
        """
        return _openql.Pass_get_sub_pass(self, target)

    def does_sub_pass_exist(self, target):
        r"""
        does_sub_pass_exist(Pass self, std::string const & target) -> bool
        ...
        """
        return _openql.Pass_does_sub_pass_exist(self, target)

    def get_num_sub_passes(self):
        r"""
        get_num_sub_passes(Pass self) -> size_t
        ...
        """
        return _openql.Pass_get_num_sub_passes(self)

    def get_sub_passes(self):
        r"""
        get_sub_passes(Pass self) -> vectorp
        ...
        """
        return _openql.Pass_get_sub_passes(self)

    def get_sub_passes_by_type(self, target):
        r"""
        get_sub_passes_by_type(Pass self, std::string const & target) -> vectorp
        ...
        """
        return _openql.Pass_get_sub_passes_by_type(self, target)

    def remove_sub_pass(self, target):
        r"""
        remove_sub_pass(Pass self, std::string const & target)
        ...
        """
        return _openql.Pass_remove_sub_pass(self, target)

    def clear_sub_passes(self):
        r"""
        clear_sub_passes(Pass self)
        ...
        """
        return _openql.Pass_clear_sub_passes(self)
...
class Compiler(object):
    ...
    def get_pass_types(self):
        r"""
        get_pass_types(Compiler self) -> std::string
        ...
        """
        return _openql.Compiler_get_pass_types(self)
    ...
    def get_strategy(self):
        r"""
        get_strategy(Compiler self) -> std::string
        ...
        """
        return _openql.Compiler_get_strategy(self)
    ...
    def set_option_recursively(self, option, value, must_exist=True):
        r"""
        set_option_recursively(Compiler self, std::string const & option, std::string const & value, bool must_exist=True) -> size_t
        ...
        """
        return _openql.Compiler_set_option_recursively(self, option, value, must_exist)
    ...
    def group_pass(self, *args):
        r"""
        group_pass(Compiler self, std::string const & target, std::string const & sub_name="main") -> Pass
        ...
        """
        return _openql.Compiler_group_pass(self, *args)

    def group_passes(self, _from, to, group_name):
        r"""
        group_passes(Compiler self, std::string const & _from, std::string const & to, std::string const & group_name) -> Pass
        ...
        """
        return _openql.Compiler_group_passes(self, _from, to, group_name)

    def flatten_subgroup(self, *args):
        r"""
        flatten_subgroup(Compiler self, std::string const & target, std::string const & name_prefix="")
        ...
        """
        return _openql.Compiler_flatten_subgroup(self, *args)
    ...
    def construct(self):
        ...
        """
        return _openql.Compiler_construct(self)
