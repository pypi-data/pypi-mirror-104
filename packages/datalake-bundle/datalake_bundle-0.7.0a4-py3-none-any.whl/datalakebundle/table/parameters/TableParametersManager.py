...
class TableParametersManager:
    ...
    def __init__(
        ...
        self.__table_defaults = table_defaults.to_dict()
        ...
        self.__table_parameters = [
            table_parameters_parser.parse(identifier, self.__table_defaults, explicit_config or dict())
            for identifier, explicit_config in raw_table_parameters.to_dict().items()
        ]
