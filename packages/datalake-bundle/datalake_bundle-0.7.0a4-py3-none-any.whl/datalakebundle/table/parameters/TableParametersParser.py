...
class TableParametersParser:
    ...
    def parse(self, identifier: str, defaults: dict = None, explicit_config: dict = None):
        defaults = defaults or dict()
        explicit_config = explicit_config or dict()
        table_names = self.__table_names_preparer.prepare(identifier)

        all_fields = {**table_names.to_dict(), **explicit_config}
