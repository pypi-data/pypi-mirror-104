...
class TableOverwriter:
    def __init__(self, logger: Logger, table_creator: TableCreator, table_recreator: TableRecreator, data_writer: DataWriter):
        self.__logger = logger
        self.__table_creator = table_creator
        self.__table_recreator = table_recreator
        self.__data_writer = data_writer

    def overwrite(self, result: DataFrame, table_definition: TableDefinition, recreate_table: bool):
        ...
        self.__data_writer.overwrite(result, output_table_name, table_definition.schema, table_definition.partition_by)
