...
EncryptionConfigurationTypeDef = TypedDict(
    "EncryptionConfigurationTypeDef",
    {"NoEncryptionConfig": NoEncryptionConfig, "KMSEncryptionConfig": "KMSEncryptionConfigTypeDef"},
    total=False,
)
...
ProcessorParameterTypeDef = TypedDict(
    "ProcessorParameterTypeDef", {"ParameterName": ProcessorParameterName, "ParameterValue": str}
)

_RequiredProcessorTypeDef = TypedDict("_RequiredProcessorTypeDef", {"Type": ProcessorType})
...
_RequiredDeliveryStreamEncryptionConfigurationInputTypeDef = TypedDict(
    "_RequiredDeliveryStreamEncryptionConfigurationInputTypeDef", {"KeyType": KeyType}
)
