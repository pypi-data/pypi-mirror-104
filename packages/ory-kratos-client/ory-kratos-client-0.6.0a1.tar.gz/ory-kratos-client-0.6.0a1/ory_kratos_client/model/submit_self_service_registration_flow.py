...
class SubmitSelfServiceRegistrationFlow(ModelComposed):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        """SubmitSelfServiceRegistrationFlow - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            method (str): Method to use  This field must be set to `password` when using the password method.. [optional]  # noqa: E501
        """
