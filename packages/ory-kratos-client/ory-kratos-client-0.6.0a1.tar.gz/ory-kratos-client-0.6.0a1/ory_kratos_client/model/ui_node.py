...
class UiNode(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'attributes': (UiNodeAttributes,),  # noqa: E501
            'group': (str,),  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, attributes, group, messages, meta, type, *args, **kwargs):  # noqa: E501
        """UiNode - a model defined in OpenAPI
