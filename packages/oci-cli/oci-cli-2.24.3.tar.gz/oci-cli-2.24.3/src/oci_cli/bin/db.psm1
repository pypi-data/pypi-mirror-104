...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id compartment-id cpu-core-count customer-contacts data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-id' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id autonomous-database-backup-id clone-type compartment-id cpu-core-count customer-contacts data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-backup-timestamp' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id autonomous-database-id clone-type compartment-id cpu-core-count customer-contacts data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label standby-whitelisted-ips subnet-id timestamp wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-clone' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id clone-type compartment-id cpu-core-count customer-contacts data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-acl-enabled is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label source-id standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-refreshable-clone' = 'admin-password are-primary-whitelisted-ips-used autonomous-container-database-id compartment-id cpu-core-count customer-contacts data-storage-size-in-tbs db-name db-version db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-data-guard-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds nsg-ids private-endpoint-label refreshable-mode source-id standby-whitelisted-ips subnet-id wait-for-state wait-interval-seconds whitelisted-ips'
