...
AppInstanceStreamingConfigurationTypeDef = TypedDict(
    "AppInstanceStreamingConfigurationTypeDef",
    {"AppInstanceDataType": AppInstanceDataType, "ResourceArn": str},
)
...
InviteTypeDef = TypedDict(
    "InviteTypeDef",
    {"InviteId": str, "Status": InviteStatus, "EmailAddress": str, "EmailStatus": EmailStatus},
    total=False,
)
...
MemberErrorTypeDef = TypedDict(
    "MemberErrorTypeDef",
    {"MemberId": str, "ErrorCode": ErrorCode, "ErrorMessage": str},
    total=False,
)

MemberTypeDef = TypedDict(
    "MemberTypeDef",
    {"MemberId": str, "MemberType": MemberType, "Email": str, "FullName": str, "AccountId": str},
    total=False,
)
...
OrderedPhoneNumberTypeDef = TypedDict(
    "OrderedPhoneNumberTypeDef",
    {"E164PhoneNumber": str, "Status": OrderedPhoneNumberStatus},
    total=False,
)
...
PhoneNumberAssociationTypeDef = TypedDict(
    "PhoneNumberAssociationTypeDef",
    {"Value": str, "Name": PhoneNumberAssociationName, "AssociatedTimestamp": datetime},
    total=False,
)
...
PhoneNumberErrorTypeDef = TypedDict(
    "PhoneNumberErrorTypeDef",
    {"PhoneNumberId": str, "ErrorCode": ErrorCode, "ErrorMessage": str},
    total=False,
)
...
StreamingNotificationTargetTypeDef = TypedDict(
    "StreamingNotificationTargetTypeDef", {"NotificationTarget": NotificationTarget}
)
...
UserErrorTypeDef = TypedDict(
    "UserErrorTypeDef", {"UserId": str, "ErrorCode": ErrorCode, "ErrorMessage": str}, total=False
)
...
MembershipItemTypeDef = TypedDict(
    "MembershipItemTypeDef", {"MemberId": str, "Role": RoomMembershipRole}, total=False
)
...
_OptionalUpdatePhoneNumberRequestItemTypeDef = TypedDict(
    ...
    {"ProductType": PhoneNumberProductType, "CallingName": str},
    total=False,
)
