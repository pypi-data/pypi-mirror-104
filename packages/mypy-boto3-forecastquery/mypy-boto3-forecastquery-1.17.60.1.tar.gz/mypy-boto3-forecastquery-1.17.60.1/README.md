...
[boto3.ForecastQueryService 1.17.60](https://boto3.amazonaws.com/v1/documentation/api/1.17.60/reference/services/forecastquery.html#ForecastQueryService) service
compatible with
