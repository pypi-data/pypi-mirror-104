...
class NotifyThread(QtCore.QThread):
    ...
    signal_between_Windows = QtCore.pyqtSignal(object)
...
#     MainWindow.setWindowFlags(flags)
    ...
    ui.setQue(qForGui)
    print('after setting queue')
    MainWindow.show()
    print('after main winddow show')
    notifyThread.signal_between_Windows.emit('appReady')
    return app.exec_()
...
#     Path(IMG_FOLDER).mkdir(parents=True, exist_ok=True)
    ...
    #lib_path = '/usr/local/lib/python3.7/dist-packages/spotii'
...
#     
    ...
    OnOff.start()
    TestMonitor.start()
    guiRtn=gui(qForGui,notifyThread)
