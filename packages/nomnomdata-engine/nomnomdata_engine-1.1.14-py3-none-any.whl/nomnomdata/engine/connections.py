...
Neo4jConnection = Connection(
    ...
    description="URL, username and password.",
    categories=["Neo4j"],
    parameter_groups=[
        ParameterGroup(
            Parameter(
                ...
                name="url",
                display_name="Host URL",
                description="Enter a URL that contains hostname, port and database name.",
                required=True,
                default="bolt://yourserver.yourcompany.com:7687/yourdatabase",
            ),
            Parameter(
                type=String(),
                name="username",
