...
AccessMethodTypeDef = TypedDict(
    "AccessMethodTypeDef",
    {"CustomObjectIdentifier": str, "AccessMethodType": AccessMethodType},
    total=False,
)
...
ExtendedKeyUsageTypeDef = TypedDict(
    "ExtendedKeyUsageTypeDef",
    {"ExtendedKeyUsageType": ExtendedKeyUsageType, "ExtendedKeyUsageObjectIdentifier": str},
    total=False,
)
...
PolicyQualifierInfoTypeDef = TypedDict(
    "PolicyQualifierInfoTypeDef",
    {"PolicyQualifierId": PolicyQualifierId, "Qualifier": "QualifierTypeDef"},
)
