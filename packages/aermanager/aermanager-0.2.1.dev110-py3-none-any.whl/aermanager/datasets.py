...
class SpikeTrainDataset(HDF5FolderDataset):
    ...
    Args:
        ...
        force_n_bins (int, None): Force all output rasters to have length equal to this value. \
    ...
    def _pick_data_from_file(self, file):
        ...
        if len(raster) >= self.n_bins:  # cut the raster to n_bins of length
            return raster[:self.n_bins]
