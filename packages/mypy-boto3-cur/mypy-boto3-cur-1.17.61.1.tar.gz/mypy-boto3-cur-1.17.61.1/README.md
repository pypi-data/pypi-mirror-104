...
[boto3.CostandUsageReportService 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/cur.html#CostandUsageReportService) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_cur/README.md)
...
`mypy_boto3_cur.literals` module contains literals extracted from shapes
...
def check_value(value: AWSRegion) -> bool:
    ...
```
