...
[boto3.AlexaForBusiness 1.17.62](https://boto3.amazonaws.com/v1/documentation/api/1.17.62/reference/services/alexaforbusiness.html#AlexaForBusiness) service
compatible with
...
[auto-generated docs](https://github.com/vemel/mypy_boto3_builder/service_docs/mypy_boto3_alexaforbusiness/README.md)
...
`mypy_boto3_alexaforbusiness.literals` module contains literals extracted from shapes
...
def check_value(value: BusinessReportFailureCode) -> bool:
    ...
```
