...
class DBoardFactory(object):
    ...
    def __new__(self, dapi, dmode=DBoardPreferedDapiMode.REGISTER):
        '''Constructor'''
            ...
            if isinstance(self.dapi.comm, DSerial):
                ...
                for bdr in dcom.COM_SPEEDS:
                    ...
                    try:
                        ...
                        self.api.log.error('The attempt to connect @ {0:d} baud failed!'.format(bdr))
                        continue
                ...
                try:
                    ...
                    self.api.log.error('The attempt to read is failed')
