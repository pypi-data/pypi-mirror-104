...
class BaseDBoard(object):
    ...
    def getBoardClasses(cls):
        '''Returns all known card classes'''
    ...
    def setReg(self, reg, value, synchronous=True):
        ...
        :param Register reg: The register to be modified
    ...
    def getPressure(self, refresh=False):
        if refresh: 
            self.dapi.readReg(self.regs.cap)
        return self.regs.cap.value        
    ...
    def setFactoryData(self, sn, fd, hv):
        ...
        :param tuple hv: 2-tuple of intetger for major and minor version number.
        ''' 
