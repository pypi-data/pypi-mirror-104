...
FailoverStateTypeDef = TypedDict(
    "FailoverStateTypeDef",
    {"Status": FailoverStatus, "FromDbClusterArn": str, "ToDbClusterArn": str},
    total=False,
)
...
TargetHealthTypeDef = TypedDict(
    "TargetHealthTypeDef",
    {"State": TargetState, "Reason": TargetHealthReason, "Description": str},
    total=False,
)
...
StopActivityStreamResponseTypeDef = TypedDict(
    "StopActivityStreamResponseTypeDef",
    {"KmsKeyId": str, "KinesisStreamName": str, "Status": ActivityStreamStatus},
    total=False,
)
