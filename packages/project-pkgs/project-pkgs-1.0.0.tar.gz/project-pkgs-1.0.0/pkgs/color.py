...
LastEditTime: 2021.04.29 19:35:44
'''
import os

# 是否启用颜色
_enable_color = os.getenv('TERM_COLOR', 'enable') != 'disable'
...
def convert_color(color: str) -> str:
    return _color_dict.get(color, _red)


def set_color(color: str) -> str:
    return '\033[%sm' % convert_color(color) if _enable_color else ''
...
if __name__ == '__main__':
    blackln('Love life, enjoy life.')
    blackln('Love life, enjoy life.', True)

    redln('Love life, enjoy life.')
    redln('Love life, enjoy life.', True)

    greenln('Love life, enjoy life.')
    greenln('Love life, enjoy life.', True)

    yellowln('Love life, enjoy life.')
    yellowln('Love life, enjoy life.', True)

    blueln('Love life, enjoy life.')
    blueln('Love life, enjoy life.', True)

    magentaln('Love life, enjoy life.')
    magentaln('Love life, enjoy life.', True)

    cyanln('Love life, enjoy life.')
    cyanln('Love life, enjoy life.', True)

    whiteln('Love life, enjoy life.')
    whiteln('Love life, enjoy life.', True)
