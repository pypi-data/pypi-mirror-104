...
class EventBridgeClient:
    """
    [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client)
    ...
    def activate_event_source(self, Name: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.activate_event_source)
    ...
    def can_paginate(self, operation_name: str) -> bool:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.can_paginate)
    ...
    def cancel_replay(self, ReplayName: str) -> CancelReplayResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.cancel_replay)
    ...
    def create_api_destination(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.create_api_destination)
    ...
    def create_archive(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.create_archive)
    ...
    def create_connection(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.create_connection)
    ...
    def create_event_bus(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.create_event_bus)
    ...
    def create_partner_event_source(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.create_partner_event_source)
    ...
    def deactivate_event_source(self, Name: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.deactivate_event_source)
    ...
    def deauthorize_connection(self, Name: str) -> DeauthorizeConnectionResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.deauthorize_connection)
    ...
    def delete_api_destination(self, Name: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_api_destination)
    ...
    def delete_archive(self, ArchiveName: str) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_archive)
    ...
    def delete_connection(self, Name: str) -> DeleteConnectionResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_connection)
    ...
    def delete_event_bus(self, Name: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_event_bus)
    ...
    def delete_partner_event_source(self, Name: str, Account: str) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_partner_event_source)
    ...
    def delete_rule(self, Name: str, EventBusName: str = None, Force: bool = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.delete_rule)
    ...
    def describe_api_destination(self, Name: str) -> DescribeApiDestinationResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_api_destination)
    ...
    def describe_archive(self, ArchiveName: str) -> DescribeArchiveResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_archive)
    ...
    def describe_connection(self, Name: str) -> DescribeConnectionResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_connection)
    ...
    def describe_event_bus(self, Name: str = None) -> DescribeEventBusResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_event_bus)
    ...
    def describe_event_source(self, Name: str) -> DescribeEventSourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_event_source)
    ...
    def describe_partner_event_source(self, Name: str) -> DescribePartnerEventSourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_partner_event_source)
    ...
    def describe_replay(self, ReplayName: str) -> DescribeReplayResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_replay)
    ...
    def describe_rule(self, Name: str, EventBusName: str = None) -> DescribeRuleResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.describe_rule)
    ...
    def disable_rule(self, Name: str, EventBusName: str = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.disable_rule)
    ...
    def enable_rule(self, Name: str, EventBusName: str = None) -> None:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.enable_rule)
    ...
    def generate_presigned_url(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.generate_presigned_url)
    ...
    def list_api_destinations(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_api_destinations)
    ...
    def list_archives(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_archives)
    ...
    def list_connections(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_connections)
    ...
    def list_event_buses(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_event_buses)
    ...
    def list_event_sources(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_event_sources)
    ...
    def list_partner_event_source_accounts(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_partner_event_source_accounts)
    ...
    def list_partner_event_sources(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_partner_event_sources)
    ...
    def list_replays(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_replays)
    ...
    def list_rule_names_by_target(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_rule_names_by_target)
    ...
    def list_rules(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_rules)
    ...
    def list_tags_for_resource(self, ResourceARN: str) -> ListTagsForResourceResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_tags_for_resource)
    ...
    def list_targets_by_rule(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.list_targets_by_rule)
    ...
    def put_events(self, Entries: List[PutEventsRequestEntryTypeDef]) -> PutEventsResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.put_events)
    ...
    def put_partner_events(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.put_partner_events)
    ...
    def put_permission(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.put_permission)
    ...
    def put_rule(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.put_rule)
    ...
    def put_targets(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.put_targets)
    ...
    def remove_permission(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.remove_permission)
    ...
    def remove_targets(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.remove_targets)
    ...
    def start_replay(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.start_replay)
    ...
    def tag_resource(self, ResourceARN: str, Tags: List["TagTypeDef"]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.tag_resource)
    ...
    def test_event_pattern(self, EventPattern: str, Event: str) -> TestEventPatternResponseTypeDef:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.test_event_pattern)
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.untag_resource)
    ...
    def update_api_destination(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.update_api_destination)
    ...
    def update_archive(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.update_archive)
    ...
    def update_connection(
        ...
        """
        [Show boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/events.html#EventBridge.Client.update_connection)
