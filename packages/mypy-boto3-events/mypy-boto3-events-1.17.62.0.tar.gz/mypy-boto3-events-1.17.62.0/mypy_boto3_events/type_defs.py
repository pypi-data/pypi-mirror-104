...
SageMakerPipelineParameterTypeDef = TypedDict(
    "SageMakerPipelineParameterTypeDef", {"Name": str, "Value": str}
)
...
CancelReplayResponseTypeDef = TypedDict(
    "CancelReplayResponseTypeDef",
    {"ReplayArn": str, "State": ReplayState, "StateReason": str},
    total=False,
)
...
CreateArchiveResponseTypeDef = TypedDict(
    "CreateArchiveResponseTypeDef",
    {"ArchiveArn": str, "State": ArchiveState, "StateReason": str, "CreationTime": datetime},
    total=False,
)
...
StartReplayResponseTypeDef = TypedDict(
    "StartReplayResponseTypeDef",
    {"ReplayArn": str, "State": ReplayState, "StateReason": str, "ReplayStartTime": datetime},
    total=False,
)
