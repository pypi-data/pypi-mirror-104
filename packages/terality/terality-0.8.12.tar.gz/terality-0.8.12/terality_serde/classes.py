...
class TypeSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, value: str) -> type:
...
class TupleSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, as_list: list) -> tuple:
...
class SliceSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, as_list: list) -> slice:
...
class DateTimeSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, isoformat: str) -> datetime:
...
class PathSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, path_as_str: str) -> Path:
...
class NumpyScalarSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls, value: str, class_name: str) -> np.number:
...
class NumpyF32Serde(NumpyScalarSerde):
    class_ = np.float32
    ...
    @classmethod
    def from_json(cls, float_as_array: str) -> np.float32:
...
class PandasMissingSerde(ExternalTypeSerializer):
    ...
    @classmethod
    def from_json(cls) -> np.number:
        return cls.class_()


class PandasNASerde(PandasMissingSerde):
    class_ = pd._libs.missing.NAType
    class_name = 'pd.NA'


class PandasNaTSerde(PandasMissingSerde):
    class_ = pd._libs.tslibs.nattype.NaTType
    class_name = 'pd.NaT'


scalar_types = [
    DateTimeSerde, TimeStampSerde,
    NumpyBoolSerde,
    NumpyU8Serde, NumpyU16Serde, NumpyU32Serde, NumpyU64Serde,
    NumpyI8Serde, NumpyI16Serde, NumpyI32Serde, NumpyI64Serde, NumpyF32Serde, NumpyF64Serde,
    PandasNASerde, PandasNaTSerde
]


all_external_types = [
    TupleSerde, SliceSerde, DateTimeSerde, TimeStampSerde, PathSerde, TypeSerde,
    NumpyBoolSerde, NumpyU8Serde, NumpyU16Serde, NumpyU32Serde, NumpyU64Serde,
    NumpyI8Serde, NumpyI16Serde, NumpyI32Serde, NumpyI64Serde, NumpyF32Serde, NumpyF64Serde,
    PandasNASerde, PandasNaTSerde
]
