...
class TestObjectAccess:
    ...
    def test_valid_object_access_2(self):
        ...
        id = "test"
        object_access = ObjectAccess(medium=ObjectAccessMedium.ASSET_MANAGER,
                                     id=id,
                                     filename="this_file")
    ...
    def test_invalid_object_access_1(self):
        with pytest.raises(ObjectAccessError):
            ObjectAccess(medium=ObjectAccessMedium.ASSET_MANAGER)

    def test_invalid_object_access_2(self):
        with pytest.raises(ObjectAccessError):
            ObjectAccess(medium=ObjectAccessMedium.URL,
                         filename="abc")
