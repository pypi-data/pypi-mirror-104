...
def main():
    ...
    parser_run.add_argument('-of', '--of', '-ofactor', '--ofactor',
                            dest='ofactor',
                            help='Provide oversampling factor (default=1)',
                            type=int,
                            default=1,
    )
    parser_run.add_argument('-oc', '--oc', '-ocorr', '--ocorr', '-overcorr', '--overcorr',
                            dest='ocorr',
                            help='Turn off oversampling correction based on time series data (or provided by -ofactor)',
                            default=True,
                            action='store_false',
    )
