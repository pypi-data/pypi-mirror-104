...
class Outputs(object):
	...
	cf_disbursement_leasepayment = tuple
	cf_disbursement_merr = tuple
	...
	cf_pretax_operating_cashflow = tuple
	...
	cf_reserve_leasepayment = tuple
	cf_reserve_leasepayment_interest = tuple
	cf_reserve_om = tuple
	...
	cf_sponsor_adj_reserve_release = tuple
	cf_sponsor_aftertax = tuple
	cf_sponsor_aftertax_cash = tuple
	cf_sponsor_aftertax_devfee = tuple
	cf_sponsor_aftertax_irr = tuple
	cf_sponsor_aftertax_npv = tuple
	cf_sponsor_aftertax_tax = tuple
	cf_sponsor_fedtax = tuple
	cf_sponsor_fedtax_income_prior_incentives = tuple
	cf_sponsor_fedtax_income_with_incentives = tuple
	cf_sponsor_fedtax_taxable_incentives = tuple
	cf_sponsor_financing_activities = tuple
	cf_sponsor_investing_activities = tuple
	cf_sponsor_lpra = tuple
	cf_sponsor_margin = tuple
	cf_sponsor_me1cs = tuple
	cf_sponsor_me1ra = tuple
	cf_sponsor_me2cs = tuple
	cf_sponsor_me2ra = tuple
	cf_sponsor_me3cs = tuple
	cf_sponsor_me3ra = tuple
	cf_sponsor_mecs = tuple
	cf_sponsor_operating_activities = tuple
	cf_sponsor_operating_margin = tuple
	cf_sponsor_pretax = tuple
	cf_sponsor_pretax_irr = tuple
	cf_sponsor_pretax_npv = tuple
	cf_sponsor_ra = tuple
	cf_sponsor_receivablesra = tuple
	cf_sponsor_statax = tuple
	cf_sponsor_statax_income_prior_incentives = tuple
	cf_sponsor_statax_income_with_incentives = tuple
	cf_sponsor_statax_taxable_incentives = tuple
	cf_sponsor_wcra = tuple
	...
	cf_tax_investor_fedtax = tuple
	cf_tax_investor_fedtax_income_prior_incentives = tuple
	cf_tax_investor_fedtax_income_with_incentives = tuple
	cf_tax_investor_fedtax_taxable_incentives = tuple
	cf_tax_investor_financing_activities = tuple
	cf_tax_investor_investing_activities = tuple
	cf_tax_investor_operating_activities = tuple
	cf_tax_investor_pretax = tuple
	cf_tax_investor_pretax_cashflow = tuple
	cf_tax_investor_pretax_irr = tuple
	cf_tax_investor_pretax_npv = tuple
	cf_tax_investor_statax = tuple
	cf_tax_investor_statax_income_prior_incentives = tuple
...
def default(config) -> Saleleaseback:
	pass

def new() -> Saleleaseback:
	pass

def wrap(ssc_data_t) -> Saleleaseback:
	pass

def from_existing(model, config="") -> Saleleaseback:
	pass
