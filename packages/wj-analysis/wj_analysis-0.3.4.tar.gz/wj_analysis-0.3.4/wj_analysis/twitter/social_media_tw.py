...
class SocialpresTW():
    ...
    def c_pres_tw(self):
        ...
        try:
            ...
            df_med_c = df_m2.drop(
                columns=['created_at', 'description', 'text', 'tweet_id', "auto"]).groupby(
                    'screen_name')
    ...
    def id_pres_tw(self):
        ...
        """
        col_med = [
            'created_at', 'description', 'text', 'tweet_id', 'in_reply_to_status_id', 'screen_name'
        ]
        ...
        auto_n = self.auto_n
        thread = self.thread
        df_empty_id = pd.DataFrame(columns=['created_at', 'text', 'screen_name', 'tweet_id'])
        ...
        try:
            ...
            df_med_id = df_m2[[
                "created_at", "text", "screen_name", "tweet_id", 'in_reply_to_status_id', brand
            ]]
