...
class Traceability():
    ...
    def __init__(self, df_pages, groups):
        ...
        if len(df_pages) > 0:
            try:
                ...
                df_fan_count = df_fan_count.groupby(['userid', 'username',
    ...
    def absolute(self):
        ...
        try:
            return df_fan_count[['group', 'userid', 'username', 'date',
    ...
    def differences(self):
        ...
        try:
            ...
            return df_fan_count_diff[['group', 'userid', 'username', 'date',
                                      'value']].dropna(subset=['value'])
    ...
    def percentage(self):
        ...
        try:
            ...
            return df_fan_count_perc[['group', 'userid', 'username', 'date',
                                      'value']].dropna(subset=['value'])
