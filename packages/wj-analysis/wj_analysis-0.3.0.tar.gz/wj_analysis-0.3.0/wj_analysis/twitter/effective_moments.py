...
class EffectMomentsTW():
    ...
    def moments(self):
        ...
        colum_tweet = ['twitter_id', 'group', 'screen_name', 'tweet_id',
                       'created_at', 'engagement_rate_by_post',
        ...
        try:
            ...
            df_eff_day = df_eff_day.rename(columns={'twitter_id': '_object_id',
            ...
            df_eff_hours = df_eff_hours.rename(columns={'twitter_id': '_object_id',
                                                        'screen_name': '_object_name',
                                                        'tweet_id': 'counts'})
            ...
            df_eff_days_hours = df_eff_days_hours.rename(columns={'twitter_id': '_object_id',
                                                                  'screen_name': '_object_name',
                                                                  'tweet_id': 'counts'})
