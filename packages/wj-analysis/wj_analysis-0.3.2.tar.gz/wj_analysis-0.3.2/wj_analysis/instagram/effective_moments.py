...
class EffectMomentsIG():
    ...
    def moments(self):
        ...
        colum_ig = ['owner_id', 'created_at', 'owner_username', 'shortcode',
                    'group', 'engagement_rate_by_post',
        ...
        try:
            ...
            df_eff_day = df_eff_day.rename(columns={'owner_id': '_object_id',
            ...
            df_eff_hours = df_eff_hours.rename(columns={'owner_id': '_object_id',
                                                        'owner_username': '_object_name',
                                                        'shortcode': 'counts'})
            ...
            df_eff_days_hours = df_eff_days_hours.rename(columns={'owner_id': '_object_id',
                                                                  'owner_username': '_object_name',
                                                                  'shortcode': "counts"})
