...
class Traceability():
    ...
    def absolute(self):
        ...
        try:
            ...
            print(e)
            print(f'Class: {self.__str__()}\nMethod: {METHOD_NAME}\n')
            return pd.DataFrame(columns=['group', 'page_id', 'name', 'date', 'value']).dropna(
                subset=['value'])
    ...
    def differences(self):
        ...
        try:
            ...
            return df_fan_count_diff[['group', 'page_id', 'name', 'date',
    ...
    def percentage(self):
        ...
        try:
            ...
            return df_fan_count_perc[['group', 'page_id', 'name', 'date',
                                      'value']].dropna(subset=['value'])
