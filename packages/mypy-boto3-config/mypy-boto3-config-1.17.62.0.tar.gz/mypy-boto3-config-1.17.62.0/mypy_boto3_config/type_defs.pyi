...
AggregateConformancePackComplianceCountTypeDef = TypedDict(
    "AggregateConformancePackComplianceCountTypeDef",
    {"CompliantConformancePackCount": int, "NonCompliantConformancePackCount": int},
    total=False,
)

AggregateConformancePackComplianceSummaryTypeDef = TypedDict(
    "AggregateConformancePackComplianceSummaryTypeDef",
    {"ComplianceSummary": "AggregateConformancePackComplianceCountTypeDef", "GroupName": str},
    total=False,
)
...
_RequiredAggregateResourceIdentifierTypeDef = TypedDict(
    ...
    {"SourceAccountId": str, "SourceRegion": str, "ResourceId": str, "ResourceType": ResourceType},
)
...
ConformancePackComplianceSummaryTypeDef = TypedDict(
    "ConformancePackComplianceSummaryTypeDef",
    {"ConformancePackName": str, "ConformancePackComplianceStatus": ConformancePackComplianceType},
)
...
ConformancePackRuleComplianceTypeDef = TypedDict(
    "ConformancePackRuleComplianceTypeDef",
    {"ConfigRuleName": str, "ComplianceType": ConformancePackComplianceType, "Controls": List[str]},
    total=False,
)
...
_RequiredMemberAccountStatusTypeDef = TypedDict(
    ...
    {"AccountId": str, "ConfigRuleName": str, "MemberAccountRuleStatus": MemberAccountRuleStatus},
)
...
_RequiredOrganizationConfigRuleStatusTypeDef = TypedDict(
    ...
    {"OrganizationConfigRuleName": str, "OrganizationRuleStatus": OrganizationRuleStatus},
)
...
_RequiredOrganizationConformancePackDetailedStatusTypeDef = TypedDict(
    ...
    {"AccountId": str, "ConformancePackName": str, "Status": OrganizationResourceDetailedStatus},
)
...
_RequiredOrganizationConformancePackStatusTypeDef = TypedDict(
    ...
    {"OrganizationConformancePackName": str, "Status": OrganizationResourceStatus},
)
...
RecordingGroupTypeDef = TypedDict(
    "RecordingGroupTypeDef",
    {"allSupported": bool, "includeGlobalResourceTypes": bool, "resourceTypes": List[ResourceType]},
    total=False,
)

RelationshipTypeDef = TypedDict(
    "RelationshipTypeDef",
    {"resourceType": ResourceType, "resourceId": str, "resourceName": str, "relationshipName": str},
    total=False,
)

_RequiredRemediationConfigurationTypeDef = TypedDict(
    "_RequiredRemediationConfigurationTypeDef",
    {"ConfigRuleName": str, "TargetType": RemediationTargetType, "TargetId": str},
)
...
ResourceCountTypeDef = TypedDict(
    "ResourceCountTypeDef", {"resourceType": ResourceType, "count": int}, total=False
)
...
ResourceKeyTypeDef = TypedDict(
    "ResourceKeyTypeDef", {"resourceType": ResourceType, "resourceId": str}
)

ResourceValueTypeDef = TypedDict("ResourceValueTypeDef", {"Value": ResourceValueType})
...
_RequiredSourceTypeDef = TypedDict(
    "_RequiredSourceTypeDef", {"Owner": Owner, "SourceIdentifier": str}
)
...
ConfigRuleComplianceFiltersTypeDef = TypedDict(
    "ConfigRuleComplianceFiltersTypeDef",
    {"ConfigRuleName": str, "ComplianceType": ComplianceType, "AccountId": str, "AwsRegion": str},
    total=False,
)
...
ConformancePackComplianceFiltersTypeDef = TypedDict(
    "ConformancePackComplianceFiltersTypeDef",
    {"ConfigRuleNames": List[str], "ComplianceType": ConformancePackComplianceType},
    total=False,
)
...
OrganizationResourceDetailedStatusFiltersTypeDef = TypedDict(
    "OrganizationResourceDetailedStatusFiltersTypeDef",
    {"AccountId": str, "Status": OrganizationResourceDetailedStatus},
    total=False,
)
...
ResourceCountFiltersTypeDef = TypedDict(
    "ResourceCountFiltersTypeDef",
    {"ResourceType": ResourceType, "AccountId": str, "Region": str},
    total=False,
)
...
StatusDetailFiltersTypeDef = TypedDict(
    "StatusDetailFiltersTypeDef",
    {"AccountId": str, "MemberAccountRuleStatus": MemberAccountRuleStatus},
    total=False,
)
