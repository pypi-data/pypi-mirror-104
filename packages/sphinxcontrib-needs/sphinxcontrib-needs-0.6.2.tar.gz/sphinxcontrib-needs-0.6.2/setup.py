...
install_requires = \
['sphinx-copybutton>=0.3.0,<0.4.0', 'sphinxcontrib-plantuml']

extras_require = \
{':(python_version >= "3.6" and python_version < "3.7") and (extra == "docs")': ['sphinx>2.2,<=3.0'],
 ':python_version >= "3.6" and python_version < "4.0"': ['matplotlib>=3.1.0,<4.0.0'],
 ':python_version >= "3.7" and python_version < "4.0"': ['sphinx>2.2,<=4.0']}
