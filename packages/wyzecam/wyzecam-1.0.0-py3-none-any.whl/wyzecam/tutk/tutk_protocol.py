...
class TutkWyzeProtocolMessage(object):
    """
    ...
    """
    The expected response code for this type of message.
    """
...
class K10000ConnectRequest(TutkWyzeProtocolMessage):
    ...
    def __init__(self):
        ...
        super(K10000ConnectRequest, self).__init__(10000)
...
class K10002ConnectAuth(TutkWyzeProtocolMessage):
    ...
    def __init__(
        ...
        """
        super(K10002ConnectAuth, self).__init__(10002)
...
class K10008ConnectUserAuth(TutkWyzeProtocolMessage):
    ...
    def __init__(
        ...
        :param open_audio: True if we wish to start streaming audio after authentication is successful.
        """
        super(K10008ConnectUserAuth, self).__init__(10008)
...
class K10010ControlChannel(TutkWyzeProtocolMessage):
    ...
    def __init__(self, k: int = 1, v: int = 2):
        super(K10010ControlChannel, self).__init__(10010)
...
class K10020CheckCameraInfo(TutkWyzeProtocolMessage):
    ...
    def __init__(self):
        super(K10020CheckCameraInfo, self).__init__(10020)
...
class K10056SetResolvingBit(TutkWyzeProtocolMessage):
    ...
    def __init__(
        ...
        """
        super(K10056SetResolvingBit, self).__init__(10056)
...
class K10620CheckNight(TutkWyzeProtocolMessage):
    ...
    def __init__(self):
        super(K10620CheckNight, self).__init__(10620)
...
class K10640GetSpotlightStatus(TutkWyzeProtocolMessage):
    ...
    def __init__(self):
        super(K10640GetSpotlightStatus, self).__init__(10640)
