...
[boto3.MediaPackage 1.17.61](https://boto3.amazonaws.com/v1/documentation/api/1.17.61/reference/services/mediapackage.html#MediaPackage) service
compatible with
...
`mypy_boto3_mediapackage.literals` module contains literals extracted from shapes
