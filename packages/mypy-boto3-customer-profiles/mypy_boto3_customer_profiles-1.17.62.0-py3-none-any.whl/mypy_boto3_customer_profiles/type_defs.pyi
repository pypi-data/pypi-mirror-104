...
MatchItemTypeDef = TypedDict(
    "MatchItemTypeDef", {"MatchId": str, "ProfileIds": List[str]}, total=False
)

MatchingResponseTypeDef = TypedDict("MatchingResponseTypeDef", {"Enabled": bool}, total=False)
...
MatchingRequestTypeDef = TypedDict("MatchingRequestTypeDef", {"Enabled": bool})

MergeProfilesResponseTypeDef = TypedDict(
    "MergeProfilesResponseTypeDef", {"Message": str}, total=False
)
